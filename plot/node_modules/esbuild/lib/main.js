  ...
  let handleIncomingPacket = (bytes) => {
    if (isFirstPacket) {
      ...
      if (binaryVersion !== "0.14.23") {
        throw new Error(
          `Cannot start service: Host version "${"0.14.23"}" does not match binary version ${
...
var ensureServiceIsRunning = () => {
  ...
  let child = child_process.spawn(
    command,
    args.concat(`--service=${"0.14.23"}`, "--ping"),
    {
      windowsHide: true,
