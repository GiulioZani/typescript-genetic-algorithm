...
e = this,
  t = function (e) {
    ...
    "undefined" != typeof window && "function" == typeof window.btoa
      ...
      } : "function" == typeof Buffer && (l = function (e) {
    ...
    var c = function (e) {
      this.version = 3,
        ...
        this.mappings = function (e) {
          for (
            var t = 0, s = 0, i = 0, n = 0, r = "", o = 0; o < e.length; o++
          ) {
            var h = e[o];
            if (o > 0 && (r += ";"), 0 !== h.length) {
    ...
    var y = "\n",
      E = { insertLeft: !1, insertRight: !1, storeName: !1 },
      x = function (e, t) {
        void 0 === t && (t = {});
    ...
    x.prototype.addSourcemapLocation = function (e) {
      ...
      x.prototype.overwrite = function (e, t, s, i) {
        ...
        var o = this.byStart[e], l = this.byEnd[t];
        if (o) {
      ...
      x.prototype.lastLine = function () {
        var e = this.outro.lastIndexOf(y);
        if (-1 !== e) return this.outro.substr(e + 1);
        var t = this.outro, s = this.lastChunk;
        do {
          if (s.outro.length > 0) {
            if (-1 !== (e = s.outro.lastIndexOf(y))) {
              return s.outro.substr(e + 1) + t;
            }
            t = s.outro + t;
          }
          if (s.content.length > 0) {
            if (-1 !== (e = s.content.lastIndexOf(y))) {
              return s.content.substr(e + 1) + t;
            }
            t = s.content + t;
          }
          if (s.intro.length > 0) {
            if (-1 !== (e = s.intro.lastIndexOf(y))) {
              return s.intro.substr(e + 1) + t;
            }
            t = s.intro + t;
          }
        } while (s = s.previous);
        return -1 !== (e = this.intro.lastIndexOf(y))
          ? this.intro.substr(e + 1) + t : this.intro + t;
      },
      x.prototype.slice = function (e, t) {
        ...
        for (; t < 0;) t += this.original.length;
        for (
          var s = "", i = this.firstChunk; i && (i.start > e || i.end <= e);
        ) {
    ...
    b.prototype.addSource = function (e) {
      if (e instanceof x) {
      ...
      if (
        ["filename", "indentExclusionRanges", "separator"].forEach(
          function (t) {
            v.call(e, t) || (e[t] = e.content[t]);
          },
        ),
          void 0 === e.separator && (e.separator = this.separator),
          e.filename
      ) {
        if (v.call(this.uniqueSourceIndexByFilename, e.filename)) {
          var t =
      ...
      b.prototype.clone = function () {
        var e = new b({ intro: this.intro, separator: this.separator });
      ...
      b.prototype.generateDecodedMap = function (e) {
        var t = this;
        void 0 === e && (e = {});
        var s = [];
      ...
      b.prototype.generateMap = function (e) {
        return new c(this.generateDecodedMap(e));
      },
      ...
      b.prototype.prepend = function (e) {
        return this.intro = e + this.intro, this;
      },
      ...
      b.prototype.trimLines = function () {
        return this.trim("[\\r\\n]");
      },
      b.prototype.trim = function (e) {
        return this.trimStart(e).trimEnd(e);
      },
      b.prototype.trimStart = function (e) {
        var t = new RegExp("^" + (e || "\\s") + "+");
      ...
      b.prototype.trimEnd = function (e) {
    ...
    class F {
      constructor() {
        this.entityPaths = Object.create(null, { [B]: { value: new Set() } });
      }
      ...
      getEntities(e) {
        ...
        for (const s of e) {
          t = t[s] = t[s] || Object.create(null, { [B]: { value: new Set() } });
        }
        return t[B];
      }
    }
    ...
    class W {
      constructor() {
        this.entityPaths = Object.create(null, { [B]: { value: new Map() } });
      }
      trackEntityAtPathAndGetIfTracked(e, t, s) {
        let i = this.entityPaths;
        for (const t of e) {
          i = i[t] = i[t] || Object.create(null, { [B]: { value: new Map() } });
        }
    ...
    function ee(e) {
      const t = I(e);
      return t.substr(0, t.length - _(e).length);
    }
    function te(e) {
      return k(e) ? $(T(), e) : e;
    }
    ...
    function ne(e, t, s, i) {
      if ("object" == typeof t) {
        ...
        e.pos = t;
        const { line: n, column: r } = Q(s, t, { offsetLine: 1 });
    ...
    var re;
    function ae({ fileName: e, code: t }, s) {
      const i = {
        code: re.CHUNK_INVALID,
        message: `Chunk "${e}" is not valid JavaScript: ${s.message}.`,
      };
      return ne(i, s.loc, t, e), i;
    }
    function oe(e, t, s) {
      return {
        code: "INVALID_EXPORT_OPTION",
        message:
          `"${e}" was specified for "output.exports", but entry module "${
            te(s)
    ...
    function le(e, t, s) {
      return {
        code: re.MISSING_EXPORT,
        message: `'${e}' is not exported by ${te(s)}, imported by ${te(t)}`,
        url:
          "https://rollupjs.org/guide/en/#error-name-is-not-exported-by-module",
      };
    }
    function ce(e) {
      const t = Array.from(e.implicitlyLoadedBefore, (e) => te(e.id)).sort();
      return {
        code: re.MISSING_IMPLICIT_DEPENDANT,
        message: `Module "${
          te(e.id)
    ...
    function ue(e, t, s) {
      ...
      return {
        code: re.UNEXPECTED_NAMED_IMPORT,
        id: e,
    ...
    function pe(e) {
      return { code: re.VALIDATION_ERROR, message: e };
    }
    function fe() {
      return {
        code: re.ALREADY_CLOSED,
        message:
          'Bundle is already closed, no more calls to "generate" or "write" are allowed.',
      };
    }
    function me(e, t, s) {
      ge(e, t, s.onwarn, s.strictDeprecations);
    }
    function ge(e, t, s, i) {
      if (t || i) {
        const t = function (e) {
          return {
            code: re.DEPRECATED_FEATURE,
    ...
    const Ee = /[^$_a-zA-Z0-9]/g, xe = (e) => /\d/.test(e[0]);
    function ve(e) {
      return e = e.replace(/-(\w)/g, (e, t) => t.toUpperCase()).replace(
        Ee,
        "_",
      ),
        (xe(e) || ye.has(e)) && (e = `_${e}`),
    ...
    class be {
      constructor(e, t, s, i, n) {
        this.options = e,
          ...
          this.used = !1,
          this.variableName = "",
          this.suggestedVariableName = ve(t.split(/[\\/]/).pop());
        const { importers: r, dynamicImporters: a } = this,
          o = this.info = {
            ast: null,
            code: null,
            dynamicallyImportedIdResolutions: Y,
      ...
      getVariableForExportName(e) {
        ...
        return t ||
          (this.declarations[e] = t = new q(this, e),
    ...
    const Se = {
        ArrayPattern(e, t) {
          for (const s of t.elements) s && Se[s.type](e, s);
        },
        AssignmentPattern(e, t) {
          Se[t.left.type](e, t.left);
        },
        Identifier(e, t) {
          e.push(t.name);
        },
        ...
        ObjectPattern(e, t) {
          for (const s of t.properties) {
            "RestElement" === s.type
              ? Se.RestElement(e, s)
              : Se[s.value.type](e, s.value);
          }
        },
        RestElement(e, t) {
          Se[t.argument.type](e, t.argument);
        },
      },
      Ae = function (e) {
        const t = [];
        return Se[e.type](t, e), t;
      };
    function Pe() {
      return {
        brokenFlow: 0,
    ...
    const Ie = new class extends U {
        getLiteralValueAtPath() {}
      }(),
      Ne = { value: { callsArgs: null, returns: G } },
      _e = new class extends U {
        getReturnExpressionWhenCalledAtPath(e) {
          return 1 === e.length ? ze(Oe, e[0]) : G;
        }
        hasEffectsWhenAccessedAtPath(e) {
          return e.length > 1;
        }
        hasEffectsWhenCalledAtPath(e, t, s) {
          return 1 !== e.length || Fe(Oe, e[0], t, s);
        }
      }(),
      $e = { value: { callsArgs: null, returns: _e } },
      Te = new class extends U {
        getReturnExpressionWhenCalledAtPath(e) {
          return 1 === e.length ? ze(Ve, e[0]) : G;
        }
        hasEffectsWhenAccessedAtPath(e) {
          return e.length > 1;
        }
        hasEffectsWhenCalledAtPath(e, t, s) {
          return 1 !== e.length || Fe(Ve, e[0], t, s);
        }
      }(),
      Re = { value: { callsArgs: null, returns: Te } },
      Me = new class extends U {
        getReturnExpressionWhenCalledAtPath(e) {
          return 1 === e.length ? ze(Be, e[0]) : G;
        }
        hasEffectsWhenAccessedAtPath(e) {
          return e.length > 1;
        }
        hasEffectsWhenCalledAtPath(e, t, s) {
          return 1 !== e.length || Fe(Be, e[0], t, s);
        }
      }(),
      ...
      Be = Ce({
        ...
        padStart: De,
        repeat: De,
        replace: { value: { callsArgs: [1], returns: Me } },
        replaceAll: { value: { callsArgs: [1], returns: Me } },
        search: Re,
        slice: De,
        small: De,
        split: Ne,
    ...
    function Fe(e, t, s, i) {
      ...
      for (const n of e[t].callsArgs) {
        if (
          s.args[n] &&
          s.args[n].hasEffectsWhenCalledAtPath(L, {
            args: we,
            thisParam: null,
            withNew: !1,
          }, i)
    ...
    Ue.Program = Ue.BlockStatement = Ue.StaticBlock = function (e, t, s) {
      ...
      Ue.BreakStatement = Ue.ContinueStatement = je,
      ...
      Ue.ObjectPattern = function (e, t, s) {
        for (var i = 0, n = e.properties; i < n.length; i += 1) {
          var r = n[i];
          "Property" === r.type
            ? (r.computed && s(r.key, t, "Expression"),
              s(r.value, t, "Pattern"))
            : "RestElement" === r.type && s(r.argument, t, "Pattern");
        }
      },
      Ue.Expression = We,
      Ue.ThisExpression = Ue.Super = Ue.MetaProperty = je,
      ...
      Ue.FunctionExpression = Ue.ArrowFunctionExpression =
      ...
      Ue.ExportNamedDeclaration = Ue.ExportDefaultDeclaration = function (
        e,
        t,
        s,
      ) {
      ...
      Ue.ImportSpecifier = Ue.ImportDefaultSpecifier = Ue
        .ImportNamespaceSpecifier = Ue.Identifier = Ue.PrivateIdentifier = Ue
          .Literal = je,
    ...
    const Ge = "ArrowFunctionExpression",
      He = "BlockStatement",
      qe = "CallExpression",
      Ke = "ExpressionStatement",
      Xe = "Identifier",
      Ye = "Program";
    let Qe = "sourceMa";
    Qe += "ppingURL";
    const Ze = new RegExp(
      ...
      Je = "_rollupAnnotations",
      et = "_rollupRemoved";
    function tt(e, t, s = e.type) {
      const { annotations: i } = t;
      let n = i[t.annotationIndex];
      for (; n && e.start >= n.end;) {
        nt(e, n, t.code), n = i[++t.annotationIndex];
      }
      if (n && n.end <= e.end) {
        for (Ue[s](e, t, tt); (n = i[t.annotationIndex]) && n.end <= e.end;) {
    ...
    function nt(e, t, s) {
      const i = [];
      let n;
      if (rt(s.slice(t.end, e.start), st)) {
        const t = e.start;
        for (;;) {
      ...
      if (n) ot(e, t, !1);
      else for (const e of i) ot(e, t, !0);
    }
    function rt(e, t) {
      let s;
      for (; null !== (s = t.exec(e));) {
    ...
    const at = /[@#]__PURE__/;
    function ot(e, t, s) {
      const i = s ? Je : et, n = e[i];
      n ? n.push(t) : e[i] = [t];
    }
    const ht = { Literal: [], Program: ["body"] }, lt = "variables";
    class ct extends U {
      constructor(e, t, s) {
        super(),
          this.esTreeNode = e,
          this.keys = ht[e.type] || function (e) {
            return ht[e.type] = Object.keys(e).filter(
        ...
        for (const [t, s] of Object.entries(e)) {
          if (!this.hasOwnProperty(t)) {
            if (95 === t.charCodeAt(0)) {
              if (t === Je) this.annotations = s;
              else if (t === et) {
                for (const { start: e, end: t } of s) {this.context.magicString
                    .remove(e, t);}
              }
      ...
      render(e, t) {
        for (const s of this.keys) {
          ...
          if (null !== i) {
            if (Array.isArray(i)) {
              for (const s of i) null !== s && s.render(e, t);
            } else i.render(e, t);
          }
        }
      }
      shouldBeIncluded(e) {
        return this.included || !e.brokenFlow && this.hasEffects(ke());
      }
    ...
    class ut extends ct {
      ...
      deoptimizeThisOnEventAtPath(e, t, s, i) {
        t.length > 0 &&
          this.argument.deoptimizeThisOnEventAtPath(e, [M, ...t], s, i);
      }
      hasEffects(e) {
        ...
        return this.argument.hasEffects(e) ||
          t &&
            ("always" === t ||
              this.argument.hasEffectsWhenAccessedAtPath(O, e));
      }
      applyDeoptimizations() {
        this.deoptimized = !0,
          this.argument.deoptimizePath([M, M]),
        ...
        if (
          ...
          !0 === this.description.mutatesSelfAsArray &&
            (null === (i = t.thisParam) || void 0 === i
              ? void 0
              : i.hasEffectsWhenAssignedAtPath(V, s))
        ) {
          return !0;
        }
        ...
        for (const e of this.description.callsArgs) {
          if (
            null === (n = t.args[e]) || void 0 === n
              ? void 0
              : n.hasEffectsWhenCalledAtPath(L, {
                args: we,
                thisParam: null,
                withNew: !1,
              }, s)
    ...
    class Et extends U {
      ...
      deoptimizeAllProperties() {
        ...
        if (!this.hasUnknownDeoptimizedProperty) {
          ...
          for (
            ...
            for (const t of e) t.deoptimizePath(O);
          }
          null === (e = this.prototypeExpression) || void 0 === e ||
          e.deoptimizePath([M, M]), this.deoptimizeCachedEntities();
        }
      }
      deoptimizeIntegerProperties() {
        if (
          ...
          for (const [e, t] of Object.entries(this.propertiesAndGettersByKey)) {
            if (yt.test(e)) for (const e of t) e.deoptimizePath(O);
          }
      ...
      deoptimizePath(e) {
        ...
        const i = 1 === e.length ? O : e.slice(1);
        for (
        ...
        null === (t = this.prototypeExpression) || void 0 === t ||
          t.deoptimizePath(1 === e.length ? [M, M] : e);
      }
      deoptimizeThisOnEventAtPath(e, t, s, i) {
        var n;
        const [r, ...a] = t;
        if (
          ...
          return void s.deoptimizePath(O);
        }
      ...
      getLiteralValueAtPath(e, t, s) {
        ...
        return n ? n.getLiteralValueAtPath(e.slice(1), t, s)
      ...
      getReturnExpressionWhenCalledAtPath(e, t, s, i) {
        ...
        return r ? r.getReturnExpressionWhenCalledAtPath(e.slice(1), t, s, i)
        : this.prototypeExpression
      ...
      hasEffectsWhenAccessedAtPath(e, t) {
        ...
        if ("string" == typeof s) {
          ...
          for (
            ...
            for (const s of e) {if (s.hasEffectsWhenAccessedAtPath(i, t)) {
                return !0;
              }}
          }
        }
      ...
      hasEffectsWhenCalledAtPath(e, t, s) {
        ...
        return n ? n.hasEffectsWhenCalledAtPath(e.slice(1), t, s)
        : !this.prototypeExpression ||
      ...
      deoptimizeCachedIntegerEntities() {
        for (
          const [e, t] of Object.entries(this.expressionsToBeDeoptimizedByKey)
        ) {
          if (yt.test(e)) for (const e of t) e.deoptimizeCache();
        }
    ...
    class Rt extends H {
      ...
      consolidateInitializers() {
        if (null !== this.additionalInitializers) {
          for (const e of this.additionalInitializers) e.deoptimizePath(O);
          this.additionalInitializers = null;
        }
      }
      deoptimizePath(e) {
        ...
        if (
          ...
          if (0 === e.length) {
            if (!this.isReassigned) {
              ...
              this.expressionsToBeDeoptimized = [];
              for (const t of e) t.deoptimizeCache();
              null === (t = this.init) || void 0 === t || t.deoptimizePath(O);
            }
          } else {
            null === (s = this.init) || void 0 === s || s.deoptimizePath(e);
          }
        }
      }
      deoptimizeThisOnEventAtPath(e, t, s, i) {
        if (this.isReassigned || !this.init) return s.deoptimizePath(O);
      ...
      getLiteralValueAtPath(e, t, s) {
        return this.isReassigned || !this.init ? j
      ...
      getReturnExpressionWhenCalledAtPath(e, t, s, i) {
        return this.isReassigned || !this.init ? G
      ...
      hasEffectsWhenAssignedAtPath(e, t) {
        return !!this.included ||
          0 !== e.length &&
            (!!this.isReassigned ||
              this.init &&
                !t.accessed.trackEntityAtPathAndGetIfTracked(e, this) &&
      ...
      include() {
        if (!this.included) {
          ...
          for (const e of this.declarations) {
            e.included || e.include(Pe(), !1);
            let t = e.parent;
            for (; !t.included && (t.included = !0, t.type !== Ye);) {
              t = t.parent;
            }
          }
        }
    ...
    class Lt {
      ...
      addDeclaration(e, t, s, i) {
        ...
        return r
          ...
          : (r = new Rt(e.name, e, s || Ie, t), this.variables.set(n, r)),
          r;
      }
      contains(e) {
    ...
    class Ot extends Lt {
      ...
      addAccessedDynamicImport(e) {
        (this.accessedDynamicImports ||
          (this.accessedDynamicImports = new Set())).add(e),
          this.parent instanceof Ot && this.parent.addAccessedDynamicImport(e);
      }
      addAccessedGlobals(e, t) {
        const s = t.get(this) || new Set();
        for (const t of e) s.add(t);
        t.set(this, s),
          this.parent instanceof Ot && this.parent.addAccessedGlobals(e, t);
      }
      ...
      deconflict(e, t, s) {
        ...
        for (const [e, t] of this.variables) {
          (t.included || t.alwaysRendered) && t.setRenderNames(null, Dt(e, i));
        }
    ...
    class Vt extends Ot {
      constructor(e, t) {
        super(e),
          ...
          this.hasRest = !1,
          this.context = t,
          this.hoistedBodyVarScope = new Ot(this);
      }
      addParameterDeclaration(e) {
        const t = e.name;
        let s = this.hoistedBodyVarScope.variables.get(t);
        return s
          ? s.addDeclaration(e, null)
          : s = new Rt(t, e, G, this.context),
    ...
    class Bt extends Vt {
      ...
      updateReturnExpression() {
        if (1 === this.returnExpressions.length) {
          ...
          for (const e of this.returnExpressions) e.deoptimizePath(O);
        }
      }
    }
    function Ft(e, t, s, i) {
    ...
    function zt(e, t) {
      if (
        e.annotations || e.parent.type !== Ke || (e = e.parent), e.annotations
      ) {
        for (const s of e.annotations) t.remove(s.start, s.end);
      }
    }
    const Wt = { isNoStatement: !0 };
    function jt(e, t, s = 0) {
      let i, n;
      for (i = e.indexOf(t, s);;) {
    ...
    const Ut = /\S/g;
    function Gt(e, t) {
      return Ut.lastIndex = t, Ut.exec(e).index;
    }
    function Ht(e) {
      let t, s, i = 0;
      for (t = e.indexOf("\n", i);;) {
    ...
    function qt(e, t, s, i, n) {
      ...
      c && (h = s + Ht(t.original.slice(s, l.start))[1]);
      for (let s = 1; s <= e.length; s++) {
        r = l,
          ...
          o || c
            ? (h = r.end +
              Ht(t.original.slice(r.end, void 0 === l ? i : l.start))[1],
              r.included
    ...
    function Kt(e, t, s, i) {
      ...
      for (let i = 0; i < e.length; i++) {
        for (
          a = e[i],
            void 0 !== r &&
            (c = r.end + jt(t.original.slice(r.end, a.start), ",")),
            o = h = c + 1 + Ht(t.original.slice(c + 1, a.start))[1];
    ...
    function Xt(e, t, s) {
      for (;;) {
        const [i, n] = Ht(e.original.slice(t, s));
        if (-1 === i) break;
        e.remove(t + i, t += n);
      }
    }
    ...
    class Qt extends ct {
      ...
      shouldBeIncluded(e) {
        return this.directive && "use strict" !== this.directive
          ? this.parent.type !== Ye : super.shouldBeIncluded(e);
      }
    }
    class Zt extends ct {
      constructor() {
      ...
      createScope(e) {
        this.scope = this.parent.preventChildBlockScope ? e : new Yt(e);
      }
      hasEffects(e) {
      ...
      initialise() {
        const e = this.body[0];
        this.deoptimizeBody = e instanceof Qt && "use asm" === e.directive;
      }
      render(e, t) {
        this.body.length ? qt(this.body, e, this.start + 1, this.end - 1, t)
        : super.render(e, t);
      }
    }
    function Jt(e, t) {
      if ("MemberExpression" === e.type) return !e.computed && Jt(e.object, e);
    ...
    const es = Symbol("Value Properties"),
      ts = { pure: !0 },
      ss = { pure: !1 },
      is = { __proto__: null, [es]: ss },
      ns = { __proto__: null, [es]: ts },
      rs = { __proto__: null, [es]: ss, prototype: is },
      as = { __proto__: null, [es]: ts, prototype: is },
      os = { __proto__: null, [es]: ts, from: ns, of: ns, prototype: is },
      hs = { __proto__: null, [es]: ts, supportedLocalesOf: as },
      ls = {
        global: is,
        globalThis: is,
        self: is,
        ...
        ArrayBuffer: { __proto__: null, [es]: ts, isView: ns, prototype: is },
        Atomics: is,
        BigInt: rs,
        BigInt64Array: rs,
        BigUint64Array: rs,
    ...
    for (const e of ["window", "global", "self", "globalThis"]) ls[e] = ls;
    function cs(e) {
      let t = ls;
      for (const s of e) {
    ...
    class us extends H {
      ...
      hasEffectsWhenAccessedAtPath(e) {
        return !function (e) {
          return 1 === e.length ? "undefined" === e[0] || null !== cs(e)
          : null !== cs(e.slice(0, -1));
        }([this.name, ...e]);
      }
    ...
    const ds = { __proto__: null, class: !0, const: !0, let: !0, var: !0 };
    class ps extends ct {
      constructor() {
        super(...arguments),
          this.variable = null,
      ...
      bind() {
        null === this.variable && Jt(this, this.parent) &&
      ...
      getReturnExpressionWhenCalledAtPath(e, t, s, i) {
        return this.getVariableRespectingTDZ()
          .getReturnExpressionWhenCalledAtPath(e, t, s, i);
      }
      hasEffects() {
        return this.deoptimized || this.applyDeoptimizations(),
          ...
          this.context.options.treeshake.unknownGlobalSideEffects &&
            this.variable instanceof us &&
            this.variable.hasEffectsWhenAccessedAtPath(L);
      }
      hasEffectsWhenAccessedAtPath(e, t) {
      ...
      isPossibleTDZ() {
        ...
        if (
          !(this.variable instanceof Rt && this.variable.kind &&
            this.variable.kind in ds)
        ) {
        ...
        return this.variable.declarations &&
            ...
            fs(this) === fs(e) ? this.isTDZAccess = !0
        : this.variable.initReached ? this.isTDZAccess = !1
        : this.isTDZAccess = !0;
      }
      ...
      render(
        ...
        if (this.variable) {
          ...
          (e.overwrite(this.start, this.end, r, {
            ...
            "eval" === r && s === qe && i && e.appendRight(this.start, "0, ");
        }
      }
      applyDeoptimizations() {
        this.deoptimized = !0,
          null !== this.variable && this.variable instanceof Rt &&
    ...
    class ms extends ct {
      ...
      applyDeoptimizations() {
        this.deoptimized = !0,
          ...
          (this.declarationInit.deoptimizePath([M, M]),
            this.context.requestTreeshakingPass());
      }
    }
    class gs extends ct {
      ...
      deoptimizePath(e) {
        1 === e.length && e[0] === M &&
          this.scope.getReturnExpression().deoptimizePath(O);
      }
        ...
        : this.async
          ? (this.deoptimizedReturn ||
            (this.deoptimizedReturn = !0,
              this.scope.getReturnExpression().deoptimizePath(O),
              this.context.requestTreeshakingPass()),
            G) : this.scope.getReturnExpression();
      }
      hasEffects() {
        return !1;
      }
      ...
      include(e, t) {
        this.included = !0;
        for (const s of this.params) s instanceof ps || s.include(e, t);
      ...
      initialise() {
        this.scope.addParameterVariables(
          this.params.map((e) => e.declare("parameter", G)),
          this.params[this.params.length - 1] instanceof ms,
        ),
      ...
      parseNode(e) {
        e.body.type === He &&
        (this.body = new Zt(e.body, this, this.scope.hoistedBodyVarScope)),
          super.parseNode(e);
      }
    }
    function ys(
      ...
      }
      {
        const s = [];
        for (const i of e) {
          for (const e of t.get(i)) s.push([e, i.getName(n) + r]);
        }
        return `exports(${i(s, { lineBreakIndent: null })})`;
      }
    }
    function Es(e, t, s, i, { exportNamesByVariable: n, snippets: { _: r } }) {
      i.prependRight(t, `exports('${n.get(e)}',${r}`), i.appendLeft(s, ")");
    }
    function xs(e, t, s, i, n, r) {
      const { _: a, getPropertyAccess: o } = r.snippets;
      n.appendLeft(s, `,${a}${ys([e], r)},${a}${e.getName(o)}`),
        i && (n.prependRight(t, "("), n.appendLeft(s, ")"));
    }
    gs.prototype.preventChildBlockScope = !0;
    class vs extends ct {
      addExportedVariables(e, t) {
      ...
      hasEffectsWhenAssignedAtPath(e, t) {
        ...
        for (const e of this.properties) {
          if (e.hasEffectsWhenAssignedAtPath(L, t)) return !0;
        }
        return !1;
      }
      markDeclarationReached() {
    ...
    class bs extends ct {
      ...
      hasEffects(e) {
        return this.deoptimized || this.applyDeoptimizations(),
          ...
          this.left.hasEffectsWhenAssignedAtPath(L, e);
      }
      hasEffectsWhenAccessedAtPath(e, t) {
        ...
        this.deoptimized || this.applyDeoptimizations(),
          ...
          (t || "=" !== this.operator || this.left.included ||
            (s = ke(),
              ...
              this.left.hasEffectsWhenAssignedAtPath(L, s))) &&
      ...
      render(
        ...
        if (this.left.included) this.left.render(e, t), this.right.render(e, t);
          ...
          const r = Gt(e.original, jt(e.original, "=", this.left.end) + 1);
          e.remove(this.start, r),
            s && Xt(e, r, this.right.start),
        ...
        if ("system" === t.format) {
          if (this.left instanceof ps) {
            const s = this.left.variable, i = t.exportNamesByVariable.get(s);
            if (i) {
              return void (1 === i.length
                ? Es(s, this.start, this.end, e, t)
                : xs(s, this.start, this.end, this.parent.type !== Ke, e, t));
            }
          } else {
            const s = [];
            if (
              ...
              }(s, this.start, this.end, n === Ke, e, t);
            }
          }
        }
        this.left.included && this.left instanceof vs &&
          (n === Ke || n === Ge) &&
          (e.appendRight(this.start, "("), e.prependLeft(this.end, ")"));
      }
      applyDeoptimizations() {
        this.deoptimized = !0,
          this.left.deoptimizePath(L),
          this.right.deoptimizePath(O),
          this.context.requestTreeshakingPass();
      }
    }
    class Ss extends Rt {
    ...
    class As extends Rt {
      constructor(e) {
        super("this", null, null, e),
          ...
          this.thisDeoptimizations = new W();
      }
      ...
      deoptimizeThisOnEventAtPath(e, t, s) {
        ...
        if (
          !this.thisDeoptimizations.trackEntityAtPathAndGetIfTracked(t, e, s)
        ) {
    ...
    class Ps extends Bt {
      constructor(e, t) {
        super(e, t),
          this.variables.set("arguments", this.argumentsVariable = new Ss(t)),
          this.variables.set("this", this.thisVariable = new As(t));
      }
      findLexicalBoundary() {
        return this;
      }
    ...
    class ks extends ct {
      ...
      createScope(e) {
        this.scope = new Ps(e, this.context);
      }
      deoptimizePath(e) {
        1 === e.length &&
          ("prototype" === e[0]
      ...
      hasEffectsWhenCalledAtPath(e, t, s) {
        ...
        s.replacedVariableInits.set(
          ...
          t.withNew ? new Et(Object.create(null), xt) : G,
        );
      ...
      include(e, t) {
        ...
        for (const i of this.params) i instanceof ps && !s || i.include(e, t);
    ...
    ks.prototype.preventChildBlockScope = !0;
    const ws = {
      "!=": (e, t) => e != t,
      "!==": (e, t) => e !== t,
      "%": (e, t) => e % t,
    ...
    class Cs extends ct {
      ...
      getLiteralValueAtPath(e) {
        return e.length > 0 ||
            ...
            47 === this.context.code.charCodeAt(this.start) ? j : this.value;
      }
      getReturnExpressionWhenCalledAtPath(e) {
        return 1 !== e.length ? G : ze(this.members, e[0]);
      }
      hasEffectsWhenAccessedAtPath(e) {
      ...
      hasEffectsWhenCalledAtPath(e, t, s) {
        return 1 !== e.length || Fe(this.members, e[0], t, s);
      }
      initialise() {
    ...
    function Is(e) {
      return e.computed
        ? (t = e.property) instanceof Cs ? String(t.value) : null
        : e.property.name;
      var t;
    }
    function Ns(e) {
    ...
    class _s extends ct {
      ...
      deoptimizeThisOnEventAtPath(e, t, s, i) {
        this.variable ? this.variable.deoptimizeThisOnEventAtPath(e, t, s, i)
        : this.replacement ||
          (t.length < 7
      ...
      hasEffects(e) {
        ...
        return this.property.hasEffects(e) || this.object.hasEffects(e) ||
          !(this.variable || this.replacement ||
              this.parent instanceof bs && "=" === this.parent.operator) &&
            t &&
            ("always" === t ||
      ...
      includeCallArguments(e, t) {
        this.variable ? this.variable.includeCallArguments(e, t)
        : super.includeCallArguments(e, t);
      }
      initialise() {
        this.propertyKey = Is(this);
      }
      render(
        e,
        t,
      ...
      resolveNamespaceVariables(e, t) {
        ...
        if (!i) {
          ...
          return this.context.warn({
            code: "MISSING_EXPORT",
            exporter: te(i),
            importer: te(this.context.fileName),
            message: `'${s}' is not exported by '${te(i)}'`,
            missing: s,
            url:
              "https://rollupjs.org/guide/en/#error-name-is-not-exported-by-module",
          }, t[0].pos),
    ...
    class $s extends Vt {
      addDeclaration(e, t, s, i) {
        ...
        return n
          ? (this.parent.addDeclaration(e, t, Ie, i), n.addDeclaration(e, s), n)
    ...
    class Ts extends Ot {
      constructor(e, t, s) {
        super(e),
          this.variables.set(
            "this",
            this.thisVariable = new Rt("this", null, t, s),
          ),
          this.instanceScope = new Ot(this),
          this.instanceScope.variables.set("this", new As(s));
      }
      findLexicalBoundary() {
        return this;
      }
    ...
    class Rs extends ct {
      constructor() {
        super(...arguments),
          ...
          this.accessorCallOptions = { args: we, thisParam: null, withNew: !1 };
      }
      deoptimizeCache() {}
      deoptimizePath(e) {
      ...
      deoptimizeThisOnEventAtPath(e, t, s, i) {
        return 0 === e && "get" === this.kind && 0 === t.length ||
          ...
          ? this.value.deoptimizeThisOnEventAtPath(2, L, s, i)
          : void this.getAccessedValue().deoptimizeThisOnEventAtPath(
            e,
            t,
            s,
            i,
            ...
            ? (this.accessedValue = G,
              this.accessedValue = this.value
                .getReturnExpressionWhenCalledAtPath(
                  ...
                  z,
                  this,
                )) : this.accessedValue = this.value : this.accessedValue;
      }
    }
    class Ms extends Rs {}
    class Ds extends U {
    ...
    class Ls extends ct {
      ...
      hasEffects(e) {
        ...
        return null === (s = this.id) || void 0 === s ||
          s.markDeclarationReached(),
        ...
        return 0 === e.length
          ? !t.withNew ||
            (null !== this.classConstructor
              ? this.classConstructor.hasEffectsWhenCalledAtPath(L, t, s)
      ...
      initialise() {
        ...
        for (const e of this.body.body) {
          if (e instanceof Ms && "constructor" === e.kind) {
      ...
      getObjectEntity() {
        ...
        for (const s of this.body.body) {
          ...
          if (s.computed) {
            ...
            if (e === j) {
              i.push({ key: M, kind: r, property: s });
              continue;
            }
            a = String(e);
          } else a = s.key instanceof ps ? s.key.name : String(s.key.value);
        ...
        return e.unshift({
          ...
          property: new Et(
            t,
            this.superClass ? new Ds(this.superClass, "prototype") : xt,
          ),
        }),
          this.objectEntity = new Et(e, this.superClass || xt);
      }
    }
    class Os extends Ls {
      initialise() {
      ...
      parseNode(e) {
        null !== e.id && (this.id = new ps(e.id, this, this.scope.parent)),
          super.parseNode(e);
      }
      render(e, t) {
        const { exportNamesByVariable: s, format: i, snippets: { _: n } } = t;
        "system" === i && this.id && s.has(this.id.variable) &&
        e.appendLeft(this.end, `${n}${ys([this.id.variable], t)};`),
          super.render(e, t);
      }
    }
    class Vs extends U {
    ...
    class zs extends ct {
      ...
      render(e, t, s) {
        const { start: i, end: n } = s,
          r = function (e, t) {
            return Gt(e, jt(e, "default", t) + 7);
          }(e.original, this.start);
        if (this.declaration instanceof Fs) {
        ...
        } else if (this.declaration instanceof Os) {
          this.renderNamedDeclaration(
            e,
            r,
            "class",
          ...
          if (this.variable.getOriginalVariable() !== this.variable) {
            return void Ft(this, e, i, n);
          }
          if (!this.variable.included) {
            return e.remove(this.start, r),
              this.declaration.render(e, t, { renderedSurroundingElement: Ke }),
      ...
      renderNamedDeclaration(e, t, s, i, n, r) {
        ...
        e.remove(this.start, t),
          n && e.appendLeft(
            function (e, t, s, i) {
              const n = jt(e, t, i) + t.length;
              e = e.slice(n, jt(e, s, n));
              const r = jt(e, "*");
              return -1 === r ? n : n + r + 1;
            }(e.original, s, i, t),
            ` ${l}`,
          ),
          "system" === o && this.declaration instanceof Os &&
          a.has(this.variable) &&
          e.appendLeft(this.end, ` ${ys([this.variable], r)};`);
      }
    ...
    class Ws extends ct {
      ...
      render(e, t, s) {
        const { start: i, end: n } = s;
        null === this.declaration ? e.remove(i, n)
    ...
    class Gs extends ct {
      ...
      hasEffects(e) {
        ...
        if (t === j) {
          ...
          return e.brokenFlow = t,
            null !== this.alternate &&
            (!!this.alternate.hasEffects(e) || (e.brokenFlow = e.brokenFlow < s
              ? e.brokenFlow
              : s,
              !1));
        }
        return t ? this.consequent.hasEffects(e)
      ...
      parseNode(e) {
        this.consequentScope = new js(this.scope),
          this.consequent =
          ...
          e.alternate &&
          (this.alternateScope = new js(this.scope),
            this.alternate =
      ...
      render(e, t) {
        ...
        r
          ...
          : e.remove(this.start, this.consequent.start),
          this.consequent.included && (a || i === j || i)
          ...
          this.alternate && (!this.alternate.included || !a && i !== j && i
      ...
      getTestValue() {
        return this.testValue === Us
          ? this.testValue = this.test.getLiteralValueAtPath(L, z, this)
          : this.testValue;
      }
      ...
      renderHoistedDeclarations(e, t, s) {
        ...
        if (i) {
          const e = this.parent.type, s = e !== Ye && e !== He;
      ...
      shouldKeepAlternateBranch() {
        let e = this.parent;
        do {
          if (e instanceof Gs && e.alternate) return !0;
    ...
    Hs.prototype.needsBoundaries = !0;
    const qs = "_interopDefault",
      Ks = "_interopDefaultLegacy",
      Xs = "_interopNamespace",
      Ys = "_interopNamespaceDefault",
      Qs = "_interopNamespaceDefaultOnly",
      Zs = "_mergeNamespaces",
      Js = {
        auto: qs,
        default: null,
      ...
      ei = (e, t) => "esModule" === e || t && ("auto" === e || "true" === e),
      ti = {
        auto: Xs,
        default: Ys,
        defaultOnly: Qs,
      ...
      si = (e, t) => ei(e, t) && Js[e] === qs,
      ii = (e, t, s, i, n, r, a) => {
        const o = new Set(e);
        for (const e of mi) t.has(e) && o.add(e);
        return mi.map((e) => o.has(e) ? ni[e](s, i, n, r, a, o) : "").join("");
      },
      ni = {
        [Ks](e, t, s) {
          ...
          return `function _mergeNamespaces(n, m)${n}{${a}${e}${
            li(
              `{${a}${e}${e}${e}if${n}(k${n}!==${n}'default'${n}&&${n}!(k in n))${n}{${a}` +
                (s ? o ? ui : di : pi)(e, e + e + e + e, t) +
                `${e}${e}${e}}${a}` + `${e}${e}}`,
              o,
              e,
              t,
            )
          }${a}${e}return ${fi("n", i)};${a}}${a}${a}`;
        },
      },
      ri = ({ _: e, getObject: t }) =>
        `e${e}:${e}${t([["default", "e"]], { lineBreakIndent: null })}`,
      ai = ({ _: e, getPropertyAccess: t }) => `e${t("default")}${e}:${e}e`,
      oi = (e, t, s, i, n, r) => {
        const { _: a, cnst: o, getPropertyAccess: h, n: l, s: c } = s,
          u = `{${l}` + (i ? ci : pi)(e, t + e + e, s) + `${t}${e}}`;
        return `${t}${o} n${a}=${a}${
          r
            ? `{__proto__:${a}null,${a}[Symbol.toStringTag]:${a}'Module'}`
            : "Object.create(null)"
        };${l}${t}if${a}(e)${a}{${l}${t}${e}${hi(u, !i, s)}${l}${t}}${l}${t}n${
          h("default")
        }${a}=${a}e;${l}${t}return ${fi("n", n)}${c}${l}`;
      },
      hi = (e, t, { _: s, cnst: i, getFunctionIntro: n, s: r }) =>
        "var" !== i || t ? `for${s}(${i} k in e)${s}${e}`
      ...
      ci = (e, t, s) => {
        const { _: i, n: n } = s;
        return `${t}if${i}(k${i}!==${i}'default')${i}{${n}` + ui(e, t + e, s) +
          `${t}}${n}`;
      },
      ui = (e, t, { _: s, cnst: i, getDirectReturnFunction: n, n: r }) => {
        const [a, o] = n([], {
          functionReturn: !0,
          lineBreakIndent: null,
          name: null,
      ...
      di = (e, t, { _: s, cnst: i, getDirectReturnFunction: n, n: r }) => {
        const [a, o] = n([], {
          functionReturn: !0,
          lineBreakIndent: null,
          name: null,
      ...
      pi = (e, t, { _: s, n: i }) => `${t}n[k]${s}=${s}e[k];${i}`,
      fi = (e, t) => t ? `Object.freeze(${e})` : e,
      mi = Object.keys(ni);
    function gi(e, t, s) {
      return "external" === t ? ti[String(s(e instanceof be ? e.id : null))]
      : "default" === t ? Qs : null;
    }
    const yi = { amd: ["require"], cjs: ["require"], system: ["module"] },
      Ei = "ROLLUP_ASSET_URL_",
      xi = "ROLLUP_CHUNK_URL_",
      vi = "ROLLUP_FILE_URL_",
      bi = {
      ...
      Ii = {
        amd: ki(() => Ai("module.uri, document.baseURI")),
        cjs: ki((e) =>
          `(typeof document === 'undefined' ? ${
    ...
    class Ni extends ct {
      ...
      render(e, t) {
        this.body.length ? qt(this.body, e, this.start, this.end, t)
        : super.render(e, t);
      }
    }
    class _i extends ct {
      ...
      render(e, t, s) {
        if (this.consequent.length) {
          ...
          const i = this.test
              ? this.test.end
              : jt(e.original, "default", this.start) + 7,
            n = jt(e.original, ":", i) + 1;
          qt(this.consequent, e, n, s.end, t);
        } else super.render(e, t);
      }
    }
    _i.prototype.needsBoundaries = !0;
    class $i extends ct {
      getLiteralValueAtPath(e) {
        return e.length > 0 || 1 !== this.quasis.length ? j
    ...
    class Ri extends Rt {
      constructor(e, t, s) {
        ...
        (i instanceof Fs || i instanceof Os) && i.id
          ? (this.hasId = !0, this.originalId = i.id)
          : i instanceof ps && (this.originalId = i);
      }
      addReference(e) {
      ...
      getBaseVariableName() {
        ...
        return e === this ? super.getBaseVariableName()
        : e.getBaseVariableName();
      }
        ...
        return !this.originalId ||
            !this.hasId &&
              (this.originalId.isPossibleTDZ() ||
                ...
                this.originalId.variable instanceof Ti ||
                "syntheticNamespace" in this.originalId.variable) ? null
    ...
    class Mi extends Ot {
      constructor(e, t) {
        super(e),
          this.context = t,
          this.variables.set("this", new Rt("this", null, Ie, t));
      }
      addExportDefaultDeclaration(e, t, s) {
        const i = new Ri(e, t, s);
      ...
      findVariable(e) {
        ...
        return s instanceof us && this.accessedOutsideVariables.set(e, s), s;
      }
    }
    const Di = {
      "!": (e) => !e,
    ...
    class Oi extends ct {
        ...
        if (
          function (e, t) {
            for (const s of e) {
              ...
              if (s.id.type === Xe) if (t.has(s.id.variable)) return !1;
              else {
                const e = [];
      ...
      renderDeclarationEnd(e, t, s, i, n, r, a, o) {
        ...
        e.remove(this.end - 1, this.end),
          ...
          null !== s
            ...
            : e.appendLeft(n, t),
          r.length > 0 && e.appendLeft(n, ` ${ys(r, a)};`);
      }
      renderReplacedDeclarations(e, t, { isNoStatement: s }) {
        ...
        let n, r;
        r = Gt(e.original, this.start + this.kind.length);
        let a = r - 1;
          ...
          p = function (e, t, s) {
            ...
            if ("system" === t.format) {
              for (const { node: r } of e) {
                r.id instanceof ps && r.init && 0 === s.length &&
                  1 ===
                    (null ===
                          (i = t.exportNamesByVariable.get(r.id.variable)) ||
                        void 0 === i
                      ? void 0
                      : i.length)
          ...
          if (s.included) {
            if (
              s.render(e, t),
                ...
                h = "",
                !s.id.included ||
                s.id instanceof ps && Li(s.id.variable, t.exportNamesByVariable)
            ) {
              c && (u += ";"), l = !1;
            } else {
              if (p && p === s.id.variable) {
                const i = jt(e.original, "=", s.id.end);
                Es(p, Gt(e.original, i + 1), null === f ? m : f, e, t);
              }
    ...
    const Vi = {
        ArrayExpression: class extends ct {
          constructor() {
            super(...arguments), this.objectEntity = null;
          }
          deoptimizePath(e) {
          ...
          getObjectEntity() {
            if (null !== this.objectEntity) return this.objectEntity;
            const e = [{ key: "length", kind: "init", property: Te }];
            let t = !1;
            for (let s = 0; s < this.elements.length; s++) {
              const i = this.elements[s];
              i instanceof ut || t
                ? i &&
                  (t = !0, e.unshift({ key: D, kind: "init", property: i }))
                : i
                ? e.push({ key: String(s), kind: "init", property: i })
                : e.push({ key: String(s), kind: "init", property: Ie });
            }
            return this.objectEntity = new Et(e, Tt);
          }
        },
        ArrayPattern: class extends ct {
          addExportedVariables(e, t) {
            for (const s of this.elements) {
              null !== s && s.addExportedVariables(e, t);
            }
          }
          declare(e) {
            const t = [];
            for (const s of this.elements) {
              null !== s && t.push(...s.declare(e, G));
            }
            return t;
          }
          deoptimizePath(e) {
          ...
          hasEffectsWhenAssignedAtPath(e, t) {
            ...
            for (
              ...
              if (null !== e && e.hasEffectsWhenAssignedAtPath(L, t)) return !0;
            }
            return !1;
          }
          markDeclarationReached() {
        ...
        AssignmentPattern: class extends ct {
          constructor() {
            super(...arguments), this.deoptimized = !1;
          }
          addExportedVariables(e, t) {
          ...
          render(e, t, { isShorthandProperty: s } = K) {
        ...
        AwaitExpression: class extends ct {
          constructor() {
            super(...arguments), this.deoptimized = !1;
          }
          hasEffects() {
          ...
          include(e, t) {
            if (
              this.deoptimized || this.applyDeoptimizations(), !this.included
            ) {
              this.included = !0;
              e:
              if (!this.context.usesTopLevelAwait) {
                let e = this.parent;
                do {
                  if (e instanceof ks || e instanceof gs) break e;
                } while (e = e.parent);
          ...
          applyDeoptimizations() {
            this.deoptimized = !0,
              this.argument.deoptimizePath(O),
              this.context.requestTreeshakingPass();
          }
        },
        BinaryExpression: class extends ct {
          deoptimizeCache() {}
          getLiteralValueAtPath(e, t, s) {
          ...
          hasEffects(e) {
            return "+" === this.operator && this.parent instanceof Qt &&
                "" === this.left.getLiteralValueAtPath(L, z, this) ||
              super.hasEffects(e);
          }
          hasEffectsWhenAccessedAtPath(e) {
            return e.length > 1;
          }
          render(e, t, { renderedSurroundingElement: s } = K) {
            this.left.render(e, t, { renderedSurroundingElement: s }),
              this.right.render(e, t);
          }
        },
        BlockStatement: Zt,
        BreakStatement: class extends ct {
          hasEffects(e) {
            if (this.label) {
        ...
        CallExpression: class extends ct {
          constructor() {
            super(...arguments),
              this.deoptimized = !1,
          ...
          bind() {
            super.bind(),
              ...
              this.callOptions = {
                args: this.arguments,
                thisParam: this.callee instanceof _s && !this.callee.variable
                  ? this.callee.object
                  : null,
                withNew: !1,
              };
          ...
          deoptimizePath(e) {
            if (
              ...
              this.context.deoptimizationTracker
                .trackEntityAtPathAndGetIfTracked(e, this)
            ) {
              return;
            }
          ...
          deoptimizeThisOnEventAtPath(e, t, s, i) {
            ...
            n === G ? s.deoptimizePath(O)
            : i.withTrackedEntityAtPath(t, n, () => {
          ...
          getReturnExpressionWhenCalledAtPath(e, t, s, i) {
            ...
            return this.returnExpression === G ? G
            : s.withTrackedEntityAtPath(
              e,
              n,
          ...
          include(e, t) {
            this.deoptimized || this.applyDeoptimizations(),
              t
                ? (super.include(e, t),
                  t === lt && this.callee instanceof ps &&
          ...
          render(e, t, { renderedSurroundingElement: s } = K) {
            if (
              ...
              if (this.arguments[this.arguments.length - 1].included) {for (
                  const s of this.arguments
                ) {
                  s.render(e, t);
                }} else {
                ...
                if (s >= 0) {
                  ...
                  e.remove(
                    jt(e.original, ",", this.arguments[s].end),
                    this.end - 1,
                  );
                } else {
                  e.remove(
                    jt(e.original, "(", this.callee.end) + 1,
                    this.end - 1,
                  );
                }
              }
          ...
          applyDeoptimizations() {
            ...
            for (const e of this.arguments) e.deoptimizePath(O);
            this.context.requestTreeshakingPass();
          }
        ...
        CatchClause: class extends ct {
          createScope(e) {
            this.scope = new $s(e, this.context);
          }
          parseNode(e) {
            const { param: t } = e;
            t &&
            (this.param = new (this.context.getNodeConstructor(t.type))(
              ...
              this.param.declare("parameter", G)), super.parseNode(e);
          }
        },
        ChainExpression: class extends ct {},
        ClassBody: class extends ct {
          createScope(e) {
            this.scope = new Ts(e, this.parent, this.context);
          }
          include(e, t) {
            this.included = !0,
        ...
        ClassDeclaration: Os,
        ClassExpression: class extends Ls {
          render(e, t, { renderedSurroundingElement: s } = K) {
            super.render(e, t),
              s === Ke &&
              (e.appendRight(this.start, "("), e.prependLeft(this.end, ")"));
        ...
        ConditionalExpression: class extends ct {
          constructor() {
            super(...arguments),
              this.expressionsToBeDeoptimized = [],
          ...
          deoptimizeCache() {
            if (null !== this.usedBranch) {
              const e = this.usedBranch === this.consequent ? this.alternate
              : this.consequent;
              this.usedBranch = null, e.deoptimizePath(O);
              for (const e of this.expressionsToBeDeoptimized) {
                e.deoptimizeCache();
              }
            }
          ...
          deoptimizePath(e) {
            ...
            null === t
              ? (this.consequent.deoptimizePath(e),
                this.alternate.deoptimizePath(e)) : t.deoptimizePath(e);
          }
          deoptimizeThisOnEventAtPath(e, t, s, i) {
          ...
          render(
            ...
            if (this.test.included) {
              ...
              const o = jt(e.original, ":", this.consequent.end),
                h = Gt(
                  e.original,
                  (this.consequent.included
                    ? jt(e.original, "?", this.test.end)
                    : o) + 1,
                );
              i && Xt(e, h, a.start),
        ...
        ContinueStatement: class extends ct {
          hasEffects(e) {
            if (this.label) {
              if (!e.ignore.labels.has(this.label.name)) return !0;
              e.includedLabels.add(this.label.name), e.brokenFlow = 2;
        ...
        DoWhileStatement: class extends ct {
          hasEffects(e) {
            if (this.test.hasEffects(e)) return !0;
        ...
        EmptyStatement: class extends ct {
          hasEffects() {
            return !1;
          }
        },
        ExportAllDeclaration: Bs,
        ExportDefaultDeclaration: zs,
        ExportNamedDeclaration: Ws,
        ExportSpecifier: class extends ct {},
        ExpressionStatement: Qt,
        ForInStatement: class extends ct {
          constructor() {
            super(...arguments), this.deoptimized = !1;
          }
          createScope(e) {
          ...
          render(e, t) {
            this.left.render(e, t, Wt),
              this.right.render(e, t, Wt),
        ...
        ForOfStatement: class extends ct {
          constructor() {
            super(...arguments), this.deoptimized = !1;
          }
          createScope(e) {
        ...
        ForStatement: class extends ct {
          ...
          render(e, t) {
            this.init && this.init.render(e, t, Wt),
              this.test && this.test.render(e, t, Wt),
              this.update && this.update.render(e, t, Wt),
              this.body.render(e, t);
          }
        },
        FunctionDeclaration: Fs,
        FunctionExpression: class extends ks {
          render(e, t, { renderedSurroundingElement: s } = K) {
            super.render(e, t),
              s === Ke &&
              (e.appendRight(this.start, "("), e.prependLeft(this.end, ")"));
        ...
        Identifier: ps,
        IfStatement: Gs,
        ImportDeclaration: Hs,
        ImportDefaultSpecifier: class extends ct {},
        ImportExpression: class extends ct {
          constructor() {
            super(...arguments),
            ...
            if (this.inlineNamespace) {
              ...
              e.overwrite(
                ...
                `Promise.resolve().then(${n}${
                  this.inlineNamespace.getName(i)
                }${r})`,
                { contentOnly: !0 },
              );
            } else {
          ...
          getDynamicImportMechanismAndHelper(
            ...
            switch (n) {
              ...
              case "es":
                if (i) {return {
                    helper: null,
                    mechanism: { left: `${i}(`, right: ")" },
                  };}
            }
            return { helper: null, mechanism: null };
          }
        },
        ImportNamespaceSpecifier: class extends ct {},
        ImportSpecifier: class extends ct {},
        LabeledStatement: class extends ct {
          hasEffects(e) {
          ...
          render(e, t) {
            this.label.included
              ...
              : e.remove(
                this.start,
                Gt(e.original, jt(e.original, ":", this.label.end) + 1),
              ), this.body.render(e, t);
          }
        },
        Literal: Cs,
        LogicalExpression: class extends ct {
          constructor() {
            super(...arguments),
              this.expressionsToBeDeoptimized = [],
              this.isBranchResolutionAnalysed = !1,
          ...
          render(
            ...
            if (this.left.included && this.right.included) {
              ...
              const a = jt(e.original, this.operator, this.left.end);
              if (this.right.included) {
                const t = Gt(e.original, a + 2);
                e.remove(this.start, t), i && Xt(e, t, this.right.start);
        ...
        MemberExpression: _s,
        MetaProperty: class extends ct {
          addAccessedGlobals(e, t) {
            const s = this.metaProperty,
              i =
                (s && (s.startsWith(vi) || s.startsWith(Ei) || s.startsWith(xi))
                  ? Si
                  : bi)[e];
          ...
          getReferencedFileName(e) {
            ...
            return t && t.startsWith(vi) ? e.getFileName(t.substr(vi.length))
            : null;
          }
          hasEffects() {
            return !1;
          ...
          include() {
            if (
              ...
              const e = this.parent;
              this.metaProperty =
                e instanceof _s && "string" == typeof e.propertyKey
                  ? e.propertyKey : null;
            }
          }
          renderFinalMechanism(e, t, s, i, n) {
            ...
            if (
              o && (o.startsWith(vi) || o.startsWith(Ei) || o.startsWith(xi))
            ) {
              let i, r = null, h = null, l = null;
              o.startsWith(vi) ? (r = o.substr(vi.length), i = n.getFileName(r))
              : o.startsWith(Ei)
                ? (me(
                  `Using the "${Ei}" prefix to reference files is deprecated. Use the "${vi}" prefix instead.`,
                  !0,
                  this.context.options,
                ),
                  h = o.substr(Ei.length),
                  i = n.getFileName(h))
                : (me(
                  `Using the "${xi}" prefix to reference files is deprecated. Use the "${vi}" prefix instead.`,
                  !0,
                  this.context.options,
                ),
                  l = o.substr(xi.length),
                  i = n.getFileName(l));
              const c = C($(N(t), i));
              let u;
              return null !== h &&
            ...
            const h =
              n.hookFirstSync("resolveImportMeta", [o, {
                ...
                format: s,
                moduleId: this.context.module.id,
              }]) || (null === (r = Ii[s]) || void 0 === r
                ? void 0
                : r.call(Ii, o, { chunkId: t, snippets: i }));
            "string" == typeof h && (a instanceof _s
              ? e.overwrite(a.start, a.end, h, { contentOnly: !0 })
              : e.overwrite(this.start, this.end, h, { contentOnly: !0 }));
          }
        },
        MethodDefinition: Ms,
        NewExpression: class extends ct {
          constructor() {
            super(...arguments), this.deoptimized = !1;
          }
          hasEffects(e) {
            ...
            return (!this.context.options.treeshake.annotations ||
              !this.annotations) &&
              (this.callee.hasEffects(e) ||
                this.callee.hasEffectsWhenCalledAtPath(L, this.callOptions, e));
          }
          hasEffectsWhenAccessedAtPath(e) {
            return e.length > 0;
          }
        ...
        ObjectExpression: class extends ct {
          constructor() {
            super(...arguments), this.objectEntity = null;
          }
          deoptimizeCache() {
          ...
          getObjectEntity() {
            ...
            for (const s of this.properties) {
              if (s instanceof ut) {
                t.push({ key: M, kind: "init", property: s });
                continue;
              }
              let i;
              if (s.computed) {
                const e = s.key.getLiteralValueAtPath(L, z, this);
                if (e === j) {
                  t.push({ key: M, kind: s.kind, property: s });
                  continue;
                }
                i = String(e);
              } else if (
                i = s.key instanceof ps ? s.key.name : String(s.key.value),
                  "__proto__" === i && "init" === s.kind
              ) {
                e = s.value instanceof Cs && null === s.value.value
                  ? null
                  : s.value;
                continue;
              }
        ...
        ObjectPattern: vs,
        PrivateIdentifier: class extends ct {},
        Program: Ni,
        Property: class extends Rs {
          constructor() {
            super(...arguments),
              this.deoptimized = !1,
        ...
        PropertyDefinition: class extends ct {
          deoptimizePath(e) {
            var t;
          ...
          hasEffectsWhenCalledAtPath(e, t, s) {
            return !this.value ||
              this.value.hasEffectsWhenCalledAtPath(e, t, s);
          }
        },
        RestElement: ms,
        ReturnStatement: class extends ct {
          hasEffects(e) {
        ...
        SequenceExpression: class extends ct {
          deoptimizePath(e) {
          ...
          include(e, t) {
            ...
            for (const i of this.expressions) {
              (t || i === s && !(this.parent instanceof Qt) ||
          ...
          render(
            ...
            for (
              const { node: h, separator: l, start: c, end: u } of Kt(
                this.expressions,
                e,
                this.start,
                this.end,
              ...
              if (h.included) {
                if (r++, a = l, 1 === r && n && Xt(e, c, h.start), 1 === r) {
        ...
        StaticBlock: class extends ct {
          ...
          include(e, t) {
            this.included = !0;
            for (const s of this.body) {(t || s.shouldBeIncluded(e)) &&
                s.include(e, t);}
          }
          render(e, t) {
            this.body.length
              ? qt(this.body, e, this.start + 1, this.end - 1, t)
              : super.render(e, t);
          }
        },
        Super: class extends ct {
          bind() {
        ...
        SwitchCase: _i,
        SwitchStatement: class extends ct {
          createScope(e) {
            this.scope = new Yt(e);
          }
          hasEffects(e) {
          ...
          initialise() {
            for (let e = 0; e < this.cases.length; e++) {
              if (null === this.cases[e].test) {return void (this.defaultCase =
                  e);}
            }
          ...
          render(e, t) {
            this.discriminant.render(e, t),
              this.cases.length > 0 &&
              qt(this.cases, e, this.cases[0].start, this.end - 1, t);
          }
        },
        TaggedTemplateExpression: class extends ct {
          bind() {
            if (super.bind(), this.tag.type === Xe) {
          ...
          hasEffects(e) {
            return super.hasEffects(e) ||
              this.tag.hasEffectsWhenCalledAtPath(L, this.callOptions, e);
          }
          initialise() {
            this.callOptions = { args: we, thisParam: null, withNew: !1 };
          }
          render(e, t) {
        ...
        TemplateElement: class extends ct {
          bind() {}
          hasEffects() {
            return !1;
          }
        ...
        TemplateLiteral: $i,
        ThisExpression: class extends ct {
          bind() {
            this.variable = this.scope.findVariable("this");
          }
          deoptimizePath(e) {
          ...
          initialise() {
            this.alias = this.scope.findLexicalBoundary() instanceof Mi
        ...
        ThrowStatement: class extends ct {
          hasEffects() {
            return !0;
          }
          include(e, t) {
        ...
        UnaryExpression: class extends ct {
          ...
          getLiteralValueAtPath(e, t, s) {
            ...
            return i === j ? j : Di[this.operator](i);
          }
          hasEffects(e) {
            return this.deoptimized || this.applyDeoptimizations(),
              !("typeof" === this.operator && this.argument instanceof ps) &&
              (this.argument.hasEffects(e) ||
                "delete" === this.operator &&
                  this.argument.hasEffectsWhenAssignedAtPath(L, e));
          }
          hasEffectsWhenAccessedAtPath(e) {
        ...
        UpdateExpression: class extends ct {
          constructor() {
            super(...arguments), this.deoptimized = !1;
          }
          hasEffects(e) {
          ...
          render(e, t) {
            const { exportNamesByVariable: s, format: i, snippets: { _: n } } =
              t;
          ...
          applyDeoptimizations() {
            this.deoptimized = !0,
              this.argument.deoptimizePath(L),
              this.argument instanceof ps &&
              (this.scope.findVariable(this.argument.name).isReassigned = !0),
              this.context.requestTreeshakingPass();
          }
        },
        VariableDeclaration: Oi,
        VariableDeclarator: class extends ct {
          declareDeclarator(e) {
            this.id.declare(e, this.init || Ie);
          }
          deoptimizePath(e) {
          ...
          render(e, t) {
            ...
            if (n) this.id.render(e, t);
              ...
              const t = jt(e.original, "=", this.id.end);
              e.remove(this.start, Gt(e.original, t + 1));
            }
            this.init
              ? this.init.render(
                e,
                t,
                n ? K : { renderedSurroundingElement: Ke },
              )
              : this.id instanceof ps && Li(this.id.variable, s) &&
                e.appendLeft(this.end, `${i}=${i}void 0`);
          }
        },
        WhileStatement: class extends ct {
          hasEffects(e) {
            if (this.test.hasEffects(e)) return !0;
            const { brokenFlow: t, ignore: { breaks: s, continues: i } } = e;
            return e.ignore.breaks = !0,
        ...
        YieldExpression: class extends ct {
          constructor() {
            super(...arguments), this.deoptimized = !1;
          }
          hasEffects(e) {
          ...
          applyDeoptimizations() {
            ...
            e && (e.deoptimizePath(O), this.context.requestTreeshakingPass());
          }
        },
      },
      Bi = "_missingExportShim";
    class Fi extends H {
      constructor(e) {
        super(Bi), this.module = e;
      }
      include() {
    ...
    class zi extends H {
      ...
      getMemberVariables() {
        ...
        for (
          const t of this.context.getExports().concat(
      ...
      prepare(e) {
        this.mergedNamespaces.length > 0 &&
          this.module.scope.addAccessedGlobals([Zs], e);
      }
      renderBlock(e) {
        const {
            exportNamesByVariable: t,
        ...
        return this.mergedNamespaces.length > 0 &&
          ...
          "system" === s && t.has(this) && (f += `${c}${ys([this], e)};`),
          f;
      }
      renderFirst() {
    ...
    class Wi extends H {
      ...
      getBaseVariable() {
        ...
        for (; e instanceof Ri || e instanceof Wi;) {
          if (e instanceof Ri) {
    ...
    var Gi = "performance" in ("undefined" != typeof globalThis
          ? globalThis
    ...
    function Yi(e, t = 3) {
      e = Xi(e, t);
      const s = Hi.memoryUsage().heapUsed, i = Gi.now(), n = Ki.get(e);
      void 0 === n
        ? Ki.set(e, {
          memory: 0,
          startMemory: s,
    ...
    function Qi(e, t = 3) {
      ...
      const s = Ki.get(e);
      if (void 0 !== s) {
        const e = Hi.memoryUsage().heapUsed;
        s.memory += e - s.startMemory,
          s.time += Gi.now() - s.startTime,
          s.totalMemory = Math.max(s.totalMemory, e);
      }
    }
    function Zi() {
      const e = {};
      for (const [t, { memory: s, time: i, totalMemory: n }] of Ki) {
        e[t] = [i, s, n];
      }
      return e;
    }
    ...
    class on {
      constructor(e, t, s, i, n, r, a) {
        this.graph = e,
          ...
          this.exportShimVariable = new Fi(this),
        ...
        this.info = {
          ...
          get implicitlyLoadedAfterOneOf() {
            return Array.from(u, Ui).sort();
          },
          get implicitlyLoadedBefore() {
            return Array.from(d, Ui).sort();
          },
          ...
          isExternal: !1,
          get isIncluded() {
            return e.phase !== ji.GENERATE ? null : o.isIncluded();
          },
          meta: { ...a },
          moduleSideEffects: n,
      ...
      basename() {
        const e = I(this.id), t = _(this.id);
        return ve(t ? e.slice(0, -t.length) : e);
      }
      bindReferences() {
        this.ast.bind();
      }
      error(e, t) {
        return this.addLocationToLogProps(e, t), ie(e);
      }
      getAllExportNames() {
        ...
        for (const e of this.exportAllModules) {
          if (e instanceof be) this.allExportNames.add(`*${e.id}`);
          else {
      ...
      getDependenciesToBeIncluded() {
        ...
        for (let e of i) {
          ...
          e instanceof Wi
            ? e = e.getBaseVariable()
            : e instanceof Ri && (e = e.getOriginalVariable()), t.add(e.module);
        }
        if (
      ...
      getExportNamesByVariable() {
        ...
        for (const t of this.getAllExportNames()) {
          ...
          if (
            s instanceof Ri && (s = s.getOriginalVariable()),
              !s || !(s.included || s instanceof q)
          ) {
            continue;
          }
          const i = e.get(s);
          ...
          this.syntheticNamespace
            ...
            : ie(
              (e = this.id,
                ...
                {
                  code: re.SYNTHETIC_NAMED_EXPORTS_NEED_NAMESPACE_EXPORT,
                  id: e,
                  message: `Module "${
                    te(e)
      ...
      getVariableForExportName(
        ...
        if ("*" === e[0]) {
          return 1 === e.length ? [this.namespace]
        ...
        if (r) {
          const [e] = an(r.module, r.localName, t, !1, n);
          return e
            ? (t && hn(e, t, this), [e])
            : this.error(le(r.localName, this.id, r.module.id), r.start);
        }
        const a = this.exports.get(e);
        if (a) {
          if (a === rn) return [this.exportShimVariable];
          const e = a.localName, s = this.traceVariable(e, t);
          return t &&
            (R(t.sideEffectDependenciesByVariable, s, () => new Set()).add(
              this,
            ),
              hn(s, t, this)),
            [s];
        ...
        return this.info.syntheticNamedExports
          ? [
            R(this.syntheticExports, e, () =>
              new Wi(this.astContext, e, this.getSyntheticNamespace())),
          ]
          : !s && this.options.shimMissingExports
          ? (this.shimMissingExport(e), [this.exportShimVariable]) : [null];
      }
      hasEffects() {
        return "no-treeshake" === this.info.moduleSideEffects ||
          this.ast.included && this.ast.hasEffects(ke());
      }
      include() {
        const e = Pe();
        ...
        for (const e of this.getReexports()) {
          ...
          t &&
            (t.deoptimizePath(O),
              ...
              t instanceof q && (t.module.reexported = !0));
        }
        e &&
      ...
      includeAllInBundle() {
        this.ast.include(Pe(), !0), this.includeAllExports(!1);
      }
      isIncluded() {
      ...
      linkImports() {
        ...
        for (const t of this.exportAllSources) {
          ...
          s instanceof be ? e.push(s) : this.exportAllModules.push(s);
        }
      ...
      setSource(
        ...
        this.magicString = new S(t, {
          ...
          this.astContext = {
            ...
            getNodeConstructor: (e) => Vi[e] || Vi.UnknownNode,
          ...
          this.scope = new Mi(this.graph.scope, this.astContext),
          this.namespace = new zi(this.astContext),
          this.ast = new Ni(
            e,
      ...
      toJSON() {
        return {
          ...
          dependencies: Array.from(this.dependencies, Ui),
          id: this.id,
          meta: this.info.meta,
      ...
      traceVariable(e, t) {
        ...
        if (i) {
          const e = i.module;
          if (e instanceof on && "*" === i.name) return e.namespace;
          const [s] = e.getVariableForExportName(i.name, {
            importerForSideEffects: t || this,
          });
          return s || this.error(le(i.name, this.id, e.id), i.start);
        }
        return null;
      }
      tryParse() {
        try {
          ...
          return this.id.endsWith(".json")
            ...
            this.error(
              { code: "PARSE_ERROR", message: t, parserError: e },
              e.pos,
            );
        }
      }
      updateOptions(
        { meta: e, moduleSideEffects: t, syntheticNamedExports: s },
      ) {
      ...
      addDynamicImport(e) {
        ...
        t instanceof $i
          ...
          : t instanceof Cs && "string" == typeof t.value && (t = t.value),
      ...
      addExport(e) {
        ...
        } else if (e.source instanceof Cs) {
          const t = e.source.value;
          this.sources.add(t);
      ...
      addLocationToLogProps(e, t) {
        ...
        if (i) {
          ...
          ne(e, { column: n, line: r }, s, this.id);
        }
      }
      ...
      getVariableFromNamespaceReexports(e, t, s) {
        ...
        if (n.size > 0) {
          ...
          return 1 === t.length
            ? [s]
            : (this.options.onwarn(function (e, t, s) {
              return {
                code: re.NAMESPACE_CONFLICT,
        ...
        if (r.size > 0) {
          ...
          return t.length > 1 && this.options.onwarn(function (e, t, s, i) {
            return {
              code: re.AMBIGUOUS_EXTERNAL_NAMESPACES,
        ...
        if (!e.included) {
          ...
          if (t instanceof on && (t.isExecuted || nn(t), t !== this)) {
            const t = function (e, t) {
              const s = R(
                t.sideEffectDependenciesByVariable,
                e,
                () => new Set(),
              );
              let i = e;
            ...
            for (const e of t) e.isExecuted || nn(e);
          }
        }
      }
    ...
    function cn(e, t) {
      return e.autoId ? `${e.basePath ? e.basePath + "/" : ""}${ln(t)}`
      : e.id || "";
    }
    function un(e, t, s, i, n, r, a, o = "return ") {
      const {
        _: h,
        cnst: l,
        ...
        return `${p}${p}${o}${
          function (e, t, s, i, n) {
            ...
            for (
              ...
              if (c) return dn(o, c[0].imported, h, a, e, l, s, r, i, n);
            }
          }(e, t, i, a, d)
        };`;
      }
      ...
      for (
        ...
        if (g && s) {
          for (const t of g) {
            if ("*" !== t.reexported) {
              const s = dn(l, t.imported, u, o, e, f, i, n, a, d);
    ...
    function dn(e, t, s, i, n, r, a, o, h, l) {
      if ("default" === t) {
        if (!i) {
          const t = String(a(o)), s = Js[t] ? n : e;
          return ei(t, h) ? `${s}${l("default")}` : s;
        }
        return s ? `${e}${l("default")}` : e;
      }
      return "*" === t ? (i ? !s : ti[String(a(o))]) ? r : e : `${e}${l(t)}`;
    }
    ...
    const fn = (e, t, s, { _: i, getDirectReturnFunction: n, n: r }) => {
      if (t) {
        const [t, a] = n([], {
          functionReturn: !0,
          lineBreakIndent: null,
    ...
    function mn(e, t, s, i, n, r, a, o) {
      ...
      for (
        ...
        if (r) {
          for (
            const { imported: e, reexported: t } of [...i || [], ...l || []]
          ) {
            if ("*" === e && "*" !== t) {
              o || p(h, Qs, a);
              break;
          ...
          let r = !1, o = !1;
          for (
            const { imported: t, reexported: n } of [...i || [], ...l || []]
          ) {
            let i, l;
            "default" === t
              ? r || (r = !0, s !== h && (l = s, i = Js[e]))
              : "*" === t && "*" !== n && (o || (o = !0, i = ti[e], l = h)),
              i && p(l, i, a);
          }
        }
      }
      return `${ii(u, r, a, o, s, i, n)}${
    ...
    function En(e, t) {
      const s = t.map(({ id: e }) => e).filter((e) => e in yn);
      s.length &&
        e({
    ...
    const xn = (e, t) => e.split(".").map(t).join("");
    function vn(e, t, s, i, { _: n, getPropertyAccess: r }) {
      const a = e.split(".");
    ...
    const Sn = ({ dependencies: e, exports: t }) => {
        ...
        for (const { reexports: t } of e) {
          if (t) {
            for (const e of t) "*" !== e.reexported && s.add(e.reexported);
          }
        }
        return s;
      },
      An = (e, t, { _: s, cnst: i, getObject: n, n: r }) =>
        e
    ...
    function wn(e, t, { _: s, n: i }) {
      return 0 === e.length ? ""
      : 1 === e.length ? `exports('${e[0].name}',${s}${e[0].value});${i}${i}`
    ...
    const Cn = (e, t, s) =>
      ...
      In = (e, t, s) =>
        wn(
          e.filter((e) => e.local === Bi).map(
            (e) => ({ name: e.exported, value: Bi }),
          ),
          t,
          s,
        );
    function Nn(e, t, s) {
      return e ? `${t}${xn(e, s)}` : "null";
    }
    var _n = {
      amd: function (
        e,
        ...
        const w = cn(f, r),
          C = (w
            ...
            : "") + (b.length ? `[${b.join(`,${k}`)}],${k}` : ""),
          I = v ? `${k}'use strict';` : "";
        e.prepend(`${o}${mn(s, E, g, y, x, t, a, d)}`);
        const N = un(i, s, c, E, d, a, g);
        let _ = pn(c && n, h && m, l && x, k, A);
        return _ && (_ = A + A + _),
          e.append(`${N}${_}${u}`),
          e.indent(a).prepend(
            `${f.define}(${C}(${
              P(S, { isAsync: !1, name: null })
            }{${I}${A}${A}`,
          ).append(`${A}${A}}));`);
      },
      cjs: function (
        ...
        const A = function (e, { _: t, cnst: s, n: i }, n) {
          ...
          P = mn(s, g, f, m, y, t, r, u);
        e.prepend(`${b}${a}${S}${A}${P}`);
        const k = un(i, s, l, g, u, r, f, `module.exports${x}=${x}`);
        return e.append(`${k}${c}`);
      },
      es: function (
        e,
        ...
        p.length > 0 && (i += p.join(d) + d + d),
          (i += ii(null, t, s, o, h, l, c)) && e.prepend(i);
        const f = function (e, { _: t, cnst: s }) {
          ...
          return n.length && i.push(`export${t}{${t}${n.join(`,${t}`)}${t}};`),
            i;
        }(a, o);
      ...
      iife: function (
        ...
        const {
          ...
          w = E && -1 !== E.indexOf("."),
          C = !p && !w;
        if (E && C && (xe(I = E) || ye.has(I) || Ee.test(I))) {
          return ie({
        ...
        c({
          ...
          o && n && (p
            ? (_.unshift(`this${xn(E, P)}${b}=${b}this${xn(E, P)}${b}||${b}{}`),
              $.unshift("exports"))
            : (_.unshift("{}"), $.unshift("exports")));
        const T = v
            ? `${r}'use strict';${k}`
            : "",
          R = mn(s, y, m, f, x, t, r, l);
        e.prepend(`${a}${R}`);
        let M = `(${A($, { isAsync: !1, name: null })}{${k}${T}${k}`;
        n &&
          (!E || p && o ||
            (M = (C ? `${S} ${E}` : `this${xn(E, P)}`) + `${b}=${b}${M}`),
            w &&
            (M = function (e, t, s, { _: i, getPropertyAccess: n, s: r }, a) {
              const o = e.split(".");
              o[0] = ("function" == typeof s ? s(o[0]) : s[o[0]]) || o[0],
                o.pop();
              let h = t;
              return o.map(
                (e) => (h += n(e), `${h}${i}=${i}${h}${i}||${i}{}${r}`),
              ).join(a ? "," : "\n") + (a && o.length ? ";" : "\n");
            }(E, "this", g, l, u) + M));
        let D = `${k}${k}})(${_.join(`,${b}`)});`;
        n && !p && o && (D = `${k}${k}${r}return exports;${D}`);
        const L = un(i, s, o, y, l, r, m);
        let O = pn(o && n, d, x, b, k);
        return O && (O = k + k + O),
          e.append(`${L}${O}${h}`),
      ...
      system: function (
        ...
        let w = `System.register(${P}[` + s.map(({ id: e }) =>
          ...
          `],${g}(${E(k, { isAsync: !1, name: null })}{${x}${r}${
            f ? "'use strict';" : ""
          }` + An(A, r, o) + Pn(b, r, o) + `${x}${r}return${g}{${
          S.length
            ? `${x}${r}${r}setters:${g}[${
              S.map((e) =>
                e
        ...
        w += `${r}${r}execute:${g}(${
          E([], { isAsync: l, name: null })
        }{${x}${x}`;
        const C = `${r}${r}})${x}${r}}${v}${x}}));`;
        return e.prepend(a + ii(null, t, r, o, c, u, p) + kn(i, r, o)),
          e.append(`${h}${x}${x}` + Cn(i, r, o) + In(i, r, o)),
      ...
      umd: function (
        ...
        En(u, s);
        const R = s.map((e) => `'${gn(e.id)}'`),
          M = s.map((e) => `require('${e.id}')`),
          D = bn(s),
          L = D.map((e) => Nn(e.globalName, T, I)),
          O = D.map((e) => e.name);
        h && (n || S) &&
          (R.unshift("'exports'"),
            M.unshift("exports"),
            L.unshift(
              vn(x, T, b, (m ? `${Nn(x, T, I)}${P}||${P}` : "") + "{}", c),
            ),
            O.unshift("exports"));
        const V = cn(d, r),
          B = (V ? `'${V}',${P}` : "") +
        ...
        if (S) {
          ...
          let t;
          t = !h && n
            ? `${k} ${e}${P}=${P}${vn(x, T, b, `${$}(${L.join(`,${P}`)})`, c)};`
            : `${k} ${e}${P}=${P}${L.shift()};${N}${a}${a}${$}(${
              [e].concat(L).join(`,${P}`)
            });`,
            j = `(${
          ...
          j = `${$}(${L.join(`,${P}`)})`, !h && n && (j = vn(x, T, b, j, c));
        }
        const U = n || S && h || L.length > 0, G = [$];
        U && G.unshift(T);
        const H = U ? `this,${P}` : "",
          q = U
          ...
          Q = N + N + "}));";
        e.prepend(`${o}${mn(s, E, g, y, v, t, a, c)}`);
        const Z = un(i, s, h, E, c, a, g);
        let J = pn(h && n, f, v, P, N);
        return J && (J = N + N + J),
          e.append(`${Z}${J}${l}`),
        ...
        for (const r of this.mappings) {
          ...
          for (const n of r) {
            ...
            if (o) {
              ...
              if (-1 === r) {
                r = e.length,
                  e.push(o.source.filename),
                  t[r] = o.source.content;
              ...
              if (o.name) {
                let e = i.get(o.name);
                void 0 === e &&
                (e = s.length, s.push(o.name), i.set(o.name, e)), h[4] = e;
              }
              a.push(h);
            }
          }
    ...
    On.equal = function (e, t, s) {
      if (e != t) throw new Error(s || "Assertion failed: " + e + " != " + t);
    };
    var Vn = { exports: {} };
    "function" == typeof Object.create ? Vn.exports = function (e, t) {
      t &&
        (e.super_ = t,
    ...
    function Un(e) {
      ...
      : 5 === e.length
        ...
        : 3 === e.length
        ? "00000" + e
        : 2 === e.length ? "000000" + e : 1 === e.length ? "0000000" + e : e;
    }
    Dn.inherits = Fn,
      Dn.toArray = function (e, t) {
      ...
      Dn.toHex = function (e) {
        for (var t = "", s = 0; s < e.length; s++) t += jn(e[s].toString(16));
        return t;
      },
      Dn.htonl = Wn,
      Dn.toHex32 = function (e, t) {
        for (var s = "", i = 0; i < e.length; i++) {
          var n = e[i];
          "little" === t && (n = Wn(n)), s += Un(n.toString(16));
        }
        return s;
      },
      Dn.zero2 = jn,
      Dn.zero8 = Un,
      Dn.join32 = function (e, t, s, i) {
        var n = s - t;
        Bn(n % 4 == 0);
        for (
          var r = new Array(n / 4), a = 0, o = t; a < r.length; a++, o += 4
        ) {
          var h;
          h = "big" === i
      ...
      Dn.rotr32 = function (e, t) {
        return e >>> t | e << 32 - t;
      },
      Dn.rotl32 = function (e, t) {
        return e << t | e >>> 32 - t;
      },
      Dn.sum32 = function (e, t) {
        return e + t >>> 0;
      },
      Dn.sum32_3 = function (e, t, s) {
        return e + t + s >>> 0;
      },
      Dn.sum32_4 = function (e, t, s, i) {
        return e + t + s + i >>> 0;
      },
      Dn.sum32_5 = function (e, t, s, i, n) {
        return e + t + s + i + n >>> 0;
      },
      Dn.sum64 = function (e, t, s, i) {
        var n = e[t], r = i + e[t + 1] >>> 0, a = (r < i ? 1 : 0) + s + n;
        e[t] = a >>> 0, e[t + 1] = r;
      },
      Dn.sum64_hi = function (e, t, s, i) {
        return (t + i >>> 0 < t ? 1 : 0) + e + s >>> 0;
      },
      Dn.sum64_lo = function (e, t, s, i) {
        return t + i >>> 0;
      },
      Dn.sum64_4_hi = function (e, t, s, i, n, r, a, o) {
        var h = 0, l = t;
        return h += (l = l + i >>> 0) < t ? 1 : 0,
          h += (l = l + r >>> 0) < r ? 1 : 0,
          e + s + n + a + (h += (l = l + o >>> 0) < o ? 1 : 0) >>> 0;
      },
      Dn.sum64_4_lo = function (e, t, s, i, n, r, a, o) {
        return t + i + r + o >>> 0;
      },
      Dn.sum64_5_hi = function (e, t, s, i, n, r, a, o, h, l) {
        var c = 0, u = t;
      ...
      Dn.sum64_5_lo = function (e, t, s, i, n, r, a, o, h, l) {
        return t + i + r + o + l >>> 0;
      },
      Dn.rotr64_hi = function (e, t, s) {
        return (t << 32 - s | e >>> s) >>> 0;
      },
      Dn.rotr64_lo = function (e, t, s) {
        return (e << 32 - s | t >>> s) >>> 0;
      },
      Dn.shr64_hi = function (e, t, s) {
        return e >>> s;
      },
      Dn.shr64_lo = function (e, t, s) {
        return (e << 32 - s | t >>> s) >>> 0;
      };
    var Gn = {}, Hn = Dn, qn = Ln;
    function Kn() {
    ...
    Gn.BlockHash = Kn,
      Kn.prototype.update = function (e, t) {
        if (
          e = Hn.toArray(e, t),
            this.pending
          ...
          this.pending = e.slice(e.length - s, e.length),
            ...
            e = Hn.join32(e, 0, e.length - s, this.endian);
          for (var i = 0; i < e.length; i += this._delta32) {this._update(
              e,
              i,
              i + this._delta32,
            );}
    ...
    Xn.ft_1 = function (e, t, s, i) {
      ...
      Xn.maj32 = Zn,
      Xn.p32 = Jn,
      Xn.s0_256 = function (e) {
        return Yn(e, 2) ^ Yn(e, 13) ^ Yn(e, 22);
      },
      Xn.s1_256 = function (e) {
        return Yn(e, 6) ^ Yn(e, 11) ^ Yn(e, 25);
      },
      Xn.g0_256 = function (e) {
        return Yn(e, 7) ^ Yn(e, 18) ^ e >>> 3;
      },
      Xn.g1_256 = function (e) {
        return Yn(e, 17) ^ Yn(e, 19) ^ e >>> 10;
      };
    var er = Dn,
      tr = Gn,
      sr = Xn,
    ...
    mr.blockSize = 512,
      ...
      mr.prototype._update = function (e, t) {
        ...
        for (; i < s.length; i++) {
          s[i] = rr(dr(s[i - 2]), s[i - 7], ur(s[i - 15]), s[i - 16]);
        }
        var n = this.h[0],
          r = this.h[1],
          a = this.h[2],
          ...
          c = this.h[6],
          u = this.h[7];
        for (ir(this.k.length === s.length), i = 0; i < s.length; i++) {
          var d = ar(u, cr(h), or(h, l, c), this.k[i], s[i]),
            p = nr(lr(n), hr(n, r, a));
          u = c, c = l, l = h, h = nr(o, d), o = a, a = r, r = n, n = nr(d, p);
        }
        this.h[0] = nr(this.h[0], n),
          this.h[1] = nr(this.h[1], r),
          this.h[2] = nr(this.h[2], a),
          this.h[3] = nr(this.h[3], o),
          this.h[4] = nr(this.h[4], h),
          this.h[5] = nr(this.h[5], l),
          this.h[6] = nr(this.h[6], c),
          this.h[7] = nr(this.h[7], u);
      },
      mr.prototype._digest = function (e) {
        return "hex" === e ? er.toHex32(this.h, "big")
        : er.split32(this.h, "big");
      };
    var yr = gr;
    const Er = () => yr(),
      xr = { amd: Sr, cjs: Sr, es: br, iife: Sr, system: br, umd: Sr };
    function vr(e, t, s, i, n, r, a, o, h, l, c, u, d) {
      ...
      !function (e, t, s) {
        for (const i of t) {
          for (const t of i.scope.variables.values()) {
            t.included &&
              !(t.renderBaseName ||
                t instanceof Ri && t.getOriginalVariable() !== t) &&
              t.setRenderNames(null, Dt(t.name, e));
          }
          if (s.has(i)) {
            const t = i.namespace;
            t.setRenderNames(null, Dt(t.name, e));
      ...
      }(i, p, d), xr[n](i, s, t, r, a, o, h, l);
      for (const e of p) e.scope.deconflict(n, c, u);
    }
    function br(e, t, s, i, n, r, a, o) {
      for (const t of s.dependencies) {
        (n || t instanceof be) &&
          (t.variableName = Dt(t.suggestedVariableName, e));
      }
      for (const s of t) {
        const t = s.module, i = s.name;
        s.isNamespace && (n || t instanceof be)
          ? s.setRenderNames(
            null,
            (t instanceof be ? t : a.get(t)).variableName,
          )
          : t instanceof be && "default" === i
          ? s.setRenderNames(
            null,
            Dt(
          ...
          : s.setRenderNames(null, Dt(i, e));
      }
      for (const t of o) t.setRenderNames(null, Dt(t.name, e));
    }
    function Sr(
      e,
      t,
      ...
      for (const t of n) t.variableName = Dt(t.suggestedVariableName, e);
      for (const t of i) {
        t.namespaceVariableName = Dt(
          `${t.suggestedVariableName}__namespace`,
          e,
        );
      }
      for (const t of s) {
        i.has(t) && si(String(r(t.id)), o)
          ? t.defaultVariableName = t.namespaceVariableName
          : t.defaultVariableName = Dt(
            `${t.suggestedVariableName}__default`,
            e,
          );
      }
        ...
        if (t instanceof be) {
          ...
          if ("default" === s) {
            const s = String(r(t.id)),
              i = Js[s] ? t.defaultVariableName : t.variableName;
            ei(s, o)
              ? e.setRenderNames(i, "default")
              : e.setRenderNames(null, i);
          } else {
            "*" === s
              ? e.setRenderNames(
                null,
                ti[String(r(t.id))] ? t.namespaceVariableName : t.variableName,
              )
    ...
    const Ar = /[\\'\r\n\u2028\u2029]/,
      ...
      kr = /\\/g;
    function wr(e) {
      return e.match(Ar) ? e.replace(kr, "\\\\").replace(Pr, "\\$1") : e;
    }
    function Cr(e, { exports: t, name: s, format: i }, n, r, a) {
      const o = e.getExportNames();
      if ("default" === t) {
        if (1 !== o.length || "default" !== o[0]) {return ie(
            oe("default", o, r),
          );}
      } else if ("none" === t && o.length) return ie(oe("none", o, r));
      return "auto" === t &&
        (0 === o.length
          ? t = "none"
    ...
    function Nr(e, t, s, i, n) {
      ...
      for (const e of r) {
        ...
        const r = n.get(e);
        r === i ? s.has(e) || (s.add(e), Nr(e, t, s, i, n)) : t.push(r);
      }
    }
    function _r(e) {
      if (!e) return null;
      ...
      const t = "string" == typeof e.mappings ? function (e) {
        for (
          var t = [], i = [], n = [0, 0, 0, 0, 0], a = 0, o = 0, h = 0, l = 0;
          o < e.length;
          o++
        ) {
          var c = e.charCodeAt(o);
          if (44 === c) r(i, n, a), a = 0;
          else if (59 === c) r(i, n, a), a = 0, t.push(i), i = [], n[0] = 0;
          else {
            var u = s[c];
            if (void 0 === u) {
              throw new Error(
      ...
      return se(e)
        ? ie(
          ...
          if (!s.hasOwnProperty(i)) {
            return ie(
              pe(`"[${i}]" is not a valid placeholder in "${t}" pattern.`),
            );
          }
          const n = s[i]();
          return se(n)
    ...
    class Dr {
      constructor(e, t, s, i, n, r, a, o, h, l) {
        ...
        this.suggestedVariableName = ve(this.generateVariableName());
      }
      static generateFacade(e, t, s, i, n, r, a, o, h, l) {
        const c = new Dr([], e, t, s, i, n, r, a, o, null);
        c.assignFacadeName(l, h), a.has(h) || a.set(h, c);
        for (const e of h.getDependenciesToBeIncluded()) {
          c.dependencies.add(e instanceof on ? r.get(e) : e);
        }
          ...
          if (!s.has(t)) {
            return 0 === s.size && e.isUserDefinedEntryPoint &&
              ...
              this.inputOptions.onwarn({
                ...
                id: e.id,
                message:
                  `To preserve the export signature of the entry module "${
                    te(e.id)
            ...
            for (const n of e) {
              ...
              if (t.has(e)) {
                do {
                  e = Mt(++i),
                    49 === e.charCodeAt(0) &&
                    (i += 9 * 64 ** (e.length - 1), e = Mt(i));
                } while (ye.has(e) || t.has(e));
              }
              t.set(e, n), s.set(n, [e]);
            }
      ...
      generateFacades() {
        ...
        for (const e of s) {
          const s = Array.from(
            new Set(
              e.chunkNames.filter(({ isUserDefined: e }) => e).map(
                ({ name: e }) => e,
              ),
            ),
            (e) => ({ name: e }),
      ...
      generateId(e, t, s, i) {
        ...
        return Tr(
          $r("function" == typeof n ? n(this.getChunkInfo()) : n, r, {
            format: () => t.format,
            hash: () =>
              i
      ...
      generateIdPreserveModules(e, t, s, i) {
        const [{ id: n }] = this.orderedModules,
          r = this.outputOptions.sanitizeFileName(n.split(Or, 1)[0]);
        let a;
        ...
        if (k(r)) {
          const s = N(r),
            i = _(r),
            n = `${s}/${
              $r(h, "output.entryFileNames", {
                assetExtname: () => Rr.includes(i) ? "" : i,
                ext: () => i.substr(1),
                extname: () => i,
                format: () => t.format,
                name: () => this.getChunkName(),
      ...
      getChunkInfoWithFileNames() {
        return Object.assign(this.getChunkInfo(), {
          code: void 0,
          dynamicImports: Array.from(this.dynamicDependencies, Ui),
          fileName: this.id,
          implicitlyLoadedBefore: Array.from(this.implicitlyLoadedBefore, Ui),
          importedBindings: this.getImportedBindingsPerDependency(),
          imports: Array.from(this.dependencies, Ui),
          map: void 0,
      ...
      getExportNames() {
        var e;
        return null !== (e = this.sortedExportNames) && void 0 !== e ? e
        ...
        return e.update(t),
          ...
          e.update(
            this.getExportNames().map((e) => {
              ...
              return `${te(t.module.id).replace(/\\/g, "/")}:${t.name}:${e}`;
            }).join(","),
          ),
          this.renderedHash = e.digest("hex");
      }
      getVariableExportName(e) {
        return this.outputOptions.preserveModules && e instanceof zi ? "*"
      ...
      preRender(e, t, s) {
        ...
        if (
          ...
          for (const e of this.dependencies) {
            e instanceof Dr && this.inlineChunkDependencies(e);
          }
        }
        this.prepareModulesForRendering(s),
        ...
        for (const t of this.orderedModules) {
          ...
          if (t.isIncluded() || this.includedNamespaces.has(t)) {
            ...
            if (
              ...
              n.renderFirst() ? h += r + e : a.addSource(new S(e));
            }
          }
          const { renderedExports: i, removedExports: n } = t
              .getRenderedExports(),
        ...
        if (
          h && a.prepend(h + r + r),
            ...
            a.prepend(
              `${r}${s.cnst} _missingExportShim${i}=${i}void 0;${r}${r}`,
            ),
            e.compact
      ...
      async render(e, t, s, i) {
        ...
        for (const e of this.dependencies) {
          ...
          if (e instanceof be) {
            ...
            t.id = wr(
              e.renormalizeRenderPath ? this.getRelativePath(s, !1) : s,
            );
          } else {
            t.namedExportsMode = "default" !== e.exportMode,
              t.id = wr(this.getRelativePath(e.id, !1));
          }
        }
        ...
        if (e.sourcemap) {
          ...
          d = function (e, t, s, i, n, r) {
            const a = Rn(r),
              ...
              h = new Tn(t, o),
              l = i.reduce(a, h);
            let { sources: u, sourcesContent: d, names: p, mappings: f } = l
              .traceMappings();
            if (e) {
              const t = N(e);
              u = u.map((e) => $(t, e)), e = I(e);
            ...
            d.sources = d.sources.map((s) => {
              ...
              if (i) {
                ...
                return "string" != typeof e &&
                  ie(
                    pe("sourcemapPathTransform function must return a string."),
                  ),
                  e;
              }
              return s;
      ...
      assignFacadeName({ fileName: e, name: t }, s) {
        e ? this.fileName = e
        : this.name = this.outputOptions.sanitizeFileName(t || Lr(s));
      }
            ...
            if (h = t.alternativeReexportModules.get(e), h) {
              ...
              this.inputOptions.onwarn(
                (i = s.getExportNamesByVariable().get(e)[0],
                  ...
                  a = t.id,
                  {
                    code: re.CYCLIC_CROSS_CHUNK_REEXPORT,
                    exporter: n,
                    importer: a,
          ...
          if (
            r instanceof be
              ...
              : (i.update(r.getRenderedHash()),
                i.update(r.generateId(e, t, s, !1))), !(r instanceof be)
          ) {
      ...
      ensureReexportsAreAvailableForModule(e) {
        ...
        for (const s of t.keys()) {
          const t = s instanceof Wi, i = t ? s.getBaseVariable() : s;
          if (!(i instanceof zi && this.outputOptions.preserveModules)) {
      ...
      finaliseDynamicImports(e, t) {
        ...
        for (const [e, i] of this.renderedModuleSources) {
          for (const { node: n, resolution: r } of e.dynamicImports) {
            ...
            const o = r instanceof on
              ? `'${wr(this.getRelativePath((a || e).id, s))}'`
              : r instanceof be
              ? `'${
                wr(
            ...
            n.renderFinalResolution(
              i,
              o,
              r instanceof on && !(null == a ? void 0 : a.strictFacade) &&
      ...
      getChunkDependencyDeclarations(e, t) {
        ...
        for (const t of this.dependencies) {
          const r = s.get(t) || null,
            a = i.get(t) || null,
            o = t instanceof be || "default" !== t.exportMode;
          n.set(t, {
            defaultVariableName: t.defaultVariableName,
            globalName: t instanceof be &&
              ("umd" === e.format || "iife" === e.format) &&
              Mr(t, e.globals, null !== (r || a), this.inputOptions.onwarn),
            id: void 0,
            imports: r,
            isChunk: t instanceof Dr,
            name: t.variableName,
            namedExportsMode: o,
        ...
        for (const i of this.getExportNames()) {
          ...
          if (n instanceof Rt) {
            for (const e of n.declarations) {
              if (
                e.parent instanceof Fs ||
                e instanceof zs && e.declaration instanceof Fs
              ) {
                a = !0;
                break;
              }
            }
          } else n instanceof Wi && (r = o, "es" === e && (o = n.renderName));
      ...
      getDependenciesToBeDeconflicted(e, t, s) {
        ...
        for (
          const t of [...this.exportNamesByVariable.keys(), ...this.imports]
        ) {
          if (e || t.isNamespace) {
            const a = t.module;
            if (a instanceof be) {
              i.add(a),
                e && ("default" === t.name
                  ? Js[String(s(a.id))] && n.add(a)
                  : "*" === t.name && ti[String(s(a.id))] && r.add(a));
            } else {
      ...
      getFallbackChunkName() {
        return this.manualChunkAlias ? this.manualChunkAlias
        : this.dynamicName ? this.dynamicName
        : this.fileName ? ee(this.fileName)
        : ee(this.orderedModules[this.orderedModules.length - 1].id);
      }
        ...
        for (const i of this.imports) {
          ...
          if (n instanceof be) {
            if (
              ...
              return ie(ue(n.id, a, !1));
            }
          } else r = this.chunkByModule.get(n), a = r.getVariableExportName(i);
          R(s, r, () => []).push({ imported: a, local: i.getName(e) });
        }
        return s;
      }
      ...
      getReexportSpecifiers() {
        ...
        for (let i of this.getExportNames()) {
          ...
          if ("*" === i[0]) {
            const s = i.substr(1);
            "defaultOnly" === t(s) && this.inputOptions.onwarn(de(s)),
              a = e,
              n = this.modulesById.get(s),
              r = i = "*";
          } else {
            const s = this.exportsByName.get(i);
            if (s instanceof Wi) continue;
            const o = s.module;
            if (o instanceof on) {
              ...
              if (
                ...
                return ie(ue(o.id, r, !0));
              }
              a = e && ("default" !== r || ei(String(t(o.id)), !0));
            }
          }
          R(s, n, () => []).push({
            imported: r,
        ...
        for (const t of e.dependencies) {
          this.dependencies.has(t) ||
            (this.dependencies.add(t),
              t instanceof Dr && this.inlineChunkDependencies(t));
        }
      }
      prepareModulesForRendering(e) {
        ...
        for (const i of this.orderedModules) {
          ...
          this.includedNamespaces.has(i) &&
            !this.outputOptions.preserveModules && i.namespace.prepare(s);
        }
      }
      setExternalRenderPaths(e, t) {
        for (const s of [...this.dependencies, ...this.dynamicDependencies]) {
          s instanceof be && s.setRenderPath(e, t);
        }
      }
      setIdentifierRenderResolutions(
        ...
        switch (this.needsExportsShim && n.add(Bi), s && n.add("Symbol"), e) {
          case "system":
      ...
      setUpChunkImportsAndExportsForModule(e) {
        ...
        if (
          !this.outputOptions.preserveModules && this.includedNamespaces.has(e)
        ) {
        ...
        for (let s of t) {
          s instanceof Ri && (s = s.getOriginalVariable()),
            s instanceof Wi && (s = s.getBaseVariable());
          const t = this.chunkByModule.get(s.module);
          t !== this &&
            (this.imports.add(s),
              !(s instanceof zi && this.outputOptions.preserveModules) &&
              s.module instanceof on &&
        ...
        for (const { node: t, resolution: s } of e.dynamicImports) {
          t.included && s instanceof on && this.chunkByModule.get(s) === this &&
      ...
      return null !==
            (n =
              null !==
                ...
                ? void 0
                : i.name) && void 0 !== n ? n : ee(e.id);
    }
    const Or = /[?#]/;
    function Vr(e, t, s) {
      e in t && s(function (e) {
        return {
          code: re.FILE_NAME_CONFLICT,
          message:
    ...
    class jr {
      constructor(e, t, s) {
        this.graph = e,
          ...
          this.getFileName = (e) => {
            ...
            return t
              ? "chunk" === t.type ? Wr(t, this.facadeChunkByModule) : zr(t, e)
              : ie(
                (s = e,
                  {
                    code: re.FILE_NOT_FOUND,
                    message:
          ...
          this.setAssetSource = (e, t) => {
            ...
            if (void 0 !== s.source) {
              return ie(
                (n = s.name || e,
                  {
                    code: re.ASSET_SOURCE_ALREADY_SET,
                    message:
            ...
            const r = Fr(t, s, e);
            this.bundle ? this.finalizeAsset(s, r, e, this.bundle)
            : s.source = r;
          },
          this.setOutputBundle = (e, t, s) => {
            this.outputOptions = t,
              this.bundle = e,
              this.facadeChunkByModule = s;
          ...
          this.filesByReferenceId = s ? new Map(s.filesByReferenceId)
          : new Map();
      }
      ...
      emitAsset(e) {
        const t = void 0 !== e.source ? Fr(e.source, e, null) : void 0,
      ...
      emitChunk(e) {
        ...
        return this.graph.moduleLoader.emitChunk(e).then((e) => t.module = e)
          .catch(() => {}),
      ...
      finalizeAsset(e, t, s, i) {
        const n = e.fileName || function (e, t) {
            for (const [s, i] of Object.entries(e)) {
              if ("asset" === i.type && Ur(t, i.source)) return s;
            }
            return null;
            ...
            return Tr(
              $r(
                ...
                "output.assetFileNames",
                {
                  ...
                  name: () => n.substr(0, n.length - _(n).length),
                },
              ),
              i,
            );
    ...
    function qr(e, t) {
      ...
      for (const [e, s] of t) Kr(e, n[s] = n[s] || [], i);
      for (const [e, t] of Object.entries(n)) s.push({ alias: e, modules: t });
      const r = new Map(),
        { dependentEntryPointsByModule: a, dynamicEntryModules: o } = function (
          e,
        ) {
          ...
          for (const e of i) {
            ...
            for (const r of n) {
              ...
              for (const e of r.getDependenciesToBeIncluded()) {
                e instanceof be || n.add(e);
              }
              for (const { resolution: e } of r.dynamicImports) {
                e instanceof on && e.includedDynamicImporters.length > 0 &&
                  (t.add(e), i.add(e));
              }
        ...
        h = function (e, t) {
          ...
          for (const i of t) {
            ...
            for (
              const s of [
                ...i.includedDynamicImporters,
                ...i.implicitlyLoadedAfter,
              ]
            ) {
        ...
        for (const n of s) {
          ...
          if (!t || !u(t, a.get(n))) {
            ...
            for (const e of n.getDependenciesToBeIncluded()) {
              e instanceof be || i.has(e) || s.add(e);
            }
          }
        }
      }
    ...
    function Kr(e, t, s) {
      ...
      for (const e of i) {
        s.add(e), t.push(e);
        for (const t of e.dependencies) t instanceof be || s.has(t) || i.add(t);
      }
    }
    const Xr = (e, t) => e.execIndex > t.execIndex ? 1 : -1;
    function Yr(e, t, s) {
      const i = Symbol(e.id), n = [te(e.id)];
      let r = t;
      for (e.cycles.add(i); r !== e;) {
        r.cycles.add(i), n.push(te(r.id)), r = s.get(r);
      }
      return n.push(n[0]), n.reverse(), n;
    }
    const Qr = (e, t) => t ? `(${e})` : e, Zr = /^(?!\d)[\w$]+$/;
    class Jr {
      constructor(e, t, s, i, n) {
      ...
      async generate(e) {
        ...
        try {
          await this.pluginDriver.hookParallel("renderStart", [
            this.outputOptions,
            this.inputOptions,
          ]), Ji("generate chunks", 2);
          const e = await this.generateChunks();
          e.length > 1 &&
            (s = this.outputOptions,
              i = this.inputOptions.onwarn,
              "umd" === s.format || "iife" === s.format
                ? ie(
                  he(
                    "output.format",
                    "outputformat",
          ...
          const n = function (e) {
            ...
            const t = e.slice(1).reduce((e, t) => {
              ...
              let i;
              for (
                i = 0; e[i] === s[i] && i < Math.min(e.length, s.length); i++
              );
              return e.slice(0, i);
            }, e[0].split(/\/+|\\+/));
            ...
            const t = [];
            for (const s of e) {
              for (const e of s.entryModules) k(e.id) && t.push(e.id);
            }
            return t;
          }(e));
          ...
          const r = await async function (e, t) {
              try {
                let [s, i, n, r] = await Promise.all([
                  t.hookReduceValue("banner", e.banner(), [], Gr),
                  t.hookReduceValue("footer", e.footer(), [], Gr),
                  t.hookReduceValue("intro", e.intro(), [], Hr),
                  t.hookReduceValue("outro", e.outro(), [], Hr),
                ]);
                return n && (n += "\n\n"),
                  r && (r = `\n\n${r}`),
                  s.length && (s += "\n"),
            ...
            a = function (
              ...
              const { _: r, n: a, s: o } = e
                ...
                d = n ? (e) => Zr.test(e) : (e) => !ye.has(e) && Zr.test(e);
              return {
                _: r,
                cnst: h,
          ...
          this.prerenderChunks(e, n, a),
            en("render modules", 2),
            await this.addFinalizedChunksToBundle(e, n, r, t, a);
        } catch (e) {
      ...
      assignChunkIds(e, t, s, i) {
        const n = [], r = [];
        for (const t of e) {
          (t.facadeModule && t.facadeModule.isUserDefinedEntryPoint ? n : r)
            .push(t);
        }
        const a = n.concat(r);
        for (const e of a) {
          this.outputOptions.file
            ? e.id = I(this.outputOptions.file)
            : this.outputOptions.preserveModules
        ...
        for (const t of Object.values(e)) {
          if (
            ...
            try {
              ...
              this.inputOptions.onwarn(ae(t, e));
            }
          }
        }
      ...
      async generateChunks() {
        const { manualChunks: e } = this.outputOptions,
          ...
          i = new Map();
        for (
          const { alias: e, modules: n }
            of this.outputOptions.inlineDynamicImports
              ? [{ alias: null, modules: ea(this.graph.modulesById) }]
              : this.outputOptions.preserveModules
              ? ea(this.graph.modulesById).map(
                (e) => ({ alias: null, modules: [e] }),
              )
              : qr(this.graph.entryModules, t)
        ) {
          n.sort(Xr);
          const t = new Dr(
            n,
    ...
    var sa = {
      ...
      na = {
        5: ia,
        "5module": ia + " export import",
        6: ia + " const class extends export import super",
      },
      ra = /^in(stanceof)?$/,
      aa =
    ...
    function pa(e, t) {
      ...
      : e < 91 ||
        (e < 97
          ? 95 === e
          : e < 123 || (e <= 65535
            ? e >= 170 && ha.test(String.fromCharCode(e))
            : !1 !== t && da(e, ca)));
    }
    function fa(e, t) {
      return e < 48 ? 36 === e
      : e < 58 ||
        !(e < 65) &&
          (e < 91 || (e < 97
            ? 95 === e
            : e < 123 || (e <= 65535
              ? e >= 170 && la.test(String.fromCharCode(e))
              : !1 !== t && (da(e, ca) || da(e, ua)))));
    }
    var ma = function (e, t) {
      void 0 === t && (t = {}),
    ...
    function ga(e, t) {
      return new ma(e, { beforeExpr: !0, binop: t });
    }
    var ya = { beforeExpr: !0 }, Ea = { startsExpr: !0 }, xa = {};
    function va(e, t) {
      return void 0 === t && (t = {}), t.keyword = e, xa[e] = new ma(e, t);
    }
    var ba = {
        num: new ma("num", Ea),
        regexp: new ma("regexp", Ea),
        string: new ma("string", Ea),
        name: new ma("name", Ea),
        privateId: new ma("privateId", Ea),
        eof: new ma("eof"),
        bracketL: new ma("[", { beforeExpr: !0, startsExpr: !0 }),
        bracketR: new ma("]"),
        braceL: new ma("{", { beforeExpr: !0, startsExpr: !0 }),
        braceR: new ma("}"),
        parenL: new ma("(", { beforeExpr: !0, startsExpr: !0 }),
        parenR: new ma(")"),
        comma: new ma(",", ya),
        semi: new ma(";", ya),
        colon: new ma(":", ya),
        ...
        questionDot: new ma("?."),
        arrow: new ma("=>", ya),
        template: new ma("template"),
        invalidTemplate: new ma("invalidTemplate"),
        ellipsis: new ma("...", ya),
        backQuote: new ma("`", Ea),
        dollarBraceL: new ma("${", { beforeExpr: !0, startsExpr: !0 }),
        eq: new ma("=", { beforeExpr: !0, isAssign: !0 }),
        assign: new ma("_=", { beforeExpr: !0, isAssign: !0 }),
        incDec: new ma("++/--", { prefix: !0, postfix: !0, startsExpr: !0 }),
        prefix: new ma("!/~", { beforeExpr: !0, prefix: !0, startsExpr: !0 }),
        logicalOR: ga("||", 1),
        logicalAND: ga("&&", 2),
        bitwiseOR: ga("|", 3),
        bitwiseXOR: ga("^", 4),
        ...
        star: ga("*", 10),
        slash: ga("/", 10),
        starstar: new ma("**", { beforeExpr: !0 }),
        coalesce: ga("??", 1),
        _break: va("break"),
        _case: va("case", ya),
        _catch: va("catch"),
        _continue: va("continue"),
        _debugger: va("debugger"),
        _default: va("default", ya),
        _do: va("do", { isLoop: !0, beforeExpr: !0 }),
        _else: va("else", ya),
        _finally: va("finally"),
        _for: va("for", { isLoop: !0 }),
        _function: va("function", Ea),
        _if: va("if"),
        _return: va("return", ya),
        _switch: va("switch"),
        _throw: va("throw", ya),
        _try: va("try"),
        _var: va("var"),
        _const: va("const"),
        _while: va("while", { isLoop: !0 }),
        _with: va("with"),
        _new: va("new", { beforeExpr: !0, startsExpr: !0 }),
        _this: va("this", Ea),
        _super: va("super", Ea),
        _class: va("class", Ea),
        _extends: va("extends", ya),
        _export: va("export"),
        _import: va("import", Ea),
        _null: va("null", Ea),
        _true: va("true", Ea),
        _false: va("false", Ea),
        _in: va("in", { beforeExpr: !0, binop: 7 }),
        _instanceof: va("instanceof", { beforeExpr: !0, binop: 7 }),
        _typeof: va("typeof", { beforeExpr: !0, prefix: !0, startsExpr: !0 }),
        _void: va("void", { beforeExpr: !0, prefix: !0, startsExpr: !0 }),
        _delete: va("delete", { beforeExpr: !0, prefix: !0, startsExpr: !0 }),
      },
      Sa = /\r\n?|\n|\u2028|\u2029/,
      Aa = new RegExp(Sa.source, "g");
    function Pa(e) {
    ...
    var wa = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/,
      ...
      Ta = Array.isArray || function (e) {
        return "[object Array]" === _a.call(e);
      };
    function Ra(e) {
    ...
    function Fa(e) {
      var t = {};
      for (var s in Va) t[s] = e && $a(e, s) ? e[s] : Va[s];
      if (
      ...
      return Ta(t.onComment) && (t.onComment = function (e, t) {
        return function (s, i, n, r, a, o) {
          var h = { type: s ? "Block" : "Line", value: i, start: n, end: r };
          e.locations && (h.loc = new La(this, a, o)),
    ...
    var ja = function (e, t, s) {
        ...
        var i = "";
        !0 !== e.allowReserved &&
        (i = sa[e.ecmaVersion >= 6 ? 6 : 5 === e.ecmaVersion ? 5 : 3],
          "module" === e.sourceType && (i += " await")),
          this.reservedWords = Ra(i);
        var n = (i ? i + " " : "") + sa.strict;
        this.reservedWordsStrict = Ra(n),
          this.reservedWordsStrictBind = Ra(n + " " + sa.strictBind),
          this.input = String(t),
          this.containsEsc = !1,
          s
            ? (this.pos = s,
              ...
              this.curLine =
                this.input.slice(0, this.lineStart).split(Sa).length)
    ...
    ja.prototype.parse = function () {
      ...
      ja.parse = function (e, t) {
        return new this(t, e).parse();
      },
      ja.parseExpressionAt = function (e, t, s) {
        var i = new this(s, e, t);
        return i.nextToken(), i.parseExpression();
      },
      ja.tokenizer = function (e, t) {
        return new this(t, e);
      },
    ...
    Ga.strictDirective = function (e) {
      for (;;) {
        Ca.lastIndex = e, e += Ca.exec(this.input)[0].length;
        var t = Ha.exec(this.input.slice(e));
        if (!t) return !1;
        if ("use strict" === (t[1] || t[2])) {
          Ca.lastIndex = e + t[0].length;
          var s = Ca.exec(this.input),
      ...
      Ga.isContextual = function (e) {
        return this.type === ba.name && this.value === e && !this.containsEsc;
      },
      Ga.eatContextual = function (e) {
        return !!this.isContextual(e) && (this.next(), !0);
      },
      Ga.expectContextual = function (e) {
        this.eatContextual(e) || this.unexpected();
      },
      Ga.canInsertSemicolon = function () {
        return this.type === ba.eof || this.type === ba.braceR ||
          Sa.test(this.input.slice(this.lastTokEnd, this.start));
      },
      Ga.insertSemicolon = function () {
      ...
      Ga.semicolon = function () {
        this.eat(ba.semi) || this.insertSemicolon() || this.unexpected();
      },
      Ga.afterTrailingComma = function (e, t) {
        if (this.type === e) {
      ...
      Ga.expect = function (e) {
        this.eat(e) || this.unexpected();
      },
      Ga.unexpected = function (e) {
        this.raise(null != e ? e : this.start, "Unexpected token");
      },
      Ga.checkPatternErrors = function (e, t) {
        if (e) {
          e.trailingComma > -1 &&
      ...
      Ga.checkExpressionErrors = function (e, t) {
        if (!e) return !1;
      ...
      Ga.checkYieldAwaitInDefaultParams = function () {
    ...
    var Xa = { kind: "loop" }, Ya = { kind: "switch" };
    Ka.isLet = function (e) {
      if (this.options.ecmaVersion < 6 || !this.isContextual("let")) return !1;
      Ca.lastIndex = this.pos;
      var t = Ca.exec(this.input),
      ...
      if (123 === i) return !0;
      if (pa(i, !0)) {
        for (var n = s + 1; fa(i = this.input.charCodeAt(n), !0);) ++n;
        if (92 === i || i > 55295 && i < 56320) return !0;
        var r = this.input.slice(s, n);
        if (!ra.test(r)) return !0;
      }
      return !1;
    },
      Ka.isAsyncFunction = function () {
        if (
        ...
        Ca.lastIndex = this.pos;
        var e, t = Ca.exec(this.input), s = this.pos + t[0].length;
        return !(Sa.test(this.input.slice(this.pos, s)) ||
          "function" !== this.input.slice(s, s + 8) ||
          s + 8 !== this.input.length &&
            (fa(e = this.input.charCodeAt(s + 8)) || e > 55295 && e < 56320));
      },
      Ka.parseStatement = function (e, t, s) {
        var i, n = this.type, r = this.startNode();
        switch (this.isLet(e) && (n = ba._var, i = "let"), n) {
          case ba._break:
          case ba._continue:
          ...
          case ba._export:
          case ba._import:
            if (this.options.ecmaVersion > 10 && n === ba._import) {
              Ca.lastIndex = this.pos;
              var a = Ca.exec(this.input),
            ...
            return this.options.allowImportExportEverywhere ||
              ...
              n === ba._import ? this.parseImport(r) : this.parseExport(r, s);
          default:
            ...
            return n === ba.name && "Identifier" === c.type &&
                this.eat(ba.colon) ? this.parseLabeledStatement(r, l, c, e)
            : this.parseExpressionStatement(r, c);
        }
      },
      Ka.parseBreakContinueStatement = function (e, t) {
        var s = "break" === t;
        this.next(),
          this.eat(ba.semi) || this.insertSemicolon()
            ? e.label = null
            : this.type !== ba.name
            ? this.unexpected()
      ...
      Ka.parseDebuggerStatement = function (e) {
        return this.next(),
          this.semicolon(),
          this.finishNode(e, "DebuggerStatement");
      },
      Ka.parseDoStatement = function (e) {
        return this.next(),
          this.labels.push(Xa),
          e.body = this.parseStatement("do"),
          this.labels.pop(),
          this.expect(ba._while),
          e.test = this.parseParenExpression(),
          this.options.ecmaVersion >= 6 ? this.eat(ba.semi) : this.semicolon(),
          this.finishNode(e, "DoWhileStatement");
      },
      Ka.parseForStatement = function (e) {
        this.next();
        var t =
        ...
        if (
          this.labels.push(Xa),
            this.enterScope(0),
            this.expect(ba.parenL),
            this.type === ba.semi
        ) {
          return t > -1 && this.unexpected(t), this.parseFor(e, null);
        }
        var s = this.isLet();
        if (this.type === ba._var || this.type === ba._const || s) {
          ...
          return this.next(),
            ...
            (this.type === ba._in ||
              ...
              ? (this.options.ecmaVersion >= 9 && (this.type === ba._in
      ...
      Ka.parseFunctionStatement = function (e, t, s) {
        return this.next(), this.parseFunction(e, Za | (s ? 0 : Ja), !1, t);
      },
      Ka.parseIfStatement = function (e) {
        return this.next(),
          e.test = this.parseParenExpression(),
          e.consequent = this.parseStatement("if"),
          e.alternate = this.eat(ba._else) ? this.parseStatement("if") : null,
          this.finishNode(e, "IfStatement");
      },
      Ka.parseReturnStatement = function (e) {
        return this.inFunction || this.options.allowReturnOutsideFunction ||
          this.raise(this.start, "'return' outside of function"),
          this.next(),
          this.eat(ba.semi) || this.insertSemicolon() ? e.argument = null
          : (e.argument = this.parseExpression(), this.semicolon()),
          this.finishNode(e, "ReturnStatement");
      },
      Ka.parseSwitchStatement = function (e) {
        var t;
        this.next(),
          e.discriminant = this.parseParenExpression(),
          e.cases = [],
          this.expect(ba.braceL),
          this.labels.push(Ya),
          this.enterScope(0);
        for (var s = !1; this.type !== ba.braceR;) {
          if (this.type === ba._case || this.type === ba._default) {
            var i = this.type === ba._case;
      ...
      Ka.parseThrowStatement = function (e) {
        return this.next(),
          Sa.test(this.input.slice(this.lastTokEnd, this.start)) &&
    ...
    var Qa = [];
    Ka.parseTryStatement = function (e) {
      if (
        this.next(),
      ...
      return e.finalizer = this.eat(ba._finally) ? this.parseBlock() : null,
        e.handler || e.finalizer ||
        this.raise(e.start, "Missing catch or finally clause"),
        this.finishNode(e, "TryStatement");
    },
      Ka.parseVarStatement = function (e, t) {
        return this.next(),
          this.parseVar(e, !1, t),
          this.semicolon(),
          this.finishNode(e, "VariableDeclaration");
      },
      Ka.parseWhileStatement = function (e) {
        return this.next(),
          e.test = this.parseParenExpression(),
          this.labels.push(Xa),
      ...
      Ka.parseWithStatement = function (e) {
      ...
      Ka.parseEmptyStatement = function (e) {
        return this.next(), this.finishNode(e, "EmptyStatement");
      },
      Ka.parseLabeledStatement = function (e, t, s, i) {
      ...
      Ka.parseExpressionStatement = function (e, t) {
        return e.expression = t,
          this.semicolon(),
          this.finishNode(e, "ExpressionStatement");
      },
      Ka.parseBlock = function (e, t, s) {
        for (
          void 0 === e && (e = !0),
      ...
      Ka.parseFor = function (e, t) {
        return e.init = t,
          this.expect(ba.semi),
          e.test = this.type === ba.semi ? null : this.parseExpression(),
          this.expect(ba.semi),
          e.update = this.type === ba.parenR ? null : this.parseExpression(),
          this.expect(ba.parenR),
      ...
      Ka.parseForIn = function (e, t) {
        var s = this.type === ba._in;
        return this.next(),
          "VariableDeclaration" === t.type && null != t.declarations[0].init &&
          (!s || this.options.ecmaVersion < 8 || this.strict ||
          ...
          if (
            this.parseVarId(i, s),
              this.eat(ba.eq)
                ...
                : "const" !== s || this.type === ba._in ||
                    this.options.ecmaVersion >= 6 && this.isContextual("of")
                ? "Identifier" === i.id.type ||
                    t && (this.type === ba._in || this.isContextual("of"))
                  ? i.init = null
                  : this.raise(
                    this.lastTokEnd,
    ...
    Ka.parseFunction = function (e, t, s, i, n) {
      this.initFunction(e),
        (this.options.ecmaVersion >= 9 ||
          this.options.ecmaVersion >= 6 && !i) &&
        (this.type === ba.star && t & Ja && this.unexpected(),
          e.generator = this.eat(ba.star)),
        this.options.ecmaVersion >= 8 && (e.async = !!i),
        t & Za &&
        (e.id = 4 & t && this.type !== ba.name ? null : this.parseIdent(),
          !e.id || t & Ja ||
      ...
      return this.yieldPos = 0,
        ...
        this.enterScope(Wa(e.async, e.generator)),
        t & Za || (e.id = this.type === ba.name ? this.parseIdent() : null),
        ...
        this.finishNode(
          e,
          t & Za ? "FunctionDeclaration" : "FunctionExpression",
        );
    },
      Ka.parseFunctionParams = function (e) {
        this.expect(ba.parenL),
      ...
      Ka.parseClass = function (e, t) {
        this.next();
        var s = this.strict;
        this.strict = !0, this.parseClassId(e, t), this.parseClassSuper(e);
        var i = this.enterClassBody(), n = this.startNode(), r = !1;
        for (n.body = [], this.expect(ba.braceL); this.type !== ba.braceR;) {
            ...
            (n.body.push(a),
              "MethodDefinition" === a.type && "constructor" === a.kind
                ? (r &&
                  ...
                  r = !0)
                : a.key && "PrivateIdentifier" === a.key.type && eo(i, a) &&
                  this.raiseRecoverable(
                    a.key.start,
                    "Identifier '#" + a.key.name +
      ...
      Ka.parseClassElement = function (e) {
        if (this.eat(ba.semi)) return null;
        ...
        if (this.eatContextual("static")) {
          if (t >= 13 && this.eat(ba.braceL)) {
            return this.parseClassStaticBlock(s), s;
          }
          this.isClassElementNameStart() || this.type === ba.star
            ? o = !0
            : i = "static";
        }
        if (
        ...
        if (
          i
            ...
            t < 13 || this.type === ba.parenL || "method" !== a || n || r
        ) {
          var l = !s.static && to(s, "constructor"), c = l && e;
          l && "method" !== a &&
      ...
      Ka.isClassElementNameStart = function () {
        return this.type === ba.name || this.type === ba.privateId ||
          this.type === ba.num || this.type === ba.string ||
          this.type === ba.bracketL || this.type.keyword;
      },
      Ka.parseClassElementName = function (e) {
        this.type === ba.privateId
      ...
      Ka.parseClassStaticBlock = function (e) {
        e.body = [];
        var t = this.labels;
        for (this.labels = [], this.enterScope(320); this.type !== ba.braceR;) {
      ...
      Ka.parseClassId = function (e, t) {
        this.type === ba.name
          ? (e.id = this.parseIdent(), t && this.checkLValSimple(e.id, 2, !1))
          : (!0 === t && this.unexpected(), e.id = null);
      },
      Ka.parseClassSuper = function (e) {
        e.superClass = this.eat(ba._extends) ? this.parseExprSubscripts(!1)
        : null;
      },
      Ka.enterClassBody = function () {
        var e = { declared: Object.create(null), used: [] };
        return this.privateNameStack.push(e), e.declared;
      },
      Ka.exitClassBody = function () {
        for (
      ...
      Ka.parseExport = function (e, t) {
        if (this.next(), this.eat(ba.star)) {
          return this.options.ecmaVersion >= 11 &&
            ...
            this.type !== ba.string && this.unexpected(),
            e.source = this.parseExprAtom(),
            this.semicolon(),
            this.finishNode(e, "ExportAllDeclaration");
        }
        if (this.eat(ba._default)) {
          var s;
          if (
            this.checkExport(t, "default", this.lastTokStart),
              this.type === ba._function || (s = this.isAsyncFunction())
          ) {
            var i = this.startNode();
            this.next(),
              s && this.next(),
              e.declaration = this.parseFunction(i, 4 | Za, !1, s);
          } else if (this.type === ba._class) {
      ...
      Ka.checkExport = function (e, t, s) {
        e &&
          ($a(e, t) && this.raiseRecoverable(s, "Duplicate export '" + t + "'"),
            e[t] = !0);
      },
      Ka.checkPatternExport = function (e, t) {
        var s = t.type;
      ...
      Ka.checkVariableExport = function (e, t) {
        if (e) {
      ...
      Ka.shouldParseExportStatement = function () {
      ...
      Ka.parseExportSpecifiers = function (e) {
        var t = [], s = !0;
        for (this.expect(ba.braceL); !this.eat(ba.braceR);) {
          if (s) s = !1;
          else if (this.expect(ba.comma), this.afterTrailingComma(ba.braceR)) {
            break;
          }
          var i = this.startNode();
      ...
      Ka.parseImport = function (e) {
        return this.next(),
          this.type === ba.string
            ? (e.specifiers = Qa, e.source = this.parseExprAtom())
            : (e.specifiers = this.parseImportSpecifiers(),
              this.expectContextual("from"),
              e.source = this.type === ba.string
                ? this.parseExprAtom()
                : this.unexpected()),
          this.semicolon(),
          this.finishNode(e, "ImportDeclaration");
      },
      Ka.parseImportSpecifiers = function () {
        var e = [], t = !0;
        if (this.type === ba.name) {
      ...
      Ka.parseModuleExportName = function () {
        if (this.options.ecmaVersion >= 13 && this.type === ba.string) {
          var e = this.parseLiteral(this.value);
          return Ma.test(e.value) &&
            this.raise(
              e.start,
      ...
      Ka.adaptDirectivePrologue = function (e) {
        for (var t = 0; t < e.length && this.isDirectiveCandidate(e[t]); ++t) {
          e[t].directive = e[t].expression.raw.slice(1, -1);
        }
      },
      Ka.isDirectiveCandidate = function (e) {
    ...
    var so = ja.prototype;
    so.toAssignable = function (e, t, s) {
      ...
      so.toAssignableList = function (e, t) {
        ...
        if (s) {
          var r = e[s - 1];
          6 === this.options.ecmaVersion && t && r &&
            "RestElement" === r.type && "Identifier" !== r.argument.type &&
            this.unexpected(r.argument.start);
        }
        return e;
      },
      so.parseSpread = function (e) {
        var t = this.startNode();
        return this.next(),
      ...
      so.parseRestBinding = function () {
        ...
        return this.next(),
          6 === this.options.ecmaVersion && this.type !== ba.name &&
          this.unexpected(),
          e.argument = this.parseBindingAtom(),
          this.finishNode(e, "RestElement");
      },
      so.parseBindingAtom = function () {
        if (this.options.ecmaVersion >= 6) {
          switch (this.type) {
            case ba.bracketL:
              var e = this.startNode();
              return this.next(),
                e.elements = this.parseBindingList(ba.bracketR, !0, !0),
      ...
      so.parseBindingList = function (e, t, s) {
        for (var i = [], n = !0; !this.eat(e);) {
          if (n ? n = !1 : this.expect(ba.comma), t && this.type === ba.comma) {
            i.push(null);
          } else {
            if (s && this.afterTrailingComma(e)) break;
            if (this.type === ba.ellipsis) {
      ...
      so.parseBindingListItem = function (e) {
        return e;
      },
      so.parseMaybeDefault = function (e, t, s) {
        if (
          s = s || this.parseBindingAtom(),
            this.options.ecmaVersion < 6 || !this.eat(ba.eq)
        ) {
          return s;
        }
      ...
      so.checkLValSimple = function (e, t, s) {
        void 0 === t && (t = 0);
        var i = 0 !== t;
        switch (e.type) {
          case "Identifier":
      ...
      so.checkLValPattern = function (e, t, s) {
      ...
      so.checkLValInnerPattern = function (e, t, s) {
        switch (void 0 === t && (t = 0), e.type) {
          case "Property":
    ...
    var io = function (e, t, s, i, n) {
      ...
      no = {
        ...
        p_stat: new io("(", !1),
        p_expr: new io("(", !0),
        q_tmpl: new io("`", !0, !0, function (e) {
          return e.tryReadTemplateToken();
        }),
        f_stat: new io("function", !1),
        f_expr: new io("function", !0),
        f_expr_gen: new io("function", !0, !1, null, !0),
        f_gen: new io("function", !1, !1, null, !0),
      },
      ro = ja.prototype;
    ro.initialContext = function () {
      return [no.b_stat];
    },
      ro.curContext = function () {
        return this.context[this.context.length - 1];
      },
      ro.braceIsBlock = function (e) {
        var t = this.curContext();
        return t === no.f_expr || t === no.f_stat ||
          (e !== ba.colon || t !== no.b_stat && t !== no.b_expr
            ? e === ba._return || e === ba.name && this.exprAllowed
              ? Sa.test(this.input.slice(this.lastTokEnd, this.start))
              : e === ba._else || e === ba.semi || e === ba.eof ||
                e === ba.parenR || e === ba.arrow || (e === ba.braceL
                  ? t === no.b_stat
                  : e !== ba._var && e !== ba._const && e !== ba.name &&
                    !this.exprAllowed)
            : !t.isExpr);
      },
      ro.inGeneratorContext = function () {
      ...
      ro.updateContext = function (e) {
        var t, s = this.type;
        s.keyword && e === ba.dot ? this.exprAllowed = !1
        : (t = s.updateContext) ? t.call(this, e)
        : this.exprAllowed = s.beforeExpr;
      },
      ro.overrideContext = function (e) {
        this.curContext() !== e && (this.context[this.context.length - 1] = e);
      },
      ba.parenR.updateContext = ba.braceR.updateContext = function () {
        if (1 !== this.context.length) {
          var e = this.context.pop();
          e === no.b_stat && "function" === this.curContext().token &&
          (e = this.context.pop()), this.exprAllowed = !e.isExpr;
        } else this.exprAllowed = !0;
      },
      ba.braceL.updateContext = function (e) {
        this.context.push(this.braceIsBlock(e) ? no.b_stat : no.b_expr),
          this.exprAllowed = !0;
      },
      ba.dollarBraceL.updateContext = function () {
        this.context.push(no.b_tmpl), this.exprAllowed = !0;
      },
      ba.parenL.updateContext = function (e) {
        var t = e === ba._if || e === ba._for || e === ba._with ||
          e === ba._while;
        this.context.push(t ? no.p_stat : no.p_expr), this.exprAllowed = !0;
      },
      ba.incDec.updateContext = function () {},
      ba._function.updateContext = ba._class.updateContext = function (e) {
        !e.beforeExpr || e === ba._else ||
          e === ba.semi && this.curContext() !== no.p_stat ||
          e === ba._return &&
            Sa.test(this.input.slice(this.lastTokEnd, this.start)) ||
          (e === ba.colon || e === ba.braceL) && this.curContext() === no.b_stat
          ? this.context.push(no.f_stat)
          : this.context.push(no.f_expr),
          this.exprAllowed = !1;
      },
      ba.backQuote.updateContext = function () {
        this.curContext() === no.q_tmpl
          ? this.context.pop()
          : this.context.push(no.q_tmpl), this.exprAllowed = !1;
      },
      ba.star.updateContext = function (e) {
        if (e === ba._function) {
          var t = this.context.length - 1;
          this.context[t] === no.f_expr
            ? this.context[t] = no.f_expr_gen
            : this.context[t] = no.f_gen;
        }
        this.exprAllowed = !0;
      },
      ba.name.updateContext = function (e) {
        var t = !1;
        this.options.ecmaVersion >= 6 && e !== ba.dot &&
    ...
    function oo(e) {
      return "MemberExpression" === e.type &&
        ...
        "ChainExpression" === e.type && oo(e.expression);
    }
    ao.checkPropClash = function (e, t, s) {
      if (
        ...
        if (this.options.ecmaVersion >= 6) {
          ...
          a
            ...
            : a = t[i] = { init: !1, get: !1, set: !1 }, a[r] = !0;
        }
      }
    },
      ao.parseExpression = function (e, t) {
        var s = this.start, i = this.startLoc, n = this.parseMaybeAssign(e, t);
        if (this.type === ba.comma) {
          var r = this.startNodeAt(s, i);
          for (r.expressions = [n]; this.eat(ba.comma);) {r.expressions.push(
      ...
      ao.parseMaybeAssign = function (e, t, s) {
        ...
        this.type !== ba.parenL && this.type !== ba.name ||
        ...
        if (s && (l = s.call(this, l, o, h)), this.type.isAssign) {
          ...
          return c.operator = this.value,
            this.type === ba.eq && (l = this.toAssignable(l, !1, t)),
      ...
      ao.parseExprOp = function (e, t, s, i, n) {
        var r = this.type.binop;
        if (null != r && (!n || this.type !== ba._in) && r > i) {
          var a = this.type === ba.logicalOR || this.type === ba.logicalAND,
            o = this.type === ba.coalesce;
          o && (r = ba.logicalAND.binop);
          var h = this.value;
          this.next();
          var l = this.start,
            c = this.startLoc,
          ...
          return (a && this.type === ba.coalesce ||
            o && (this.type === ba.logicalOR || this.type === ba.logicalAND)) &&
            this.raiseRecoverable(
              this.start,
      ...
      ao.buildBinary = function (e, t, s, i, n, r) {
      ...
      ao.parseMaybeUnary = function (e, t, s, i) {
        var n, r = this.start, a = this.startLoc;
        if (this.isContextual("await") && this.canAwait) {
          n = this.parseAwait(i), t = !0;
        } else if (this.type.prefix) {
          var o = this.startNode(), h = this.type === ba.incDec;
          o.operator = this.value,
            ...
            : this.strict && "delete" === o.operator &&
              ...
              : "delete" === o.operator && oo(o.argument)
              ? this.raiseRecoverable(
                o.start,
        ...
        } else if (t || this.type !== ba.privateId) {
          if (
          ...
          (i || 0 === this.privateNameStack.length) && this.unexpected(),
            ...
            this.type !== ba._in && this.unexpected();
        }
        return s || !this.eat(ba.starstar) ? n
      ...
      ao.parseExprSubscripts = function (e, t) {
      ...
      ao.parseSubscripts = function (e, t, s, i, n) {
        for (
      ...
      ao.parseSubscript = function (e, t, s, i, n, r, a) {
        var o = this.options.ecmaVersion >= 11,
          h = o && this.eat(ba.questionDot);
        i && h &&
          this.raise(
            this.lastTokStart,
            "Optional chaining cannot appear in the callee of new expressions",
          );
        var l = this.eat(ba.bracketL);
        if (
          l || h && this.type !== ba.parenL && this.type !== ba.backQuote ||
          this.eat(ba.dot)
        ) {
          var c = this.startNodeAt(t, s);
          c.object = e,
            l
              ? (c.property = this.parseExpression(), this.expect(ba.bracketR))
              : this.type === ba.privateId && "Super" !== e.type
          ...
          if (n && !h && !this.canInsertSemicolon() && this.eat(ba.arrow)) {
        ...
        } else if (this.type === ba.backQuote) {
          (h || r) &&
            this.raise(
              this.start,
      ...
      ao.parseExprAtom = function (e, t) {
        this.type === ba.slash && this.readRegexp();
        ...
        switch (this.type) {
          case ba._super:
            return this.allowSuper ||
              ...
              s = this.startNode(),
              this.next(),
              this.type !== ba.parenL || this.allowDirectSuper ||
              this.raise(
                s.start,
                "super() call outside constructor of a subclass",
              ),
              this.type !== ba.dot && this.type !== ba.bracketL &&
              this.type !== ba.parenL && this.unexpected(),
          ...
          case ba.name:
            ...
            if (
              ...
              !this.canInsertSemicolon() && this.eat(ba._function)
            ) {
              return this.overrideContext(no.f_expr),
                this.parseFunction(this.startNodeAt(n, r), 0, !1, !0, t);
            }
            if (i && !this.canInsertSemicolon()) {
              if (this.eat(ba.arrow)) {
              ...
              if (
                ...
                return o = this.parseIdent(!1),
                  !this.canInsertSemicolon() && this.eat(ba.arrow) ||
                  this.unexpected(),
          ...
          case ba._true:
          case ba._false:
            return (s = this.startNode()).value = this.type === ba._null
              ? null
              : this.type === ba._true,
          ...
          case ba.bracketL:
            return s = this.startNode(),
              this.next(),
              s.elements = this.parseExprList(ba.bracketR, !0, !0, e),
              this.finishNode(s, "ArrayExpression");
          case ba.braceL:
            return this.overrideContext(no.b_expr), this.parseObj(!1, e);
          case ba._function:
      ...
      ao.parseDynamicImport = function (e) {
        if (
          this.next(), e.source = this.parseMaybeAssign(), !this.eat(ba.parenR)
        ) {
          var t = this.start;
          this.eat(ba.comma) && this.eat(ba.parenR)
            ? this.raiseRecoverable(
              t,
      ...
      ao.parseParenExpression = function () {
        this.expect(ba.parenL);
        var e = this.parseExpression();
        return this.expect(ba.parenR), e;
      },
      ao.parseParenAndDistinguishExpression = function (e, t) {
        var s,
          i = this.start,
          n = this.startLoc,
        ...
        if (this.options.ecmaVersion >= 6) {
          ...
          var a,
            ...
            p = this.yieldPos,
            f = this.awaitPos;
          for (this.yieldPos = 0, this.awaitPos = 0; this.type !== ba.parenR;) {
            if (
              c ? c = !1 : this.expect(ba.comma),
                r && this.afterTrailingComma(ba.parenR, !0)
            ) {
              u = !0;
              break;
            }
          ...
          if (
            this.expect(ba.parenR),
              e && !this.canInsertSemicolon() && this.eat(ba.arrow)
          ) {
          ...
          l.length && !u || this.unexpected(this.lastTokStart),
            ...
            l.length > 1
              ? ((s = this.startNodeAt(o, h)).expressions = l,
                this.finishNodeAt(s, "SequenceExpression", m, g))
              : s = l[0];
      ...
      ao.parseParenItem = function (e) {
        return e;
      },
      ao.parseParenArrowList = function (e, t, s, i) {
        return this.parseArrowExpression(this.startNodeAt(e, t), s, !1, i);
      };
    var ho = [];
    ao.parseNew = function () {
      this.containsEsc &&
        this.raiseRecoverable(this.start, "Escape sequence in keyword new");
      var e = this.startNode(), t = this.parseIdent(!0);
      if (this.options.ecmaVersion >= 6 && this.eat(ba.dot)) {
        e.meta = t;
      ...
      var i = this.start, n = this.startLoc, r = this.type === ba._import;
      ...
      ao.parseTemplateElement = function (e) {
        var t = e.isTagged, s = this.startNode();
        return this.type === ba.invalidTemplate
          ? (t ||
            this.raiseRecoverable(
              this.start,
          ...
          this.next(),
          s.tail = this.type === ba.backQuote,
          this.finishNode(s, "TemplateElement");
      },
      ao.parseTemplate = function (e) {
        void 0 === e && (e = {});
        var t = e.isTagged;
        void 0 === t && (t = !1);
        var s = this.startNode();
        ...
        for (s.quasis = [i]; !i.tail;) {
          ...
          this.raise(this.pos, "Unterminated template literal"),
            this.expect(ba.dollarBraceL),
            s.expressions.push(this.parseExpression()),
            this.expect(ba.braceR),
            s.quasis.push(i = this.parseTemplateElement({ isTagged: t }));
        }
        return this.next(), this.finishNode(s, "TemplateLiteral");
      },
      ao.isAsyncProp = function (e) {
        return !e.computed && "Identifier" === e.key.type &&
          "async" === e.key.name &&
          (this.type === ba.name || this.type === ba.num ||
            this.type === ba.string || this.type === ba.bracketL ||
            this.type.keyword ||
            this.options.ecmaVersion >= 9 && this.type === ba.star) &&
          !Sa.test(this.input.slice(this.lastTokEnd, this.start));
      },
      ao.parseObj = function (e, t) {
        var s = this.startNode(), i = !0, n = {};
        for (s.properties = [], this.next(); !this.eat(ba.braceR);) {
          if (i) i = !1;
          else if (
            this.expect(ba.comma),
              this.options.ecmaVersion >= 5 &&
              this.afterTrailingComma(ba.braceR)
          ) {
            break;
          }
      ...
      ao.parseProperty = function (e, t) {
        var s, i, n, r, a = this.startNode();
        if (this.options.ecmaVersion >= 9 && this.eat(ba.ellipsis)) {
          return e
            ...
            : (this.type === ba.parenL && t &&
              ...
              this.type === ba.comma && t && t.trailingComma < 0 &&
      ...
      ao.parsePropertyValue = function (e, t, s, i, n, r, a, o) {
        if (
          ...
          this.type === ba.comma || this.type === ba.braceR ||
          this.type === ba.eq
        ) {
      ...
      ao.parsePropertyName = function (e) {
        if (this.options.ecmaVersion >= 6) {
          if (this.eat(ba.bracketL)) {
            return e.computed = !0,
              e.key = this.parseMaybeAssign(),
              this.expect(ba.bracketR),
              e.key;
          }
          e.computed = !1;
        }
        return e.key = this.type === ba.num || this.type === ba.string
          ? this.parseExprAtom()
          : this.parseIdent("never" !== this.options.allowReserved);
      },
      ao.initFunction = function (e) {
        e.id = null,
          this.options.ecmaVersion >= 6 && (e.generator = e.expression = !1),
          this.options.ecmaVersion >= 8 && (e.async = !1);
      },
      ao.parseMethod = function (e, t, s) {
        var i = this.startNode(),
          n = this.yieldPos,
          r = this.awaitPos,
        ...
        return this.initFunction(i),
          ...
          this.awaitPos = 0,
          this.awaitIdentPos = 0,
          this.enterScope(64 | Wa(t, i.generator) | (s ? 128 : 0)),
          this.expect(ba.parenL),
      ...
      ao.parseArrowExpression = function (e, t, s, i) {
        var n = this.yieldPos, r = this.awaitPos, a = this.awaitIdentPos;
        return this.enterScope(16 | Wa(s, !1)),
          this.initFunction(e),
      ...
      ao.parseFunctionBody = function (e, t, s, i) {
        var n = t && this.type !== ba.braceL, r = this.strict, a = !1;
        if (n) {
      ...
      ao.parseExprList = function (e, t, s, i) {
        for (var n = [], r = !0; !this.eat(e);) {
          if (r) r = !1;
          else if (this.expect(ba.comma), t && this.afterTrailingComma(e)) {
            break;
          }
          var a = void 0;
          s && this.type === ba.comma
            ? a = null
            : this.type === ba.ellipsis
            ? (a = this.parseSpread(i),
              i && this.type === ba.comma && i.trailingComma < 0 &&
              (i.trailingComma = this.start))
            : a = this.parseMaybeAssign(!1, i), n.push(a);
        }
        return n;
      },
      ao.checkUnreserved = function (e) {
      ...
      ao.parseIdent = function (e, t) {
        var s = this.startNode();
        return this.type === ba.name
          ? s.name = this.value
          : this.type.keyword
      ...
      ao.parsePrivateIdent = function () {
        var e = this.startNode();
        return this.type === ba.privateId
          ? e.name = this.value
          : this.unexpected(),
          this.next(),
      ...
      ao.parseYield = function (e) {
        this.yieldPos || (this.yieldPos = this.start);
        var t = this.startNode();
        return this.next(),
          this.type === ba.semi || this.canInsertSemicolon() ||
            this.type !== ba.star && !this.type.startsExpr
            ? (t.delegate = !1, t.argument = null)
            : (t.delegate = this.eat(ba.star),
              t.argument = this.parseMaybeAssign(e)),
          this.finishNode(t, "YieldExpression");
      },
      ao.parseAwait = function (e) {
    ...
    var lo = ja.prototype;
    lo.raise = function (e, t) {
      var s = Oa(this.input, e);
      t += " (" + s.line + ":" + s.column + ")";
      var i = new SyntaxError(t);
      throw i.pos = e, i.loc = s, i.raisedAt = this.pos, i;
    },
      lo.raiseRecoverable = lo.raise,
      lo.curPosition = function () {
    ...
    co.enterScope = function (e) {
      this.scopeStack.push(new uo(e));
    },
      co.exitScope = function () {
        this.scopeStack.pop();
      },
      co.treatFunctionsAsVarInScope = function (e) {
        return 2 & e.flags || !this.inModule && 1 & e.flags;
      },
      co.declareName = function (e, t, s) {
        var i = !1;
        if (2 === t) {
      ...
      co.checkLocalExport = function (e) {
    ...
    var po = function (e, t, s) {
        this.type = "",
          this.start = t,
          this.end = 0,
          e.options.locations && (this.loc = new La(e, s)),
    ...
    fo.startNode = function () {
      return new po(this, this.start, this.startLoc);
    },
      fo.startNodeAt = function (e, t) {
        return new po(this, e, t);
      },
      fo.finishNode = function (e, t) {
        return mo.call(this, e, t, this.lastTokEnd, this.lastTokEndLoc);
      },
      fo.finishNodeAt = function (e, t, s, i) {
        return mo.call(this, e, t, s, i);
      },
      fo.copyNode = function (e) {
        var t = new po(this, e.start, this.startLoc);
    ...
    var go =
      ...
      yo = go + " Extended_Pictographic",
      Eo = yo + " EBase EComp EMod EPres ExtPict",
      xo = {
        9: go,
        10: yo,
        11: yo,
    ...
    function Co(e) {
      var t = wo[e] = {
        binary: Ra(xo[e] + " " + vo),
        nonBinary: { General_Category: Ra(vo), Script: Ra(ko[e]) },
      };
    ...
    for (var Io = 0, No = [9, 10, 11, 12, 13]; Io < No.length; Io += 1) {
      Co(No[Io]);
    }
    var _o = ja.prototype,
      $o = function (e) {
    ...
    $o.prototype.reset = function (e, t, s) {
      var i = -1 !== s.indexOf("u");
      this.start = 0 | e,
        this.source = t + "",
        this.flags = s,
      ...
      $o.prototype.nextIndex = function (e, t) {
        void 0 === t && (t = !1);
        var s = this.source, i = s.length;
        if (e >= i) return i;
      ...
      $o.prototype.lookahead = function (e) {
        return void 0 === e && (e = !1),
          this.at(this.nextIndex(this.pos, e), e);
      },
      $o.prototype.advance = function (e) {
        void 0 === e && (e = !1), this.pos = this.nextIndex(this.pos, e);
      },
      $o.prototype.eat = function (e, t) {
        return void 0 === t && (t = !1),
          this.current(t) === e && (this.advance(t), !0);
      },
      _o.validateRegExpFlags = function (e) {
      ...
      _o.regexp_disjunction = function (e) {
      ...
      _o.regexp_alternative = function (e) {
        for (; e.pos < e.source.length && this.regexp_eatTerm(e););
      },
      _o.regexp_eatTerm = function (e) {
      ...
      _o.regexp_eatAssertion = function (e) {
        var t = e.pos;
      ...
      _o.regexp_eatQuantifier = function (e, t) {
        return void 0 === t && (t = !1),
          !!this.regexp_eatQuantifierPrefix(e, t) && (e.eat(63), !0);
      },
      _o.regexp_eatQuantifierPrefix = function (e, t) {
        return e.eat(42) || e.eat(43) || e.eat(63) ||
          this.regexp_eatBracedQuantifier(e, t);
      },
      _o.regexp_eatBracedQuantifier = function (e, t) {
        var s = e.pos;
        if (e.eat(123)) {
          var i = 0, n = -1;
          if (
      ...
      _o.regexp_eatReverseSolidusAtomEscape = function (e) {
        var t = e.pos;
        if (e.eat(92)) {
      ...
      _o.regexp_eatUncapturingGroup = function (e) {
        var t = e.pos;
        if (e.eat(40)) {
      ...
      _o.regexp_eatCapturingGroup = function (e) {
        if (e.eat(40)) {
          if (
            this.options.ecmaVersion >= 9
      ...
      _o.regexp_eatExtendedAtom = function (e) {
      ...
      _o.regexp_eatInvalidBracedQuantifier = function (e) {
        return this.regexp_eatBracedQuantifier(e, !0) &&
          e.raise("Nothing to repeat"),
          !1;
      },
      _o.regexp_eatSyntaxCharacter = function (e) {
        var t = e.current();
        return !!Ro(t) && (e.lastIntValue = t, e.advance(), !0);
      },
      _o.regexp_eatPatternCharacters = function (e) {
        for (var t = e.pos, s = 0; -1 !== (s = e.current()) && !Ro(s);) {
          e.advance();
        }
        return e.pos !== t;
      },
      _o.regexp_eatExtendedPatternCharacter = function (e) {
        var t = e.current();
        return !(-1 === t || 36 === t || t >= 40 && t <= 43 || 46 === t ||
          63 === t || 91 === t || 94 === t || 124 === t || (e.advance(), 0));
      },
      _o.regexp_groupSpecifier = function (e) {
        if (e.eat(63)) {
      ...
      _o.regexp_eatGroupName = function (e) {
      ...
      _o.regexp_eatRegExpIdentifierName = function (e) {
        if (e.lastStringValue = "", this.regexp_eatRegExpIdentifierStart(e)) {
          for (
            e.lastStringValue += To(e.lastIntValue);
      ...
      _o.regexp_eatRegExpIdentifierStart = function (e) {
        var t = e.pos, s = this.options.ecmaVersion >= 11, i = e.current(s);
        return e.advance(s),
          92 === i && this.regexp_eatRegExpUnicodeEscapeSequence(e, s) &&
          (i = e.lastIntValue),
          (function (e) {
              return pa(e, !0) || 36 === e || 95 === e;
            })(i)
            ? (e.lastIntValue = i, !0)
            : (e.pos = t, !1);
      },
      _o.regexp_eatRegExpIdentifierPart = function (e) {
        var t = e.pos, s = this.options.ecmaVersion >= 11, i = e.current(s);
        return e.advance(s),
          92 === i && this.regexp_eatRegExpUnicodeEscapeSequence(e, s) &&
          (i = e.lastIntValue),
          (function (e) {
              return fa(e, !0) || 36 === e || 95 === e || 8204 === e ||
                8205 === e;
            })(i)
            ? (e.lastIntValue = i, !0)
            : (e.pos = t, !1);
      },
      _o.regexp_eatAtomEscape = function (e) {
      ...
      _o.regexp_eatBackReference = function (e) {
        var t = e.pos;
      ...
      _o.regexp_eatKGroupName = function (e) {
        if (e.eat(107)) {
          if (this.regexp_eatGroupName(e)) {
      ...
      _o.regexp_eatCharacterEscape = function (e) {
      ...
      _o.regexp_eatCControlLetter = function (e) {
        var t = e.pos;
        if (e.eat(99)) {
      ...
      _o.regexp_eatZero = function (e) {
        return 48 === e.current() && !Oo(e.lookahead()) &&
          (e.lastIntValue = 0, e.advance(), !0);
      },
      _o.regexp_eatControlEscape = function (e) {
        var t = e.current();
      ...
      _o.regexp_eatControlLetter = function (e) {
        var t = e.current();
        return !!Mo(t) && (e.lastIntValue = t % 32, e.advance(), !0);
      },
      _o.regexp_eatRegExpUnicodeEscapeSequence = function (e, t) {
        void 0 === t && (t = !1);
          ...
          if (this.regexp_eatFixedHexDigits(e, 4)) {
            ...
            if (n && r >= 55296 && r <= 56319) {
              ...
              if (
                ...
                if (o >= 56320 && o <= 57343) {
                  return e.lastIntValue = 1024 * (r - 55296) + (o - 56320) +
                    65536,
                    !0;
                }
              }
      ...
      _o.regexp_eatIdentityEscape = function (e) {
        if (e.switchU) {
      ...
      _o.regexp_eatDecimalEscape = function (e) {
        e.lastIntValue = 0;
        var t = e.current();
        if (t >= 49 && t <= 57) {
          do {
      ...
      _o.regexp_eatCharacterClassEscape = function (e) {
        var t = e.current();
        if (
          function (e) {
            return 100 === e || 68 === e || 115 === e || 83 === e ||
              119 === e || 87 === e;
          }(t)
        ) {
      ...
      _o.regexp_eatUnicodePropertyValueExpression = function (e) {
        var t = e.pos;
      ...
      _o.regexp_validateUnicodePropertyNameAndValue = function (e, t, s) {
        $a(e.unicodeProperties.nonBinary, t) ||
        e.raise("Invalid property name"),
          e.unicodeProperties.nonBinary[t].test(s) ||
          e.raise("Invalid property value");
      },
      _o.regexp_validateUnicodePropertyNameOrValue = function (e, t) {
        e.unicodeProperties.binary.test(t) || e.raise("Invalid property name");
      },
      _o.regexp_eatUnicodePropertyName = function (e) {
        var t = 0;
        for (e.lastStringValue = ""; Do(t = e.current());) {
          e.lastStringValue += To(t), e.advance();
        }
        return "" !== e.lastStringValue;
      },
      _o.regexp_eatUnicodePropertyValue = function (e) {
        var t = 0;
      ...
      _o.regexp_eatLoneUnicodePropertyNameOrValue = function (e) {
        return this.regexp_eatUnicodePropertyValue(e);
      },
      _o.regexp_eatCharacterClass = function (e) {
        if (e.eat(91)) {
      ...
      _o.regexp_classRanges = function (e) {
      ...
      _o.regexp_eatClassAtom = function (e) {
        var t = e.pos;
        if (e.eat(92)) {
          if (this.regexp_eatClassEscape(e)) return !0;
          if (e.switchU) {
            var s = e.current();
            (99 === s || Fo(s)) && e.raise("Invalid class escape"),
              e.raise("Invalid escape");
          }
          e.pos = t;
        }
      ...
      _o.regexp_eatClassEscape = function (e) {
        var t = e.pos;
      ...
      _o.regexp_eatClassControlLetter = function (e) {
        var t = e.current();
        return !(!Oo(t) && 95 !== t ||
          (e.lastIntValue = t % 32, e.advance(), 0));
      },
      _o.regexp_eatHexEscapeSequence = function (e) {
        var t = e.pos;
        if (e.eat(120)) {
      ...
      _o.regexp_eatDecimalDigits = function (e) {
        var t = e.pos, s = 0;
      ...
      _o.regexp_eatHexDigits = function (e) {
        var t = e.pos, s = 0;
      ...
      _o.regexp_eatLegacyOctalEscapeSequence = function (e) {
      ...
      _o.regexp_eatOctalDigit = function (e) {
        var t = e.current();
        return Fo(t) ? (e.lastIntValue = t - 48, e.advance(), !0)
        : (e.lastIntValue = 0, !1);
      },
      _o.regexp_eatFixedHexDigits = function (e, t) {
        var s = e.pos;
        e.lastIntValue = 0;
        for (var i = 0; i < t; ++i) {
          var n = e.current();
          if (!Vo(n)) return e.pos = s, !1;
    ...
    var zo = function (e) {
        this.type = e.type,
          ...
          this.start = e.start,
          this.end = e.end,
          e.options.locations && (this.loc = new La(e, e.startLoc, e.endLoc)),
    ...
    Wo.next = function (e) {
      ...
      this.raiseRecoverable(
        ...
        this.options.onToken && this.options.onToken(new zo(this)),
      ...
      "undefined" != typeof Symbol && (Wo[Symbol.iterator] = function () {
        var e = this;
        return {
          next: function () {
            var t = e.getToken();
            return { done: t.type === ba.eof, value: t };
          },
        };
      }),
      Wo.nextToken = function () {
        ...
        return e && e.preserveSpace || this.skipSpace(),
          ...
          this.pos >= this.input.length ? this.finishToken(ba.eof) : e.override
            ? e.override(this)
            : void this.readToken(this.fullCharCodeAtPos());
      },
      Wo.readToken = function (e) {
        return pa(e, this.options.ecmaVersion >= 6) || 92 === e
      ...
      Wo.skipBlockComment = function () {
        ...
        if (
          ...
          for (var i = void 0, n = t; (i = ka(this.input, n, this.pos)) > -1;) {
      ...
      Wo.skipLineComment = function (e) {
        for (
          ...
          this.pos < this.input.length && !Pa(i);
        ) {
        ...
        for (; this.pos < this.input.length;) {
          ...
          switch (e) {
            ...
            default:
              if (
                !(e > 8 && e < 14 ||
                  e >= 5760 && wa.test(String.fromCharCode(e)))
              ) {
                break e;
              }
              ++this.pos;
      ...
      Wo.readToken_dot = function () {
        ...
        return this.options.ecmaVersion >= 6 && 46 === e && 46 === t
          ? (this.pos += 3, this.finishToken(ba.ellipsis))
          : (++this.pos, this.finishToken(ba.dot));
      },
      Wo.readToken_slash = function () {
        var e = this.input.charCodeAt(this.pos + 1);
        return this.exprAllowed ? (++this.pos, this.readRegexp())
        : 61 === e ? this.finishOp(ba.assign, 2) : this.finishOp(ba.slash, 1);
      },
      Wo.readToken_mult_modulo_exp = function (e) {
        var t = this.input.charCodeAt(this.pos + 1),
          s = 1,
          i = 42 === e ? ba.star : ba.modulo;
        return this.options.ecmaVersion >= 7 && 42 === e && 42 === t &&
          (++s, i = ba.starstar, t = this.input.charCodeAt(this.pos + 2)),
          61 === t ? this.finishOp(ba.assign, s + 1) : this.finishOp(i, s);
      },
      Wo.readToken_pipe_amp = function (e) {
        ...
        return t === e
          ? this.options.ecmaVersion >= 12 &&
            ...
            ? this.finishOp(ba.assign, 3)
            : this.finishOp(124 === e ? ba.logicalOR : ba.logicalAND, 2)
          : 61 === t ? this.finishOp(ba.assign, 2)
          : this.finishOp(124 === e ? ba.bitwiseOR : ba.bitwiseAND, 1);
      },
      Wo.readToken_caret = function () {
        return 61 === this.input.charCodeAt(this.pos + 1)
          ? this.finishOp(ba.assign, 2) : this.finishOp(ba.bitwiseXOR, 1);
      },
      Wo.readToken_plus_min = function (e) {
        ...
        return t === e
          ? 45 !== t || this.inModule ||
              ...
              0 !== this.lastTokEnd &&
                !Sa.test(this.input.slice(this.lastTokEnd, this.pos))
            ? this.finishOp(ba.incDec, 2)
            : (this.skipLineComment(3), this.skipSpace(), this.nextToken())
          : 61 === t ? this.finishOp(ba.assign, 2)
          : this.finishOp(ba.plusMin, 1);
      },
      ...
      Wo.readToken_eq_excl = function (e) {
        ...
        return 61 === t
          ...
          ? (this.pos += 2, this.finishToken(ba.arrow))
          : this.finishOp(61 === e ? ba.eq : ba.prefix, 1);
      },
      Wo.readToken_question = function () {
        ...
        if (e >= 11) {
          ...
          if (46 === t) {
            ...
            if (s < 48 || s > 57) return this.finishOp(ba.questionDot, 2);
          }
          if (63 === t) {
            return e >= 12 && 61 === this.input.charCodeAt(this.pos + 2)
              ? this.finishOp(ba.assign, 3)
              : this.finishOp(ba.coalesce, 2);
          }
        }
        return this.finishOp(ba.question, 1);
      },
      Wo.readToken_numberSign = function () {
        var e = 35;
        if (
          this.options.ecmaVersion >= 13 &&
          (++this.pos, pa(e = this.fullCharCodeAtPos(), !0) || 92 === e)
        ) {
          return this.finishToken(ba.privateId, this.readWord1());
        }
        this.raise(this.pos, "Unexpected character '" + Uo(e) + "'");
      },
      Wo.getTokenFromCode = function (e) {
        switch (e) {
          ...
          case 40:
            return ++this.pos, this.finishToken(ba.parenL);
          case 41:
            return ++this.pos, this.finishToken(ba.parenR);
          case 59:
            return ++this.pos, this.finishToken(ba.semi);
          case 44:
            return ++this.pos, this.finishToken(ba.comma);
          case 91:
            return ++this.pos, this.finishToken(ba.bracketL);
          case 93:
            return ++this.pos, this.finishToken(ba.bracketR);
          case 123:
            return ++this.pos, this.finishToken(ba.braceL);
          case 125:
            return ++this.pos, this.finishToken(ba.braceR);
          case 58:
            return ++this.pos, this.finishToken(ba.colon);
          case 96:
            if (this.options.ecmaVersion < 6) break;
            return ++this.pos, this.finishToken(ba.backQuote);
          case 48:
            var t = this.input.charCodeAt(this.pos + 1);
          ...
          case 126:
            return this.finishOp(ba.prefix, 1);
          case 35:
      ...
      Wo.readRegexp = function () {
        for (var e, t, s = this.pos;;) {
          ...
          if (
            Sa.test(i) && this.raise(s, "Unterminated regular expression"), e
          ) {
            e = !1;
          } else {
            if ("[" === i) t = !0;
        ...
        var o = this.regexpState || (this.regexpState = new $o(this));
        o.reset(s, n, a),
        ...
        return this.finishToken(ba.regexp, { pattern: n, flags: a, value: h });
      },
      ...
      Wo.readRadixNumber = function (e) {
        ...
        return null == s &&
          ...
          this.options.ecmaVersion >= 11 &&
            ...
            ? (s = jo(this.input.slice(t, this.pos)), ++this.pos)
            : pa(this.fullCharCodeAtPos()) &&
              this.raise(this.pos, "Identifier directly after number"),
          this.finishToken(ba.num, s);
      },
      Wo.readNumber = function (e) {
        ...
        return this.finishToken(ba.num, a);
      },
        ...
        for (var t = "", s = ++this.pos;;) {
          ...
          92 === i
            ...
            ? (this.options.ecmaVersion < 10 &&
              ...
              this.options.locations &&
              (this.curLine++, this.lineStart = this.pos))
            : (Pa(i) && this.raise(this.start, "Unterminated string constant"),
              ++this.pos);
        }
        return t += this.input.slice(s, this.pos++),
          this.finishToken(ba.string, t);
      };
    var Go = {};
    Wo.tryReadTemplateToken = function () {
      ...
      Wo.invalidStringToken = function (e, t) {
        if (this.inTemplateElement && this.options.ecmaVersion >= 9) throw Go;
        this.raise(e, t);
      },
      Wo.readTmplToken = function () {
        for (var e = "", t = this.pos;;) {
          ...
          if (
            96 === s || 36 === s && 123 === this.input.charCodeAt(this.pos + 1)
          ) {
            return this.pos !== this.start ||
                this.type !== ba.template && this.type !== ba.invalidTemplate
              ? (e += this.input.slice(t, this.pos),
                this.finishToken(ba.template, e))
              : 36 === s
              ? (this.pos += 2, this.finishToken(ba.dollarBraceL))
              : (++this.pos, this.finishToken(ba.backQuote));
          }
          if (92 === s) {
            e += this.input.slice(t, this.pos),
      ...
      Wo.readWord1 = function () {
        ...
        for (
          ...
          if (fa(n, i)) this.pos += n <= 65535 ? 1 : 2;
          else {
            if (92 !== n) break;
      ...
      Wo.readWord = function () {
        var e = this.readWord1(), t = ba.name;
        return this.keywords.test(e) && (t = xa[e]), this.finishToken(t, e);
      },
      ja.acorn = {
        Parser: ja,
        version: "8.7.0",
        ...
        tokContexts: no,
        isIdentifierChar: fa,
        isIdentifierStart: pa,
        Token: zo,
        isNewLine: Pa,
        lineBreak: Sa,
        lineBreakG: Aa,
        nonASCIIwhitespace: wa,
      };
    class Ho {
      constructor(e) {
    ...
    const qo = (e) =>
      ...
      Ko = {
        mkdir: qo("fs.mkdir"),
        readFile: qo("fs.readFile"),
        writeFile: qo("fs.writeFile"),
      };
    async function Xo(e, t, s, i, n, r, a, o) {
      const h = await function (e, t, s, i, n, r, a) {
        let o = null, h = null;
        if (n) {
          o = new Set();
          for (const s of n) {
            e === s.source && t === s.importer && o.add(s.plugin);
          }
          h = (e, t) => ({
            ...e,
            resolve: (e, s, { custom: r, isEntry: a, skipSelf: o } = K) =>
              i(
                e,
                s,
                r,
                a,
                o ? [...n, { importer: s, plugin: t, source: e }] : n,
              ),
          });
        }
        return s.hookFirst(
          "resolveId",
          [e, t, { custom: r, isEntry: a }],
          h,
          o,
        );
      }(e, t, i, n, r, a, o);
    ...
    const Yo = "at position ", Qo = "at output position ";
    function Zo(e, t, { hook: s, id: i } = {}) {
      return "string" == typeof e && (e = { message: e }),
        e.code && e.code !== re.PLUGIN_ERROR && (e.pluginCode = e.code),
        e.code = re.PLUGIN_ERROR,
        e.plugin = t,
        s && (e.hook = s),
        i && (e.id = i),
        ie(e);
    ...
    const Jo = [{
      ...
      eh = { delete: () => !1, get() {}, has: () => !1, set() {} };
    function th(e) {
      return e.startsWith(Yo) || e.startsWith(Qo)
        ? ie({
    ...
    async function sh(e, t, s, i) {
      const n = t.id, r = [];
      let a = null === e.map ? null : _r(e.map);
      const o = e.code;
      let h = e.ast;
      const l = [], u = [];
      let d = !1;
      ...
      try {
        g = await s.hookReduceArg0("transform", [m, n], function (e, s, n) {
          ...
          if ("string" == typeof s) a = s;
            ...
            if (t.updateOptions(s), null == s.code) {
              return (s.map || s.ast) && i(function (e) {
                return {
                  code: re.NO_TRANSFORM_MAP_OR_AST_WITHOUT_CODE,
                  message:
          ...
          return null !== o &&
            r.push(
              _r("string" == typeof o ? JSON.parse(o) : o) ||
          ...
          return f = t.name, {
            ...
            emitAsset: (
              t,
              s,
            ) => (u.push({ name: t, source: s, type: "asset" }),
              e.emitAsset(t, s)),
            emitChunk: (
              t,
              s,
            ...
            getCombinedSourcemap() {
              const e = function (e, t, s, i, n) {
                return i.length
                  ? { version: 3, ...Mn(e, t, s, i, Rn(n)).traceMappings() }
                  : s;
              }(n, o, a, r, i);
              return e
                ? (a !== e && (a = e, r.length = 0),
                  new c({ ...e, file: null, sourcesContent: e.sourcesContent }))
                : new S(o).generateMap({
                  hires: !0,
                  includeContent: !0,
                  source: n,
    ...
    class nh {
      constructor(e, t, s, i) {
        this.graph = e,
          ...
          this.hasModuleSideEffects = s.treeshake
            ? s.treeshake.moduleSideEffects : () => !0,
          this.readQueue = new Ho(s.maxParallelFileReads);
      }
      ...
      async addModuleSource(e, t, s) {
        ...
        try {
          i = await this.readQueue.run(async () => {
            var t;
            return null !==
                  (t = await this.pluginDriver.hookFirst("load", [e])) &&
                void 0 !== t
              ? t
              : await Ko.readFile(e, "utf8");
          });
        } catch (s) {
          en("load modules", 3);
          let i = `Could not load ${e}`;
          throw t && (i += ` (imported by ${te(t)})`),
            i += `: ${s.message}`,
            s.message = i,
            s;
        }
        ...
        if (
          ...
          s.updateOptions(n),
            s.setSource(await sh(n, s, this.pluginDriver, this.options.onwarn));
        } else {
          if (r.transformFiles) {
      ...
      async fetchModule(
        ...
        if (o instanceof on) return await this.handleExistingModule(o, r, a), o;
        const h = new on(this.graph, e, this.options, r, s, i, t);
        ...
        if (s.external) {
          ...
          this.modulesById.has(n) ||
            this.modulesById.set(
              n,
              new be(this.options, n, r, a, "absolute" !== i && k(n)),
            );
          const o = this.modulesById.get(n);
          return o instanceof be ? Promise.resolve(o) : ie(function (e, t) {
            return {
              code: re.INVALID_EXTERNAL_ID,
      ...
      async fetchStaticDependencies(e, t) {
        ...
        if (
          ...
          for (const t of e.dependencies) {
            t instanceof on && (t.importedFromNotTreeshaken = !0);
          }
        }
      }
        ...
        if (e) {
          if ("object" == typeof e) {
            ...
            return {
              ...e,
              external: n &&
                ("relative" === n || !k(e.id) || !0 === n && oh(e.id, s, i) ||
                  "absolute"),
            };
          }
          const n = this.options.external(e, t, !0);
          return {
            external: n && (oh(e, s, i) || "absolute"),
            id: n && i ? rh(e, t) : e,
          };
        }
        const n = i ? rh(s, t) : s;
        return !1 === e || this.options.external(n, t, !0)
          ? { external: oh(n, s, i) || "absolute", id: n } : null;
      }
          ...
          async (t) => [
            ...
            e.resolvedIds[t] = e.resolvedIds[t] ||
              this.handleResolveId(
                await this.resolveId(t, e.id, X, !1),
                t,
                e.id,
              ),
          ],
      ...
      getResolvedIdWithDefaults(e) {
        ...
        return {
          ...
          moduleSideEffects: null !== (t = e.moduleSideEffects) && void 0 !== t
            ? t : this.hasModuleSideEffects(e.id, !!i),
      ...
      handleResolveId(e, t, s) {
        return null === e ? w(t) ? ie(function (e, t) {
          return {
            code: re.UNRESOLVED_IMPORT,
            message: `Could not resolve '${e}' from ${te(t)}`,
          };
        ...
        : (e.external && e.syntheticNamedExports &&
          this.options.onwarn(function (e, t) {
            return {
              code: re.EXTERNAL_SYNTHETIC_EXPORTS,
              importer: te(t),
              message:
      ...
      async loadEntryModule(e, t, s, i) {
        ...
        return null == n ? ie(
          null === i
            ? function (e) {
              return {
                code: re.UNRESOLVED_ENTRY,
                message: `Could not resolve entry module (${te(e)}).`,
              };
            }(e)
            : function (e, t) {
              return {
          ...
          ? ie(
            null === i
              ? function (e) {
                return {
                  code: re.UNRESOLVED_ENTRY,
                  message: `Entry module cannot be external (${te(e)}).`,
                };
              }(e)
              : function (e, t) {
                return {
      ...
      async resolveDynamicImport(e, t, s) {
        const i = await this.pluginDriver.hookFirst("resolveDynamicImport", [
          t,
          s,
        ]);
        return "string" != typeof t
          ? "string" == typeof i ? i
          : i ? { external: !1, moduleSideEffects: !0, ...i } : null
          : null == i
          ? e.resolvedIds[t] = e.resolvedIds[t] ||
            this.handleResolveId(await this.resolveId(t, e.id, X, !1), t, e.id)
          : this.handleResolveId(
            this.getResolvedIdWithDefaults(
    ...
    function rh(e, t) {
      return w(e) ? t ? T(t, "..", e) : T(e) : e;
    }
    function ah(e, { fileName: t, name: s }, i, n) {
      var r;
      if (null !== t) e.chunkFileNames.add(t);
        ...
        for (
          ;
          (null === (r = e.chunkNames[t]) || void 0 === r
            ? void 0
            : r.priority) < n;
        ) {
          t++;
    ...
    function oh(e, t, s) {
      return !0 === s || "ifRelativeSource" === s && w(t) || !k(e);
    }
    async function hh(e) {
      const [t, s] = await e;
    ...
    class lh extends Lt {
      constructor() {
        super(), this.parent = null, this.variables.set("undefined", new Ti());
      }
      findVariable(e) {
        let t = this.variables.get(e);
        return t || (t = new us(e), this.variables.set(e, t)), t;
      }
    }
    function ch(e, t, s, i, n, r) {
      let a = !1;
      return (
        ...o
      ) => (a ||
    ...
    function uh(e, s, i, n, r, a) {
      let o, h = !0;
      if (
        "string" != typeof e.cacheKey &&
        (e.name.startsWith(Yo) || e.name.startsWith(Qo) || a.has(e.name)
          ? h = !1
          : a.add(e.name)), s
      ) {
        if (h) {
          const t = e.cacheKey || e.name;
          c = s[t] || (s[t] = Object.create(null)),
            o = {
              delete: (e) => delete c[e],
              get(e) {
                const t = c[e];
      ...
      const u = {
        ...
        cache: o,
        emitAsset: ch(
          (e, t) => r.emitFile({ name: e, source: t, type: "asset" }),
          "emitAsset",
          "emitFile",
          e.name,
          !0,
        ...
        emitChunk: ch(
          (e, t) => r.emitFile({ id: e, name: t && t.name, type: "chunk" }),
          "emitChunk",
          "emitFile",
          e.name,
          !0,
        ...
        meta: { rollupVersion: t, watchMode: i.watchMode },
        get moduleIds() {
        ...
        resolve: (t, s, { custom: n, isEntry: r, skipSelf: a } = K) =>
        ...
        resolveId: ch(
          (e, t) =>
            i.moduleLoader.resolveId(e, t, K, void 0).then((e) => e && e.id),
          "resolveId",
          "resolve",
          e.name,
          !0,
    ...
    class fh {
      constructor(e, t, s, i, n) {
        this.graph = e,
          this.options = t,
          function (e, t) {
            for (const { active: s, deprecated: i, replacement: n } of Jo) {
              for (const r of e) {
                i in r &&
                  me(
                    {
          ...
          this.pluginCache = i,
          this.fileEmitter = new jr(e, t, n && n.fileEmitter),
        ...
        if (
          this.pluginContexts = new Map(
            this.plugins.map((s) => [s, uh(s, i, e, t, this.fileEmitter, r)]),
          ), n
        ) {
          for (const e of s) {
            for (const s of dh) {
              s in e &&
                t.onwarn(
                  (a = e.name,
                    o = s,
                    {
                      code: re.INPUT_HOOK_IN_OUTPUT_PLUGIN,
                      message:
      ...
      createOutputPluginDriver(e) {
        return new fh(this.graph, this.options, e, this.pluginCache, this);
      }
      hookFirst(e, t, s, i) {
      ...
      runHook(e, t, s, i, n) {
        ...
        return n && (a = n(a, s)),
          Promise.resolve().then(() => {
            if ("function" != typeof r) return i ? r : ph(e, s.name);
            const n = r.apply(a, t);
            if (!n || !n.then) return n;
            const o = Promise.resolve(n);
            return o.then(() => o);
          }).catch((t) => Zo(t, s.name, { hook: e }));
      }
      runHookSync(e, t, s, i) {
        const n = s[e];
        if (!n) return;
        ...
        i && (r = i(r, s));
        try {
          return "function" != typeof n ? ph(e, s.name) : n.apply(r, t);
        } catch (t) {
          return Zo(t, s.name, { hook: e });
        }
      }
    }
    class mh {
      constructor(e, t) {
        ...
        if (
          this.options = e,
            ...
            this.deoptimizationTracker = new F(),
            this.entryModules = [],
            this.modulesById = new Map(),
            this.needsTreeshakingPass = !1,
            this.phase = ji.LOAD_AND_PARSE,
            this.scope = new lh(),
        ...
        this.pluginDriver = new fh(this, e, e.plugins, this.pluginCache),
          this.acornParser = ja.extend(...e.acornInjectPlugins),
          this.moduleLoader = new nh(
            this,
            this.modulesById,
            this.options,
            this.pluginDriver,
      ...
      async build() {
        Ji("generate module graph", 2),
          await this.generateModuleGraph(),
          en("generate module graph", 2),
          Ji("sort modules", 2),
          this.phase = ji.ANALYSE,
          this.sortModules(),
          en("sort modules", 2),
          Ji("mark included statements", 2),
          this.includeStatements(),
          en("mark included statements", 2),
          this.phase = ji.GENERATE;
      }
      contextParse(e, t = {}) {
        ...
        return "object" == typeof s && s.push(...i),
          ...
          function (e, t, s) {
            const i = [], n = [];
            for (const t of e) {at.test(t.value) ? i.push(t)
              : Ze.test(t.value) && n.push(t);}
            for (const e of n) ot(t, e, !1);
            tt(t, { annotationIndex: 0, annotations: i, code: s });
          }(i, n, e),
          n;
      }
      getCache() {
      ...
      async generateModuleGraph() {
        ...
        for (const e of this.modulesById.values()) {
          e instanceof on ? this.modules.push(e) : this.externalModules.push(e);
        }
      }
      includeStatements() {
        ...
        if (this.options.treeshake) {
          let e = 1;
          do {
            Ji(`treeshaking pass ${e}`, 3), this.needsTreeshakingPass = !1;
        ...
        for (const e of this.implicitEntryModules) {
          for (const t of e.implicitlyLoadedAfter) {
            t.info.isEntry || t.isIncluded() || ie(ce(t));
          }
        }
      }
      sortModules() {
        const { orderedModules: e, cyclePaths: t } = function (e) {
          ...
          const s = [],
            ...
            o = (e) => {
              if (e instanceof on) {
                for (const t of e.dependencies) {
                  r.has(t) ? i.has(t) || s.push(Yr(t, e, r))
                  : (r.set(t, e), o(t));
                }
                for (const t of e.implicitlyLoadedBefore) n.add(t);
                for (
                  const { resolution: t } of e.dynamicImports
                ) {
                  t instanceof on && n.add(t);
                }
                a.push(e);
              }
    ...
    const yh = (e) => console.warn(e.message || e);
    function Eh(e, t, s, i, n = /$./) {
      const r = new Set(t),
    ...
    const xh = {
        ...
        if (r) {
          ...
          ie(
            he(
              `${s}.preset`,
              Sh(s),
              `valid values are ${J(Object.keys(t))}`,
              r,
            ),
          );
        }
          ...
          ? (e) => {
            e.toString = () => {
              ...
              return e.plugin && (t += `(${e.plugin} plugin) `),
                e.loc &&
                (t += `${te(e.loc.file)} (${e.loc.line}:${e.loc.column}) `),
                t += e.message,
                t;
            }, t(e, yh);
          }
      ...
      Ch = (e) => {
        ...
        if (e) {
          const t = new Set(), s = [];
          for (const i of gh(e)) i instanceof RegExp ? s.push(i) : t.add(i);
      ...
      Th = (e, t) => {
        ...
        if (s) {
          const e = Object.create(null);
          for (const [t, i] of Object.entries(s)) e[T(t)] = i;
          return (s) => e[s] || t;
        }
        return () => t;
      },
      ...
      Dh = (e, t, s) => {
        const i = e.treeshake;
        if (!1 === i) return !1;
        const n = bh(e.treeshake, xh, "treeshake", "false, true, ");
        return void 0 !== n.pureExternalModules &&
          ...
          ),
          {
            ...
            moduleSideEffects: "object" == typeof i && i.pureExternalModules
              ? Lh(i.moduleSideEffects, i.pureExternalModules)
              : Lh(n.moduleSideEffects, void 0),
      ...
      Vh = /^[a-z]:/i;
    function Bh(e) {
      const t = Vh.exec(e), s = t ? t[0] : "";
      return s + e.substr(s.length).replace(Oh, "_");
    }
    const Fh = (e, t, s) => {
        const { file: i } = e;
        if ("string" == typeof i) {
      ...
      Hh = (e) => {
        ...
        if ((t.autoId || t.basePath) && t.id) {return ie(
            he(
              "output.amd.id",
              "outputamd",
    ...
    const Zh = (e, t) => {
        const s = bh(e.generatedCode, vh, "output.generatedCode", "");
        return {
      ...
      el = new Set(["auto", "esModule", "default", "defaultOnly", !0, !1]),
      tl = (e, t) => {
        const s = e.interop,
          i = new Set(),
          n = (e) => {
              ...
              if (i.add(e), !el.has(e)) {
                return ie(
                  he(
                    ...
                    "outputinterop",
                    `use one of ${
                      Array.from(el.values(), (e) => JSON.stringify(e)).join(
                        ", ",
                      )
                    }`,
                    e,
    ...
    async function rl(e, t, s, i, n) {
      const { options: r, outputPluginDriver: a, unsetOptions: o } = function (
          ...
          const n = gh(e.plugins);
          nl(n, Qo);
          const r = t.createOutputPluginDriver(n);
          return { ...al(s, i, e, r), outputPluginDriver: r };
      ...
      if (e) {
        ...
        await Promise.all(
          Object.values(l).map((e) =>
            async function (e, t) {
              const s = T(t.dir || N(t.file), e.fileName);
              let i, n;
              if (await Ko.mkdir(N(s), { recursive: !0 }), "asset" === e.type) {
                n = e.source;
                ...
                "inline" === t.sourcemap
                  ? r = e.map.toUrl()
                  : (r = `${I(e.fileName)}.map`,
                    i = Ko.writeFile(`${s}.map`, e.map.toString())),
                  "hidden" !== t.sourcemap &&
                  (n += `//# sourceMappingURL=${r}\n`);
              }
              return Promise.all([Ko.writeFile(s, n), i]);
            }(e, r)),
        ), await a.hookParallel("writeBundle", [r, l]);
      }
      return c = l,
        {
          output: Object.values(c).filter((e) => Object.keys(e).length > 0)
            .sort((e, t) => {
              const s = hl(e), i = hl(t);
    ...
    function al(e, t, s, i) {
      return function (e, t, s) {
        ...
        const c = new Set(s),
          ...
          y = {
            amd: Hh(e),
            assetFileNames: null !== (i = e.assetFileNames) && void 0 !== i ? i
            ...
            compact: u,
            dir: Kh(e, m),
            dynamicImportFunction: Xh(e, t),
            entryFileNames: Yh(e, c),
            ...
            interop: tl(e, t),
            intro: qh(e, "intro"),
            manualChunks: sl(e, p, f, t),
            minifyInternalExports: il(e, d, u),
            name: e.name,
            namespaceToStringTag: e.namespaceToStringTag || !1,
            noConflict: e.noConflict || !1,
            outro: qh(e, "outro"),
            paths: e.paths || {},
            plugins: gh(e.plugins),
            preferConst: g,
            preserveModules: f,
            preserveModulesRoot: Gh(e),
            sanitizeFileName: "function" == typeof e.sanitizeFileName
              ? e.sanitizeFileName : !1 === e.sanitizeFileName ? (e) => e : Bh,
        ...
        return Eh(e, Object.keys(y), "output options", t.onwarn),
        ...
        i.hookReduceArg0Sync("outputOptions", [s.output || s], (e, t) =>
          ...
          const t = () =>
            e.error({
              code: re.CANNOT_EMIT_FROM_OPTIONS_HOOK,
              message:
    ...
    var ol;
    function hl(e) {
      return "asset" === e.type ? ol.ASSET
      : e.isEntry ? ol.ENTRY_CHUNK : ol.SECONDARY_CHUNK;
    }
    !function (e) {
      ...
      e.VERSION = t,
      e.defineConfig = function (e) {
        return e;
      },
      e.rollup = function (e) {
        return async function (e, s) {
          const { options: i, unsetOptions: n } = await async function (e, s) {
            if (!e) {
              throw new Error("You must supply an options object to rollup");
            }
            const i = gh(e.plugins),
              { options: n, unsetOptions: r } = function (e) {
                var t, s, i;
                const n = new Set(),
                  r = null !== (t = e.context) && void 0 !== t
                    ? t
                    : "undefined",
                  a = Ah(e),
                  ...
                  h = {
                    ...
                    experimentalCacheExpiry:
                      null !== (s = e.experimentalCacheExpiry) && void 0 !== s
                        ? s
                        : 10,
                    external: Ch(e.external),
                    inlineDynamicImports: Ih(e, a, o),
                    input: Nh(e),
                    makeAbsoluteExternalsRelative:
                      null === (i = e.makeAbsoluteExternalsRelative) ||
                      void 0 === i || i,
                    manualChunks: _h(e, a, o),
                    maxParallelFileReads: $h(e),
                    moduleContext: Th(e, r),
                    onwarn: a,
                    perf: e.perf || !1,
                    plugins: gh(e.plugins),
                    preserveEntrySignatures: Rh(e, n),
                    preserveModules: Mh(e, a, o),
                ...
                await i.reduce(
                  function (e) {
                    return async (s, i) =>
                      i.options &&
                        await i.options.call({
                          meta: { rollupVersion: t, watchMode: e },
                        }, await s) || s;
                  }(s),
                  Promise.resolve(e),
                ),
              );
            return nl(n.plugins, Yo), { options: n, unsetOptions: r };
          }(e, null !== s);
          !function (e) {
            e.perf
              ? (Ki = new Map(),
                Ji = Yi,
                en = Qi,
                e.plugins = e.plugins.map(sn)) : (Ji = qi, en = qi);
          }(i);
          const r = new mh(i, s), a = !1 !== e.cache;
          delete i.cache, delete e.cache, Ji("BUILD", 1);
          try {
            ...
            throw t.length > 0 && (e.watchFiles = t),
              await r.pluginDriver.hookParallel("buildEnd", [e]),
              await r.pluginDriver.hookParallel("closeBundle", []),
              e;
          }
          await r.pluginDriver.hookParallel("buildEnd", []), en("BUILD", 1);
          const o = {
            cache: a ? r.getCache() : void 0,
            async close() {
              o.closed ||
                (o.closed = !0,
                  await r.pluginDriver.hookParallel("closeBundle", []));
            ...
            closed: !1,
            generate: async (e) => o.closed ? ie(fe()) : rl(!1, i, n, e, r),
            watchFiles: Object.keys(r.watchFiles),
            write: async (e) => o.closed ? ie(fe()) : rl(!0, i, n, e, r),
          };
          return i.perf && (o.getTimings = Zi), o;
        }(e, null);
      },
  ...
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["exports"], t)
    : t(
      (e = "undefined" != typeof globalThis ? globalThis : e || self).rollup =
        {},
    );
