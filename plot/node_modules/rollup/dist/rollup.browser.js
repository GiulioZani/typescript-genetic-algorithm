  ...
  t = function (e) {
    ...
    class dt extends U {
      ...
      getReturnExpressionWhenCalledAtPath(e, t) {
        return e.length > 0 ? G : this.description.returnsPrimitive ||
          ("self" === this.description.returns ? t.thisParam || G
      ...
      hasEffectsWhenCalledAtPath(e, t, s) {
        ...
        if (
          ...
          !0 === this.description.mutatesSelfAsArray &&
            (null === (i = t.thisParam) || void 0 === i ? void 0
        ...
        for (const e of this.description.callsArgs) {
          if (
            null === (n = t.args[e]) || void 0 === n ? void 0
    ...
    class Et extends U {
      ...
      hasEffectsWhenAccessedAtPath(e, t) {
        ...
        if (e.length > 1) {
          ...
          return n ? n.hasEffectsWhenAccessedAtPath(i, t)
          : !this.prototypeExpression ||
        ...
        if ("string" == typeof s) {
          ...
          for (
            ...
            for (const s of e) {
              if (s.hasEffectsWhenAccessedAtPath(i, t)) {
                return !0;
              }
            }
          }
      ...
      getMemberExpression(e) {
        ...
        return 1 === (null == t ? void 0 : t.length)
          ...
          : t || this.unmatchablePropertiesAndGetters.length > 0 ||
              this.unknownIntegerProps.length && yt.test(e)
          ? G
          : null;
      }
    ...
    class Rt extends H {
      ...
      getLiteralValueAtPath(e, t, s) {
        return this.isReassigned || !this.init ? j : t.withTrackedEntityAtPath(
          e,
          this.init,
      ...
      getReturnExpressionWhenCalledAtPath(e, t, s, i) {
        return this.isReassigned || !this.init ? G : s.withTrackedEntityAtPath(
          e,
          this.init,
    ...
    class gs extends ct {
      ...
      getReturnExpressionWhenCalledAtPath(e) {
        return 0 !== e.length ? G : this.async
    ...
    class ks extends ct {
      ...
      deoptimizePath(e) {
        1 === e.length &&
          ("prototype" === e[0] ? this.isPrototypeDeoptimized = !0
          : e[0] === M &&
    ...
    class Ls extends ct {
      ...
      hasEffects(e) {
        var t, s;
        const i = (null === (t = this.superClass) || void 0 === t
          ? void 0
    ...
    function gi(e, t, s) {
      return "external" === t
        ? ti[String(s(e instanceof be ? e.id : null))]
        : "default" === t
        ? Qs
        : null;
    }
    ...
    class _i extends ct {
      ...
      render(e, t, s) {
        if (this.consequent.length) {
          ...
          const i = this.test ? this.test.end
    ...
    const Vi = {
        ArrayExpression: class extends ct {
          ...
          getObjectEntity() {
            ...
            for (let s = 0; s < this.elements.length; s++) {
              ...
              i instanceof ut || t ? i &&
                (t = !0, e.unshift({ key: D, kind: "init", property: i })) : i
        ...
        CallExpression: class extends ct {
          ...
          getLiteralValueAtPath(e, t, s) {
            ...
            return i === G ? j : t.withTrackedEntityAtPath(
              e,
              i,
          ...
          getReturnExpressionWhenCalledAtPath(e, t, s, i) {
            ...
            return this.returnExpression === G ? G : s.withTrackedEntityAtPath(
              e,
              n,
        ...
        LogicalExpression: class extends ct {
          ...
          hasEffectsWhenAccessedAtPath(e, t) {
            const s = this.getUsedBranch();
            return null === s ? this.left.hasEffectsWhenAccessedAtPath(e, t) ||
              this.right.hasEffectsWhenAccessedAtPath(e, t)
            : s.hasEffectsWhenAccessedAtPath(e, t);
          }
          hasEffectsWhenAssignedAtPath(e, t) {
            const s = this.getUsedBranch();
            return null === s ? this.left.hasEffectsWhenAssignedAtPath(e, t) ||
              this.right.hasEffectsWhenAssignedAtPath(e, t)
            : s.hasEffectsWhenAssignedAtPath(e, t);
          }
          hasEffectsWhenCalledAtPath(e, t, s) {
            const i = this.getUsedBranch();
            return null === i ? this.left.hasEffectsWhenCalledAtPath(e, t, s) ||
            ...
            if (!this.isBranchResolutionAnalysed) {
              ...
              this.usedBranch =
                "||" === this.operator && e || "&&" === this.operator && !e ||
                  "??" === this.operator && null != e ? this.left : this.right;
            }
        ...
        MetaProperty: class extends ct {
          ...
          renderFinalMechanism(e, t, s, i, n) {
            ...
            if (
              ...
              o.startsWith(vi)
                ? (r = o.substr(vi.length), i = n.getFileName(r))
                : o.startsWith(Ei)
                ? (me(
        ...
        TryStatement: class extends ct {
          ...
          hasEffects(e) {
            return (this.context.options.treeshake.tryCatchDeoptimization
              ? this.block.body.length > 0 : this.block.hasEffects(e)) ||
        ...
        UpdateExpression: class extends ct {
          ...
          render(e, t) {
            ...
            if (this.argument.render(e, t), "system" === i) {
              ...
              if (r) {
                if (this.prefix) {
                  1 === r.length ? Es(i, this.start, this.end, e, t) : xs(
                    i,
                    this.start,
                    this.end,
                    this.parent.type !== Ke,
    ...
    class on {
      ...
      getSyntheticNamespace() {
        return null === this.syntheticNamespace &&
          ...
          this.syntheticNamespace ? this.syntheticNamespace : ie(
                ...
                (i.add(a),
                  t.has(a)
                    ...
                    : (a.info.moduleSideEffects || s.has(a)) &&
                      (a instanceof be || a.hasEffects() ? e.add(a)
                      : n(a.dependencies)));
            }
          };
      ...
      getVariableFromNamespaceReexports(e, t, s) {
        ...
        for (const a of this.exportAllModules) {
          ...
          a instanceof be || h ? r.add(o) : o instanceof Wi
            ? i || (i = o)
            : o && n.set(o, a);
        }
        if (n.size > 0) {
    ...
    function Rn(e) {
      return function (t, s) {
        return s.mappings ? new Tn(s, [t]) : (e({
      ...
      for (const e of t) {
        ...
        if (t instanceof be) {
          ...
          if ("default" === s) {
            ...
            ei(s, o) ? e.setRenderNames(i, "default")
    ...
    function _r(e) {
      ...
      const t = "string" == typeof e.mappings
        ? function (e) {
          for (
    ...
    class Dr {
      ...
      generateIdPreserveModules(e, t, s, i) {
        ...
        let a;
        const o = i.has("entryFileNames") ? "[name][assetExtname].js"
          : t.entryFileNames,
      ...
      getExportNames() {
        ...
        return null !== (e = this.sortedExportNames) && void 0 !== e
          ? e
          : this.sortedExportNames = Array.from(this.exportsByName.keys())
            .sort();
      }
      getRenderedHash() {
      ...
      preRender(e, t, s) {
        ...
        if (
          h && a.prepend(h + r + r),
            ...
            e.compact ? this.renderedSource = a
    ...
    class Jr {
      ...
      async generateChunks() {
        const { manualChunks: e } = this.outputOptions,
          t = "object" == typeof e ? await this.addManualChunks(e)
      ...
      Ka.parseLabeledStatement = function (e, t, s, i) {
        ...
        for (
          var a = this.type.isLoop ? "loop"
            : this.type === ba._switch ? "switch" : null,
    ...
    Ka.parseFunction = function (e, t, s, i, n) {
      ...
      Ka.parseClassElement = function (e) {
        ...
        if (this.eatContextual("static")) {
          ...
          this.isClassElementNameStart() || this.type === ba.star ? o = !0
          : i = "static";
        }
        if (
          s.static = o,
            ...
            (!this.isClassElementNameStart() && this.type !== ba.star ||
                this.canInsertSemicolon() ? i = "async" : r = !0),
      ...
      Ka.checkPatternExport = function (e, t) {
        ...
        if ("Identifier" === s) this.checkExport(e, t.name, t.start);
          ...
          : "AssignmentPattern" === s ? this.checkPatternExport(e, t.left)
          : "RestElement" === s
    ...
    ro.initialContext = function () {
          ...
          (e !== ba.colon || t !== no.b_stat && t !== no.b_expr
            ? e === ba._return || e === ba.name && this.exprAllowed
              ...
              : e === ba._else || e === ba.semi || e === ba.eof ||
                e === ba.parenR || e === ba.arrow ||
                (e === ba.braceL ? t === no.b_stat
      ...
      ba._function.updateContext = ba._class.updateContext = function (e) {
        !e.beforeExpr || e === ba._else ||
          ...
          : this.context.push(no.f_expr), this.exprAllowed = !1;
      },
      ...
      ba.star.updateContext = function (e) {
        if (e === ba._function) {
          ...
          this.context[t] === no.f_expr ? this.context[t] = no.f_expr_gen
    ...
    ao.checkPropClash = function (e, t, s) {
      ...
      ao.parseExpression = function (e, t) {
        ...
        if (this.type === ba.comma) {
          ...
          for (r.expressions = [n]; this.eat(ba.comma);) {
            r.expressions.push(
      ...
      ao.parseMaybeUnary = function (e, t, s, i) {
        ...
        return s || !this.eat(ba.starstar) ? n : t
      ...
      ao.parseDynamicImport = function (e) {
        if (
          ...
          var t = this.start;
          this.eat(ba.comma) && this.eat(ba.parenR) ? this.raiseRecoverable(
            t,
    ...
    ao.parseNew = function () {
      ...
      ao.parseExprList = function (e, t, s, i) {
        for (var n = [], r = !0; !this.eat(e);) {
          ...
          var a = void 0;
          s && this.type === ba.comma ? a = null : this.type === ba.ellipsis
    ...
    var _o = ja.prototype,
      $o = function (e) {
        this.parser = e,
          this.validFlags = "gim" + (e.options.ecmaVersion >= 6
            ? "uy"
            : "") +
    ...
    $o.prototype.reset = function (e, t, s) {
      ...
      $o.prototype.nextIndex = function (e, t) {
        ...
        return !t && !this.switchU || r <= 55295 || r >= 57344 || e + 1 >= i ||
            (n = s.charCodeAt(e + 1)) < 56320 || n > 57343
          ? e + 1
          : e + 2;
      },
      ...
      _o.regexp_eatTerm = function (e) {
        return this.regexp_eatAssertion(e)
          ? (e.lastAssertionIsQuantifiable && this.regexp_eatQuantifier(e) &&
            ...
            !0)
          : !!(e.switchU ? this.regexp_eatAtom(e)
    ...
    function th(e) {
      return e.startsWith(Yo) || e.startsWith(Qo) ? ie({
    ...
    class nh {
      ...
      async emitChunk(
        ...
        const a = { fileName: e || null, id: t, importer: s, name: i || null },
          o = n ? await this.addEntryWithImplicitDependants(a, n)
      ...
      async addModuleSource(e, t, s) {
        ...
        en("load modules", 3);
        const n = "string" == typeof i ? { code: i }
      ...
      getNormalizedResolvedIdWithoutDefaults(e, t, s) {
        ...
        return !1 === e || this.options.external(n, t, !0)
          ? { external: oh(n, s, i) || "absolute", id: n }
          : null;
      }
    ...
    class mh {
      constructor(e, t) {
        ...
        if (
          ...
          this.pluginCache =
            (null === (i = e.cache) || void 0 === i ? void 0 : i.plugins) ||
            Object.create(null);
      ...
      contextParse(e, t = {}) {
        ...
        return "object" == typeof s && s.push(...i),
          ...
          function (e, t, s) {
            const i = [], n = [];
            for (const t of e) {
              at.test(t.value) ? i.push(t) : Ze.test(t.value) && n.push(t);
            }
    ...
    const Fh = (e, t, s) => {
      ...
      jh = (e, t, s) => {
        var i;
        const n = (null !== (i = e.preserveModules) && void 0 !== i
          ? i
          : s.preserveModules) || !1;
        if (n) {
          if (t) {
