  ...
  include() {
    if (!this.included) {
      ...
      if (this.meta.name === "import") {
        ...
        this.metaProperty = parent instanceof MemberExpression &&
  ...
  preRender(options, inputBase, snippets) {
    ...
    for (const module of this.orderedModules) {
      ...
      renderedModules[module.id] = {
        get code() {
          var _a, _b;
          return (_b = (_a = renderedModuleSources.get(module)) === null ||
                    _a === void 0
                  ? void 0
...
async function addJsExtensionIfNecessary(file, preserveSymlinks) {
  var _a, _b;
  return ((_b = (_a = await findFile(file, preserveSymlinks)) !== null &&
            _a !== void 0
          ? _a
