...
function mergeOptions(
  ...
  defaultOnWarnHandler = rollup.defaultOnWarn,
) {
...
function mergeInputOptions(config, overrides, defaultOnWarnHandler) {
  ...
  const inputOptions = {
    ...
    treeshake: getObjectOption(
      ...
      overrides,
      "treeshake",
      rollup.objectifyOptionWithPresets(
        rollup.treeshakePresets,
        "treeshake",
        "false, true, ",
      ),
    ),
...
const getObjectOption = (
  ...
  overrides,
  name,
  objectifyValue = rollup.objectifyOption,
) => {
