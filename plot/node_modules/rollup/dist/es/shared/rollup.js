...
import require$$0, {
  ...
  dirname,
  extname,
  isAbsolute as isAbsolute$1,
  posix,
  relative as relative$1,
  resolve,
  win32,
} from "path";
...
const SOURCEMAPPING_URL_RE = new RegExp(
  `^#${whiteSpaceNoNewline}+${SOURCEMAPPING_URL}=.+`,
);
...
function normalizeRelativeExternalId(source, importer) {
  return isRelative(source)
    ? importer ? resolve(importer, "..", source) : resolve(source)
    : source;
}
...
async function writeOutputFile(outputFile, outputOptions) {
  ...
  if (outputFile.type === "asset") {
    ...
    if (outputOptions.sourcemap && outputFile.map) {
      ...
      if (outputOptions.sourcemap === "inline") {
        ...
        writeSourceMapPromise = promises.writeFile(
          `${fileName}.map`,
  ...
  return Promise.all([
    promises.writeFile(fileName, source),
