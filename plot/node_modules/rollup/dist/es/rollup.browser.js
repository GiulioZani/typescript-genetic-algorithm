...
m.prototype.addEdit = function (e, t, s, i) {
  ...
  m.prototype.advance = function (e) {
    if (e) {
      var t = e.split("\n");
      if (t.length > 1) {
        for (var s = 0; s < t.length - 1; s++) {this.generatedCodeLine++,
            this.raw[this.generatedCodeLine] = this.rawSegments = [];}
        this.generatedCodeColumn = 0;
      }
...
E.prototype.addSourcemapLocation = function (e) {
  ...
  E.prototype.append = function (e) {
    if ("string" != typeof e) {throw new TypeError(
        "outro content must be a string",
      );}
    ...
    this._split(e),
      ...
      (y.storeName ||
        (console.warn(
          ...
          y.storeName = !0),
        i = { storeName: !0 });
    var n = void 0 !== i && i.storeName, r = void 0 !== i && i.contentOnly;
    if (n) {
      var a = this.original.slice(e, t);
      this.storedNames[a] = !0;
    }
    var h = this.byStart[e], l = this.byEnd[t];
    if (h) {
  ...
  E.prototype.lastLine = function () {
    ...
    var t = this.outro, s = this.lastChunk;
    do {
      if (s.outro.length > 0) {
        if (-1 !== (e = s.outro.lastIndexOf(g))) {
          return s.outro.substr(e + 1) + t;
        }
        t = s.outro + t;
      }
      if (s.content.length > 0) {
        if (-1 !== (e = s.content.lastIndexOf(g))) {
          return s.content.substr(e + 1) + t;
        }
        t = s.content + t;
      }
      if (s.intro.length > 0) {
        if (-1 !== (e = s.intro.lastIndexOf(g))) {
          return s.intro.substr(e + 1) + t;
        }
        t = s.intro + t;
      }
    } while (s = s.previous);
    return -1 !== (e = this.intro.lastIndexOf(g)) ? this.intro.substr(e + 1) + t
    : this.intro + t;
  },
  ...
  E.prototype._splitChunk = function (e, t) {
    if (e.edited && e.content.length) {
      ...
      throw new Error(
        "Cannot split a chunk that has already been edited (" + s.line + ":" +
          s.column + ' – "' + e.original + '")',
      );
    }
    var i = e.split(t);
  ...
  E.prototype.isEmpty = function () {
    ...
    do {
      if (
        ...
        e.content.length && e.content.trim() || e.outro.length && e.outro.trim()
      ) {
        return !1;
      }
    } while (e = e.next);
...
v.prototype.addSource = function (e) {
  ...
  if (
    ...
    if (x.call(this.uniqueSourceIndexByFilename, e.filename)) {
      ...
      if (e.content.original !== t.content) {
        throw new Error(
          "Illegal source: same filename (" + e.filename +
            "), different contents",
        );
      }
    } else {
  ...
  v.prototype.indent = function (e) {
    ...
    return this.sources.forEach(function (i, n) {
      ...
      this.intro &&
      (this.intro = e + this.intro.replace(/^[^\n]/gm, function (t, s) {
        return s > 0 ? e + t : t;
      })),
      this;
  },
  ...
  v.prototype.isEmpty = function () {
    return (!this.intro.length || !this.intro.trim()) &&
  ...
  v.prototype.trimEnd = function (e) {
    var t, s = new RegExp((e || "\\s") + "+$"), i = this.sources.length - 1;
    do {
      if (!(t = this.sources[i--])) {
...
class B {
  ...
  getEntities(e) {
    ...
    for (const s of e) {
      t = t[s] = t[s] || Object.create(null, { [V]: { value: new Set() } });
    }
    return t[V];
  }
}
...
class z {
  ...
  trackEntityAtPathAndGetIfTracked(e, t, s) {
    ...
    for (const t of e) {
      i = i[t] = i[t] || Object.create(null, { [V]: { value: new Map() } });
    }
    const n = T(i[V], t, () => new Set());
    return !!n.has(s) || (n.add(s), !1);
  }
}
const W = Symbol("Unknown Value");
class U {
  constructor() {
    this.included = !1;
  }
...
const q = Object.freeze(Object.create(null)),
  K = Object.freeze({}),
  X = Object.freeze([]);
function Y(e, t, s) {
  if ("number" == typeof s) {
  ...
  return function (e, t) {
    ...
    var s = t.offsetLine || 0,
      ...
      a = n.map(function (e, t) {
        var s = r + e.length + 1, i = { start: r, end: s, line: t };
        return r = s, i;
      }),
      o = 0;
    function h(e, t) {
...
function Z(e, t) {
  const s = e.length <= 1, i = e.map((e) => `"${e}"`);
...
function ie(e, t, s, i) {
  if ("object" == typeof t) {
    ...
    e.pos = t;
    const { line: n, column: r } = Y(s, t, { offsetLine: 1 });
...
var ne;
function re({ fileName: e, code: t }, s) {
  const i = {
    code: ne.CHUNK_INVALID,
    message: `Chunk "${e}" is not valid JavaScript: ${s.message}.`,
  };
  return ie(i, s.loc, t, e), i;
}
function ae(e, t, s) {
  return {
    code: "INVALID_EXPORT_OPTION",
    message: `"${e}" was specified for "output.exports", but entry module "${
      ee(s)
...
function oe(e, t, s, i) {
  return {
    code: ne.INVALID_OPTION,
    message: `Invalid value ${
      void 0 !== i ? `${JSON.stringify(i)} ` : ""
    }for option "${e}" - ${s}.`,
...
function he(e, t, s) {
  return {
    code: ne.MISSING_EXPORT,
    message: `'${e}' is not exported by ${ee(s)}, imported by ${ee(t)}`,
    url: "https://rollupjs.org/guide/en/#error-name-is-not-exported-by-module",
  };
}
function le(e) {
  const t = Array.from(e.implicitlyLoadedBefore, (e) => ee(e.id)).sort();
  return {
    code: ne.MISSING_IMPLICIT_DEPENDANT,
    message: `Module "${ee(e.id)}" that should be implicitly loaded before ${
      Z(t)
...
function ce(e, t, s) {
  ...
  return {
    code: ne.UNEXPECTED_NAMED_IMPORT,
    id: e,
    message: `The named export "${t}" was ${i}ed from the external module ${
      ee(e)
...
function ue(e) {
  return {
    code: ne.UNEXPECTED_NAMED_IMPORT,
    id: e,
    message: `There was a namespace "*" reexport from the external module ${
      ee(e)
...
function de(e) {
  return { code: ne.VALIDATION_ERROR, message: e };
}
function pe() {
  return {
    code: ne.ALREADY_CLOSED,
    message:
      'Bundle is already closed, no more calls to "generate" or "write" are allowed.',
  };
}
function fe(e, t, s) {
  me(e, t, s.onwarn, s.strictDeprecations);
}
function me(e, t, s, i) {
  if (t || i) {
    const t = function (e) {
      return {
        code: ne.DEPRECATED_FEATURE,
...
const ye = /[^$_a-zA-Z0-9]/g, Ee = (e) => /\d/.test(e[0]);
function xe(e) {
  return e = e.replace(/-(\w)/g, (e, t) => t.toUpperCase()).replace(ye, "_"),
    (Ee(e) || ge.has(e)) && (e = `_${e}`),
    e || "_";
}
class ve {
  constructor(e, t, s, i, n) {
    this.options = e,
      ...
      this.used = !1,
      this.variableName = "",
      this.suggestedVariableName = xe(t.split(/[\\/]/).pop());
    const { importers: r, dynamicImporters: a } = this,
      o = this.info = {
        ast: null,
        code: null,
        dynamicallyImportedIdResolutions: X,
        dynamicallyImportedIds: X,
        ...
        id: t,
        implicitlyLoadedAfterOneOf: X,
        implicitlyLoadedBefore: X,
        importedIdResolutions: X,
        importedIds: X,
        get importers() {
          return r.sort();
        },
  ...
  getVariableForExportName(e) {
    ...
    return t ||
      (this.declarations[e] = t = new H(this, e),
        this.exportedVariables.set(t, e)),
      [t];
  }
  setRenderPath(e, t) {
    return this.renderPath = "function" == typeof e.paths
      ? e.paths(this.id)
      : e.paths[this.id],
      this.renderPath || (this.renderPath = this.renormalizeRenderPath
        ? w(_(t, this.id))
        : this.id),
      this.renderPath;
  }
  ...
  warnUnusedImports() {
    ...
    const t = new Set();
    for (const s of e) {
      const { importers: e } = this.declarations[s].module;
    ...
    this.options.onwarn({
      ...
      message: `${
        Z(e, ["is", "are"])
      } imported from external module "${this.id}" but never used in ${
        Z(s.map((e) => ee(e)))
      }.`,
      names: e,
      source: this.id,
...
const be = {
    ArrayPattern(e, t) {
      for (const s of t.elements) s && be[s.type](e, s);
    },
    AssignmentPattern(e, t) {
      be[t.left.type](e, t.left);
    },
    Identifier(e, t) {
      e.push(t.name);
    },
    ...
    ObjectPattern(e, t) {
      for (const s of t.properties) {
        "RestElement" === s.type
          ? be.RestElement(e, s)
          : be[s.value.type](e, s.value);
      }
    },
    RestElement(e, t) {
      be[t.argument.type](e, t.argument);
    },
  },
  Se = function (e) {
    const t = [];
    return be[e.type](t, e), t;
  };
new Set(
...
const Ce = new class extends U {
    getLiteralValueAtPath() {}
  }(),
  Ie = { value: { callsArgs: null, returns: j } },
  Ne = new class extends U {
    getReturnExpressionWhenCalledAtPath(e) {
      return 1 === e.length ? Fe(Le, e[0]) : j;
    }
    hasEffectsWhenAccessedAtPath(e) {
      return e.length > 1;
    }
    hasEffectsWhenCalledAtPath(e, t, s) {
      return 1 !== e.length || Be(Le, e[0], t, s);
    }
  }(),
  _e = { value: { callsArgs: null, returns: Ne } },
  $e = new class extends U {
    getReturnExpressionWhenCalledAtPath(e) {
      return 1 === e.length ? Fe(Oe, e[0]) : j;
    }
    hasEffectsWhenAccessedAtPath(e) {
      return e.length > 1;
    }
    hasEffectsWhenCalledAtPath(e, t, s) {
      return 1 !== e.length || Be(Oe, e[0], t, s);
    }
  }(),
  Te = { value: { callsArgs: null, returns: $e } },
  Re = new class extends U {
    getReturnExpressionWhenCalledAtPath(e) {
      return 1 === e.length ? Fe(Ve, e[0]) : j;
    }
    hasEffectsWhenAccessedAtPath(e) {
      return e.length > 1;
    }
    hasEffectsWhenCalledAtPath(e, t, s) {
      return 1 !== e.length || Be(Ve, e[0], t, s);
    }
  }(),
  Me = { value: { callsArgs: null, returns: Re } },
  De = we({
    hasOwnProperty: _e,
    isPrototypeOf: _e,
    propertyIsEnumerable: _e,
    toLocaleString: Me,
    toString: Me,
    valueOf: Ie,
  }),
  ...
  Ve = we({
    ...
    padStart: Me,
    repeat: Me,
    replace: { value: { callsArgs: [1], returns: Re } },
    replaceAll: { value: { callsArgs: [1], returns: Re } },
    search: Te,
    slice: Me,
    small: Me,
    split: Ie,
...
function Be(e, t, s, i) {
  ...
  for (const n of e[t].callsArgs) {
    if (
      s.args[n] &&
      s.args[n].hasEffectsWhenCalledAtPath(D, {
        args: ke,
        thisParam: null,
        withNew: !1,
      }, i)
...
function Fe(e, t) {
  return "string" == typeof t && e[t] ? e[t].returns : j;
}
function ze(e, t, s) {
  s(e, t);
}
function We(e, t, s) {}
var Ue = {};
Ue.Program = Ue.BlockStatement = Ue.StaticBlock = function (e, t, s) {
  for (var i = 0, n = e.body; i < n.length; i += 1) s(n[i], t, "Statement");
},
  Ue.Statement = ze,
  Ue.EmptyStatement = We,
  Ue.ExpressionStatement = Ue.ParenthesizedExpression = Ue.ChainExpression =
    function (e, t, s) {
      return s(e.expression, t, "Expression");
    },
  Ue.IfStatement = function (e, t, s) {
    s(e.test, t, "Expression"),
      s(e.consequent, t, "Statement"),
      e.alternate && s(e.alternate, t, "Statement");
  },
  Ue.LabeledStatement = function (e, t, s) {
    return s(e.body, t, "Statement");
  },
  Ue.BreakStatement = Ue.ContinueStatement = We,
  Ue.WithStatement = function (e, t, s) {
    s(e.object, t, "Expression"), s(e.body, t, "Statement");
  },
  Ue.SwitchStatement = function (e, t, s) {
  ...
  Ue.SwitchCase = function (e, t, s) {
    e.test && s(e.test, t, "Expression");
    for (var i = 0, n = e.consequent; i < n.length; i += 1) {
      s(n[i], t, "Statement");
    }
  },
  Ue.ReturnStatement = Ue.YieldExpression = Ue.AwaitExpression = function (
    e,
    t,
    s,
  ) {
  ...
  Ue.Expression = ze,
  Ue.ThisExpression = Ue.Super = Ue.MetaProperty = We,
  Ue.ArrayExpression = function (e, t, s) {
    for (var i = 0, n = e.elements; i < n.length; i += 1) {
      var r = n[i];
      r && s(r, t, "Expression");
    }
  },
  Ue.ObjectExpression = function (e, t, s) {
    for (var i = 0, n = e.properties; i < n.length; i += 1) s(n[i], t);
  },
  Ue.FunctionExpression = Ue.ArrowFunctionExpression = Ue.FunctionDeclaration,
  Ue.SequenceExpression = function (e, t, s) {
    for (var i = 0, n = e.expressions; i < n.length; i += 1) {
      s(n[i], t, "Expression");
    }
  },
  Ue.TemplateLiteral = function (e, t, s) {
    for (var i = 0, n = e.quasis; i < n.length; i += 1) s(n[i], t);
    for (var r = 0, a = e.expressions; r < a.length; r += 1) {
      s(a[r], t, "Expression");
    }
  },
  Ue.TemplateElement = We,
  Ue.UnaryExpression = Ue.UpdateExpression = function (e, t, s) {
    s(e.argument, t, "Expression");
  },
  Ue.BinaryExpression = Ue.LogicalExpression = function (e, t, s) {
    s(e.left, t, "Expression"), s(e.right, t, "Expression");
  },
  Ue.AssignmentExpression = Ue.AssignmentPattern = function (e, t, s) {
    s(e.left, t, "Pattern"), s(e.right, t, "Expression");
  },
  Ue.ConditionalExpression = function (e, t, s) {
    s(e.test, t, "Expression"),
      s(e.consequent, t, "Expression"),
      s(e.alternate, t, "Expression");
  },
  Ue.NewExpression = Ue.CallExpression = function (e, t, s) {
  ...
  Ue.MemberExpression = function (e, t, s) {
    s(e.object, t, "Expression"), e.computed && s(e.property, t, "Expression");
  },
  Ue.ExportNamedDeclaration = Ue.ExportDefaultDeclaration = function (e, t, s) {
    e.declaration &&
    s(
      e.declaration,
      t,
  ...
  Ue.ExportAllDeclaration = function (e, t, s) {
    e.exported && s(e.exported, t), s(e.source, t, "Expression");
  },
  Ue.ImportDeclaration = function (e, t, s) {
    for (var i = 0, n = e.specifiers; i < n.length; i += 1) s(n[i], t);
    s(e.source, t, "Expression");
  },
  Ue.ImportExpression = function (e, t, s) {
    s(e.source, t, "Expression");
  },
  Ue.ImportSpecifier = Ue.ImportDefaultSpecifier = Ue.ImportNamespaceSpecifier =
    Ue.Identifier = Ue.PrivateIdentifier = Ue.Literal = We,
  Ue.TaggedTemplateExpression = function (e, t, s) {
    s(e.tag, t, "Expression"), s(e.quasi, t, "Expression");
  },
  Ue.ClassDeclaration = Ue.ClassExpression = function (e, t, s) {
    return s(e, t, "Class");
  },
  Ue.Class = function (e, t, s) {
    e.id && s(e.id, t, "Pattern"),
      e.superClass && s(e.superClass, t, "Expression"),
      s(e.body, t);
  },
  Ue.ClassBody = function (e, t, s) {
    for (var i = 0, n = e.body; i < n.length; i += 1) s(n[i], t);
  },
  Ue.MethodDefinition = Ue.PropertyDefinition = Ue.Property = function (
    e,
    t,
    s,
  ) {
...
function He(e, t, s = e.type) {
  const { annotations: i } = t;
  let n = i[t.annotationIndex];
  for (; n && e.start >= n.end;) Xe(e, n, t.code), n = i[++t.annotationIndex];
  if (n && n.end <= e.end) {
    for (Ue[s](e, t, He); (n = i[t.annotationIndex]) && n.end <= e.end;) {
      ++t.annotationIndex, Ze(e, n, !1);
    }
  }
}
const qe = /[^\s(]/g, Ke = /\S/g;
function Xe(e, t, s) {
  const i = [];
  let n;
  if (Ye(s.slice(t.end, e.start), qe)) {
    const t = e.start;
    for (;;) {
  ...
  if (n) Ze(e, t, !1);
  else for (const e of i) Ze(e, t, !0);
}
function Ye(e, t) {
  let s;
  for (; null !== (s = t.exec(e));) {
...
const Qe = /[@#]__PURE__/;
function Ze(e, t, s) {
  const i = s ? "_rollupAnnotations" : "_rollupRemoved", n = e[i];
  n ? n.push(t) : e[i] = [t];
}
const Je = { Literal: [], Program: ["body"] };
class et extends U {
  constructor(e, t, s) {
    super(),
      this.esTreeNode = e,
      this.keys = Je[e.type] || function (e) {
        return Je[e.type] = Object.keys(e).filter(
  ...
  include(e, t) {
    ...
    for (const s of this.keys) {
      ...
      if (null !== i) {
        if (Array.isArray(i)) {
          for (const s of i) null !== s && s.include(e, t);
        } else i.include(e, t);
      }
    }
  }
    ...
    for (const [t, s] of Object.entries(e)) {
      if (!this.hasOwnProperty(t)) {
        if (95 === t.charCodeAt(0)) {
          if ("_rollupAnnotations" === t) this.annotations = s;
          else if ("_rollupRemoved" === t) {
            for (const { start: e, end: t } of s) {
              this.context.magicString.remove(e, t);
            }
          }
        } else if ("object" != typeof s || null === s) this[t] = s;
          ...
          this[t] = new (this.context.getNodeConstructor(s.type))(
            s,
            this,
            this.scope,
          );
  ...
  shouldBeIncluded(e) {
    return this.included || !e.brokenFlow && this.hasEffects(Pe());
  }
...
class tt extends et {
  ...
  deoptimizeThisOnEventAtPath(e, t, s, i) {
    t.length > 0 &&
      this.argument.deoptimizeThisOnEventAtPath(e, [R, ...t], s, i);
  }
  hasEffects(e) {
    this.deoptimized || this.applyDeoptimizations();
    const { propertyReadSideEffects: t } = this.context.options.treeshake;
    return this.argument.hasEffects(e) ||
      t && ("always" === t || this.argument.hasEffectsWhenAccessedAtPath(L, e));
  }
  applyDeoptimizations() {
    this.deoptimized = !0,
...
class st extends U {
  ...
  deoptimizeThisOnEventAtPath(e, t, s) {
    2 === e && 0 === t.length && this.description.mutatesSelfAsArray &&
      s.deoptimizePath(O);
  }
  ...
  hasEffectsWhenCalledAtPath(e, t, s) {
    ...
    if (
      ...
      !0 === this.description.mutatesSelfAsArray &&
        (null === (i = t.thisParam) || void 0 === i
          ? void 0
          : i.hasEffectsWhenAssignedAtPath(O, s))
    ) {
      return !0;
    }
    ...
    for (const e of this.description.callsArgs) {
      if (
        null === (n = t.args[e]) || void 0 === n
          ? void 0
          : n.hasEffectsWhenCalledAtPath(D, {
            args: ke,
            thisParam: null,
            withNew: !1,
          }, s)
...
class ht extends U {
  ...
  deoptimizeAllProperties() {
    ...
    if (!this.hasUnknownDeoptimizedProperty) {
      ...
      for (
        const e of Object.values(this.propertiesAndGettersByKey).concat(
          Object.values(this.settersByKey),
        )
      ) {
        for (const t of e) t.deoptimizePath(L);
      }
      null === (e = this.prototypeExpression) || void 0 === e ||
      e.deoptimizePath([R, R]), this.deoptimizeCachedEntities();
    }
  }
  deoptimizeIntegerProperties() {
    if (
      !this.hasUnknownDeoptimizedProperty && !this.hasUnknownDeoptimizedInteger
    ) {
      this.hasUnknownDeoptimizedInteger = !0;
      for (const [e, t] of Object.entries(this.propertiesAndGettersByKey)) {
        if (ot.test(e)) for (const e of t) e.deoptimizePath(L);
      }
  ...
  deoptimizePath(e) {
    ...
    const i = 1 === e.length ? L : e.slice(1);
    for (
      const e of "string" == typeof s
        ? (this.propertiesAndGettersByKey[s] ||
          this.unmatchablePropertiesAndGetters).concat(
            this.settersByKey[s] || this.unmatchableSetters,
          )
        : this.allProperties
    ) {
      e.deoptimizePath(i);
    }
    null === (t = this.prototypeExpression) || void 0 === t ||
      t.deoptimizePath(1 === e.length ? [R, R] : e);
  }
  deoptimizeThisOnEventAtPath(e, t, s, i) {
    var n;
    const [r, ...a] = t;
    if (
      ...
      (2 === e || t.length > 1) && "string" == typeof r &&
        this.deoptimizedPaths[r]
    ) {
      return void s.deoptimizePath(L);
    }
    const [o, h, l] = 2 === e || t.length > 1
      ? [
    ...
    if ("string" == typeof r) {
      if (o[r]) {
        ...
        return void (this.immutable ||
          this.thisParametersToBeDeoptimized.add(s));
      }
      for (const t of l) t.deoptimizeThisOnEventAtPath(e, a, s, i);
      if (ot.test(r)) {
        for (const t of this.unknownIntegerProps) {
          t.deoptimizeThisOnEventAtPath(e, a, s, i);
        }
      }
    } else {
      for (const t of Object.values(h).concat([l])) {
        for (const n of t) n.deoptimizeThisOnEventAtPath(e, a, s, i);
      }
      for (const t of this.unknownIntegerProps) {
        t.deoptimizeThisOnEventAtPath(e, a, s, i);
      }
    }
    this.immutable || this.thisParametersToBeDeoptimized.add(s),
      null === (n = this.prototypeExpression) || void 0 === n ||
      n.deoptimizeThisOnEventAtPath(e, t, s, i);
  }
  getLiteralValueAtPath(e, t, s) {
    if (0 === e.length) return W;
    const i = e[0], n = this.getMemberExpressionAndTrackDeopt(i, s);
    return n
      ? n.getLiteralValueAtPath(e.slice(1), t, s)
      : this.prototypeExpression
      ? this.prototypeExpression.getLiteralValueAtPath(e, t, s)
      : 1 !== e.length
      ? W
      : void 0;
  }
  getReturnExpressionWhenCalledAtPath(e, t, s, i) {
    ...
    return r
      ? r.getReturnExpressionWhenCalledAtPath(e.slice(1), t, s, i)
      : this.prototypeExpression
      ? this.prototypeExpression.getReturnExpressionWhenCalledAtPath(e, t, s, i)
      : j;
  }
  hasEffectsWhenAccessedAtPath(e, t) {
    const [s, ...i] = e;
    if (e.length > 1) {
      ...
      return n
        ? n.hasEffectsWhenAccessedAtPath(i, t)
        : !this.prototypeExpression ||
          this.prototypeExpression.hasEffectsWhenAccessedAtPath(e, t);
    }
    ...
    if ("string" == typeof s) {
      if (this.propertiesAndGettersByKey[s]) {
        ...
        if (e) {
          for (const s of e) {
            if (s.hasEffectsWhenAccessedAtPath(i, t)) return !0;
          }
        }
        return !1;
      }
      for (const e of this.unmatchableGetters) {
        if (e.hasEffectsWhenAccessedAtPath(i, t)) return !0;
      }
    } else {
      for (
        const e of Object.values(this.gettersByKey).concat([
          this.unmatchableGetters,
        ])
      ) {
        for (const s of e) if (s.hasEffectsWhenAccessedAtPath(i, t)) return !0;
      }
    }
  ...
  hasEffectsWhenAssignedAtPath(e, t) {
    ...
    if (e.length > 1) {
      ...
      const n = this.getMemberExpression(s);
      return n
        ? n.hasEffectsWhenAssignedAtPath(i, t)
        : !this.prototypeExpression ||
          this.prototypeExpression.hasEffectsWhenAssignedAtPath(e, t);
    }
    if (this.hasUnknownDeoptimizedProperty) return !0;
    if ("string" == typeof s) {
      if (this.propertiesAndSettersByKey[s]) {
        ...
        if (e) {
          for (const s of e) {
            if (s.hasEffectsWhenAssignedAtPath(i, t)) return !0;
          }
        }
        return !1;
      }
      for (const e of this.unmatchableSetters) {
        if (e.hasEffectsWhenAssignedAtPath(i, t)) return !0;
      }
    }
    return !!this.prototypeExpression &&
      this.prototypeExpression.hasEffectsWhenAssignedAtPath(e, t);
  ...
  hasEffectsWhenCalledAtPath(e, t, s) {
    ...
    return n
      ? n.hasEffectsWhenCalledAtPath(e.slice(1), t, s)
      : !this.prototypeExpression ||
        this.prototypeExpression.hasEffectsWhenCalledAtPath(e, t, s);
  }
  buildPropertyMaps(e) {
    const {
        allProperties: t,
    ...
    for (let u = e.length - 1; u >= 0; u--) {
      ...
      if (t.push(f), "string" != typeof d) {
        ...
        "set" === p ? i[d] || (i[d] = [f, ...c], n[d] = [f, ...l]) : "get" === p
          ? s[d] || (s[d] = [f, ...o], r[d] = [f, ...h])
          : (i[d] || (i[d] = [f, ...c]), s[d] || (s[d] = [f, ...o]));
      }
    }
  }
  deoptimizeCachedEntities() {
    ...
    for (const e of this.thisParametersToBeDeoptimized) e.deoptimizePath(L);
  }
  deoptimizeCachedIntegerEntities() {
    for (const [e, t] of Object.entries(this.expressionsToBeDeoptimizedByKey)) {
      if (ot.test(e)) for (const e of t) e.deoptimizeCache();
    }
    for (const e of this.thisParametersToBeDeoptimized) e.deoptimizePath(O);
  }
  getMemberExpression(e) {
    if (
      this.hasUnknownDeoptimizedProperty || "string" != typeof e ||
      this.hasUnknownDeoptimizedInteger && ot.test(e) ||
    ...
    return 1 === (null == t ? void 0 : t.length)
      ? t[0]
      : t || this.unmatchablePropertiesAndGetters.length > 0 ||
          this.unknownIntegerProps.length && ot.test(e)
      ? j
      : null;
  }
...
class At extends G {
  ...
  consolidateInitializers() {
    if (null !== this.additionalInitializers) {
      for (const e of this.additionalInitializers) e.deoptimizePath(L);
      this.additionalInitializers = null;
    }
  }
  deoptimizePath(e) {
    ...
    if (
      ...
      if (0 === e.length) {
        if (!this.isReassigned) {
          ...
          null === (t = this.init) || void 0 === t || t.deoptimizePath(L);
        }
      } else null === (s = this.init) || void 0 === s || s.deoptimizePath(e);
    }
  }
  deoptimizeThisOnEventAtPath(e, t, s, i) {
    if (this.isReassigned || !this.init) return s.deoptimizePath(L);
    i.withTrackedEntityAtPath(
      t,
      this.init,
      () => this.init.deoptimizeThisOnEventAtPath(e, t, s, i),
      void 0,
    );
  }
  getLiteralValueAtPath(e, t, s) {
    return this.isReassigned || !this.init
      ...
      : t.withTrackedEntityAtPath(
        ...
        () => (this.expressionsToBeDeoptimized.push(s),
          this.init.getLiteralValueAtPath(e, t, s)),
        W,
      );
  }
  getReturnExpressionWhenCalledAtPath(e, t, s, i) {
    return this.isReassigned || !this.init
      ...
      : s.withTrackedEntityAtPath(
        ...
        () => (this.expressionsToBeDeoptimized.push(i),
          this.init.getReturnExpressionWhenCalledAtPath(e, t, s, i)),
        j,
      );
  }
  hasEffectsWhenAccessedAtPath(e, t) {
    return !!this.isReassigned ||
      this.init && !t.accessed.trackEntityAtPathAndGetIfTracked(e, this) &&
        this.init.hasEffectsWhenAccessedAtPath(e, t);
  }
  hasEffectsWhenAssignedAtPath(e, t) {
    return !!this.included ||
      0 !== e.length &&
        (!!this.isReassigned ||
          this.init && !t.accessed.trackEntityAtPathAndGetIfTracked(e, this) &&
            this.init.hasEffectsWhenAssignedAtPath(e, t));
  }
  hasEffectsWhenCalledAtPath(e, t, s) {
    return !!this.isReassigned ||
      this.init && !(t.withNew
          ? s.instantiated
          : s.called).trackEntityAtPathAndGetIfTracked(e, t, this) &&
        this.init.hasEffectsWhenCalledAtPath(e, t, s);
  }
  include() {
    if (!this.included) {
      this.included = !0;
      for (const e of this.declarations) {
        e.included || e.include(Ae(), !1);
        let t = e.parent;
  ...
  includeCallArguments(e, t) {
    if (
      this.isReassigned || this.init && e.includedCallArguments.has(this.init)
    ) {
      for (const s of t) s.include(e, !1);
    } else {
      this.init &&
  ...
  markInitializersForDeoptimization() {
    return null === this.additionalInitializers &&
...
class wt {
  ...
  addDeclaration(e, t, s, i) {
    ...
    return r
      ...
      : (r = new At(e.name, e, s || Ce, t), this.variables.set(n, r)),
      r;
  }
  contains(e) {
...
class Ct extends wt {
  ...
  addAccessedDynamicImport(e) {
    (this.accessedDynamicImports || (this.accessedDynamicImports = new Set()))
      .add(e),
      this.parent instanceof Ct && this.parent.addAccessedDynamicImport(e);
  }
  addAccessedGlobals(e, t) {
    const s = t.get(this) || new Set();
    for (const t of e) s.add(t);
    t.set(this, s),
      this.parent instanceof Ct && this.parent.addAccessedGlobals(e, t);
  }
  ...
  addReturnExpression(e) {
    this.parent instanceof Ct && this.parent.addReturnExpression(e);
  }
  addUsedOutsideNames(e, t, s, i) {
    for (const i of this.accessedOutsideVariables.values()) {
      i.included &&
        (e.add(i.getBaseVariableName()),
  ...
  deconflict(e, t, s) {
    ...
    for (const [e, t] of this.variables) {
      (t.included || t.alwaysRendered) && t.setRenderNames(null, kt(e, i));
    }
...
class It extends Ct {
  constructor(e, t) {
    super(e),
      ...
      this.hasRest = !1,
      this.context = t,
      this.hoistedBodyVarScope = new Ct(this);
  }
  addParameterDeclaration(e) {
    const t = e.name;
    let s = this.hoistedBodyVarScope.variables.get(t);
    return s ? s.addDeclaration(e, null) : s = new At(t, e, j, this.context),
...
class Nt extends It {
  ...
  updateReturnExpression() {
    if (1 === this.returnExpressions.length) {
      ...
      this.returnExpression = j;
      for (const e of this.returnExpressions) e.deoptimizePath(L);
    }
  }
}
function _t(e, t, s, i) {
...
function Ot(e, t, s, i, n) {
  ...
  c && (h = s + Lt(t.original.slice(s, l.start))[1]);
  for (let s = 1; s <= e.length; s++) {
    r = l,
      ...
      o || c
        ? (h = r.end +
          Lt(t.original.slice(r.end, void 0 === l ? i : l.start))[1],
          r.included
            ? o
...
function Vt(e, t, s, i) {
  ...
  for (let i = 0; i < e.length; i++) {
    for (
      a = e[i],
        void 0 !== r && (c = r.end + Rt(t.original.slice(r.end, a.start), ",")),
        o = h = c + 1 + Lt(t.original.slice(c + 1, a.start))[1];
  ...
  return n.push({ contentEnd: i, end: i, node: r, separator: null, start: s }),
    n;
}
function Bt(e, t, s) {
  for (;;) {
    const [i, n] = Lt(e.original.slice(t, s));
    if (-1 === i) break;
    e.remove(t + i, t += n);
  }
}
...
class zt extends et {
  initialise() {
    this.directive && "use strict" !== this.directive &&
      "Program" === this.parent.type &&
      this.context.warn({
        code: "MODULE_LEVEL_DIRECTIVE",
        message:
          `Module level directives cause errors when bundled, '${this.directive}' was ignored.`,
      }, this.start);
  }
  render(e, t) {
...
class Wt extends et {
  ...
  addImplicitReturnExpressionToScope() {
    ...
    e && "ReturnStatement" === e.type || this.scope.addReturnExpression(j);
  }
  createScope(e) {
    this.scope = this.parent.preventChildBlockScope ? e : new Ft(e);
  }
  hasEffects(e) {
  ...
  initialise() {
    const e = this.body[0];
    this.deoptimizeBody = e instanceof zt && "use asm" === e.directive;
  }
  render(e, t) {
    this.body.length
      ? Ot(this.body, e, this.start + 1, this.end - 1, t)
      : super.render(e, t);
  }
}
function Ut(e, t) {
  if ("MemberExpression" === e.type) return !e.computed && Ut(e.object, e);
...
const jt = Symbol("Value Properties"),
  Gt = { pure: !0 },
  Ht = { pure: !1 },
  qt = { __proto__: null, [jt]: Ht },
  Kt = { __proto__: null, [jt]: Gt },
  Xt = { __proto__: null, [jt]: Ht, prototype: qt },
  Yt = { __proto__: null, [jt]: Gt, prototype: qt },
  Qt = { __proto__: null, [jt]: Gt, from: Kt, of: Kt, prototype: qt },
  Zt = { __proto__: null, [jt]: Gt, supportedLocalesOf: Yt },
  Jt = {
    global: qt,
    globalThis: qt,
    self: qt,
    ...
    ArrayBuffer: { __proto__: null, [jt]: Gt, isView: Kt, prototype: qt },
    Atomics: qt,
    BigInt: Xt,
    BigInt64Array: Xt,
    BigUint64Array: Xt,
    ...
    Symbol: { __proto__: null, [jt]: Gt, for: Kt, keyFor: Kt, prototype: qt },
    SyntaxError: Yt,
    toLocaleString: qt,
    toString: qt,
    TypeError: Yt,
    ...
    applicationCache: qt,
    ApplicationCache: Xt,
    ApplicationCacheErrorEvent: Xt,
    atob: qt,
    Attr: Xt,
    Audio: Xt,
    AudioBuffer: Xt,
    AudioBufferSourceNode: Xt,
    AudioContext: Xt,
    AudioDestinationNode: Xt,
    AudioListener: Xt,
    AudioNode: Xt,
    AudioParam: Xt,
    AudioProcessingEvent: Xt,
    AudioScheduledSourceNode: Xt,
    AudioWorkletNode: Xt,
    BarProp: Xt,
    BaseAudioContext: Xt,
    BatteryManager: Xt,
    BeforeUnloadEvent: Xt,
    BiquadFilterNode: Xt,
    Blob: Xt,
    BlobEvent: Xt,
    blur: qt,
    BroadcastChannel: Xt,
    btoa: qt,
    ByteLengthQueuingStrategy: Xt,
    Cache: Xt,
    caches: qt,
    CacheStorage: Xt,
    cancelAnimationFrame: qt,
    cancelIdleCallback: qt,
    CanvasCaptureMediaStreamTrack: Xt,
    CanvasGradient: Xt,
    CanvasPattern: Xt,
    CanvasRenderingContext2D: Xt,
    ChannelMergerNode: Xt,
    ChannelSplitterNode: Xt,
    CharacterData: Xt,
    clientInformation: qt,
    ClipboardEvent: Xt,
    close: qt,
    closed: qt,
    CloseEvent: Xt,
    ...
    CompositionEvent: Xt,
    confirm: qt,
    ConstantSourceNode: Xt,
    ConvolverNode: Xt,
    CountQueuingStrategy: Xt,
    createImageBitmap: qt,
    Credential: Xt,
    CredentialsContainer: Xt,
    crypto: qt,
    Crypto: Xt,
    CryptoKey: Xt,
    CSS: Xt,
    ...
    CSSRule: Xt,
    CSSRuleList: Xt,
    CSSStyleDeclaration: Xt,
    CSSStyleRule: Xt,
    CSSStyleSheet: Xt,
    CSSSupportsRule: Xt,
    CustomElementRegistry: Xt,
    customElements: qt,
    CustomEvent: Xt,
    DataTransfer: Xt,
    DataTransferItem: Xt,
    DataTransferItemList: Xt,
    defaultstatus: qt,
    defaultStatus: qt,
    DelayNode: Xt,
    DeviceMotionEvent: Xt,
    DeviceOrientationEvent: Xt,
    devicePixelRatio: qt,
    dispatchEvent: qt,
    document: qt,
    Document: Xt,
    ...
    DOMError: Xt,
    DOMException: Xt,
    DOMImplementation: Xt,
    DOMMatrix: Xt,
    DOMMatrixReadOnly: Xt,
    DOMParser: Xt,
    DOMPoint: Xt,
    DOMPointReadOnly: Xt,
    DOMQuad: Xt,
    ...
    history: qt,
    History: Xt,
    HTMLAllCollection: Xt,
    HTMLAnchorElement: Xt,
    HTMLAreaElement: Xt,
    HTMLAudioElement: Xt,
    HTMLBaseElement: Xt,
    HTMLBodyElement: Xt,
    HTMLBRElement: Xt,
    HTMLButtonElement: Xt,
    HTMLCanvasElement: Xt,
    HTMLCollection: Xt,
    HTMLContentElement: Xt,
    HTMLDataElement: Xt,
    HTMLDataListElement: Xt,
    HTMLDetailsElement: Xt,
    HTMLDialogElement: Xt,
    HTMLDirectoryElement: Xt,
    HTMLDivElement: Xt,
    HTMLDListElement: Xt,
    HTMLDocument: Xt,
    HTMLElement: Xt,
    HTMLEmbedElement: Xt,
    HTMLFieldSetElement: Xt,
    HTMLFontElement: Xt,
    HTMLFormControlsCollection: Xt,
    HTMLFormElement: Xt,
    HTMLFrameElement: Xt,
    HTMLFrameSetElement: Xt,
    HTMLHeadElement: Xt,
    HTMLHeadingElement: Xt,
    HTMLHRElement: Xt,
    HTMLHtmlElement: Xt,
    HTMLIFrameElement: Xt,
    HTMLImageElement: Xt,
    HTMLInputElement: Xt,
    HTMLLabelElement: Xt,
    HTMLLegendElement: Xt,
    HTMLLIElement: Xt,
    HTMLLinkElement: Xt,
    HTMLMapElement: Xt,
    HTMLMarqueeElement: Xt,
    HTMLMediaElement: Xt,
    HTMLMenuElement: Xt,
    HTMLMetaElement: Xt,
    HTMLMeterElement: Xt,
    HTMLModElement: Xt,
    HTMLObjectElement: Xt,
    HTMLOListElement: Xt,
    HTMLOptGroupElement: Xt,
    HTMLOptionElement: Xt,
    HTMLOptionsCollection: Xt,
    HTMLOutputElement: Xt,
    HTMLParagraphElement: Xt,
    HTMLParamElement: Xt,
    HTMLPictureElement: Xt,
    HTMLPreElement: Xt,
    HTMLProgressElement: Xt,
    HTMLQuoteElement: Xt,
    HTMLScriptElement: Xt,
    HTMLSelectElement: Xt,
    HTMLShadowElement: Xt,
    HTMLSlotElement: Xt,
    HTMLSourceElement: Xt,
    HTMLSpanElement: Xt,
    HTMLStyleElement: Xt,
    HTMLTableCaptionElement: Xt,
    HTMLTableCellElement: Xt,
    HTMLTableColElement: Xt,
    HTMLTableElement: Xt,
    HTMLTableRowElement: Xt,
    HTMLTableSectionElement: Xt,
    HTMLTemplateElement: Xt,
    HTMLTextAreaElement: Xt,
    HTMLTimeElement: Xt,
    HTMLTitleElement: Xt,
    HTMLTrackElement: Xt,
    HTMLUListElement: Xt,
    HTMLUnknownElement: Xt,
    HTMLVideoElement: Xt,
    IDBCursor: Xt,
    IDBCursorWithValue: Xt,
    IDBDatabase: Xt,
    IDBFactory: Xt,
    IDBIndex: Xt,
    IDBKeyRange: Xt,
    ...
    IDBRequest: Xt,
    IDBTransaction: Xt,
    IDBVersionChangeEvent: Xt,
    IdleDeadline: Xt,
    IIRFilterNode: Xt,
    Image: Xt,
    ImageBitmap: Xt,
    ImageBitmapRenderingContext: Xt,
    ImageCapture: Xt,
    ImageData: Xt,
    indexedDB: qt,
    innerHeight: qt,
    innerWidth: qt,
    InputEvent: Xt,
    IntersectionObserver: Xt,
    IntersectionObserverEntry: Xt,
    isSecureContext: qt,
    KeyboardEvent: Xt,
    KeyframeEffect: Xt,
    length: qt,
    ...
    MediaDeviceInfo: Xt,
    MediaDevices: Xt,
    MediaElementAudioSourceNode: Xt,
    MediaEncryptedEvent: Xt,
    MediaError: Xt,
    MediaKeyMessageEvent: Xt,
    MediaKeySession: Xt,
    MediaKeyStatusMap: Xt,
    MediaKeySystemAccess: Xt,
    MediaList: Xt,
    MediaQueryList: Xt,
    MediaQueryListEvent: Xt,
    MediaRecorder: Xt,
    MediaSettingsRange: Xt,
    MediaSource: Xt,
    MediaStream: Xt,
    MediaStreamAudioDestinationNode: Xt,
    MediaStreamAudioSourceNode: Xt,
    MediaStreamEvent: Xt,
    MediaStreamTrack: Xt,
    MediaStreamTrackEvent: Xt,
    menubar: qt,
    MessageChannel: Xt,
    MessageEvent: Xt,
    MessagePort: Xt,
    MIDIAccess: Xt,
    MIDIConnectionEvent: Xt,
    MIDIInput: Xt,
    MIDIInputMap: Xt,
    MIDIMessageEvent: Xt,
    MIDIOutput: Xt,
    ...
    name: qt,
    NamedNodeMap: Xt,
    NavigationPreloadManager: Xt,
    navigator: qt,
    Navigator: Xt,
    NetworkInformation: Xt,
    Node: Xt,
    NodeFilter: qt,
    NodeIterator: Xt,
    NodeList: Xt,
    Notification: Xt,
    OfflineAudioCompletionEvent: Xt,
    OfflineAudioContext: Xt,
    offscreenBuffering: qt,
    OffscreenCanvas: Xt,
    open: qt,
    openDatabase: qt,
    Option: Xt,
    ...
    PaymentAddress: Xt,
    PaymentRequest: Xt,
    PaymentRequestUpdateEvent: Xt,
    PaymentResponse: Xt,
    performance: qt,
    Performance: Xt,
    PerformanceEntry: Xt,
    PerformanceLongTaskTiming: Xt,
    PerformanceMark: Xt,
    PerformanceMeasure: Xt,
    PerformanceNavigation: Xt,
    PerformanceNavigationTiming: Xt,
    PerformanceObserver: Xt,
    PerformanceObserverEntryList: Xt,
    PerformancePaintTiming: Xt,
    PerformanceResourceTiming: Xt,
    PerformanceTiming: Xt,
    PeriodicWave: Xt,
    Permissions: Xt,
    PermissionStatus: Xt,
    personalbar: qt,
    PhotoCapabilities: Xt,
    Plugin: Xt,
    PluginArray: Xt,
    PointerEvent: Xt,
    PopStateEvent: Xt,
    postMessage: qt,
    Presentation: Xt,
    PresentationAvailability: Xt,
    PresentationConnection: Xt,
    PresentationConnectionAvailableEvent: Xt,
    PresentationConnectionCloseEvent: Xt,
    PresentationConnectionList: Xt,
    PresentationReceiver: Xt,
    PresentationRequest: Xt,
    print: qt,
    ProcessingInstruction: Xt,
    ProgressEvent: Xt,
    PromiseRejectionEvent: Xt,
    prompt: qt,
    PushManager: Xt,
    PushSubscription: Xt,
    PushSubscriptionOptions: Xt,
    queueMicrotask: qt,
    RadioNodeList: Xt,
    Range: Xt,
    ReadableStream: Xt,
    RemotePlayback: Xt,
    removeEventListener: qt,
    Request: Xt,
    requestAnimationFrame: qt,
    requestIdleCallback: qt,
    resizeBy: qt,
    ResizeObserver: Xt,
    ResizeObserverEntry: Xt,
    resizeTo: qt,
    Response: Xt,
    RTCCertificate: Xt,
    RTCDataChannel: Xt,
    RTCDataChannelEvent: Xt,
    RTCDtlsTransport: Xt,
    RTCIceCandidate: Xt,
    RTCIceTransport: Xt,
    RTCPeerConnection: Xt,
    RTCPeerConnectionIceEvent: Xt,
    RTCRtpReceiver: Xt,
    RTCRtpSender: Xt,
    RTCSctpTransport: Xt,
    RTCSessionDescription: Xt,
    RTCStatsReport: Xt,
    RTCTrackEvent: Xt,
    screen: qt,
    Screen: Xt,
    screenLeft: qt,
    ScreenOrientation: Xt,
    screenTop: qt,
    screenX: qt,
    screenY: qt,
    ScriptProcessorNode: Xt,
    scroll: qt,
    scrollbars: qt,
    scrollBy: qt,
    scrollTo: qt,
    scrollX: qt,
    scrollY: qt,
    SecurityPolicyViolationEvent: Xt,
    Selection: Xt,
    ServiceWorker: Xt,
    ServiceWorkerContainer: Xt,
    ServiceWorkerRegistration: Xt,
    sessionStorage: qt,
    ShadowRoot: Xt,
    SharedWorker: Xt,
    SourceBuffer: Xt,
    SourceBufferList: Xt,
    speechSynthesis: qt,
    SpeechSynthesisEvent: Xt,
    SpeechSynthesisUtterance: Xt,
    StaticRange: Xt,
    status: qt,
    statusbar: qt,
    StereoPannerNode: Xt,
    ...
    SVGAngle: Xt,
    SVGAnimatedAngle: Xt,
    SVGAnimatedBoolean: Xt,
    SVGAnimatedEnumeration: Xt,
    SVGAnimatedInteger: Xt,
    SVGAnimatedLength: Xt,
    SVGAnimatedLengthList: Xt,
    SVGAnimatedNumber: Xt,
    SVGAnimatedNumberList: Xt,
    SVGAnimatedPreserveAspectRatio: Xt,
    SVGAnimatedRect: Xt,
    SVGAnimatedString: Xt,
    SVGAnimatedTransformList: Xt,
    SVGAnimateElement: Xt,
    SVGAnimateMotionElement: Xt,
    SVGAnimateTransformElement: Xt,
    SVGAnimationElement: Xt,
    SVGCircleElement: Xt,
    SVGClipPathElement: Xt,
    SVGComponentTransferFunctionElement: Xt,
    SVGDefsElement: Xt,
    SVGDescElement: Xt,
    SVGDiscardElement: Xt,
    SVGElement: Xt,
    SVGEllipseElement: Xt,
    SVGFEBlendElement: Xt,
    SVGFEColorMatrixElement: Xt,
    SVGFEComponentTransferElement: Xt,
    SVGFECompositeElement: Xt,
    SVGFEConvolveMatrixElement: Xt,
    SVGFEDiffuseLightingElement: Xt,
    SVGFEDisplacementMapElement: Xt,
    SVGFEDistantLightElement: Xt,
    SVGFEDropShadowElement: Xt,
    SVGFEFloodElement: Xt,
    SVGFEFuncAElement: Xt,
    SVGFEFuncBElement: Xt,
    SVGFEFuncGElement: Xt,
    SVGFEFuncRElement: Xt,
    SVGFEGaussianBlurElement: Xt,
    SVGFEImageElement: Xt,
    SVGFEMergeElement: Xt,
    SVGFEMergeNodeElement: Xt,
    SVGFEMorphologyElement: Xt,
    SVGFEOffsetElement: Xt,
    SVGFEPointLightElement: Xt,
    SVGFESpecularLightingElement: Xt,
    SVGFESpotLightElement: Xt,
    SVGFETileElement: Xt,
    SVGFETurbulenceElement: Xt,
    SVGFilterElement: Xt,
    SVGForeignObjectElement: Xt,
    SVGGElement: Xt,
    SVGGeometryElement: Xt,
    SVGGradientElement: Xt,
    SVGGraphicsElement: Xt,
    SVGImageElement: Xt,
    SVGLength: Xt,
    SVGLengthList: Xt,
    SVGLinearGradientElement: Xt,
    SVGLineElement: Xt,
    SVGMarkerElement: Xt,
    SVGMaskElement: Xt,
    SVGMatrix: Xt,
    SVGMetadataElement: Xt,
    SVGMPathElement: Xt,
    SVGNumber: Xt,
    SVGNumberList: Xt,
    SVGPathElement: Xt,
    SVGPatternElement: Xt,
    SVGPoint: Xt,
    SVGPointList: Xt,
    SVGPolygonElement: Xt,
    SVGPolylineElement: Xt,
    SVGPreserveAspectRatio: Xt,
    SVGRadialGradientElement: Xt,
    SVGRect: Xt,
    SVGRectElement: Xt,
    SVGScriptElement: Xt,
    SVGSetElement: Xt,
    ...
    SVGSwitchElement: Xt,
    SVGSymbolElement: Xt,
    SVGTextContentElement: Xt,
    SVGTextElement: Xt,
    SVGTextPathElement: Xt,
    SVGTextPositioningElement: Xt,
    SVGTitleElement: Xt,
    SVGTransform: Xt,
    SVGTransformList: Xt,
    SVGTSpanElement: Xt,
    ...
    WaveShaperNode: Xt,
    WebAssembly: qt,
    WebGL2RenderingContext: Xt,
    WebGLActiveInfo: Xt,
    WebGLBuffer: Xt,
    WebGLContextEvent: Xt,
    WebGLFramebuffer: Xt,
    WebGLProgram: Xt,
    WebGLQuery: Xt,
    WebGLRenderbuffer: Xt,
    WebGLRenderingContext: Xt,
    WebGLSampler: Xt,
    WebGLShader: Xt,
    WebGLShaderPrecisionFormat: Xt,
    WebGLSync: Xt,
    WebGLTexture: Xt,
    WebGLTransformFeedback: Xt,
    WebGLUniformLocation: Xt,
    WebGLVertexArrayObject: Xt,
    WebSocket: Xt,
    WheelEvent: Xt,
    Window: Xt,
    Worker: Xt,
    ...
    XMLDocument: Xt,
    XMLHttpRequest: Xt,
    XMLHttpRequestEventTarget: Xt,
    XMLHttpRequestUpload: Xt,
    XMLSerializer: Xt,
    XPathEvaluator: Xt,
    XPathExpression: Xt,
    XPathResult: Xt,
...
for (const e of ["window", "global", "self", "globalThis"]) Jt[e] = Jt;
function es(e) {
  let t = Jt;
  for (const s of e) {
...
const ss = { __proto__: null, class: !0, const: !0, let: !0, var: !0 };
class is extends et {
  constructor() {
    super(...arguments),
      this.variable = null,
  ...
  bind() {
    null === this.variable && Ut(this, this.parent) &&
    ...
    switch (e) {
      case "var":
        s = this.scope.addDeclaration(this, this.context, t, !0),
          i && i.correctVarValueBeforeDeclaration &&
          s.markInitializersForDeoptimization();
        break;
      case "function":
      case "let":
      case "const":
  ...
  deoptimizePath(e) {
    0 !== e.length || this.scope.contains(this.name) ||
    this.disallowImportReassignment(), this.variable.deoptimizePath(e);
  }
  deoptimizeThisOnEventAtPath(e, t, s, i) {
  ...
  hasEffects() {
    return this.deoptimized || this.applyDeoptimizations(),
      ...
      this.context.options.treeshake.unknownGlobalSideEffects &&
        this.variable instanceof ts &&
        this.variable.hasEffectsWhenAccessedAtPath(D);
  }
  hasEffectsWhenAccessedAtPath(e, t) {
    return null !== this.variable &&
      this.getVariableRespectingTDZ().hasEffectsWhenAccessedAtPath(e, t);
  }
  hasEffectsWhenAssignedAtPath(e, t) {
  ...
  hasEffectsWhenCalledAtPath(e, t, s) {
    return !this.variable ||
      this.getVariableRespectingTDZ().hasEffectsWhenCalledAtPath(e, t, s);
  }
  include() {
    this.deoptimized || this.applyDeoptimizations(),
      this.included ||
  ...
  isPossibleTDZ() {
    ...
    if (
      !(this.variable instanceof At && this.variable.kind &&
        this.variable.kind in ss)
    ) {
    ...
    return this.variable.declarations &&
        ...
        (e = this.variable.declarations[0]) && this.start < e.start &&
        ns(this) === ns(e)
      ? this.isTDZAccess = !0
  ...
  render(
    ...
    if (this.variable) {
      ...
      r !== this.name &&
      (e.overwrite(this.start, this.end, r, { contentOnly: !0, storeName: !0 }),
        n && e.prependRight(this.start, `${this.name}: `)),
        "eval" === r && "CallExpression" === s && i &&
        e.appendRight(this.start, "0, ");
    }
  }
  applyDeoptimizations() {
    this.deoptimized = !0,
      null !== this.variable && this.variable instanceof At &&
  ...
  getVariableRespectingTDZ() {
    return this.isPossibleTDZ() ? j : this.variable;
  }
}
function ns(e) {
...
class rs extends et {
  ...
  declare(e, t) {
    return this.declarationInit = t, this.argument.declare(e, j);
  }
  deoptimizePath(e) {
    0 === e.length && this.argument.deoptimizePath(D);
  }
  hasEffectsWhenAssignedAtPath(e, t) {
    return e.length > 0 || this.argument.hasEffectsWhenAssignedAtPath(D, t);
  }
  markDeclarationReached() {
...
class as extends et {
  ...
  deoptimizePath(e) {
    1 === e.length && e[0] === R &&
      this.scope.getReturnExpression().deoptimizePath(L);
  }
  ...
  hasEffectsWhenCalledAtPath(e, t, s) {
    ...
    if (this.async) {
      ...
      if (
        t.hasEffectsWhenCalledAtPath(["then"], {
          args: ke,
          thisParam: null,
          withNew: !1,
        }, s) ||
        e && ("always" === e || t.hasEffectsWhenAccessedAtPath(["then"], s))
      ) {
        return !0;
      }
    }
  ...
  include(e, t) {
    this.included = !0;
    for (const s of this.params) s instanceof is || s.include(e, t);
  ...
  initialise() {
    this.scope.addParameterVariables(
      this.params.map((e) => e.declare("parameter", j)),
      this.params[this.params.length - 1] instanceof rs,
    ),
  ...
  parseNode(e) {
    ...
    (this.body = new Wt(e.body, this, this.scope.hoistedBodyVarScope)),
      super.parseNode(e);
  }
}
function os(
  e,
  {
    ...
    snippets: { _: s, getObject: i, getPropertyAccess: n },
  },
  r = "",
) {
...
function hs(e, t, s, i, { exportNamesByVariable: n, snippets: { _: r } }) {
  i.prependRight(t, `exports('${n.get(e)}',${r}`), i.appendLeft(s, ")");
}
function ls(e, t, s, i, n, r) {
  const { _: a, getPropertyAccess: o } = r.snippets;
  n.appendLeft(s, `,${a}${os([e], r)},${a}${e.getName(o)}`),
    i && (n.prependRight(t, "("), n.appendLeft(s, ")"));
}
as.prototype.preventChildBlockScope = !0;
class cs extends et {
  addExportedVariables(e, t) {
  ...
  hasEffectsWhenAssignedAtPath(e, t) {
    ...
    for (const e of this.properties) {
      if (e.hasEffectsWhenAssignedAtPath(D, t)) return !0;
    }
    return !1;
  }
  markDeclarationReached() {
...
class us extends et {
  ...
  hasEffects(e) {
    return this.deoptimized || this.applyDeoptimizations(),
      this.right.hasEffects(e) || this.left.hasEffects(e) ||
      this.left.hasEffectsWhenAssignedAtPath(D, e);
  }
  hasEffectsWhenAccessedAtPath(e, t) {
  ...
  include(e, t) {
    ...
    this.deoptimized || this.applyDeoptimizations(),
      this.included = !0,
      (t || "=" !== this.operator || this.left.included ||
        (s = Pe(),
          this.left.hasEffects(s) ||
          this.left.hasEffectsWhenAssignedAtPath(D, s))) &&
  ...
  render(
    e,
    t,
    { preventASI: s, renderedParentType: i, renderedSurroundingElement: n } = q,
  ) {
    if (this.left.included) this.left.render(e, t), this.right.render(e, t);
    else {
      const r = Dt(e.original, Rt(e.original, "=", this.left.end) + 1);
      e.remove(this.start, r),
        s && Bt(e, r, this.right.start),
    ...
    if ("system" === t.format) {
      if (this.left instanceof is) {
        const s = this.left.variable, i = t.exportNamesByVariable.get(s);
        if (i) {
          return void (1 === i.length
            ? hs(s, this.start, this.end, e, t)
            : ls(
              s,
              this.start,
              this.end,
    ...
    this.left.included && this.left instanceof cs &&
  ...
  applyDeoptimizations() {
    this.deoptimized = !0,
      ...
      this.right.deoptimizePath(L),
      this.context.requestTreeshakingPass();
  }
}
class ds extends At {
  constructor(e) {
    super("arguments", null, j, e);
  }
  hasEffectsWhenAccessedAtPath(e) {
    return e.length > 1;
  }
...
class ps extends At {
  constructor(e) {
    super("this", null, null, e),
      ...
      this.thisDeoptimizations = new z();
  }
  ...
  deoptimizeThisOnEventAtPath(e, t, s) {
    ...
    if (!this.thisDeoptimizations.trackEntityAtPathAndGetIfTracked(t, e, s)) {
      for (const e of this.entitiesToBeDeoptimized) {
        this.applyThisDeoptimizationEvent(e, i);
      }
      this.thisDeoptimizationList.push(i);
    }
  }
  hasEffectsWhenAccessedAtPath(e, t) {
    return this.getInit(t).hasEffectsWhenAccessedAtPath(e, t) ||
      super.hasEffectsWhenAccessedAtPath(e, t);
  }
  hasEffectsWhenAssignedAtPath(e, t) {
    return this.getInit(t).hasEffectsWhenAssignedAtPath(e, t) ||
      super.hasEffectsWhenAssignedAtPath(e, t);
  }
  applyThisDeoptimizationEvent(e, { event: t, path: s, thisParameter: i }) {
    e.deoptimizeThisOnEventAtPath(t, s, i === this ? e : i, F);
  }
  getInit(e) {
    return e.replacedVariableInits.get(this) || j;
  }
}
class fs extends Nt {
  constructor(e, t) {
    super(e, t),
      this.variables.set("arguments", this.argumentsVariable = new ds(t)),
      this.variables.set("this", this.thisVariable = new ps(t));
  }
  findLexicalBoundary() {
    return this;
  }
...
class ms extends et {
  constructor() {
    super(...arguments),
      ...
      this.isPrototypeDeoptimized = !1;
  }
  createScope(e) {
    this.scope = new fs(e, this.context);
  }
  deoptimizePath(e) {
    1 === e.length &&
      ("prototype" === e[0]
  ...
  deoptimizeThisOnEventAtPath(e, t, s) {
    2 === e &&
      (t.length > 0
        ? s.deoptimizePath(L)
        : this.scope.thisVariable.addEntityToBeDeoptimized(s));
  }
  getReturnExpressionWhenCalledAtPath(e) {
    return 0 !== e.length
      ? j
  ...
  hasEffectsWhenCalledAtPath(e, t, s) {
    ...
    s.replacedVariableInits.set(
      ...
      t.withNew ? new ht(Object.create(null), lt) : j,
    );
  ...
  include(e, t) {
    ...
    for (const i of this.params) i instanceof is && !s || i.include(e, t);
...
ms.prototype.preventChildBlockScope = !0;
const gs = {
  "!=": (e, t) => e != t,
  "!==": (e, t) => e !== t,
  "%": (e, t) => e % t,
...
class ys extends et {
  ...
  getReturnExpressionWhenCalledAtPath(e) {
    return 1 !== e.length ? j : Fe(this.members, e[0]);
  }
  hasEffectsWhenAccessedAtPath(e) {
  ...
  hasEffectsWhenCalledAtPath(e, t, s) {
    return 1 !== e.length || Be(this.members, e[0], t, s);
  }
  initialise() {
...
function Es(e) {
  return e.computed
    ? function (e) {
      if (e instanceof ys) return String(e.value);
      return null;
    }(e.property)
    : e.property.name;
}
...
class vs extends et {
  ...
  bind() {
    this.bound = !0;
    const e = xs(this), t = e && this.scope.findVariable(e[0].key);
    if (t && t.isNamespace) {
  ...
  deoptimizePath(e) {
    0 === e.length && this.disallowNamespaceReassignment(),
      this.variable
        ...
        : this.replacement ||
          e.length < 7 &&
            this.object.deoptimizePath([this.getPropertyKey(), ...e]);
  }
  deoptimizeThisOnEventAtPath(e, t, s, i) {
    this.variable
      ? this.variable.deoptimizeThisOnEventAtPath(e, t, s, i)
      : this.replacement || (t.length < 7
  ...
  hasEffects(e) {
    this.deoptimized || this.applyDeoptimizations();
    const { propertyReadSideEffects: t } = this.context.options.treeshake;
    return this.property.hasEffects(e) || this.object.hasEffects(e) ||
      !(this.variable || this.replacement ||
          this.parent instanceof us && "=" === this.parent.operator) &&
        t &&
        ("always" === t ||
          this.object.hasEffectsWhenAccessedAtPath([this.getPropertyKey()], e));
  }
  hasEffectsWhenAccessedAtPath(e, t) {
    return null !== this.variable
  ...
  hasEffectsWhenAssignedAtPath(e, t) {
    return null !== this.variable
      ...
      : !!this.replacement ||
        (!(e.length < 7) ||
          this.object.hasEffectsWhenAssignedAtPath([
            this.getPropertyKey(),
            ...e,
          ], t));
  }
  ...
  applyDeoptimizations() {
    this.deoptimized = !0;
    const { propertyReadSideEffects: e } = this.context.options.treeshake;
    this.bound && e && !this.variable && !this.replacement &&
      (this.parent instanceof us && "=" === this.parent.operator ||
        this.object.deoptimizeThisOnEventAtPath(
          0,
          [this.propertyKey],
  ...
  getPropertyKey() {
    if (null === this.propertyKey) {
      this.propertyKey = R;
      const e = this.property.getLiteralValueAtPath(D, F, this);
      return this.propertyKey = e === W ? R : String(e);
    }
    return this.propertyKey;
  }
  resolveNamespaceVariables(e, t) {
    if (0 === t.length) return e;
    if (!e.isNamespace || e instanceof H) return null;
    ...
    if (!i) {
      ...
      return this.context.warn({
        code: "MISSING_EXPORT",
        exporter: ee(i),
        importer: ee(this.context.fileName),
        message: `'${s}' is not exported by '${ee(i)}'`,
        missing: s,
        url:
...
class bs extends It {
  addDeclaration(e, t, s, i) {
    ...
    return n
      ? (this.parent.addDeclaration(e, t, Ce, i), n.addDeclaration(e, s), n)
...
class Ss extends Ct {
  constructor(e, t, s) {
    super(e),
      this.variables.set(
        "this",
        this.thisVariable = new At("this", null, t, s),
      ),
      this.instanceScope = new Ct(this),
      this.instanceScope.variables.set("this", new ps(s));
  }
  findLexicalBoundary() {
    return this;
  }
...
class As extends et {
  constructor() {
    super(...arguments),
      ...
      this.accessorCallOptions = { args: ke, thisParam: null, withNew: !1 };
  }
  deoptimizeCache() {}
  deoptimizePath(e) {
  ...
  deoptimizeThisOnEventAtPath(e, t, s, i) {
    return 0 === e && "get" === this.kind && 0 === t.length ||
        1 === e && "set" === this.kind && 0 === t.length
      ? this.value.deoptimizeThisOnEventAtPath(2, D, s, i)
      : void this.getAccessedValue().deoptimizeThisOnEventAtPath(e, t, s, i);
  }
  getLiteralValueAtPath(e, t, s) {
  ...
  hasEffectsWhenAccessedAtPath(e, t) {
    return "get" === this.kind && 0 === e.length
      ? this.value.hasEffectsWhenCalledAtPath(D, this.accessorCallOptions, t)
      : this.getAccessedValue().hasEffectsWhenAccessedAtPath(e, t);
  }
  hasEffectsWhenAssignedAtPath(e, t) {
    return "set" === this.kind
      ? this.value.hasEffectsWhenCalledAtPath(D, this.accessorCallOptions, t)
      : this.getAccessedValue().hasEffectsWhenAssignedAtPath(e, t);
  }
  hasEffectsWhenCalledAtPath(e, t, s) {
  ...
  getAccessedValue() {
    return null === this.accessedValue
      ? "get" === this.kind
        ? (this.accessedValue = j,
          this.accessedValue = this.value.getReturnExpressionWhenCalledAtPath(
            D,
...
class ks extends U {
  ...
  hasEffectsWhenAccessedAtPath(e, t) {
    return 0 !== e.length &&
      this.object.hasEffectsWhenAccessedAtPath([this.key, ...e], t);
  }
  hasEffectsWhenAssignedAtPath(e, t) {
...
class ws extends et {
  ...
  hasEffects(e) {
    ...
    return null === (s = this.id) || void 0 === s || s.markDeclarationReached(),
      i || super.hasEffects(e);
  }
  hasEffectsWhenAccessedAtPath(e, t) {
    ...
    return 0 === e.length
      ? !t.withNew ||
        (null !== this.classConstructor
          ? this.classConstructor.hasEffectsWhenCalledAtPath(D, t, s)
          : null !== this.superClass &&
            this.superClass.hasEffectsWhenCalledAtPath(e, t, s))
      : this.getObjectEntity().hasEffectsWhenCalledAtPath(e, t, s);
  }
  include(e, t) {
    var s;
    this.included = !0,
      null === (s = this.superClass) || void 0 === s || s.include(e, t),
  ...
  initialise() {
    ...
    for (const e of this.body.body) {
      if (e instanceof Ps && "constructor" === e.kind) {
  ...
  getObjectEntity() {
    ...
    for (const s of this.body.body) {
      ...
      let a;
      if (s.computed) {
        const e = s.key.getLiteralValueAtPath(D, F, this);
        if (e === W) {
          i.push({ key: R, kind: r, property: s });
          continue;
        }
        a = String(e);
      } else a = s.key instanceof is ? s.key.name : String(s.key.value);
    ...
    return e.unshift({
      ...
      property: new ht(
        t,
        this.superClass ? new ks(this.superClass, "prototype") : lt,
      ),
    }),
      this.objectEntity = new ht(e, this.superClass || lt);
  }
}
class Cs extends ws {
  initialise() {
  ...
  parseNode(e) {
    null !== e.id && (this.id = new is(e.id, this, this.scope.parent)),
      super.parseNode(e);
  }
  render(e, t) {
    const { exportNamesByVariable: s, format: i, snippets: { _: n } } = t;
    "system" === i && this.id && s.has(this.id.variable) &&
    e.appendLeft(this.end, `${n}${os([this.id.variable], t)};`),
      super.render(e, t);
  }
}
class Is extends U {
  ...
  getReturnExpressionWhenCalledAtPath(e, t, s, i) {
    return new Is(
      this.expressions.map((n) =>
        n.getReturnExpressionWhenCalledAtPath(e, t, s, i)),
    );
  }
  hasEffectsWhenAccessedAtPath(e, t) {
...
class $s extends et {
  ...
  render(e, t, s) {
    const { start: i, end: n } = s,
      r = function (e, t) {
        return Dt(e, Rt(e, "default", t) + 7);
      }(e.original, this.start);
    if (this.declaration instanceof _s) {
    ...
    } else if (this.declaration instanceof Cs) {
      this.renderNamedDeclaration(
        e,
        r,
        "class",
  ...
  renderNamedDeclaration(e, t, s, i, n, r) {
    ...
    e.remove(this.start, t),
      n && e.appendLeft(
        function (e, t, s, i) {
          const n = Rt(e, t, i) + t.length;
          e = e.slice(n, Rt(e, s, n));
          const r = Rt(e, "*");
          return -1 === r ? n : n + r + 1;
        }(e.original, s, i, t),
        ` ${l}`,
      ),
      "system" === o && this.declaration instanceof Cs &&
      a.has(this.variable) &&
      e.appendLeft(this.end, ` ${os([this.variable], r)};`);
  }
  renderVariableDeclaration(
    ...
    const a = 59 === e.original.charCodeAt(this.end - 1),
      o = "system" === s && i.get(this.variable);
    o
      ? (e.overwrite(
        this.start,
        t,
  ...
  render(e, t, s) {
    ...
    null === this.declaration
      ...
      : (e.remove(this.start, this.declaration.start),
        this.declaration.render(e, t, { end: n, start: i }));
  }
}
Ts.prototype.needsBoundaries = !0;
class Rs extends Ft {
  constructor() {
...
const Ms = Symbol("unset");
class Ds extends et {
  constructor() {
    super(...arguments), this.testValue = Ms;
  }
  deoptimizeCache() {
    this.testValue = W;
  }
  ...
  include(e, t) {
    if (this.included = !0, t) this.includeRecursively(t, e);
      ...
      const t = this.getTestValue();
      t === W ? this.includeUnknownTest(e) : this.includeKnownTest(e, t);
    }
  }
  parseNode(e) {
    this.consequentScope = new Rs(this.scope),
      this.consequent =
        new (this.context.getNodeConstructor(e.consequent.type))(
          e.consequent,
          this,
          this.consequentScope,
        ),
      e.alternate &&
      (this.alternateScope = new Rs(this.scope),
        this.alternate =
          new (this.context.getNodeConstructor(e.alternate.type))(
            e.alternate,
            this,
            this.alternateScope,
          )),
  ...
  render(e, t) {
    ...
    r ? this.test.render(e, t) : e.remove(this.start, this.consequent.start),
      this.consequent.included && (a || i === W || i)
      ...
      this.alternate &&
      (!this.alternate.included || !a && i !== W && i
  ...
  getTestValue() {
    return this.testValue === Ms
      ? this.testValue = this.test.getLiteralValueAtPath(D, F, this)
      : this.testValue;
  }
  includeKnownTest(e, t) {
    this.test.shouldBeIncluded(e) && this.test.include(e, !1),
      t && this.consequent.shouldBeIncluded(e) &&
      this.consequent.includeAsSingleStatement(e, !1),
      null !== this.alternate && !t && this.alternate.shouldBeIncluded(e) &&
      this.alternate.includeAsSingleStatement(e, !1);
  }
  ...
  includeUnknownTest(e) {
    ...
    (this.consequent.includeAsSingleStatement(e, !1),
      s = e.brokenFlow,
      e.brokenFlow = t),
      null !== this.alternate && this.alternate.shouldBeIncluded(e) &&
      (this.alternate.includeAsSingleStatement(e, !1),
  ...
  renderHoistedDeclarations(e, t, s) {
    ...
    if (i) {
      const e = this.parent.type, s = "Program" !== e && "BlockStatement" !== e;
...
Ls.prototype.needsBoundaries = !0;
const Os = {
  ...
  Vs = (e, t) => "esModule" === e || t && ("auto" === e || "true" === e),
  Bs = {
  ...
  Fs = (e, t) => Vs(e, t) && "_interopDefault" === Os[e],
  zs = (e, t, s, i, n, r, a) => {
    const o = new Set(e);
    for (const e of Js) t.has(e) && o.add(e);
    return Js.map((e) => o.has(e) ? Ws[e](s, i, n, r, a, o) : "").join("");
  },
  Ws = {
    _interopDefaultLegacy(e, t, s) {
      ...
      return `${a}e${i}&&${i}typeof e${i}===${i}'object'${i}&&${i}'default'${i}in e${i}?${i}${
        s ? Us(t) : js(t)
      }${o}${r}${r}`;
    },
    _interopDefault(e, t, s) {
      ...
      return `${a}e${i}&&${i}e.__esModule${i}?${i}${
        s ? Us(t) : js(t)
      }${o}${r}${r}`;
    },
    _interopNamespaceDefaultOnly(
      e,
      { _: t, getDirectReturnFunction: s, getObject: i, n: n },
      r,
      a,
      o,
    ) {
      ...
      return `${h}${
        Zs(
          i([
            ["__proto__", "null"],
            ...o ? [[null, `[Symbol.toStringTag]:${t}'Module'`]] : [],
            ["default", "e"],
          ], { lineBreakIndent: null }),
          a,
        )
    ...
    _interopNamespaceDefault(e, t, s, i, n) {
      const { _: r, n: a } = t;
      return `function _interopNamespaceDefault(e)${r}{${a}` +
        Gs(e, e, t, s, i, n) + `}${a}${a}`;
    },
    _interopNamespace(e, t, s, i, n, r) {
      ...
      return `function _interopNamespace(e)${a}{${h}${e}if${a}(e${a}&&${a}e.__esModule)${a}return e;${h}` +
        Gs(e, e, t, s, i, n) + `}${h}${h}`;
    },
    _mergeNamespaces(e, t, s, i) {
      const { _: n, cnst: r, n: a } = t, o = "var" === r && s;
      return `function _mergeNamespaces(n, m)${n}{${a}${e}${
        qs(
          `{${a}${e}${e}${e}if${n}(k${n}!==${n}'default'${n}&&${n}!(k in n))${n}{${a}` +
            (s ? o ? Xs : Ys : Qs)(e, e + e + e + e, t) + `${e}${e}${e}}${a}` +
            `${e}${e}}`,
          o,
          e,
          t,
        )
      }${a}${e}return ${Zs("n", i)};${a}}${a}${a}`;
    },
  },
  Us = ({ _: e, getObject: t }) =>
    `e${e}:${e}${t([["default", "e"]], { lineBreakIndent: null })}`,
  js = ({ _: e, getPropertyAccess: t }) => `e${t("default")}${e}:${e}e`,
  Gs = (e, t, s, i, n, r) => {
    const { _: a, cnst: o, getPropertyAccess: h, n: l, s: c } = s,
      u = `{${l}` + (i ? Ks : Qs)(e, t + e + e, s) + `${t}${e}}`;
    return `${t}${o} n${a}=${a}${
      r
        ? `{__proto__:${a}null,${a}[Symbol.toStringTag]:${a}'Module'}`
        : "Object.create(null)"
    };${l}${t}if${a}(e)${a}{${l}${t}${e}${Hs(u, !i, s)}${l}${t}}${l}${t}n${
      h("default")
    }${a}=${a}e;${l}${t}return ${Zs("n", n)}${c}${l}`;
  },
  Hs = (e, t, { _: s, cnst: i, getFunctionIntro: n, s: r }) =>
    "var" !== i || t
      ? `for${s}(${i} k in e)${s}${e}`
      : `Object.keys(e).forEach(${
        n(["k"], { isAsync: !1, name: null })
      }${e})${r}`,
  qs = (
    e,
    t,
    s,
    { _: i, cnst: n, getDirectReturnFunction: r, getFunctionIntro: a, n: o },
  ) => {
    if (t) {
      const [t, n] = r(["e"], {
        functionReturn: !1,
        lineBreakIndent: { base: s, t: s },
        name: null,
      });
      return `m.forEach(${t}e${i}&&${i}typeof e${i}!==${i}'string'${i}&&${i}!Array.isArray(e)${i}&&${i}Object.keys(e).forEach(${
        a(["k"], { isAsync: !1, name: null })
      }${e})${n});`;
    }
    return `for${i}(var i${i}=${i}0;${i}i${i}<${i}m.length;${i}i++)${i}{${o}${s}${s}${n} e${i}=${i}m[i];${o}${s}${s}if${i}(typeof e${i}!==${i}'string'${i}&&${i}!Array.isArray(e))${i}{${i}for${i}(${n} k in e)${i}${e}${i}}${o}${s}}`;
  },
  Ks = (e, t, s) => {
    const { _: i, n: n } = s;
    return `${t}if${i}(k${i}!==${i}'default')${i}{${n}` + Xs(e, t + e, s) +
      `${t}}${n}`;
  },
  Xs = (e, t, { _: s, cnst: i, getDirectReturnFunction: n, n: r }) => {
    const [a, o] = n([], {
      functionReturn: !0,
      lineBreakIndent: null,
      name: null,
    });
    return `${t}${i} d${s}=${s}Object.getOwnPropertyDescriptor(e,${s}k);${r}${t}Object.defineProperty(n,${s}k,${s}d.get${s}?${s}d${s}:${s}{${r}${t}${e}enumerable:${s}true,${r}${t}${e}get:${s}${a}e[k]${o}${r}${t}});${r}`;
  },
  Ys = (e, t, { _: s, cnst: i, getDirectReturnFunction: n, n: r }) => {
    const [a, o] = n([], {
      functionReturn: !0,
      lineBreakIndent: null,
      name: null,
    });
    return `${t}${i} d${s}=${s}Object.getOwnPropertyDescriptor(e,${s}k);${r}${t}if${s}(d)${s}{${r}${t}${e}Object.defineProperty(n,${s}k,${s}d.get${s}?${s}d${s}:${s}{${r}${t}${e}${e}enumerable:${s}true,${r}${t}${e}${e}get:${s}${a}e[k]${o}${r}${t}${e}});${r}${t}}${r}`;
  },
  Qs = (e, t, { _: s, n: i }) => `${t}n[k]${s}=${s}e[k];${i}`,
  Zs = (e, t) => t ? `Object.freeze(${e})` : e,
  Js = Object.keys(Ws);
function ei(e, t, s) {
  return "external" === t
    ? Bs[String(s(e instanceof ve ? e.id : null))]
    : "default" === t
    ? "_interopNamespaceDefaultOnly"
    : null;
}
const ti = { amd: ["require"], cjs: ["require"], system: ["module"] };
const si = "ROLLUP_ASSET_URL_", ii = "ROLLUP_FILE_URL_";
const ni = {
  ...
  li = (e, t = !1) =>
    `${
      t ? "typeof document === 'undefined' ? location.href : " : ""
    }(document.currentScript && document.currentScript.src || new URL('${e}', document.baseURI).href)`,
  ci = {
    amd:
      (e) => ("." !== e[0] && (e = "./" + e),
        ai(`require.toUrl('${e}'), document.baseURI`)),
    cjs: (e) =>
      `(typeof document === 'undefined' ? ${
        ai(`'file:' + __dirname + '/${e}'`, "(require('u' + 'rl').URL)")
      } : ${oi(e)})`,
    es: (e) => ai(`'${e}', import.meta.url`),
    iife: (e) => oi(e),
    system: (e) => ai(`'${e}', module.meta.url`),
    umd: (e) =>
  ...
  ui = {
    amd: hi(() => ai("module.uri, document.baseURI")),
    cjs: hi((e) =>
      `(typeof document === 'undefined' ? ${
        ai("'file:' + __filename", "(require('u' + 'rl').URL)")
      } : ${li(e)})`),
    iife: hi((e) => li(e)),
...
class di extends et {
  ...
  render(e, t) {
    this.body.length
      ? Ot(this.body, e, this.start, this.end, t)
      : super.render(e, t);
  }
}
class pi extends et {
  ...
  render(e, t, s) {
    if (this.consequent.length) {
      ...
      const i = this.test
          ? this.test.end
          : Rt(e.original, "default", this.start) + 7,
        n = Rt(e.original, ":", i) + 1;
      Ot(this.consequent, e, n, s.end, t);
    } else super.render(e, t);
  }
}
pi.prototype.needsBoundaries = !0;
class fi extends et {
  getLiteralValueAtPath(e) {
...
class gi extends At {
  constructor(e, t, s) {
    ...
    (i instanceof _s || i instanceof Cs) && i.id
      ? (this.hasId = !0, this.originalId = i.id)
      : i instanceof is && (this.originalId = i);
  }
  addReference(e) {
    ...
    return !this.originalId ||
        !this.hasId &&
          (this.originalId.isPossibleTDZ() ||
            ...
            this.originalId.variable instanceof mi ||
...
class yi extends Ct {
  constructor(e, t) {
    super(e),
      this.context = t,
      this.variables.set("this", new At("this", null, Ce, t));
  }
  addExportDefaultDeclaration(e, t, s) {
    const i = new gi(e, t, s);
  ...
  findVariable(e) {
    ...
    return s instanceof ts && this.accessedOutsideVariables.set(e, s), s;
  }
}
const Ei = {
  "!": (e) => !e,
...
class vi extends et {
    ...
    if (
      function (e, t) {
        for (const s of e) {
          ...
          if ("Identifier" === s.id.type) if (t.has(s.id.variable)) return !1;
          else {
            const e = [];
      ...
      s.isNoStatement || 59 === e.original.charCodeAt(this.end - 1) ||
        e.appendLeft(this.end, ";");
  ...
  renderDeclarationEnd(e, t, s, i, n, r, a, o) {
    ...
    e.remove(this.end - 1, this.end),
      ...
      null !== s
        ...
        : e.appendLeft(n, t),
      r.length > 0 && e.appendLeft(n, ` ${os(r, a)};`);
  }
  renderReplacedDeclarations(e, t, { isNoStatement: s }) {
    ...
    let n, r;
    r = Dt(e.original, this.start + this.kind.length);
    let a = r - 1;
      ...
      p = function (e, t, s) {
        ...
        if ("system" === t.format) {
          for (const { node: r } of e) {
            r.id instanceof is && r.init && 0 === s.length &&
              1 ===
                (null === (i = t.exportNamesByVariable.get(r.id.variable)) ||
                    void 0 === i
                  ? void 0
                  : i.length)
              ? (n = r.id.variable, s.push(n))
              : r.id.addExportedVariables(s, t.exportNamesByVariable);
          }
    ...
    for (
      const { node: s, start: d, separator: f, contentEnd: m, end: g } of i
    ) {
      if (s.included) {
        if (
          s.render(e, t),
            ...
            h = "",
            !s.id.included ||
            s.id instanceof is && xi(s.id.variable, t.exportNamesByVariable)
        ) {
          c && (u += ";"), l = !1;
        } else {
          if (p && p === s.id.variable) {
            const i = Rt(e.original, "=", s.id.end);
            hs(p, Dt(e.original, i + 1), null === f ? m : f, e, t);
          }
          l ? u += "," : (c && (u += ";"), o += `${this.kind} `, l = !0);
        }
        r === a + 1
          ? e.overwrite(a, r, u + o)
          : (e.overwrite(a, a + 1, u), e.appendLeft(r, o)),
          n = m,
          r = g,
          c = !0,
          a = f,
...
const bi = {
  ArrayExpression: class extends et {
    constructor() {
      super(...arguments), this.objectEntity = null;
    }
    deoptimizePath(e) {
    ...
    getObjectEntity() {
      if (null !== this.objectEntity) return this.objectEntity;
      const e = [{ key: "length", kind: "init", property: $e }];
      let t = !1;
      for (let s = 0; s < this.elements.length; s++) {
        const i = this.elements[s];
        i instanceof tt || t
          ? i && (t = !0, e.unshift({ key: M, kind: "init", property: i }))
          : i
          ? e.push({ key: String(s), kind: "init", property: i })
          : e.push({ key: String(s), kind: "init", property: Ce });
      }
      return this.objectEntity = new ht(e, St);
    }
  },
  ArrayPattern: class extends et {
    addExportedVariables(e, t) {
      for (const s of this.elements) null !== s && s.addExportedVariables(e, t);
    }
    declare(e) {
      const t = [];
      for (const s of this.elements) null !== s && t.push(...s.declare(e, j));
      return t;
    }
    deoptimizePath(e) {
      if (0 === e.length) {
    ...
    hasEffectsWhenAssignedAtPath(e, t) {
      ...
      for (const e of this.elements) {
        if (null !== e && e.hasEffectsWhenAssignedAtPath(D, t)) return !0;
      }
      return !1;
    }
    markDeclarationReached() {
  ...
  ArrowFunctionExpression: as,
  AssignmentExpression: us,
  AssignmentPattern: class extends et {
    constructor() {
      super(...arguments), this.deoptimized = !1;
    }
    addExportedVariables(e, t) {
    ...
    hasEffectsWhenAssignedAtPath(e, t) {
      return e.length > 0 || this.left.hasEffectsWhenAssignedAtPath(D, t);
    }
    markDeclarationReached() {
  ...
  AwaitExpression: class extends et {
    constructor() {
      super(...arguments), this.deoptimized = !1;
    }
    hasEffects() {
    ...
    include(e, t) {
      if (this.deoptimized || this.applyDeoptimizations(), !this.included) {
        ...
        if (!this.context.usesTopLevelAwait) {
          let e = this.parent;
          do {
            if (e instanceof ms || e instanceof as) break e;
          } while (e = e.parent);
    ...
    applyDeoptimizations() {
      this.deoptimized = !0,
        this.argument.deoptimizePath(L),
        this.context.requestTreeshakingPass();
    }
  },
  BinaryExpression: class extends et {
    deoptimizeCache() {}
    getLiteralValueAtPath(e, t, s) {
      if (e.length > 0) return W;
      const i = this.left.getLiteralValueAtPath(D, t, s);
      if (i === W) return W;
      const n = this.right.getLiteralValueAtPath(D, t, s);
      if (n === W) return W;
      const r = gs[this.operator];
      return r ? r(i, n) : W;
    }
    hasEffects(e) {
      return "+" === this.operator && this.parent instanceof zt &&
          "" === this.left.getLiteralValueAtPath(D, F, this) ||
        super.hasEffects(e);
    }
    hasEffectsWhenAccessedAtPath(e) {
      return e.length > 1;
    ...
    render(e, t, { renderedSurroundingElement: s } = q) {
      this.left.render(e, t, { renderedSurroundingElement: s }),
        this.right.render(e, t);
    }
  },
  BlockStatement: Wt,
  BreakStatement: class extends et {
    hasEffects(e) {
      if (this.label) {
  ...
  CallExpression: class extends et {
    constructor() {
      super(...arguments),
        this.deoptimized = !1,
    ...
    bind() {
      if (super.bind(), this.callee instanceof is) {
      ...
      this.callOptions = {
        args: this.arguments,
        thisParam: this.callee instanceof vs && !this.callee.variable
          ? this.callee.object : null,
        withNew: !1,
      };
    }
    deoptimizeCache() {
      if (this.returnExpression !== j) {
        this.returnExpression = j;
        for (const e of this.deoptimizableDependentExpressions) {
          e.deoptimizeCache();
        }
        for (const e of this.expressionsToBeDeoptimized) e.deoptimizePath(L);
      }
    }
    deoptimizePath(e) {
      if (
      ...
      t !== j && t.deoptimizePath(e);
    }
    deoptimizeThisOnEventAtPath(e, t, s, i) {
      const n = this.getReturnExpression(i);
      n === j ? s.deoptimizePath(L) : i.withTrackedEntityAtPath(t, n, () => {
        this.expressionsToBeDeoptimized.add(s),
          n.deoptimizeThisOnEventAtPath(e, t, s, i);
      }, void 0);
    }
    getLiteralValueAtPath(e, t, s) {
    ...
    getReturnExpressionWhenCalledAtPath(e, t, s, i) {
      ...
      return this.returnExpression === j ? j
      : s.withTrackedEntityAtPath(
        e,
        n,
    ...
    hasEffects(e) {
      try {
        ...
        return (!this.context.options.treeshake.annotations ||
          !this.annotations) &&
          (this.callee.hasEffects(e) ||
            this.callee.hasEffectsWhenCalledAtPath(D, this.callOptions, e));
      } finally {
        this.deoptimized || this.applyDeoptimizations();
      }
    }
    hasEffectsWhenAccessedAtPath(e, t) {
      return !t.accessed.trackEntityAtPathAndGetIfTracked(e, this) &&
        this.getReturnExpression().hasEffectsWhenAccessedAtPath(e, t);
    }
    hasEffectsWhenAssignedAtPath(e, t) {
      return !t.assigned.trackEntityAtPathAndGetIfTracked(e, this) &&
        this.getReturnExpression().hasEffectsWhenAssignedAtPath(e, t);
    }
    hasEffectsWhenCalledAtPath(e, t, s) {
      return !(t.withNew ? s.instantiated : s.called)
        .trackEntityAtPathAndGetIfTracked(e, t, this) &&
        this.getReturnExpression().hasEffectsWhenCalledAtPath(e, t, s);
    }
    include(e, t) {
      this.deoptimized || this.applyDeoptimizations(),
        t
          ? (super.include(e, t),
            "variables" === t && this.callee instanceof is &&
      ...
      if (
        ...
        if (this.arguments[this.arguments.length - 1].included) {
          ...
          if (s >= 0) {
            ...
            e.remove(Rt(e.original, ",", this.arguments[s].end), this.end - 1);
          } else {
            e.remove(Rt(e.original, "(", this.callee.end) + 1, this.end - 1);
          }
        }
      }
    }
    applyDeoptimizations() {
      ...
      e && this.callee.deoptimizeThisOnEventAtPath(2, D, e, F);
      for (const e of this.arguments) e.deoptimizePath(L);
      this.context.requestTreeshakingPass();
    }
    getReturnExpression(e = F) {
      return null === this.returnExpression
        ? (this.returnExpression = j,
          this.returnExpression = this.callee
            .getReturnExpressionWhenCalledAtPath(D, this.callOptions, e, this))
        : this.returnExpression;
    }
  },
  CatchClause: class extends et {
    createScope(e) {
    ...
    parseNode(e) {
      ...
      (this.param = new (this.context.getNodeConstructor(t.type))(
        ...
        this.param.declare("parameter", j)), super.parseNode(e);
    }
  },
  ChainExpression: class extends et {},
  ClassBody: class extends et {
    createScope(e) {
    ...
    parseNode(e) {
      ...
      for (const s of e.body) {
        t.push(
          new (this.context.getNodeConstructor(s.type))(
            s,
            this,
            s.static ? this.scope : this.scope.instanceScope,
          ),
        );
      }
      super.parseNode(e);
  ...
  ClassDeclaration: Cs,
  ClassExpression: class extends ws {
    render(e, t, { renderedSurroundingElement: s } = q) {
      super.render(e, t),
  ...
  ConditionalExpression: class extends et {
    constructor() {
      super(...arguments),
        this.expressionsToBeDeoptimized = [],
    ...
    deoptimizeCache() {
      if (null !== this.usedBranch) {
        const e = this.usedBranch === this.consequent
          ? this.alternate
          : this.consequent;
        this.usedBranch = null, e.deoptimizePath(L);
    ...
    deoptimizeThisOnEventAtPath(e, t, s, i) {
      this.consequent.deoptimizeThisOnEventAtPath(e, t, s, i),
        this.alternate.deoptimizeThisOnEventAtPath(e, t, s, i);
    }
    getLiteralValueAtPath(e, t, s) {
    ...
    getReturnExpressionWhenCalledAtPath(e, t, s, i) {
      ...
      return null === n
        ? new Is([
          this.consequent.getReturnExpressionWhenCalledAtPath(e, t, s, i),
          this.alternate.getReturnExpressionWhenCalledAtPath(e, t, s, i),
        ])
        : (this.expressionsToBeDeoptimized.push(i),
          n.getReturnExpressionWhenCalledAtPath(e, t, s, i));
    }
    ...
    hasEffectsWhenAccessedAtPath(e, t) {
      ...
      return null === s
        ...
        : s.hasEffectsWhenAccessedAtPath(e, t);
    }
    hasEffectsWhenAssignedAtPath(e, t) {
      const s = this.getUsedBranch();
      return null === s
        ...
        : s.hasEffectsWhenAssignedAtPath(e, t);
    }
    hasEffectsWhenCalledAtPath(e, t, s) {
      const i = this.getUsedBranch();
      return null === i
        ...
        : i.hasEffectsWhenCalledAtPath(e, t, s);
    }
    include(e, t) {
      this.included = !0;
      const s = this.getUsedBranch();
      t || this.test.shouldBeIncluded(e) || null === s
    ...
    render(
      ...
      if (this.test.included) {
        ...
        const o = Rt(e.original, ":", this.consequent.end),
          h = Dt(
            e.original,
            (this.consequent.included
              ? Rt(e.original, "?", this.test.end)
              : o) + 1,
          );
        i && Bt(e, h, a.start),
    ...
    getUsedBranch() {
      ...
      const e = this.test.getLiteralValueAtPath(D, F, this);
      return e === W ? null
      : this.usedBranch = e ? this.consequent : this.alternate;
    }
  },
  ContinueStatement: class extends et {
    hasEffects(e) {
      if (this.label) {
        if (!e.ignore.labels.has(this.label.name)) return !0;
        e.includedLabels.add(this.label.name), e.brokenFlow = 2;
  ...
  DoWhileStatement: class extends et {
    hasEffects(e) {
      if (this.test.hasEffects(e)) return !0;
      const { brokenFlow: t, ignore: { breaks: s, continues: i } } = e;
      return e.ignore.breaks = !0,
  ...
  EmptyStatement: class extends et {
    hasEffects() {
      return !1;
    }
  },
  ...
  ExportSpecifier: class extends et {},
  ExpressionStatement: zt,
  ForInStatement: class extends et {
    constructor() {
      super(...arguments), this.deoptimized = !1;
    }
    createScope(e) {
    ...
    include(e, t) {
      this.deoptimized || this.applyDeoptimizations(),
        this.included = !0,
        this.left.include(e, t || !0),
        this.right.include(e, t);
      const { brokenFlow: s } = e;
      this.body.includeAsSingleStatement(e, t), e.brokenFlow = s;
    }
    render(e, t) {
      this.left.render(e, t, Tt),
        this.right.render(e, t, Tt),
  ...
  ForOfStatement: class extends et {
    constructor() {
      super(...arguments), this.deoptimized = !1;
    }
    createScope(e) {
  ...
  ForStatement: class extends et {
    ...
    include(e, t) {
      this.included = !0,
        this.init && this.init.includeAsSingleStatement(e, t),
        this.test && this.test.include(e, t);
      const { brokenFlow: s } = e;
      this.update && this.update.include(e, t),
        this.body.includeAsSingleStatement(e, t),
        e.brokenFlow = s;
    }
    render(e, t) {
      this.init && this.init.render(e, t, Tt),
        this.test && this.test.render(e, t, Tt),
        this.update && this.update.render(e, t, Tt),
        this.body.render(e, t);
    }
  },
  FunctionDeclaration: _s,
  FunctionExpression: class extends ms {
    render(e, t, { renderedSurroundingElement: s } = q) {
      super.render(e, t),
        "ExpressionStatement" === s &&
        (e.appendRight(this.start, "("), e.prependLeft(this.end, ")"));
  ...
  Identifier: is,
  IfStatement: Ds,
  ImportDeclaration: Ls,
  ImportDefaultSpecifier: class extends et {},
  ImportExpression: class extends et {
    constructor() {
      super(...arguments),
    ...
    include(e, t) {
      ...
      (this.included = !0,
        ...
        this.scope.addAccessedDynamicImport(this)), this.source.include(e, t);
    }
    initialise() {
    ...
    render(e, t) {
      if (this.inlineNamespace) {
        const {
            snippets: { getDirectReturnFunction: s, getPropertyAccess: i },
          } = t,
          [n, r] = s([], {
            functionReturn: !0,
            lineBreakIndent: null,
        ...
        e.overwrite(
          this.start,
          this.end,
          `Promise.resolve().then(${n}${this.inlineNamespace.getName(i)}${r})`,
          { contentOnly: !0 },
        );
      } else {
        this.mechanism &&
    ...
    renderFinalResolution(e, t, s, { getDirectReturnFunction: i }) {
      if (e.overwrite(this.source.start, this.source.end, t), s) {
        ...
        e.prependLeft(this.end, `.then(${t}n.${s}${n})`);
      }
    }
    setExternalResolution(e, t, s, i, n, r) {
      const { format: a } = s;
      this.resolution = t;
      const o = [...ti[a] || []];
      let h;
      ({ helper: h, mechanism: this.mechanism } = this
        .getDynamicImportMechanismAndHelper(t, e, s, i, n)),
        h && o.push(h),
    ...
    getDynamicImportMechanismAndHelper(
      ...
      const u = c.hookFirstSync("renderDynamicImport", [{
        customResolution: "string" == typeof this.resolution
          ? this.resolution
          : null,
        format: n,
        moduleId: this.context.module.id,
        targetModuleId: this.resolution && "string" != typeof this.resolution
          ? this.resolution.id
          : null,
      }]);
      if (u) return { helper: null, mechanism: u };
      const d = !this.resolution || "string" == typeof this.resolution;
      switch (n) {
        case "cjs": {
          const s = ei(e, t, a);
          let i = "require(", n = ")";
          ...
          return i = `Promise.resolve().then(${o}${i}`,
            n += `${c})`,
            !r && d &&
            (i = l(["t"], `${i}t${n}`, {
              ...
              n = ")"),
            { helper: s, mechanism: { left: i, right: n } };
        }
        case "amd": {
          const i = s ? "c" : "resolve",
            n = s ? "e" : "reject",
            ...
            f = c ? `${u}${i}(/*#__PURE__*/${c}(m))${p}` : i,
            [m, g] = h([i, n], {
              functionReturn: !1,
              lineBreakIndent: null,
              name: null,
            });
          let y = `new Promise(${m}require([`, E = `],${o}${f},${o}${n})${g})`;
          return !r && d &&
            (y = l(["t"], `${y}t${E}`, {
              needsArrowReturnParens: !1,
              needsWrappedFunction: !0,
              ...
              E = ")"),
            { helper: c, mechanism: { left: y, right: E } };
        }
        case "system":
          return {
            helper: null,
  ...
  ImportNamespaceSpecifier: class extends et {},
  ImportSpecifier: class extends et {},
  LabeledStatement: class extends et {
    hasEffects(e) {
    ...
    render(e, t) {
      this.label.included
        ...
        : e.remove(
          this.start,
          Dt(e.original, Rt(e.original, ":", this.label.end) + 1),
        ), this.body.render(e, t);
    }
  },
  Literal: ys,
  LogicalExpression: class extends et {
    constructor() {
      super(...arguments),
        this.expressionsToBeDeoptimized = [],
        this.isBranchResolutionAnalysed = !1,
    ...
    deoptimizePath(e) {
      const t = this.getUsedBranch();
      null === t ? (this.left.deoptimizePath(e), this.right.deoptimizePath(e))
      : t.deoptimizePath(e);
    }
    deoptimizeThisOnEventAtPath(e, t, s, i) {
      this.left.deoptimizeThisOnEventAtPath(e, t, s, i),
        this.right.deoptimizeThisOnEventAtPath(e, t, s, i);
    }
    getLiteralValueAtPath(e, t, s) {
      const i = this.getUsedBranch();
      return null === i ? W
    ...
    getReturnExpressionWhenCalledAtPath(e, t, s, i) {
      ...
      return null === n
        ? new Is([
          this.left.getReturnExpressionWhenCalledAtPath(e, t, s, i),
          this.right.getReturnExpressionWhenCalledAtPath(e, t, s, i),
        ])
        : (this.expressionsToBeDeoptimized.push(i),
          n.getReturnExpressionWhenCalledAtPath(e, t, s, i));
    }
    hasEffects(e) {
      return !!this.left.hasEffects(e) ||
    ...
    include(e, t) {
      this.included = !0;
      const s = this.getUsedBranch();
      t || s === this.right && this.left.shouldBeIncluded(e) || null === s
        ? (this.left.include(e, t), this.right.include(e, t)) : s.include(e, t);
    }
    render(
      e,
      t,
      ...
      if (this.left.included && this.right.included) {
        ...
        const a = Rt(e.original, this.operator, this.left.end);
        if (this.right.included) {
          const t = Dt(e.original, a + 2);
          e.remove(this.start, t), i && Bt(e, t, this.right.start);
    ...
    getUsedBranch() {
      if (!this.isBranchResolutionAnalysed) {
        this.isBranchResolutionAnalysed = !0;
        const e = this.left.getLiteralValueAtPath(D, F, this);
        if (e === W) return null;
        this.usedBranch =
          "||" === this.operator && e || "&&" === this.operator && !e ||
  ...
  MemberExpression: vs,
  MetaProperty: class extends et {
    addAccessedGlobals(e, t) {
      const s = this.metaProperty,
        i =
          (s &&
              (s.startsWith(ii) || s.startsWith(si) ||
                s.startsWith("ROLLUP_CHUNK_URL_"))
            ? ri
            : ni)[e];
    ...
    getReferencedFileName(e) {
      ...
      return t && t.startsWith(ii) ? e.getFileName(t.substr(ii.length)) : null;
    }
    hasEffects() {
      return !1;
    }
    ...
    include() {
      if (!this.included && (this.included = !0, "import" === this.meta.name)) {
        ...
        const e = this.parent;
        this.metaProperty = e instanceof vs && "string" == typeof e.propertyKey
          ? e.propertyKey
          : null;
      }
    }
    renderFinalMechanism(e, t, s, i, n) {
      var r;
      const a = this.parent, o = this.metaProperty;
      if (
        o &&
        (o.startsWith(ii) || o.startsWith(si) ||
          o.startsWith("ROLLUP_CHUNK_URL_"))
      ) {
        let i, r = null, h = null, l = null;
        o.startsWith(ii) ? (r = o.substr(ii.length), i = n.getFileName(r))
        : o.startsWith(si)
          ? (fe(
            `Using the "${si}" prefix to reference files is deprecated. Use the "${ii}" prefix instead.`,
            !0,
            this.context.options,
          ),
            h = o.substr(si.length),
            i = n.getFileName(h))
          : (fe(
            `Using the "ROLLUP_CHUNK_URL_" prefix to reference files is deprecated. Use the "${ii}" prefix instead.`,
            !0,
            this.context.options,
          ),
            l = o.substr("ROLLUP_CHUNK_URL_".length),
            i = n.getFileName(l));
        const c = w(_(I(t), i));
        let u;
        return null !== h &&
      ...
      const h =
        n.hookFirstSync("resolveImportMeta", [o, {
          chunkId: t,
          format: s,
          moduleId: this.context.module.id,
        }]) || (null === (r = ui[s]) || void 0 === r
          ? void 0
          : r.call(ui, o, { chunkId: t, snippets: i }));
      "string" == typeof h &&
        (a instanceof vs
  ...
  MethodDefinition: Ps,
  NewExpression: class extends et {
    constructor() {
      super(...arguments), this.deoptimized = !1;
    }
    hasEffects(e) {
    ...
    initialise() {
      this.callOptions = { args: this.arguments, thisParam: null, withNew: !0 };
    }
    applyDeoptimizations() {
      this.deoptimized = !0;
      for (const e of this.arguments) e.deoptimizePath(L);
  ...
  ObjectExpression: class extends et {
    constructor() {
      super(...arguments), this.objectEntity = null;
    }
    deoptimizeCache() {
    ...
    getObjectEntity() {
      ...
      for (const s of this.properties) {
        if (s instanceof tt) {
          t.push({ key: R, kind: "init", property: s });
          continue;
        }
        let i;
        if (s.computed) {
          const e = s.key.getLiteralValueAtPath(D, F, this);
          if (e === W) {
            t.push({ key: R, kind: s.kind, property: s });
            continue;
          }
          i = String(e);
        } else if (
          i = s.key instanceof is ? s.key.name : String(s.key.value),
            "__proto__" === i && "init" === s.kind
        ) {
          e = s.value instanceof ys && null === s.value.value ? null : s.value;
          continue;
        }
        t.push({ key: i, kind: s.kind, property: s });
      }
      return this.objectEntity = new ht(t, e);
    }
  },
  ObjectPattern: cs,
  PrivateIdentifier: class extends et {},
  Program: di,
  Property: class extends As {
    constructor() {
      super(...arguments), this.deoptimized = !1, this.declarationInit = null;
    }
    declare(e, t) {
      return this.declarationInit = t, this.value.declare(e, j);
    }
    hasEffects(e) {
      this.deoptimized || this.applyDeoptimizations();
      const t = this.context.options.treeshake.propertyReadSideEffects;
      return "ObjectPattern" === this.parent.type && "always" === t ||
        this.key.hasEffects(e) || this.value.hasEffects(e);
    }
    markDeclarationReached() {
  ...
  PropertyDefinition: class extends et {
    deoptimizePath(e) {
      var t;
    ...
    getLiteralValueAtPath(e, t, s) {
      return this.value ? this.value.getLiteralValueAtPath(e, t, s) : W;
    }
    getReturnExpressionWhenCalledAtPath(e, t, s, i) {
      return this.value
        ? this.value.getReturnExpressionWhenCalledAtPath(e, t, s, i) : j;
    }
    hasEffects(e) {
      return this.key.hasEffects(e) ||
        this.static && null !== this.value && this.value.hasEffects(e);
    }
    hasEffectsWhenAccessedAtPath(e, t) {
  ...
  RestElement: rs,
  ReturnStatement: class extends et {
    hasEffects(e) {
      return !(e.ignore.returnYield &&
    ...
    initialise() {
      this.scope.addReturnExpression(this.argument || j);
    }
    render(e, t) {
      this.argument &&
  ...
  SequenceExpression: class extends et {
    deoptimizePath(e) {
    ...
    include(e, t) {
      ...
      for (const i of this.expressions) {
        (t || i === s && !(this.parent instanceof zt) ||
          i.shouldBeIncluded(e)) && i.include(e, t);
      }
    }
    render(
      e,
      t,
      { renderedParentType: s, isCalleeOfRenderedParent: i, preventASI: n } = q,
    ) {
      let r = 0, a = null;
      const o = this.expressions[this.expressions.length - 1];
      for (
        const { node: h, separator: l, start: c, end: u } of Vt(
          this.expressions,
          e,
          this.start,
          this.end,
        ...
        if (h.included) {
          if (r++, a = l, 1 === r && n && Bt(e, c, h.start), 1 === r) {
  ...
  StaticBlock: class extends et {
    ...
    render(e, t) {
      this.body.length ? Ot(this.body, e, this.start + 1, this.end - 1, t)
      : super.render(e, t);
    }
  },
  Super: class extends et {
    bind() {
  ...
  SwitchCase: pi,
  SwitchStatement: class extends et {
    createScope(e) {
      this.scope = new Ft(e);
    }
    hasEffects(e) {
      ...
      return null !== this.defaultCase && 1 !== i && (e.brokenFlow = i),
        e.ignore.breaks = s,
        !1;
    }
    include(e, t) {
      ...
      let i = 1 / 0,
        n = t ||
          null !== this.defaultCase && this.defaultCase < this.cases.length - 1;
    ...
    render(e, t) {
      this.discriminant.render(e, t),
        this.cases.length > 0 &&
        Ot(this.cases, e, this.cases[0].start, this.end - 1, t);
    }
  },
  TaggedTemplateExpression: class extends et {
    bind() {
    ...
    hasEffects(e) {
      return super.hasEffects(e) ||
        this.tag.hasEffectsWhenCalledAtPath(D, this.callOptions, e);
    }
    initialise() {
      this.callOptions = { args: ke, thisParam: null, withNew: !1 };
    }
    render(e, t) {
  ...
  TemplateElement: class extends et {
    bind() {}
    hasEffects() {
      return !1;
    }
  ...
  TemplateLiteral: fi,
  ThisExpression: class extends et {
    bind() {
      this.variable = this.scope.findVariable("this");
    }
    deoptimizePath(e) {
    ...
    initialise() {
      this.alias = this.scope.findLexicalBoundary() instanceof yi
  ...
  ThrowStatement: class extends et {
    hasEffects() {
      return !0;
    }
    include(e, t) {
  ...
  TryStatement: class extends et {
    ...
    include(e, t) {
      var s;
      const i = null === (s = this.context.options.treeshake) || void 0 === s
          ? void 0
          : s.tryCatchDeoptimization,
        { brokenFlow: n } = e;
      if (this.directlyIncluded && i) {
        if (this.includedLabelsAfterBlock) {
          for (const t of this.includedLabelsAfterBlock) {e.includedLabels.add(
              t,
            );}
        }
      } else {
  ...
  UnaryExpression: class extends et {
    constructor() {
      super(...arguments), this.deoptimized = !1;
    }
    getLiteralValueAtPath(e, t, s) {
      if (e.length > 0) return W;
      const i = this.argument.getLiteralValueAtPath(D, t, s);
      return i === W ? W : Ei[this.operator](i);
    }
    hasEffects(e) {
      return this.deoptimized || this.applyDeoptimizations(),
        !("typeof" === this.operator && this.argument instanceof is) &&
        (this.argument.hasEffects(e) ||
          "delete" === this.operator &&
            this.argument.hasEffectsWhenAssignedAtPath(D, e));
    }
    hasEffectsWhenAccessedAtPath(e) {
  ...
  UpdateExpression: class extends et {
    constructor() {
      super(...arguments), this.deoptimized = !1;
    }
    hasEffects(e) {
    ...
    render(e, t) {
      ...
      if (this.argument.render(e, t), "system" === i) {
        const i = this.argument.variable, r = s.get(i);
        if (r) {
          if (this.prefix) {
            1 === r.length
              ? hs(i, this.start, this.end, e, t)
              : ls(
                i,
                this.start,
                this.end,
  ...
  VariableDeclaration: vi,
  VariableDeclarator: class extends et {
    declareDeclarator(e) {
      this.id.declare(e, this.init || Ce);
    }
    deoptimizePath(e) {
    ...
    render(e, t) {
      const { exportNamesByVariable: s, snippets: { _: i } } = t,
        n = this.id.included;
      if (n) this.id.render(e, t);
      else {
        const t = Rt(e.original, "=", this.id.end);
        e.remove(this.start, Dt(e.original, t + 1));
      }
      this.init
        ? this.init.render(
          e,
          t,
          n ? q : { renderedSurroundingElement: "ExpressionStatement" },
        )
        : this.id instanceof is && xi(this.id.variable, s) &&
          e.appendLeft(this.end, `${i}=${i}void 0`);
    }
  },
  WhileStatement: class extends et {
    hasEffects(e) {
      if (this.test.hasEffects(e)) return !0;
      const { brokenFlow: t, ignore: { breaks: s, continues: i } } = e;
      return e.ignore.breaks = !0,
  ...
  YieldExpression: class extends et {
    constructor() {
      super(...arguments), this.deoptimized = !1;
    }
    hasEffects(e) {
    ...
    applyDeoptimizations() {
      ...
      e && (e.deoptimizePath(L), this.context.requestTreeshakingPass());
    }
  },
};
class Si extends G {
...
class Ai extends G {
  ...
  getMemberVariables() {
    ...
    for (
      const t of this.context.getExports().concat(this.context.getReexports())
    ) {
  ...
  renderBlock(e) {
    const {
      ...
      p = Object.entries(d).map(([e, t]) =>
        this.referencedEarly || t.isReassigned
          ? [null, `get ${e}${a}()${a}{${a}return ${t.getName(l)}${u}${a}}`]
          : [e, t.getName(l)]);
    r && p.unshift([null, `[Symbol.toStringTag]:${a}'Module'`]),
      p.unshift([null, `__proto__:${a}null`]);
    let f = h(p, { lineBreakIndent: { base: "", t: n } });
    if (this.mergedNamespaces.length > 0) {
      f = `/*#__PURE__*/_mergeNamespaces(${f}, [${
        this.mergedNamespaces.map((e) => e.getName(l)).join(`,${a}`)
      }])`;
    }
    i && (f = `/*#__PURE__*/Object.freeze(${f})`);
    return f = `${o} ${this.getName(l)}${a}=${a}${f};`,
      "system" === s && t.has(this) && (f += `${c}${os([this], e)};`),
      f;
  }
  renderFirst() {
...
class Pi extends G {
  ...
  getBaseVariable() {
    ...
    for (; e instanceof gi || e instanceof Pi;) {
      if (e instanceof gi) {
...
var Ci = "performance" in ("undefined" != typeof globalThis
      ? globalThis
...
function Ti(e, t = 3) {
  e = $i(e, t);
  const s = Ii.memoryUsage().heapUsed, i = Ci.now(), n = _i.get(e);
  void 0 === n
    ? _i.set(e, {
      memory: 0,
      startMemory: s,
    ...
    : (n.startMemory = s, n.startTime = i);
}
function Ri(e, t = 3) {
  e = $i(e, t);
  const s = _i.get(e);
  if (void 0 !== s) {
    const e = Ii.memoryUsage().heapUsed;
    s.memory += e - s.startMemory,
      s.time += Ci.now() - s.startTime,
      s.totalMemory = Math.max(s.totalMemory, e);
  }
}
function Mi() {
  const e = {};
  for (const [t, { memory: s, time: i, totalMemory: n }] of _i) {
    e[t] = [i, s, n];
  }
  return e;
}
let Di = Ni, Li = Ni;
const Oi = ["load", "resolveDynamicImport", "resolveId", "transform"];
function Vi(e, t) {
  for (const s of Oi) {
    if (s in e) {
      let i = `plugin ${t}`;
      ...
      e[s] = function (...e) {
        ...
        return Li(i, 4),
          t && "function" == typeof t.then
            ? (Di(`${i} (async)`, 4), t.then((e) => (Li(`${i} (async)`, 4), e)))
            : t;
      };
    }
  }
...
function Bi(e) {
  ...
  for (const e of t) {
    for (const i of [...e.dependencies, ...e.implicitlyLoadedBefore]) {
      i instanceof ve || i.isExecuted ||
        !i.info.moduleSideEffects && !e.implicitlyLoadedBefore.has(i) ||
        s.has(i.id) || (i.isExecuted = !0, s.add(i.id), t.push(i));
    }
  }
}
const Fi = { identifier: null, localName: "_missingExportShim" };
function zi(e, t, s, i, n = new Map()) {
  const r = n.get(t);
  if (r) {
    if (r.has(e)) {
      return i
        ...
        : se(
          (a = t,
            o = e.id,
            {
              code: ne.CIRCULAR_REEXPORT,
              id: o,
              message: `"${a}" cannot be exported from ${
                ee(o)
...
class Wi {
  constructor(e, t, s, i, n, r, a) {
    this.graph = e,
      ...
      this.exportShimVariable = new Si(this),
    ...
    const o = this,
      {
        dynamicImports: h,
        dynamicImporters: l,
        reexportDescriptions: c,
        implicitlyLoadedAfter: u,
        implicitlyLoadedBefore: d,
        sources: p,
        importers: f,
      } = this;
    this.info = {
      ...
      get dynamicallyImportedIdResolutions() {
        return h.map(
          ({ argument: e }) => "string" == typeof e && o.resolvedIds[e],
        ).filter(Boolean);
      },
      get dynamicallyImportedIds() {
        const e = [];
        for (const { id: t } of h) t && e.push(t);
        return e;
      },
      get dynamicImporters() {
        return l.sort();
      ...
      get hasDefaultExport() {
        return o.ast ? o.exports.has("default") || c.has("default") : null;
      },
      get hasModuleSideEffects() {
        return fe(
          "Accessing ModuleInfo.hasModuleSideEffects from plugins is deprecated. Please use ModuleInfo.moduleSideEffects instead.",
          ...
          o.info.moduleSideEffects;
      },
      id: t,
      get implicitlyLoadedAfterOneOf() {
        return Array.from(u, wi).sort();
      },
      get implicitlyLoadedBefore() {
        return Array.from(d, wi).sort();
      },
      get importedIdResolutions() {
        return Array.from(p, (e) => o.resolvedIds[e]).filter(Boolean);
      },
      get importedIds() {
      ...
      isExternal: !1,
      get isIncluded() {
        return e.phase !== ki.GENERATE ? null : o.isIncluded();
      },
      meta: { ...a },
      moduleSideEffects: n,
  ...
  basename() {
    const e = C(this.id), t = N(this.id);
    return xe(t ? e.slice(0, -t.length) : e);
  }
  bindReferences() {
    this.ast.bind();
  }
  error(e, t) {
    return this.addLocationToLogProps(e, t), se(e);
  }
  getAllExportNames() {
    ...
    for (const e of this.exportAllModules) {
      if (e instanceof ve) this.allExportNames.add(`*${e.id}`);
      else {
    ...
    return "string" == typeof this.info.syntheticNamedExports &&
  ...
  getDependenciesToBeIncluded() {
    ...
    const e = new Set(),
      t = new Set(),
      s = new Set(),
      i = new Set(this.imports);
    if (
      this.info.isEntry || this.includedDynamicImporters.length > 0 ||
      this.namespace.included || this.implicitlyLoadedAfter.size > 0
    ) {
    ...
    for (let e of i) {
      ...
      e instanceof Pi
        ? e = e.getBaseVariable()
        : e instanceof gi && (e = e.getOriginalVariable()), t.add(e.module);
    }
    if (
      this.options.treeshake && "no-treeshake" !== this.info.moduleSideEffects
    ) {
      this.addRelevantSideEffectDependencies(e, t, s);
  ...
  getExportNamesByVariable() {
    ...
    for (const t of this.getAllExportNames()) {
      ...
      if (
        s instanceof gi && (s = s.getOriginalVariable()),
          !s || !(s.included || s instanceof H)
      ) {
        continue;
      }
      const i = e.get(s);
  ...
  getReexports() {
    ...
    for (const t of this.exportAllModules) {
      if (t instanceof ve) e.add(`*${t.id}`);
      else {
        for (
          const s of [...t.getReexports(), ...t.getExports()]
        ) {
          "default" !== s && e.add(s);
        }
      }
  ...
  getSyntheticNamespace() {
    return null === this.syntheticNamespace &&
      ...
      this.syntheticNamespace
        ...
        : se(
          (e = this.id,
            ...
            {
              code: ne.SYNTHETIC_NAMED_EXPORTS_NEED_NAMESPACE_EXPORT,
              id: e,
              message: `Module "${
                ee(e)
              }" that is marked with 'syntheticNamedExports: ${
                JSON.stringify(t)
              }' needs ${
                "string" == typeof t && "default" !== t
                  ? `an explicit export named "${t}"`
                  : "a default export"
  ...
  getVariableForExportName(
    ...
    if (r) {
      const [e] = zi(r.module, r.localName, t, !1, n);
      return e
        ? (t && Ui(e, t, this), [e])
        : this.error(he(r.localName, this.id, r.module.id), r.start);
    }
    const a = this.exports.get(e);
    if (a) {
      if (a === Fi) return [this.exportShimVariable];
      const e = a.localName, s = this.traceVariable(e, t);
      return t &&
        (T(t.sideEffectDependenciesByVariable, s, () => new Set()).add(this),
          Ui(s, t, this)),
        [s];
    }
    if (i) return [null];
    if ("default" !== e) {
      const s = e in this.namespaceReexportsByName
        ? this.namespaceReexportsByName[e]
        : this.getVariableFromNamespaceReexports(e, t, n);
      if (this.namespaceReexportsByName[e] = s, s[0]) return s;
    }
    return this.info.syntheticNamedExports
      ? [
        T(this.syntheticExports, e, () =>
          new Pi(this.astContext, e, this.getSyntheticNamespace())),
      ]
  ...
  hasEffects() {
    return "no-treeshake" === this.info.moduleSideEffects ||
      this.ast.included && this.ast.hasEffects(Pe());
  }
  include() {
    const e = Ae();
    ...
    for (const e of this.getReexports()) {
      ...
      t &&
        (t.deoptimizePath(L),
          ...
          t instanceof H && (t.module.reexported = !0));
    }
    e &&
  ...
  includeAllInBundle() {
    this.ast.include(Ae(), !0), this.includeAllExports(!1);
  }
  isIncluded() {
  ...
  setSource(
    ...
    this.magicString = new b(t, {
      ...
      this.astContext = {
        ...
        getNodeConstructor: (e) => bi[e] || bi.UnknownNode,
      ...
      this.scope = new yi(this.graph.scope, this.astContext),
      this.namespace = new Ai(this.astContext),
      this.ast = new di(
        e,
  ...
  toJSON() {
    return {
      ...
      dependencies: Array.from(this.dependencies, wi),
      id: this.id,
      meta: this.info.meta,
  ...
  traceVariable(e, t) {
    ...
    if (s) return s;
    const i = this.importDescriptions.get(e);
    if (i) {
      const e = i.module;
      if (e instanceof Wi && "*" === i.name) return e.namespace;
      const [s] = e.getVariableForExportName(i.name, {
        importerForSideEffects: t || this,
      });
      return s || this.error(he(i.name, this.id, e.id), i.start);
    }
    return null;
  }
  tryParse() {
    try {
      ...
      return this.id.endsWith(".json")
        ? t += " (Note that you need @rollup/plugin-json to import JSON files)"
        : this.id.endsWith(".js") ||
          (t +=
  ...
  addDynamicImport(e) {
    let t = e.source;
    t instanceof fi
      ? 1 === t.quasis.length && t.quasis[0].value.cooked &&
        (t = t.quasis[0].value.cooked)
      : t instanceof ys && "string" == typeof t.value && (t = t.value),
  ...
  addExport(e) {
    if (e instanceof $s) {
    ...
    } else if (e.source instanceof ys) {
      const t = e.source.value;
      this.sources.add(t);
      ...
      for (const t of e.specifiers) {
        const e = t.local.name, s = t.exported.name;
        this.exports.set(s, { identifier: null, localName: e });
      }
    }
  }
  addImport(e) {
    ...
    if (i) {
      ...
      try {
        ({ column: n, line: r } = function (e, t) {
          ...
          for (; s.length > 0;) {
            const e = s.pop(), i = e.mappings[t.line - 1];
            let n = !1;
            if (void 0 !== i) {
              for (const s of i) {
                if (s[0] >= t.column) {
          ...
          return t;
        }(this.sourcemapChain, { column: n, line: r })), s = this.originalCode;
      } catch (e) {
        this.options.onwarn({
          ...
          message:
            `Error when using sourcemap for reporting an error: ${e.message}`,
          pos: t,
        });
      }
      ie(e, { column: n, line: r }, s, this.id);
    }
  }
      ...
      n = (r) => {
        for (const a of r) {
          i.has(a) || (i.add(a),
            t.has(a)
              ? e.add(a)
              : (a.info.moduleSideEffects || s.has(a)) &&
                (a instanceof ve || a.hasEffects()
                  ? e.add(a)
                  : n(a.dependencies)));
        }
      };
  ...
  getVariableFromNamespaceReexports(e, t, s) {
    ...
    if (n.size > 0) {
      const t = [...n], s = t[0][0];
      return 1 === t.length ? [s] : (this.options.onwarn(function (e, t, s) {
        return {
          code: ne.NAMESPACE_CONFLICT,
          message: `Conflicting namespaces: "${
            ee(t)
          }" re-exports "${e}" from one of the modules ${
            Z(s.map((e) => ee(e)))
          } (will be ignored)`,
          name: e,
          reexporter: t,
      ...
      }(e, this.id, t.map(([, e]) => e.id))),
        [null]);
    }
    if (r.size > 0) {
      const t = [...r], s = t[0];
      return t.length > 1 && this.options.onwarn(function (e, t, s, i) {
        return {
          code: ne.AMBIGUOUS_EXTERNAL_NAMESPACES,
          message: `Ambiguous external namespace resolution: "${
            ee(t)
          }" re-exports "${e}" from one of the external modules ${
            Z(i.map((e) => ee(e)))
          }, guessing "${ee(s)}".`,
          name: e,
          reexporter: t,
      ...
      }(e, this.id, s.module.id, t.map((e) => e.module.id))),
        [s, !0];
    }
    return i ? [i] : [null];
  }
  includeAndGetAdditionalMergedNamespaces() {
    ...
    for (const s of [this, ...this.exportAllModules]) {
      if (s instanceof ve) {
        ...
        t.include(), this.imports.add(t), e.add(t);
      } else if (s.info.syntheticNamedExports) {
        const e = s.getSyntheticNamespace();
        e.include(), this.imports.add(e), t.add(e);
      }
    }
    return [...t, ...e];
  }
  ...
  includeVariable(e) {
    if (!e.included) {
      ...
      const t = e.module;
      if (t instanceof Wi && (t.isExecuted || Bi(t), t !== this)) {
        const t = function (e, t) {
          const s = T(t.sideEffectDependenciesByVariable, e, () => new Set());
          let i = e;
          const n = new Set([i]);
          for (;;) {
            const e = i.module;
            if (
              i = i instanceof gi
                ? i.getDirectOriginalVariable()
                : i instanceof Pi
                ? i.syntheticNamespace
                : null, !i || n.has(i)
            ) {
              break;
            }
        ...
        for (const e of t) e.isExecuted || Bi(e);
      }
    }
  }
  ...
  shimMissingExport(e) {
    this.options.onwarn({
      ...
      exporter: ee(this.id),
      exportName: e,
      message: `Missing export "${e}" has been shimmed in module ${
        ee(this.id)
      }.`,
    }), this.exports.set(e, Fi);
  }
}
function Ui(e, t, s) {
  if (e.module instanceof Wi && e.module !== s) {
...
function Gi(e, t) {
  return e.autoId
    ? `${e.basePath ? e.basePath + "/" : ""}${ji(t)}`
    : e.id || "";
}
function Hi(e, t, s, i, n, r, a, o = "return ") {
  const {
    _: h,
    cnst: l,
    ...
    return `${p}${p}${o}${
      function (e, t, s, i, n) {
        ...
        for (
          ...
          if (c) return qi(o, c[0].imported, h, a, e, l, s, r, i, n);
        }
      }(e, t, i, a, d)
    };`;
  }
  ...
  for (
    ...
    if (g && s) {
      for (const t of g) {
        if ("*" !== t.reexported) {
          const s = qi(l, t.imported, u, o, e, f, i, n, a, d);
          if (m && (m += p), "*" !== t.imported && t.needsLiveBinding) {
            const [e, i] = c([], {
              functionReturn: !0,
              lineBreakIndent: null,
              name: null,
            ...
            m +=
              `Object.defineProperty(exports,${h}'${t.reexported}',${h}{${p}${r}enumerable:${h}true,${p}${r}get:${h}${e}${s}${i}${p}});`;
          } else m += `exports${d(t.reexported)}${h}=${h}${s};`;
        }
      }
    }
  }
  for (const { exported: t, local: s } of e) {
    const e = `exports${d(t)}`, i = s;
    e !== i && (m && (m += p), m += `${e}${h}=${h}${i};`);
  }
    ...
    if (i && s) {
      for (const t of i) {
        if ("*" === t.reexported) {
          m && (m += p);
          const s =
            `{${p}${r}if${h}(k${h}!==${h}'default'${h}&&${h}!exports.hasOwnProperty(k))${h}${
              Xi(e, t.needsLiveBinding, r, n)
            }${f}${p}}`;
          m += "var" === l && t.needsLiveBinding
            ? `Object.keys(${e}).forEach(${
              u(["k"], { isAsync: !1, name: null })
            }${s});`
            : `for${h}(${l} k in ${e})${h}${s}`;
        }
      }
...
function qi(e, t, s, i, n, r, a, o, h, l) {
  if ("default" === t) {
    if (!i) {
      const t = String(a(o)), s = Os[t] ? n : e;
      return Vs(t, h) ? `${s}${l("default")}` : s;
    }
    return s ? `${e}${l("default")}` : e;
  }
  return "*" === t ? (i ? !s : Bs[String(a(o))]) ? r : e : `${e}${l(t)}`;
}
...
const Xi = (e, t, s, { _: i, getDirectReturnFunction: n, n: r }) => {
  if (t) {
    const [t, a] = n([], {
      functionReturn: !0,
      lineBreakIndent: null,
    ...
    return `Object.defineProperty(exports,${i}k,${i}{${r}${s}${s}enumerable:${i}true,${r}${s}${s}get:${i}${t}${e}[k]${a}${r}${s}})`;
  }
  return `exports[k]${i}=${i}${e}[k]`;
};
function Yi(e, t, s, i, n, r, a, o) {
  const { _: h, cnst: l, n: c } = o,
    u = new Set(),
    d = [],
    p = (e, t, s) => {
      u.add(t), d.push(`${l} ${e}${h}=${h}/*#__PURE__*/${t}(${s});`);
    };
  for (
    const {
      defaultVariableName: s,
      imports: i,
      id: n,
      isChunk: r,
      name: a,
    ...
    if (r) {
      ...
      const e = String(t(n));
      let r = !1, o = !1;
      for (const { imported: t, reexported: n } of [...i || [], ...l || []]) {
        let i, l;
        "default" === t
          ? r || (r = !0, s !== h && (l = s, i = Os[e]))
          : "*" === t && "*" !== n && (o || (o = !0, i = Bs[e], l = h)),
          i && p(l, i, a);
      }
    }
  }
  return `${zs(u, r, a, o, s, i, n)}${
    d.length > 0 ? `${d.join(c)}${c}${c}` : ""
  }`;
}
function Qi(e) {
  return "." === e[0] ? ji(e) : e;
...
function Ji(e, t) {
  const s = t.map(({ id: e }) => e).filter((e) => e in Zi);
  s.length &&
    e({
      code: "MISSING_NODE_BUILTINS",
      message:
        `Creating a browser bundle that depends on Node.js built-in modules (${
          Z(s)
        }). You might need to include https://github.com/snowpackjs/rollup-plugin-polyfill-node`,
      modules: s,
    });
}
const en = (e, t) => e.split(".").map(t).join("");
function tn(e, t, s, i, { _: n, getPropertyAccess: r }) {
  const a = e.split(".");
  a[0] = ("function" == typeof s ? s(a[0]) : s[a[0]]) || a[0];
  const o = a.pop();
  let h = t,
    l =
      a.map((e) => (h += r(e), `${h}${n}=${n}${h}${n}||${n}{}`)).concat(
        `${h}${r(o)}`,
      ).join(`,${n}`) + `${n}=${n}${i}`;
...
const nn = ({ dependencies: e, exports: t }) => {
    const s = new Set(t.map((e) => e.exported));
    s.add("default");
    for (const { reexports: t } of e) {
      if (t) for (const e of t) "*" !== e.reexported && s.add(e.reexported);
    }
    return s;
  },
  rn = (e, t, { _: s, cnst: i, getObject: n, n: r }) =>
    e
      ? `${r}${t}${i} _starExcludes${s}=${s}${
        n([...e].map((e) => [e, "1"]), { lineBreakIndent: { base: t, t: t } })
      };`
      : "",
  an = (e, t, { _: s, n: i }) =>
    e.length ? `${i}${t}var ${e.join(`,${s}`)};` : "",
  on = (e, t, s) =>
    hn(
      e.filter((e) => e.hoisted).map(
        (e) => ({ name: e.exported, value: e.local }),
      ),
      t,
      s,
    );
function hn(e, t, { _: s, n: i }) {
  return 0 === e.length
    ? ""
    : 1 === e.length
    ? `exports('${e[0].name}',${s}${e[0].value});${i}${i}`
    : `exports({${i}` + e.map(({ name: e, value: i }) =>
      `${t}${e}:${s}${i}`).join(`,${i}`) +
      `${i}});${i}${i}`;
}
const ln = (e, t, s) =>
    hn(
      e.filter((e) => e.expression).map(
        (e) => ({ name: e.exported, value: e.local }),
      ),
      t,
      s,
  ...
  cn = (e, t, s) =>
    hn(
      e.filter((e) => "_missingExportShim" === e.local).map(
        (e) => ({ name: e.exported, value: "_missingExportShim" }),
      ),
      t,
      s,
    );
function un(e, t, s) {
  return e ? `${t}${en(e, s)}` : "null";
}
var dn = {
  amd: function (
    e,
    ...
    Ji(p, s);
    const b = s.map((e) => `'${Qi(e.id)}'`),
      S = s.map((e) => e.name),
      { n: A, getNonArrowFunctionIntro: P, _: k } = d;
    ...
    const w = Gi(f, r),
      C = (w
        ...
        : "") + (b.length ? `[${b.join(`,${k}`)}],${k}` : ""),
      I = v ? `${k}'use strict';` : "";
    e.prepend(`${o}${Yi(s, E, g, y, x, t, a, d)}`);
    const N = Hi(i, s, c, E, d, a, g);
    let _ = Ki(c && n, h && m, l && x, k, A);
    return _ && (_ = A + A + _),
      e.append(`${N}${_}${u}`),
      e.indent(a).prepend(
        `${f.define}(${C}(${P(S, { isAsync: !1, name: null })}{${I}${A}${A}`,
      ).append(`${A}${A}}));`);
  },
  cjs: function (
    e,
    ...
    const { _: x, n: v } = u, b = E ? `'use strict';${v}${v}` : "";
    let S = Ki(l && n, o && p, h && y, x, v);
    S && (S += v + v);
    const A = function (e, { _: t, cnst: s, n: i }, n) {
        let r = "", a = !1;
      ...
      P = Yi(s, g, f, m, y, t, r, u);
    e.prepend(`${b}${a}${S}${A}${P}`);
    const k = Hi(i, s, l, g, u, r, f, `module.exports${x}=${x}`);
    return e.append(`${k}${c}`);
  },
  es: function (
    e,
        ...
        for (const { id: i, reexports: n, imports: r, name: a } of e) {
          if (n || r) {
            if (r) {
              ...
              const a = [];
              for (const t of r) {
                "default" === t.imported ? e = t : "*" === t.imported
                  ? n = t
                  : a.push(t);
              }
            ...
            if (n) {
              ...
              h.length > 0 && s.push(`export${t}{${t}${
                h.map((e) =>
                  e.imported === e.reexported
                    ? e.imported
                    : `${e.imported} as ${e.reexported}`).join(`,${t}`)
              }${t}}${t}from${t}'${i}';`);
            }
    ...
    p.length > 0 && (i += p.join(d) + d + d),
      (i += zs(null, t, s, o, h, l, c)) && e.prepend(i);
    const f = function (e, { _: t, cnst: s }) {
      const i = [], n = [];
      for (const r of e) {
        r.expression && i.push(`${s} ${r.local}${t}=${t}${r.expression};`),
          n.push(
            r.exported === r.local
              ? r.local
              : `${r.local} as ${r.exported}`,
          );
      }
      n.length && i.push(`export${t}{${t}${n.join(`,${t}`)}${t}};`);
      return i;
    }(a, o);
    return f.length && e.append(d + d + f.join(d).trim()),
      n && e.append(n),
      e.trim();
  },
  iife: function (
    ...
    const {
        _: b,
        cnst: S,
        getNonArrowFunctionIntro: A,
        getPropertyAccess: P,
        n: k,
      } = l,
      w = E && -1 !== E.indexOf("."),
      C = !p && !w;
    if (E && C && (Ee(I = E) || ge.has(I) || ye.test(I))) {
      return se({
        code: "ILLEGAL_IDENTIFIER_AS_NAME",
        message:
          `Given name "${E}" is not a legal JS identifier. If you need this, you can try "output.extend: true".`,
      });
    }
    var I;
    Ji(c, s);
    const N = sn(s),
      _ = N.map((e) => e.globalName || "null"),
      $ = N.map((e) => e.name);
    n && !E &&
    c({
      ...
      o && n && (p
        ? (_.unshift(`this${en(E, P)}${b}=${b}this${en(E, P)}${b}||${b}{}`),
          $.unshift("exports"))
        : (_.unshift("{}"), $.unshift("exports")));
    const T = v ? `${r}'use strict';${k}` : "", R = Yi(s, y, m, f, x, t, r, l);
    e.prepend(`${a}${R}`);
    let M = `(${A($, { isAsync: !1, name: null })}{${k}${T}${k}`;
    n &&
      (!E || p && o ||
        (M = (C ? `${S} ${E}` : `this${en(E, P)}`) + `${b}=${b}${M}`),
        w && (M = function (e, t, s, { _: i, getPropertyAccess: n, s: r }, a) {
          const o = e.split(".");
          o[0] = ("function" == typeof s ? s(o[0]) : s[o[0]]) || o[0], o.pop();
          let h = t;
          return o.map((e) => (h += n(e), `${h}${i}=${i}${h}${i}||${i}{}${r}`))
            .join(a ? "," : "\n") + (a && o.length ? ";" : "\n");
        }(E, "this", g, l, u) + M));
    let D = `${k}${k}})(${_.join(`,${b}`)});`;
    n && !p && o && (D = `${k}${k}${r}return exports;${D}`);
    const L = Hi(i, s, o, y, l, r, m);
    let O = Ki(o && n, d, x, b, k);
    return O && (O = k + k + O),
      e.append(`${L}${O}${h}`),
      e.indent(r).prepend(M).append(D);
  },
  system: function (
    e,
    {
    ...
    const {
        _: g,
        getFunctionIntro: y,
        getNonArrowFunctionIntro: E,
        n: x,
        s: v,
      } = o,
      { importBindings: b, setters: S, starExcludes: A } = function (
        e,
        t,
        s,
        { _: i, cnst: n, getObject: r, getPropertyAccess: a, n: o },
      ) {
        const h = [], l = [];
        let c = null;
        for (const { imports: u, reexports: d } of e) {
          ...
          if (u) {
            for (const e of u) {
              h.push(e.local),
                "*" === e.imported
                  ? p.push(`${e.local}${i}=${i}module;`)
                  : p.push(`${e.local}${i}=${i}module${a(e.imported)};`);
            }
          }
          if (d) {
            const o = [];
            ...
            if (o.length > 1 || h) {
              ...
              h
                ? (c || (c = nn({ dependencies: e, exports: t })),
                  p.push(
                    `${n} setter${i}=${i}${a};`,
                    `for${i}(${n} name in module)${i}{`,
                    `${s}if${i}(!_starExcludes[name])${i}setter[name]${i}=${i}module[name];`,
                    "}",
                    "exports(setter);",
                  ))
                : p.push(`exports(${a});`);
          ...
          l.push(p.join(`${o}${s}${s}${s}`));
        }
        return { importBindings: h, setters: l, starExcludes: c };
      }(s, i, r, o),
      P = d ? `'${d}',${g}` : "",
      k = t.has("module") ? ["exports", "module"] : n ? ["exports"] : [];
    let w = `System.register(${P}[` + s.map(({ id: e }) =>
      `'${e}'`).join(`,${g}`) +
      `],${g}(${E(k, { isAsync: !1, name: null })}{${x}${r}${
        f ? "'use strict';" : ""
      }` + rn(A, r, o) + an(b, r, o) + `${x}${r}return${g}{${
      S.length
        ? `${x}${r}${r}setters:${g}[${
          S.map((e) =>
            e
              ? `${
                y(["module"], { isAsync: !1, name: null })
              }{${x}${r}${r}${r}${e}${x}${r}${r}}`
              : m
              ? "null"
              : `${y([], { isAsync: !1, name: null })}{}`).join(`,${g}`)
        }],`
        : ""
    }${x}`;
    w += `${r}${r}execute:${g}(${E([], { isAsync: l, name: null })}{${x}${x}`;
    const C = `${r}${r}})${x}${r}}${v}${x}}));`;
    return e.prepend(a + zs(null, t, r, o, c, u, p) + on(i, r, o)),
      e.append(`${h}${x}${x}` + ln(i, r, o) + cn(i, r, o)),
      e.indent(`${r}${r}${r}`).append(C).prepend(w);
  },
  umd: function (
    e,
    {
    ...
    Ji(u, s);
    const R = s.map((e) => `'${Qi(e.id)}'`),
      M = s.map((e) => `require('${e.id}')`),
      D = sn(s),
      L = D.map((e) => un(e.globalName, T, I)),
      O = D.map((e) => e.name);
    h && (n || S) &&
      (R.unshift("'exports'"),
        M.unshift("exports"),
        L.unshift(tn(x, T, b, (m ? `${un(x, T, I)}${P}||${P}` : "") + "{}", c)),
        O.unshift("exports"));
    const V = Gi(d, r),
      B = (V ? `'${V}',${P}` : "") +
        (R.length ? `[${R.join(`,${P}`)}],${P}` : ""),
      F = d.define,
      z = !h && n ? `module.exports${P}=${P}` : "",
      W = A ? `${P}'use strict';${N}` : "";
    let U;
    if (S) {
      const e = p ? "e" : "exports";
      let t;
      if (!h && n) {
        t = `${k} ${e}${P}=${P}${tn(x, T, b, `${$}(${L.join(`,${P}`)})`, c)};`;
      } else {
        t = `${k} ${e}${P}=${P}${L.shift()};${N}${a}${a}${$}(${
          [e].concat(L).join(`,${P}`)
        });`;
      }
      U = `(${
        w([], { isAsync: !1, name: null })
      }{${N}${a}${a}${k} current${P}=${P}${
        function (e, t, { _: s, getPropertyAccess: i }) {
          let n = t;
          return e.split(".").map((e) => n += i(e)).join(`${s}&&${s}`);
        }(x, T, c)
      };${N}${a}${a}${t}${N}${a}${a}${e}.noConflict${P}=${P}${
        w([], { isAsync: !1, name: null })
      }{${P}${
        un(x, T, I)
      }${P}=${P}current;${P}return ${e}${_}${P}};${N}${a}})()`;
    } else U = `${$}(${L.join(`,${P}`)})`, !h && n && (U = tn(x, T, b, U, c));
    const j = n || S && h || L.length > 0, G = [$];
    j && G.unshift(T);
    const H = j ? `this,${P}` : "",
      q = j
        ? `(${T}${P}=${P}typeof globalThis${P}!==${P}'undefined'${P}?${P}globalThis${P}:${P}${T}${P}||${P}self,${P}`
        : "",
      K = j ? ")" : "",
      X = j
        ? `${a}typeof exports${P}===${P}'object'${P}&&${P}typeof module${P}!==${P}'undefined'${P}?${P}${z}${$}(${
          M.join(`,${P}`)
        })${P}:${N}`
        : "",
      Y = `(${C(G, { isAsync: !1, name: null })}{${N}` + X +
        `${a}typeof ${F}${P}===${P}'function'${P}&&${P}${F}.amd${P}?${P}${F}(${B}${$})${P}:${N}` +
        `${a}${q}${U}${K};${N}` +
        `})(${H}(${C(O, { isAsync: !1, name: null })}{${W}${N}`,
      Q = N + N + "}));";
    e.prepend(`${o}${Yi(s, E, g, y, v, t, a, c)}`);
    const Z = Hi(i, s, h, E, c, a, g);
    let J = Ki(h && n, f, v, P, N);
    return J && (J = N + N + J),
      e.append(`${Z}${J}${l}`),
...
class fn {
  ...
  traceMappings() {
    ...
    for (const r of this.mappings) {
      ...
      for (const n of r) {
        ...
        if (o) {
          ...
          if (-1 === r) {
            r = e.length, e.push(o.source.filename), t[r] = o.source.content;
          } else if (null == t[r]) t[r] = o.source.content;
          else if (null != o.source.content && t[r] !== o.source.content) {
            return se({
              message:
                `Multiple conflicting contents for sourcemap source ${o.source.filename}`,
            });
          }
          const h = [n[0], r, o.line, o.column];
          if (o.name) {
            let e = i.get(o.name);
            void 0 === e && (e = s.length, s.push(o.name), i.set(o.name, e)),
              h[4] = e;
          }
          a.push(h);
        }
    ...
    return { mappings: n, names: s, sources: e, sourcesContent: t };
  }
  traceSegment(e, t, s) {
  ...
  return function (t, s) {
    return s.mappings
      ...
      : (e({
        ...
        message:
          `Sourcemap is likely to be incorrect: a plugin (${s.plugin}) was used to transform files, but didn't generate a sourcemap for the transformation. Consult the plugin documentation for help`,
        plugin: s.plugin,
        url:
          "https://rollupjs.org/guide/en/#warning-sourcemap-is-likely-to-be-incorrect",
      }),
        new fn({ mappings: [], names: [] }, [t]));
  };
}
...
yn.inherits = Sn,
  ...
  yn.toHex = function (e) {
    for (var t = "", s = 0; s < e.length; s++) t += kn(e[s].toString(16));
    return t;
  },
  yn.htonl = Pn,
  yn.toHex32 = function (e, t) {
    for (var s = "", i = 0; i < e.length; i++) {
      var n = e[i];
      "little" === t && (n = Pn(n)), s += wn(n.toString(16));
    }
    return s;
  },
  yn.zero2 = kn,
  yn.zero8 = wn,
  yn.join32 = function (e, t, s, i) {
    var n = s - t;
    bn(n % 4 == 0);
  ...
  yn.split32 = function (e, t) {
    for (
      var s = new Array(4 * e.length), i = 0, n = 0; i < e.length; i++, n += 4
    ) {
      var r = e[i];
      "big" === t
        ? (s[n] = r >>> 24,
  ...
  yn.rotr32 = function (e, t) {
    return e >>> t | e << 32 - t;
  },
  yn.rotl32 = function (e, t) {
    return e << t | e >>> 32 - t;
  },
  yn.sum32 = function (e, t) {
    return e + t >>> 0;
  },
  yn.sum32_3 = function (e, t, s) {
    return e + t + s >>> 0;
  },
  yn.sum32_4 = function (e, t, s, i) {
    return e + t + s + i >>> 0;
  },
  yn.sum32_5 = function (e, t, s, i, n) {
    return e + t + s + i + n >>> 0;
  },
  yn.sum64 = function (e, t, s, i) {
    var n = e[t], r = i + e[t + 1] >>> 0, a = (r < i ? 1 : 0) + s + n;
    e[t] = a >>> 0, e[t + 1] = r;
  },
  yn.sum64_hi = function (e, t, s, i) {
    return (t + i >>> 0 < t ? 1 : 0) + e + s >>> 0;
  },
  yn.sum64_lo = function (e, t, s, i) {
    return t + i >>> 0;
  },
  yn.sum64_4_hi = function (e, t, s, i, n, r, a, o) {
    var h = 0, l = t;
    return h += (l = l + i >>> 0) < t ? 1 : 0,
      h += (l = l + r >>> 0) < r ? 1 : 0,
      e + s + n + a + (h += (l = l + o >>> 0) < o ? 1 : 0) >>> 0;
  },
  yn.sum64_4_lo = function (e, t, s, i, n, r, a, o) {
    return t + i + r + o >>> 0;
  },
  yn.sum64_5_hi = function (e, t, s, i, n, r, a, o, h, l) {
    var c = 0, u = t;
  ...
  yn.sum64_5_lo = function (e, t, s, i, n, r, a, o, h, l) {
    return t + i + r + o + l >>> 0;
  },
  yn.rotr64_hi = function (e, t, s) {
    return (t << 32 - s | e >>> s) >>> 0;
  },
  yn.rotr64_lo = function (e, t, s) {
    return (e << 32 - s | t >>> s) >>> 0;
  },
  yn.shr64_hi = function (e, t, s) {
    return e >>> s;
  },
  yn.shr64_lo = function (e, t, s) {
    return (e << 32 - s | t >>> s) >>> 0;
  };
var Cn = {}, In = yn, Nn = En;
function _n() {
...
Cn.BlockHash = _n,
  _n.prototype.update = function (e, t) {
    if (
      e = In.toArray(e, t),
        this.pending
      ...
      this.pending = e.slice(e.length - s, e.length),
        ...
        e = In.join32(e, 0, e.length - s, this.endian);
  ...
  _n.prototype.digest = function (e) {
    return this.update(this._pad()), Nn(null === this.pending), this._digest(e);
  },
  _n.prototype._pad = function () {
...
$n.ft_1 = function (e, t, s, i) {
  ...
  $n.p32 = Dn,
  $n.s0_256 = function (e) {
    return Tn(e, 2) ^ Tn(e, 13) ^ Tn(e, 22);
  },
  $n.s1_256 = function (e) {
    return Tn(e, 6) ^ Tn(e, 11) ^ Tn(e, 25);
  },
  $n.g0_256 = function (e) {
    return Tn(e, 7) ^ Tn(e, 18) ^ e >>> 3;
  },
  $n.g1_256 = function (e) {
    return Tn(e, 17) ^ Tn(e, 19) ^ e >>> 10;
  };
var Ln = yn,
  On = Cn,
  Vn = $n,
...
Qn.blockSize = 512,
  ...
  Qn.prototype._update = function (e, t) {
    ...
    for (; i < s.length; i++) {
      s[i] = zn(Kn(s[i - 2]), s[i - 7], qn(s[i - 15]), s[i - 16]);
    }
    var n = this.h[0],
      r = this.h[1],
      a = this.h[2],
      ...
      c = this.h[6],
      u = this.h[7];
    for (Bn(this.k.length === s.length), i = 0; i < s.length; i++) {
      var d = Wn(u, Hn(h), Un(h, l, c), this.k[i], s[i]),
        p = Fn(Gn(n), jn(n, r, a));
      u = c, c = l, l = h, h = Fn(o, d), o = a, a = r, r = n, n = Fn(d, p);
    }
    this.h[0] = Fn(this.h[0], n),
      this.h[1] = Fn(this.h[1], r),
      this.h[2] = Fn(this.h[2], a),
      this.h[3] = Fn(this.h[3], o),
      this.h[4] = Fn(this.h[4], h),
      this.h[5] = Fn(this.h[5], l),
      this.h[6] = Fn(this.h[6], c),
      this.h[7] = Fn(this.h[7], u);
  },
  Qn.prototype._digest = function (e) {
    return "hex" === e ? Ln.toHex32(this.h, "big") : Ln.split32(this.h, "big");
  };
var Jn = Zn;
const er = () => Jn(),
  tr = { amd: nr, cjs: nr, es: ir, iife: nr, system: ir, umd: nr };
function sr(e, t, s, i, n, r, a, o, h, l, c, u, d) {
  ...
  !function (e, t, s) {
    for (const i of t) {
      for (const t of i.scope.variables.values()) {
        t.included &&
          !(t.renderBaseName ||
            t instanceof gi && t.getOriginalVariable() !== t) &&
          t.setRenderNames(null, kt(t.name, e));
      }
      if (s.has(i)) {
        const t = i.namespace;
        t.setRenderNames(null, kt(t.name, e));
  ...
  }(i, p, d), tr[n](i, s, t, r, a, o, h, l);
  for (const e of p) e.scope.deconflict(n, c, u);
}
function ir(e, t, s, i, n, r, a, o) {
  for (const t of s.dependencies) {
    (n || t instanceof ve) && (t.variableName = kt(t.suggestedVariableName, e));
  }
  for (const s of t) {
    const t = s.module, i = s.name;
    s.isNamespace && (n || t instanceof ve)
      ? s.setRenderNames(null, (t instanceof ve ? t : a.get(t)).variableName)
      : t instanceof ve && "default" === i
      ? s.setRenderNames(
        null,
        kt(
      ...
      : s.setRenderNames(null, kt(i, e));
  }
  for (const t of o) t.setRenderNames(null, kt(t.name, e));
}
function nr(
  e,
  t,
  ...
  for (const t of n) t.variableName = kt(t.suggestedVariableName, e);
  for (const t of i) {
    t.namespaceVariableName = kt(`${t.suggestedVariableName}__namespace`, e);
  }
  for (const t of s) {
    i.has(t) && Fs(String(r(t.id)), o)
      ? t.defaultVariableName = t.namespaceVariableName
      : t.defaultVariableName = kt(`${t.suggestedVariableName}__default`, e);
  }
  for (const e of t) {
    const t = e.module;
    if (t instanceof ve) {
      ...
      if ("default" === s) {
        const s = String(r(t.id)),
          i = Os[s] ? t.defaultVariableName : t.variableName;
        Vs(s, o) ? e.setRenderNames(i, "default") : e.setRenderNames(null, i);
      } else {
        "*" === s
          ? e.setRenderNames(
            null,
            Bs[String(r(t.id))] ? t.namespaceVariableName : t.variableName,
          )
...
const rr = /[\\'\r\n\u2028\u2029]/, ar = /(['\r\n\u2028\u2029])/g, or = /\\/g;
function hr(e) {
  return e.match(rr) ? e.replace(or, "\\\\").replace(ar, "\\$1") : e;
}
function lr(e, { exports: t, name: s, format: i }, n, r, a) {
  const o = e.getExportNames();
  if ("default" === t) {
    if (1 !== o.length || "default" !== o[0]) return se(ae("default", o, r));
  } else if ("none" === t && o.length) return se(ae("none", o, r));
  return "auto" === t &&
    (0 === o.length
      ? t = "none"
      : 1 === o.length && "default" === o[0]
      ? ("cjs" === i && n.has("exports") && a(function (e) {
        const t = ee(e);
        return {
          code: ne.PREFER_NAMED_EXPORTS,
          id: e,
          message:
            `Entry module "${t}" is implicitly using "default" export mode, which means for CommonJS output that its default export is assigned to "module.exports". For many tools, such CommonJS output will not be interchangeable with the original ES module. If this is intended, explicitly set "output.exports" to either "auto" or "default", otherwise you might want to consider changing the signature of "${t}" to use named exports only.`,
          url: "https://rollupjs.org/guide/en/#outputexports",
        };
      }(r)),
        t = "default")
      : ("es" !== i && "system" !== i && -1 !== o.indexOf("default") &&
        a(function (e, t) {
          return {
            code: ne.MIXED_EXPORTS,
            id: e,
...
function ur(e, t, s, i, n) {
  ...
  for (const e of r) {
    ...
    const r = n.get(e);
    r === i ? s.has(e) || (s.add(e), ur(e, t, s, i, n)) : t.push(r);
  }
}
function dr(e) {
  if (!e) return null;
  ...
  const s = "string" == typeof e.mappings
    ? function (e) {
      for (
...
function pr(e, t, s) {
  return te(e)
    ? se(
      de(
        `Invalid pattern "${e}" for "${t}", patterns can be neither absolute nor relative paths.`,
      ),
    )
    : e.replace(/\[(\w+)\]/g, (e, i) => {
      if (!s.hasOwnProperty(i)) {
        return se(de(`"[${i}]" is not a valid placeholder in "${t}" pattern.`));
      }
      const n = s[i]();
      return te(n)
        ? se(
  ...
  return n ||
    (s
      ? (i({
        ...
        message:
          `No name was provided for external module '${e.id}' in output.globals – guessing '${e.variableName}'`,
        source: e.id,
      }),
        e.variableName)
      : void 0);
...
class yr {
      ...
      for (const e of t.includedDynamicImporters) {
        c.has(e) ||
          (this.dynamicEntryModules.push(t),
            t.info.syntheticNamedExports && !s.preserveModules &&
            (h.add(t), this.exports.add(t.namespace)));
      }
      t.implicitlyLoadedAfter.size > 0 && this.implicitEntryModules.push(t);
    }
    this.suggestedVariableName = xe(this.generateVariableName());
  }
  static generateFacade(e, t, s, i, n, r, a, o, h, l) {
    const c = new yr([], e, t, s, i, n, r, a, o, null);
    c.assignFacadeName(l, h), a.has(h) || a.set(h, c);
    for (const e of h.getDependenciesToBeIncluded()) {
      c.dependencies.add(e instanceof Wi ? r.get(e) : e);
    }
    return !c.dependencies.has(r.get(h)) && h.info.moduleSideEffects &&
      h.hasEffects() && c.dependencies.add(r.get(h)),
  ...
  canModuleBeFacade(e, t) {
    ...
    for (const t of this.exports) {
      if (!s.has(t)) {
        return 0 === s.size && e.isUserDefinedEntryPoint &&
          "strict" === e.preserveSignature &&
          this.unsetOptions.has("preserveEntrySignatures") &&
          this.inputOptions.onwarn({
            code: "EMPTY_FACADE",
            id: e.id,
            message: `To preserve the export signature of the entry module "${
              ee(e.id)
        ...
        for (const n of e) {
          ...
          if (t.has(e)) {
            do {
              e = Pt(++i),
                49 === e.charCodeAt(0) &&
                (i += 9 * 64 ** (e.length - 1), e = Pt(i));
            } while (ge.has(e) || t.has(e));
          }
          t.set(e, n), s.set(n, [e]);
        }
  ...
  generateFacades() {
    ...
    for (const e of s) {
      if (e.preserveSignature) {
        for (const t of e.getExportNamesByVariable().keys()) i.add(t);
      }
    }
    for (const e of s) {
      const s = Array.from(
        new Set(
          e.chunkNames.filter(({ isUserDefined: e }) => e).map(({ name: e }) =>
            e),
        ),
        (e) => ({ name: e }),
      );
      if (
        ...
        const t = "strict" === e.preserveSignature ||
          "exports-only" === e.preserveSignature &&
            0 !== e.getExportNamesByVariable().size;
        (!t || this.outputOptions.preserveModules ||
      ...
      t.info.syntheticNamedExports ||
        (!this.facadeModule && this.canModuleBeFacade(t, i)
          ? (this.facadeModule = t,
            ...
            this.strictFacade = !0,
            this.dynamicName = Er(t))
          : this.facadeModule === t && !this.strictFacade &&
              this.canModuleBeFacade(t, i)
          ? this.strictFacade = !0
  ...
  generateId(e, t, s, i) {
    ...
    return fr(
      pr("function" == typeof n ? n(this.getChunkInfo()) : n, r, {
        format: () => t.format,
        hash: () =>
          i
            ? this.computeContentHashWithDependencies(e, t, s)
            : "[hash]",
  ...
  generateIdPreserveModules(e, t, s, i) {
    const [{ id: n }] = this.orderedModules,
      r = this.outputOptions.sanitizeFileName(n.split(xr, 1)[0]);
    let a;
    const o = i.has("entryFileNames")
    ...
    if (P(r)) {
      const s = I(r),
        i = N(r),
        n = `${s}/${
          pr(h, "output.entryFileNames", {
            assetExtname: () => mr.includes(i) ? "" : i,
            ext: () => i.substr(1),
            extname: () => i,
            format: () => t.format,
            name: () => this.getChunkName(),
  ...
  getChunkInfoWithFileNames() {
    return Object.assign(this.getChunkInfo(), {
      code: void 0,
      dynamicImports: Array.from(this.dynamicDependencies, wi),
      fileName: this.id,
      implicitlyLoadedBefore: Array.from(this.implicitlyLoadedBefore, wi),
      importedBindings: this.getImportedBindingsPerDependency(),
      imports: Array.from(this.dependencies, wi),
      map: void 0,
  ...
  getExportNames() {
    ...
    return null !== (e = this.sortedExportNames) && void 0 !== e
      ? e
      : this.sortedExportNames = Array.from(this.exportsByName.keys()).sort();
  }
  getRenderedHash() {
    if (this.renderedHash) return this.renderedHash;
    const e = er(),
      t = this.pluginDriver.hookReduceValueSync("augmentChunkHash", "", [
        this.getChunkInfo(),
      ], (e, t) => (t && (e += t), e));
    return e.update(t),
      e.update(this.renderedSource.toString()),
      e.update(
        this.getExportNames().map((e) => {
          const t = this.exportsByName.get(e);
          return `${ee(t.module.id).replace(/\\/g, "/")}:${t.name}:${e}`;
        }).join(","),
      ),
      this.renderedHash = e.digest("hex");
  }
  getVariableExportName(e) {
    return this.outputOptions.preserveModules && e instanceof Ai
      ? "*"
  ...
  preRender(e, t, s) {
    ...
    if (
      e.hoistTransitiveImports && !this.outputOptions.preserveModules &&
      null !== this.facadeModule
    ) {
      for (const e of this.dependencies) {
        e instanceof yr && this.inlineChunkDependencies(e);
      }
    }
    ...
    for (const t of this.orderedModules) {
      ...
      if (t.isIncluded() || this.includedNamespaces.has(t)) {
        const i = t.render(o).trim();
        s = i.length(),
          s &&
          (e.compact && -1 !== i.lastLine().indexOf("//") && i.append("\n"),
            this.renderedModuleSources.set(t, i),
            a.addSource(i),
            this.usedModules.push(t));
        const n = t.namespace;
        if (
          this.includedNamespaces.has(t) && !this.outputOptions.preserveModules
        ) {
          const e = n.renderBlock(o);
          n.renderFirst() ? h += r + e : a.addSource(new b(e));
        }
      }
      const { renderedExports: i, removedExports: n } = t.getRenderedExports(),
        { renderedModuleSources: c } = this;
      l[t.id] = {
        get code() {
          var e, s;
          return null !== (s = null === (e = c.get(t)) || void 0 === e
                  ? void 0
                  : e.toString()) && void 0 !== s
            ? s
            : null;
    ...
    if (
      h && a.prepend(h + r + r),
        ...
        a.prepend(`${r}${s.cnst} _missingExportShim${i}=${i}void 0;${r}${r}`),
        e.compact ? this.renderedSource = a : this.renderedSource = a.trim(),
        this.renderedHash = void 0,
        this.isEmpty && 0 === this.getExportNames().length &&
    ...
    this.setExternalRenderPaths(e, t),
      ...
      this.renderedExports = "none" === this.exportMode
        ? []
        : this.getChunkExportDeclarations(e.format, n);
  }
  async render(e, t, s, i) {
    Di("render format", 2);
    const n = e.format, r = dn[n];
    e.dynamicImportFunction && "es" !== n &&
      this.inputOptions.onwarn(
        oe(
    ...
    for (const e of this.dependencies) {
      ...
      if (e instanceof ve) {
        ...
        t.id = hr(e.renormalizeRenderPath ? this.getRelativePath(s, !1) : s);
      } else {
        t.namedExportsMode = "default" !== e.exportMode,
          t.id = hr(this.getRelativePath(e.id, !1));
      }
    }
    this.finaliseDynamicImports(e, i), this.finaliseImportMetas(n, i);
    const a = 0 !== this.renderedExports.length ||
    ...
    for (const e of this.orderedModules) {
      ...
      if (t) for (const e of t) h.add(e);
    }
    if (o && "es" !== n && "system" !== n) {
      return se({
        code: "INVALID_TLA_FORMAT",
        message:
          `Module format ${n} does not support top-level await. Use the "es" or "system" output formats rather.`,
      });
    }
    if (!this.id) throw new Error("Internal Error: expecting chunk id");
    const c = r(this.renderedSource, {
      accessedGlobals: h,
    ...
    let f = await function (
      ...
      return s.hookReduceArg0("renderChunk", [e, i, t], (e, t, s) => {
        if (null == t) return e;
        if (
          "string" == typeof t && (t = { code: t, map: void 0 }), null !== t.map
        ) {
          const e = dr(t.map);
    ...
    if (e.sourcemap) {
      ...
      d = function (e, t, s, i, n, r) {
        const a = mn(r),
          o = s.filter((e) => !e.excludeFromSourcemap).map(
            (e) =>
              gn(
                e.id,
                e.originalCode,
          ...
          h = new fn(t, o),
          c = i.reduce(a, h);
        let { sources: u, sourcesContent: d, names: p, mappings: f } = c
          .traceMappings();
        if (e) {
          const t = I(e);
        ...
        d.sources = d.sources.map((s) => {
          ...
          if (i) {
            ...
            return "string" != typeof e &&
              se(de("sourcemapPathTransform function must return a string.")),
              e;
          }
          return s;
        }).map(w),
  ...
  assignFacadeName({ fileName: e, name: t }, s) {
    e
      ? this.fileName = e
      : this.name = this.outputOptions.sanitizeFileName(t || Er(s));
  }
        ...
        if (h = t.alternativeReexportModules.get(e), h) {
          ...
          this.inputOptions.onwarn(
            (i = s.getExportNamesByVariable().get(e)[0],
              ...
              a = t.id,
              {
                code: ne.CYCLIC_CROSS_CHUNK_REEXPORT,
                exporter: n,
                importer: a,
                message: `Export "${i}" of module ${
                  ee(n)
  ...
  computeContentHashWithDependencies(e, t, s) {
    const i = er();
    i.update([e.intro, e.outro, e.banner, e.footer].join(":")),
      i.update(t.format);
    ...
    for (const r of n) {
      if (
        r instanceof ve
          ...
          : (i.update(r.getRenderedHash()),
            i.update(r.generateId(e, t, s, !1))), !(r instanceof ve)
      ) {
  ...
  ensureReexportsAreAvailableForModule(e) {
    ...
    for (const s of t.keys()) {
      const t = s instanceof Pi, i = t ? s.getBaseVariable() : s;
  ...
  finaliseDynamicImports(e, t) {
    const s = "amd" === e.format;
    for (const [e, i] of this.renderedModuleSources) {
      for (const { node: n, resolution: r } of e.dynamicImports) {
        const e = this.chunkByModule.get(r),
          a = this.facadeChunkByModule.get(r);
        if (!r || !n.included || e === this) {
          continue;
        }
        const o = r instanceof Wi
          ? `'${hr(this.getRelativePath((a || e).id, s))}'`
          : r instanceof ve
          ? `'${
            hr(
              r.renormalizeRenderPath
                ? this.getRelativePath(r.renderPath, s)
                : r.renderPath,
            )
          }'`
          : r;
        n.renderFinalResolution(
          i,
          o,
          r instanceof Wi && !(null == a ? void 0 : a.strictFacade) &&
  ...
  finaliseImportMetas(e, t) {
    for (const [s, i] of this.renderedModuleSources) {
      for (const n of s.importMetas) {
        n.renderFinalMechanism(i, this.id, e, t, this.pluginDriver);
      }
    }
  }
  generateVariableName() {
    if (this.manualChunkAlias) return this.manualChunkAlias;
    const e = this.entryModules[0] || this.implicitEntryModules[0] ||
      this.dynamicEntryModules[0] ||
      this.orderedModules[this.orderedModules.length - 1];
    return e ? Er(e) : "chunk";
  }
  getChunkDependencyDeclarations(e, t) {
    const s = this.getImportSpecifiers(t),
      i = this.getReexportSpecifiers(),
      n = new Map();
    for (const t of this.dependencies) {
      const r = s.get(t) || null,
        a = i.get(t) || null,
        o = t instanceof ve || "default" !== t.exportMode;
      n.set(t, {
        defaultVariableName: t.defaultVariableName,
        globalName: t instanceof ve &&
          ("umd" === e.format || "iife" === e.format) &&
          gr(t, e.globals, null !== (r || a), this.inputOptions.onwarn),
        id: void 0,
        imports: r,
        isChunk: t instanceof yr,
        name: t.variableName,
        namedExportsMode: o,
  ...
  getChunkExportDeclarations(e, t) {
    ...
    for (const i of this.getExportNames()) {
      if ("*" === i[0]) continue;
      const n = this.exportsByName.get(i);
      if (!(n instanceof Pi)) {
        const e = n.module;
        if (e && this.chunkByModule.get(e) !== this) continue;
      }
      let r = null, a = !1, o = n.getName(t);
      if (n instanceof At) {
        for (const e of n.declarations) {
          if (
            e.parent instanceof _s ||
            e instanceof $s && e.declaration instanceof _s
          ) {
            a = !0;
            break;
          }
        }
      } else n instanceof Pi && (r = o, "es" === e && (o = n.renderName));
      s.push({ exported: i, expression: r, hoisted: a, local: o });
    }
    return s;
  }
  getDependenciesToBeDeconflicted(e, t, s) {
    const i = new Set(), n = new Set(), r = new Set();
    for (const t of [...this.exportNamesByVariable.keys(), ...this.imports]) {
      if (e || t.isNamespace) {
        ...
        if (a instanceof ve) {
          i.add(a),
            e && ("default" === t.name
              ? Os[String(s(a.id))] && n.add(a)
              : "*" === t.name && Bs[String(s(a.id))] && r.add(a));
        } else {
  ...
  getFallbackChunkName() {
    return this.manualChunkAlias
      ...
      : this.fileName
      ? J(this.fileName)
      : J(this.orderedModules[this.orderedModules.length - 1].id);
  }
  getImportSpecifiers(e) {
    const { interop: t } = this.outputOptions, s = new Map();
    for (const i of this.imports) {
      ...
      if (n instanceof ve) {
        if (
          ...
          return se(ce(n.id, a, !1));
        }
      } else r = this.chunkByModule.get(n), a = r.getVariableExportName(i);
      T(s, r, () => []).push({ imported: a, local: i.getName(e) });
    }
    return s;
  }
  ...
  getReexportSpecifiers() {
    ...
    for (let i of this.getExportNames()) {
      ...
      if ("*" === i[0]) {
        const s = i.substr(1);
        "defaultOnly" === t(s) && this.inputOptions.onwarn(ue(s)),
          a = e,
        ...
        if (o instanceof Wi) {
          ...
          if (
            ...
            return se(ce(o.id, r, !0));
          }
          a = e && ("default" !== r || Vs(String(t(o.id)), !0));
        }
      }
      T(s, n, () => []).push({
        imported: r,
  ...
  getRelativePath(e, t) {
    let s = w(_(I(this.id), e));
    return t && s.endsWith(".js") && (s = s.slice(0, -3)),
      ".." === s
        ? "../../" + C(e)
        : "" === s
        ? "../" + C(e)
    ...
    for (const t of e.dependencies) {
      this.dependencies.has(t) ||
        (this.dependencies.add(t),
          t instanceof yr && this.inlineChunkDependencies(t));
    }
  }
  prepareModulesForRendering(e) {
    ...
    for (const i of this.orderedModules) {
      for (const { node: n, resolution: r } of i.dynamicImports) {
        if (n.included) {
          if (r instanceof Wi) {
            const i = this.chunkByModule.get(r);
            i === this
              ? n.setInternalResolution(r.namespace)
              : n.setExternalResolution(
                (null === (t = this.facadeChunkByModule.get(r)) || void 0 === t
                  ? void 0
                  : t.exportMode) || i.exportMode,
                r,
                this.outputOptions,
                e,
                this.pluginDriver,
      ...
      for (const e of i.importMetas) {
        e.addAccessedGlobals(this.outputOptions.format, s);
      }
      this.includedNamespaces.has(i) && !this.outputOptions.preserveModules &&
        i.namespace.prepare(s);
    }
  }
  setExternalRenderPaths(e, t) {
    for (const s of [...this.dependencies, ...this.dynamicDependencies]) {
      s instanceof ve && s.setRenderPath(e, t);
    }
  }
  setIdentifierRenderResolutions(
    { format: e, interop: t, namespaceToStringTag: s },
  ) {
    const i = new Set();
    for (const t of this.getExportNames()) {
      const s = this.exportsByName.get(t);
      "es" !== e && "system" !== e && s.isReassigned && !s.isId
  ...
  setUpChunkImportsAndExportsForModule(e) {
    ...
    for (let s of t) {
      s instanceof gi && (s = s.getOriginalVariable()),
        s instanceof Pi && (s = s.getBaseVariable());
      const t = this.chunkByModule.get(s.module);
      t !== this &&
        (this.imports.add(s),
          !(s instanceof Ai && this.outputOptions.preserveModules) &&
          s.module instanceof Wi &&
          (t.exports.add(s), this.checkCircularDependencyImport(s, e)));
    }
    ...
    for (const { node: t, resolution: s } of e.dynamicImports) {
      t.included && s instanceof Wi && this.chunkByModule.get(s) === this &&
        !this.includedNamespaces.has(s) &&
        (this.includedNamespaces.add(s),
...
function Er(e) {
  ...
  return null !==
        (n =
          null !==
              (s = null === (t = e.chunkNames.find(({ isUserDefined: e }) =>
                      e)) || void 0 === t
                ? void 0
                : t.name) && void 0 !== s
            ? s
            : null === (i = e.chunkNames[0]) || void 0 === i
            ? void 0
            : i.name) && void 0 !== n
    ? n
    : J(e.id);
...
function vr(e, t, s) {
  e in t && s(function (e) {
    return {
      code: ne.FILE_NAME_CONFLICT,
      message:
        `The emitted file "${e}" overwrites a previously emitted file of the same name.`,
    };
  }(e)), t[e] = br;
}
const br = { type: "placeholder" };
function Sr(e, t, s) {
  if (!("string" == typeof e || e instanceof Uint8Array)) {
    const e = t.fileName || t.name || s;
    return se(
      de(`Could not set source for ${
        "string" == typeof e
          ? `asset "${e}"`
          : "unnamed asset"
...
function Ar(e, t) {
  return "string" != typeof e.fileName
    ? se(
      (s = e.name || t,
        {
          code: ne.ASSET_NOT_FINALISED,
          message:
            `Plugin error - Unable to get file name for asset "${s}". Ensure that the source is set and that generate is called first.`,
        }),
    )
    : e.fileName;
  var s;
...
function Pr(e, t) {
  ...
  return i ||
    se(
      (n = e.fileName || e.name,
        {
          code: ne.CHUNK_NOT_GENERATED,
          message:
            `Plugin error - Unable to get file name for chunk "${n}". Ensure that generate is called first.`,
        }),
    );
  var n;
}
class kr {
  constructor(e, t, s) {
    this.graph = e,
        ...
        for (const [t, s] of this.filesByReferenceId.entries()) {
          if ("asset" === s.type && "string" != typeof s.fileName) {
            return se(
              (e = s.name || t,
                {
                  code: ne.ASSET_SOURCE_MISSING,
                  message:
                    `Plugin error creating asset "${e}" - no asset source set.`,
                }),
            );
          }
        }
      ...
      this.emitFile = (e) =>
        (function (e) {
          ...
          ? (function (e) {
              ...
              return !t || "string" == typeof t && !te(t);
            })(e)
            ? "chunk" === e.type ? this.emitChunk(e) : this.emitAsset(e)
            : se(
              de(
      ...
      this.getFileName = (e) => {
        ...
        return t
          ? "chunk" === t.type ? Pr(t, this.facadeChunkByModule) : Ar(t, e)
          : se(
            (s = e,
              {
                code: ne.FILE_NOT_FOUND,
                message:
                  `Plugin error - Unable to get file name for unknown file "${s}".`,
              }),
          );
        var s;
      },
      this.setAssetSource = (e, t) => {
        ...
        if (!s) {
          return se(
            (i = e,
              {
                code: ne.ASSET_NOT_FOUND,
                message:
                  `Plugin error - Unable to set the source for unknown asset "${i}".`,
              }),
          );
        }
        var i, n;
        ...
        if (void 0 !== s.source) {
          return se(
            (n = s.name || e,
              {
                code: ne.ASSET_SOURCE_ALREADY_SET,
                message:
                  `Unable to set the source for asset "${n}", source already set.`,
              }),
          );
        }
        const r = Sr(t, s, e);
      ...
      this.setOutputBundle = (e, t, s) => {
        ...
        for (const e of this.filesByReferenceId.values()) {
          e.fileName && vr(e.fileName, this.bundle, this.options.onwarn);
        }
        for (const [e, t] of this.filesByReferenceId.entries()) {
          "asset" === t.type && void 0 !== t.source &&
            this.finalizeAsset(t, t.source, e, this.bundle);
        }
      },
  ...
  emitAsset(e) {
    const t = void 0 !== e.source ? Sr(e.source, e, null) : void 0,
      s = { fileName: e.fileName, name: e.name, source: t, type: "asset" },
      i = this.assignReferenceId(s, e.fileName || e.name || e.type);
    return this.bundle &&
      (e.fileName && vr(e.fileName, this.bundle, this.options.onwarn),
        void 0 !== t && this.finalizeAsset(s, t, i, this.bundle)),
      i;
  }
  emitChunk(e) {
    if (this.graph.phase > ki.LOAD_AND_PARSE) {
      return se({
        code: ne.INVALID_ROLLUP_PHASE,
        message: "Cannot emit chunks after module loading has finished.",
      });
    }
    if ("string" != typeof e.id) {
      return se(
        de(`Emitted chunks need to have a valid string id, received "${e.id}"`),
      );
    }
    const t = {
      fileName: e.fileName,
  ...
  finalizeAsset(e, t, s, i) {
    const n = e.fileName || function (e, t) {
        for (const [s, i] of Object.entries(e)) {
          if ("asset" === i.type && wr(t, i.source)) return s;
        }
        return null;
        ...
        return fr(
          pr(
            "function" == typeof s.assetFileNames
              ? s.assetFileNames({ name: e, source: t, type: "asset" })
              : s.assetFileNames,
...
const Cr = (e, t) => t ? `${e}\n${t}` : e,
  Ir = (e, t) => t ? `${e}\n\n${t}` : e;
function Nr(e, t) {
  const s = [], i = new Set(t.keys()), n = Object.create(null);
  for (const [e, s] of t) _r(e, n[s] = n[s] || [], i);
  ...
  const r = new Map(),
    { dependentEntryPointsByModule: a, dynamicEntryModules: o } = function (e) {
      const t = new Set(), s = new Map(), i = new Set(e);
      for (const e of i) {
        const n = new Set([e]);
        for (const r of n) {
          T(s, r, () => new Set()).add(e);
          for (const e of r.getDependenciesToBeIncluded()) {
            e instanceof ve || n.add(e);
          }
          for (const { resolution: e } of r.dynamicImports) {
            e instanceof Wi && e.includedDynamicImporters.length > 0 &&
              (t.add(e), i.add(e));
          }
    ...
    h = function (e, t) {
      const s = new Map();
      for (const i of t) {
        const t = T(s, i, () => new Set());
        for (
          const s of [...i.includedDynamicImporters, ...i.implicitlyLoadedAfter]
        ) {
  ...
  function c(e, t) {
    const s = new Set([e]);
    for (const n of s) {
      const o = T(r, n, () => new Set());
      if (!t || !u(t, a.get(n))) {
        o.add(e);
        for (const e of n.getDependenciesToBeIncluded()) {
          e instanceof ve || i.has(e) || s.add(e);
        }
      }
    }
  }
  ...
  return s.push(...function (e, t) {
    ...
    return Object.values(s).map((e) => ({ alias: null, modules: e }));
  }([...e, ...o], r)),
    s;
}
function _r(e, t, s) {
  ...
  for (const e of i) {
    s.add(e), t.push(e);
    for (const t of e.dependencies) t instanceof ve || s.has(t) || i.add(t);
  }
}
const $r = (e, t) => e.execIndex > t.execIndex ? 1 : -1;
function Tr(e, t, s) {
  const i = Symbol(e.id), n = [ee(e.id)];
  let r = t;
  for (e.cycles.add(i); r !== e;) {
    r.cycles.add(i), n.push(ee(r.id)), r = s.get(r);
  }
  return n.push(n[0]), n.reverse(), n;
}
const Rr = (e, t) => t ? `(${e})` : e, Mr = /^(?!\d)[\w$]+$/;
class Dr {
  constructor(e, t, s, i, n) {
  ...
  async generate(e) {
    ...
    try {
      ...
      const s = function (e) {
        ...
        const t = [];
        for (const s of e) {
          for (const e of s.entryModules) P(e.id) && t.push(e.id);
        }
        return t;
      }(e));
      Li("generate chunks", 2), Di("render modules", 2);
      const i = await async function (e, t) {
          try {
            let [s, i, n, r] = await Promise.all([
              t.hookReduceValue("banner", e.banner(), [], Cr),
              t.hookReduceValue("footer", e.footer(), [], Cr),
              t.hookReduceValue("intro", e.intro(), [], Ir),
              t.hookReduceValue("outro", e.outro(), [], Ir),
            ]);
            return n && (n += "\n\n"),
              r && (r = `\n\n${r}`),
              s.length && (s += "\n"),
              i.length && (i = "\n" + i),
              { banner: s, footer: i, intro: n, outro: r };
          } catch (e) {
            return se({
              code: "ADDON_ERROR",
              message:
                `Could not retrieve ${e.hook}. Check configuration of plugin ${e.plugin}.\n\tError Message: ${e.message}`,
            });
          }
        ...
        n = function (
          ...
          const { _: r, n: a, s: o } = e
              ...
              : { _: " ", n: "\n", s: ";" },
            h = s ? "const" : "var",
            l = (e, { isAsync: t, name: s }) =>
              `${t ? "async " : ""}function${s ? ` ${s}` : ""}${r}(${
                e.join(`,${r}`)
              })${r}`,
            c = t
              ? (e, { isAsync: t, name: s }) => {
            ...
            u = (
              e,
              { functionReturn: s, lineBreakIndent: i, name: n },
            ) => [
              `${c(e, { isAsync: !1, name: n })}${
                t
                  ? i
                    ? `${a}${i.base}${i.t}`
                    : ""
                  : `{${i ? `${a}${i.base}${i.t}` : r}${s ? "return " : ""}`
              }`,
              t
                ? `${n ? ";" : ""}${i ? `${a}${i.base}` : ""}`
                : `${o}${i ? `${a}${i.base}` : r}}`,
            ],
            d = n ? (e) => Mr.test(e) : (e) => !ge.has(e) && Mr.test(e);
          return {
            _: r,
            cnst: h,
            ...
            getDirectReturnIifeLeft: (
              e,
              s,
              { needsArrowReturnParens: i, needsWrappedFunction: n },
            ) => {
              const [r, a] = u(e, {
                functionReturn: !0,
                lineBreakIndent: null,
      ...
      this.prerenderChunks(e, s, n),
        Li("render modules", 2),
        await this.addFinalizedChunksToBundle(e, s, i, t, n);
    } catch (e) {
      throw await this.pluginDriver.hookParallel("renderError", [e]), e;
    }
    return await this.pluginDriver.hookSeq("generateBundle", [
      this.outputOptions,
      t,
      e,
    ]),
  ...
  async addFinalizedChunksToBundle(e, t, s, i, n) {
    this.assignChunkIds(e, t, s, i);
    for (const t of e) i[t.id] = t.getChunkInfoWithFileNames();
    await Promise.all(e.map(async (e) => {
      const t = i[e.id];
      Object.assign(t, await e.render(this.outputOptions, s, t, n));
    }));
  }
  async addManualChunks(e) {
    ...
    for (const { alias: e, entries: i } of s) for (const s of i) Or(e, s, t);
    return t;
  }
  assignChunkIds(e, t, s, i) {
    ...
    for (const e of a) {
      this.outputOptions.file
        ? e.id = C(this.outputOptions.file)
        : this.outputOptions.preserveModules
        ...
        : e.id = e.generateId(s, this.outputOptions, i, !0), i[e.id] = br;
    }
  }
    ...
    for (const t of Object.values(e)) {
      if (
        ...
        (fe(
          ...
          t.type = "asset"),
          this.outputOptions.validate && "string" == typeof t.code
      ) {
        try {
          ...
          this.inputOptions.onwarn(re(t, e));
        }
      }
    }
  ...
  async generateChunks() {
    const { manualChunks: e } = this.outputOptions,
      ...
      i = new Map();
    for (
      const { alias: e, modules: n } of this.outputOptions.inlineDynamicImports
        ? [{ alias: null, modules: Lr(this.graph.modulesById) }]
        : this.outputOptions.preserveModules
        ? Lr(this.graph.modulesById).map((e) => ({ alias: null, modules: [e] }))
        : Nr(this.graph.entryModules, t)
    ) {
      n.sort($r);
      const t = new yr(
        n,
  ...
  prerenderChunks(e, t, s) {
    ...
    for (const i of e) i.preRender(this.outputOptions, t, s);
  }
}
function Lr(e) {
  ...
  if ("string" == typeof i && i !== e) {
    return se(
      (n = t.id,
        ...
        a = i,
        {
          code: ne.INVALID_CHUNK,
          message: `Cannot assign ${
            ee(n)
          } to the "${r}" chunk as it is already in the "${a}" chunk.`,
        }),
    );
  }
  var n, r, a;
...
var Vr = {
  ...
  Fr = {
    5: Br,
    "5module": Br + " export import",
    6: Br + " const class extends export import super",
  },
  zr = /^in(stanceof)?$/,
  Wr =
...
function Xr(e, t) {
  return e < 65
    ...
    : e < 91 || (e < 97
      ? 95 === e
      : e < 123 || (e <= 65535
        ? e >= 170 && jr.test(String.fromCharCode(e))
        : !1 !== t && Kr(e, Hr)));
}
function Yr(e, t) {
  return e < 48
    ...
    : e < 58 || !(e < 65) && (e < 91 || (e < 97
          ? 95 === e
          : e < 123 || (e <= 65535
            ? e >= 170 && Gr.test(String.fromCharCode(e))
            : !1 !== t && (Kr(e, Hr) || Kr(e, qr)))));
}
var Qr = function (e, t) {
  void 0 === t && (t = {}),
...
function Zr(e, t) {
  return new Qr(e, { beforeExpr: !0, binop: t });
}
var Jr = { beforeExpr: !0 }, ea = { startsExpr: !0 }, ta = {};
function sa(e, t) {
  return void 0 === t && (t = {}), t.keyword = e, ta[e] = new Qr(e, t);
}
var ia = {
    num: new Qr("num", ea),
    regexp: new Qr("regexp", ea),
    string: new Qr("string", ea),
    name: new Qr("name", ea),
    privateId: new Qr("privateId", ea),
    eof: new Qr("eof"),
    bracketL: new Qr("[", { beforeExpr: !0, startsExpr: !0 }),
    bracketR: new Qr("]"),
    braceL: new Qr("{", { beforeExpr: !0, startsExpr: !0 }),
    braceR: new Qr("}"),
    parenL: new Qr("(", { beforeExpr: !0, startsExpr: !0 }),
    parenR: new Qr(")"),
    comma: new Qr(",", Jr),
    semi: new Qr(";", Jr),
    colon: new Qr(":", Jr),
    ...
    questionDot: new Qr("?."),
    arrow: new Qr("=>", Jr),
    template: new Qr("template"),
    invalidTemplate: new Qr("invalidTemplate"),
    ellipsis: new Qr("...", Jr),
    backQuote: new Qr("`", ea),
    dollarBraceL: new Qr("${", { beforeExpr: !0, startsExpr: !0 }),
    eq: new Qr("=", { beforeExpr: !0, isAssign: !0 }),
    assign: new Qr("_=", { beforeExpr: !0, isAssign: !0 }),
    incDec: new Qr("++/--", { prefix: !0, postfix: !0, startsExpr: !0 }),
    prefix: new Qr("!/~", { beforeExpr: !0, prefix: !0, startsExpr: !0 }),
    logicalOR: Zr("||", 1),
    logicalAND: Zr("&&", 2),
    bitwiseOR: Zr("|", 3),
    bitwiseXOR: Zr("^", 4),
    ...
    star: Zr("*", 10),
    slash: Zr("/", 10),
    starstar: new Qr("**", { beforeExpr: !0 }),
    coalesce: Zr("??", 1),
    _break: sa("break"),
    _case: sa("case", Jr),
    _catch: sa("catch"),
    _continue: sa("continue"),
    _debugger: sa("debugger"),
    _default: sa("default", Jr),
    _do: sa("do", { isLoop: !0, beforeExpr: !0 }),
    _else: sa("else", Jr),
    _finally: sa("finally"),
    _for: sa("for", { isLoop: !0 }),
    _function: sa("function", ea),
    _if: sa("if"),
    _return: sa("return", Jr),
    _switch: sa("switch"),
    _throw: sa("throw", Jr),
    _try: sa("try"),
    _var: sa("var"),
    _const: sa("const"),
    _while: sa("while", { isLoop: !0 }),
    _with: sa("with"),
    _new: sa("new", { beforeExpr: !0, startsExpr: !0 }),
    _this: sa("this", ea),
    _super: sa("super", ea),
    _class: sa("class", ea),
    _extends: sa("extends", Jr),
    _export: sa("export"),
    _import: sa("import", ea),
    _null: sa("null", ea),
    _true: sa("true", ea),
    _false: sa("false", ea),
    _in: sa("in", { beforeExpr: !0, binop: 7 }),
    _instanceof: sa("instanceof", { beforeExpr: !0, binop: 7 }),
    _typeof: sa("typeof", { beforeExpr: !0, prefix: !0, startsExpr: !0 }),
    _void: sa("void", { beforeExpr: !0, prefix: !0, startsExpr: !0 }),
    _delete: sa("delete", { beforeExpr: !0, prefix: !0, startsExpr: !0 }),
  },
  na = /\r\n?|\n|\u2028|\u2029/,
...
function oa(e, t, s) {
  ...
  for (var i = t; i < s; i++) {
    ...
    if (aa(n)) {
      return i < s - 1 && 13 === n && 10 === e.charCodeAt(i + 1)
        ? i + 2
        : i + 1;
    }
  }
...
ya.prototype.offset = function (e) {
  return new ya(this.line, this.column + e);
};
var Ea = function (e, t, s) {
  this.start = t,
    this.end = s,
...
function Sa(e) {
  var t = {};
  for (var s in va) t[s] = e && pa(e, s) ? e[s] : va[s];
  if (
    "latest" === t.ecmaVersion
      ? t.ecmaVersion = 1e8
      : null == t.ecmaVersion
      ? (!ba && "object" == typeof console && console.warn &&
        (ba = !0,
          console.warn(
  ...
  return fa(t.onComment) && (t.onComment = function (e, t) {
    return function (s, i, n, r, a, o) {
      var h = { type: s ? "Block" : "Line", value: i, start: n, end: r };
      e.locations && (h.loc = new Ea(this, a, o)),
...
var Pa = function (e, t, s) {
    this.options = e = Sa(e),
      ...
      this.keywords = ma(
        Fr[e.ecmaVersion >= 6 ? 6 : "module" === e.sourceType ? "5module" : 5],
      );
    var i = "";
    !0 !== e.allowReserved &&
    (i = Vr[e.ecmaVersion >= 6 ? 6 : 5 === e.ecmaVersion ? 5 : 3],
      "module" === e.sourceType && (i += " await")), this.reservedWords = ma(i);
    var n = (i ? i + " " : "") + Vr.strict;
    this.reservedWordsStrict = ma(n),
      this.reservedWordsStrictBind = ma(n + " " + Vr.strictBind),
      this.input = String(t),
      this.containsEsc = !1,
      s
        ? (this.pos = s,
          this.lineStart = this.input.lastIndexOf("\n", s - 1) + 1,
          this.curLine = this.input.slice(0, this.lineStart).split(na).length)
...
Pa.prototype.parse = function () {
  ...
  ka.allowSuper.get = function () {
    var e = this.currentThisScope(), t = e.flags, s = e.inClassFieldInit;
    return (64 & t) > 0 || s || this.options.allowSuperOutsideMethod;
  },
  ka.allowDirectSuper.get = function () {
    return (128 & this.currentThisScope().flags) > 0;
  },
  ka.treatFunctionsAsVar.get = function () {
    return this.treatFunctionsAsVarInScope(this.currentScope());
  },
  ka.allowNewDotTarget.get = function () {
    var e = this.currentThisScope(), t = e.flags, s = e.inClassFieldInit;
    return (258 & t) > 0 || s;
  },
  ka.inClassStaticBlock.get = function () {
  ...
  Pa.parseExpressionAt = function (e, t, s) {
  ...
  Object.defineProperties(Pa.prototype, ka);
var wa = Pa.prototype, Ca = /^(?:'((?:\\.|[^'\\])*?)'|"((?:\\.|[^"\\])*?)")/;
function Ia() {
  this.shorthandAssign = this.trailingComma = this.parenthesizedAssign = this
    .parenthesizedBind = this.doubleProto = -1;
}
wa.strictDirective = function (e) {
  for (;;) {
    la.lastIndex = e, e += la.exec(this.input)[0].length;
    var t = Ca.exec(this.input.slice(e));
    if (!t) return !1;
    if ("use strict" === (t[1] || t[2])) {
      la.lastIndex = e + t[0].length;
      var s = la.exec(this.input),
  ...
  wa.isContextual = function (e) {
    return this.type === ia.name && this.value === e && !this.containsEsc;
  },
  wa.eatContextual = function (e) {
    return !!this.isContextual(e) && (this.next(), !0);
  },
  wa.expectContextual = function (e) {
    this.eatContextual(e) || this.unexpected();
  },
  wa.canInsertSemicolon = function () {
    return this.type === ia.eof || this.type === ia.braceR ||
      na.test(this.input.slice(this.lastTokEnd, this.start));
  },
  wa.insertSemicolon = function () {
  ...
  wa.semicolon = function () {
    this.eat(ia.semi) || this.insertSemicolon() || this.unexpected();
  },
  wa.afterTrailingComma = function (e, t) {
    if (this.type === e) {
  ...
  wa.expect = function (e) {
    this.eat(e) || this.unexpected();
  },
  wa.unexpected = function (e) {
    this.raise(null != e ? e : this.start, "Unexpected token");
  },
  wa.checkPatternErrors = function (e, t) {
    if (e) {
      e.trailingComma > -1 &&
  ...
  wa.checkExpressionErrors = function (e, t) {
    if (!e) return !1;
...
var _a = { kind: "loop" }, $a = { kind: "switch" };
Na.isLet = function (e) {
  if (this.options.ecmaVersion < 6 || !this.isContextual("let")) return !1;
  la.lastIndex = this.pos;
  var t = la.exec(this.input),
  ...
  if (123 === i) return !0;
  if (Xr(i, !0)) {
    for (var n = s + 1; Yr(i = this.input.charCodeAt(n), !0);) ++n;
    if (92 === i || i > 55295 && i < 56320) return !0;
    var r = this.input.slice(s, n);
    if (!zr.test(r)) return !0;
  }
  return !1;
},
  Na.isAsyncFunction = function () {
    if (this.options.ecmaVersion < 8 || !this.isContextual("async")) return !1;
    la.lastIndex = this.pos;
    var e, t = la.exec(this.input), s = this.pos + t[0].length;
    return !(na.test(this.input.slice(this.pos, s)) ||
      "function" !== this.input.slice(s, s + 8) ||
      s + 8 !== this.input.length &&
        (Yr(e = this.input.charCodeAt(s + 8)) || e > 55295 && e < 56320));
  },
  Na.parseStatement = function (e, t, s) {
    var i, n = this.type, r = this.startNode();
    switch (this.isLet(e) && (n = ia._var, i = "let"), n) {
      case ia._break:
      case ia._continue:
      ...
      case ia._export:
      case ia._import:
        if (this.options.ecmaVersion > 10 && n === ia._import) {
          la.lastIndex = this.pos;
          var a = la.exec(this.input),
        ...
        return this.options.allowImportExportEverywhere ||
          ...
          n === ia._import ? this.parseImport(r) : this.parseExport(r, s);
      default:
        ...
        return n === ia.name && "Identifier" === c.type && this.eat(ia.colon)
          ? this.parseLabeledStatement(r, l, c, e)
          : this.parseExpressionStatement(r, c);
    }
  },
  Na.parseBreakContinueStatement = function (e, t) {
    var s = "break" === t;
    this.next(),
      this.eat(ia.semi) || this.insertSemicolon()
        ? e.label = null
        : this.type !== ia.name
        ? this.unexpected()
  ...
  Na.parseDebuggerStatement = function (e) {
    return this.next(),
      this.semicolon(),
      this.finishNode(e, "DebuggerStatement");
  },
  Na.parseDoStatement = function (e) {
    return this.next(),
      this.labels.push(_a),
      e.body = this.parseStatement("do"),
      this.labels.pop(),
      this.expect(ia._while),
      e.test = this.parseParenExpression(),
      this.options.ecmaVersion >= 6 ? this.eat(ia.semi) : this.semicolon(),
      this.finishNode(e, "DoWhileStatement");
  },
  Na.parseForStatement = function (e) {
    this.next();
    var t =
    ...
    if (
      this.labels.push(_a),
        this.enterScope(0),
        this.expect(ia.parenL),
        this.type === ia.semi
    ) {
      return t > -1 && this.unexpected(t), this.parseFor(e, null);
    }
    var s = this.isLet();
    if (this.type === ia._var || this.type === ia._const || s) {
      ...
      return this.next(),
        ...
        (this.type === ia._in ||
          ...
          ? (this.options.ecmaVersion >= 9 && (this.type === ia._in
  ...
  Na.parseFunctionStatement = function (e, t, s) {
    return this.next(), this.parseFunction(e, Ra | (s ? 0 : Ma), !1, t);
  },
  Na.parseIfStatement = function (e) {
    return this.next(),
      e.test = this.parseParenExpression(),
      e.consequent = this.parseStatement("if"),
      e.alternate = this.eat(ia._else) ? this.parseStatement("if") : null,
      this.finishNode(e, "IfStatement");
  },
  Na.parseReturnStatement = function (e) {
    return this.inFunction || this.options.allowReturnOutsideFunction ||
      this.raise(this.start, "'return' outside of function"),
      this.next(),
      this.eat(ia.semi) || this.insertSemicolon() ? e.argument = null
      : (e.argument = this.parseExpression(), this.semicolon()),
      this.finishNode(e, "ReturnStatement");
  },
  Na.parseSwitchStatement = function (e) {
    var t;
    this.next(),
      e.discriminant = this.parseParenExpression(),
      e.cases = [],
      this.expect(ia.braceL),
      this.labels.push($a),
      this.enterScope(0);
    for (var s = !1; this.type !== ia.braceR;) {
      if (this.type === ia._case || this.type === ia._default) {
        var i = this.type === ia._case;
  ...
  Na.parseThrowStatement = function (e) {
    return this.next(),
      na.test(this.input.slice(this.lastTokEnd, this.start)) &&
...
var Ta = [];
Na.parseTryStatement = function (e) {
  if (
    this.next(),
  ...
  return e.finalizer = this.eat(ia._finally) ? this.parseBlock() : null,
    e.handler || e.finalizer ||
    this.raise(e.start, "Missing catch or finally clause"),
    this.finishNode(e, "TryStatement");
},
  Na.parseVarStatement = function (e, t) {
    return this.next(),
      this.parseVar(e, !1, t),
      this.semicolon(),
      this.finishNode(e, "VariableDeclaration");
  },
  Na.parseWhileStatement = function (e) {
    return this.next(),
      e.test = this.parseParenExpression(),
      this.labels.push(_a),
  ...
  Na.parseWithStatement = function (e) {
  ...
  Na.parseEmptyStatement = function (e) {
    return this.next(), this.finishNode(e, "EmptyStatement");
  },
  Na.parseLabeledStatement = function (e, t, s, i) {
    ...
    return this.labels.push({ name: t, kind: a, statementStart: this.start }),
  ...
  Na.parseExpressionStatement = function (e, t) {
    return e.expression = t,
      this.semicolon(),
      this.finishNode(e, "ExpressionStatement");
  },
  Na.parseBlock = function (e, t, s) {
    for (
      void 0 === e && (e = !0),
  ...
  Na.parseFor = function (e, t) {
    return e.init = t,
      this.expect(ia.semi),
      e.test = this.type === ia.semi ? null : this.parseExpression(),
      this.expect(ia.semi),
      e.update = this.type === ia.parenR ? null : this.parseExpression(),
      this.expect(ia.parenR),
  ...
  Na.parseForIn = function (e, t) {
    var s = this.type === ia._in;
    return this.next(),
      "VariableDeclaration" === t.type && null != t.declarations[0].init &&
      (!s || this.options.ecmaVersion < 8 || this.strict || "var" !== t.kind ||
      ...
      if (
        this.parseVarId(i, s),
          this.eat(ia.eq)
            ...
            : "const" !== s || this.type === ia._in ||
                this.options.ecmaVersion >= 6 && this.isContextual("of")
            ? "Identifier" === i.id.type ||
                t && (this.type === ia._in || this.isContextual("of"))
              ? i.init = null
              : this.raise(
                this.lastTokEnd,
...
Na.parseFunction = function (e, t, s, i, n) {
  this.initFunction(e),
    (this.options.ecmaVersion >= 9 || this.options.ecmaVersion >= 6 && !i) &&
    (this.type === ia.star && t & Ma && this.unexpected(),
      e.generator = this.eat(ia.star)),
    this.options.ecmaVersion >= 8 && (e.async = !!i),
    t & Ra &&
    (e.id = 4 & t && this.type !== ia.name ? null : this.parseIdent(),
      !e.id || t & Ma ||
      this.checkLValSimple(
        e.id,
        this.strict || e.generator || e.async
          ? this.treatFunctionsAsVar ? 1 : 2
          : 3,
      ));
  ...
  return this.yieldPos = 0,
    ...
    this.enterScope(Aa(e.async, e.generator)),
    t & Ra || (e.id = this.type === ia.name ? this.parseIdent() : null),
    this.parseFunctionParams(e),
    this.parseFunctionBody(e, s, !1, n),
    this.yieldPos = r,
    this.awaitPos = a,
    this.awaitIdentPos = o,
    this.finishNode(e, t & Ra ? "FunctionDeclaration" : "FunctionExpression");
},
  Na.parseFunctionParams = function (e) {
    this.expect(ia.parenL),
  ...
  Na.parseClass = function (e, t) {
    this.next();
    var s = this.strict;
    this.strict = !0, this.parseClassId(e, t), this.parseClassSuper(e);
    var i = this.enterClassBody(), n = this.startNode(), r = !1;
    for (n.body = [], this.expect(ia.braceL); this.type !== ia.braceR;) {
        ...
        (n.body.push(a),
          "MethodDefinition" === a.type && "constructor" === a.kind
            ? (r &&
              ...
              r = !0)
            : a.key && "PrivateIdentifier" === a.key.type && Da(i, a) &&
              this.raiseRecoverable(
                a.key.start,
  ...
  Na.parseClassElement = function (e) {
    if (this.eat(ia.semi)) return null;
    ...
    if (this.eatContextual("static")) {
      if (t >= 13 && this.eat(ia.braceL)) {
        return this.parseClassStaticBlock(s), s;
      }
      this.isClassElementNameStart() || this.type === ia.star ? o = !0
      : i = "static";
    }
    if (
      s.static = o,
        !i && t >= 8 && this.eatContextual("async") &&
        (!this.isClassElementNameStart() && this.type !== ia.star ||
            this.canInsertSemicolon()
          ? i = "async"
          : r = !0),
        !i && (t >= 9 || !r) && this.eat(ia.star) && (n = !0),
        !i && !r && !n
    ) {
      var h = this.value;
      (this.eatContextual("get") || this.eatContextual("set")) &&
        (this.isClassElementNameStart() ? a = h : i = h);
    }
    if (
      i
        ? (s.computed = !1,
        ...
        t < 13 || this.type === ia.parenL || "method" !== a || n || r
    ) {
      var l = !s.static && La(s, "constructor"), c = l && e;
      l && "method" !== a &&
      this.raise(s.key.start, "Constructor can't have get/set modifier"),
        s.kind = l ? "constructor" : a,
        this.parseClassMethod(s, n, r, c);
    } else this.parseClassField(s);
    return s;
  },
  Na.isClassElementNameStart = function () {
    return this.type === ia.name || this.type === ia.privateId ||
      this.type === ia.num || this.type === ia.string ||
      this.type === ia.bracketL || this.type.keyword;
  },
  Na.parseClassElementName = function (e) {
    this.type === ia.privateId
  ...
  Na.parseClassStaticBlock = function (e) {
    e.body = [];
    var t = this.labels;
    for (this.labels = [], this.enterScope(320); this.type !== ia.braceR;) {
  ...
  Na.parseClassId = function (e, t) {
    this.type === ia.name
      ? (e.id = this.parseIdent(), t && this.checkLValSimple(e.id, 2, !1))
      : (!0 === t && this.unexpected(), e.id = null);
  },
  Na.parseClassSuper = function (e) {
    e.superClass = this.eat(ia._extends) ? this.parseExprSubscripts(!1) : null;
  },
  Na.enterClassBody = function () {
    var e = { declared: Object.create(null), used: [] };
    return this.privateNameStack.push(e), e.declared;
  },
  Na.exitClassBody = function () {
    for (
      ...
      pa(t, a.name) ||
        (n
          ...
          : this.raiseRecoverable(
            a.start,
            "Private field '#" + a.name +
              "' must be declared in an enclosing class",
          ));
    }
  },
  Na.parseExport = function (e, t) {
    if (this.next(), this.eat(ia.star)) {
      return this.options.ecmaVersion >= 11 &&
        ...
        this.type !== ia.string && this.unexpected(),
        e.source = this.parseExprAtom(),
        this.semicolon(),
        this.finishNode(e, "ExportAllDeclaration");
    }
    if (this.eat(ia._default)) {
      var s;
      if (
        this.checkExport(t, "default", this.lastTokStart),
          this.type === ia._function || (s = this.isAsyncFunction())
      ) {
        var i = this.startNode();
        this.next(),
          s && this.next(),
          e.declaration = this.parseFunction(i, 4 | Ra, !1, s);
      } else if (this.type === ia._class) {
  ...
  Na.checkExport = function (e, t, s) {
    e &&
      (pa(e, t) && this.raiseRecoverable(s, "Duplicate export '" + t + "'"),
        e[t] = !0);
  },
  Na.checkPatternExport = function (e, t) {
    var s = t.type;
    if ("Identifier" === s) this.checkExport(e, t.name, t.start);
      ...
      "Property" === s ? this.checkPatternExport(e, t.value)
      : "AssignmentPattern" === s
  ...
  Na.checkVariableExport = function (e, t) {
    if (e) {
  ...
  Na.shouldParseExportStatement = function () {
  ...
  Na.parseExportSpecifiers = function (e) {
    var t = [], s = !0;
    for (this.expect(ia.braceL); !this.eat(ia.braceR);) {
      if (s) s = !1;
      else if (this.expect(ia.comma), this.afterTrailingComma(ia.braceR)) break;
      var i = this.startNode();
  ...
  Na.parseImport = function (e) {
    return this.next(),
      this.type === ia.string
        ? (e.specifiers = Ta, e.source = this.parseExprAtom())
        : (e.specifiers = this.parseImportSpecifiers(),
          this.expectContextual("from"),
          e.source = this.type === ia.string
            ? this.parseExprAtom()
            : this.unexpected()),
      this.semicolon(),
      this.finishNode(e, "ImportDeclaration");
  },
  Na.parseImportSpecifiers = function () {
    var e = [], t = !0;
    if (this.type === ia.name) {
  ...
  Na.parseModuleExportName = function () {
    if (this.options.ecmaVersion >= 13 && this.type === ia.string) {
      var e = this.parseLiteral(this.value);
      return ga.test(e.value) &&
        this.raise(e.start, "An export name cannot include a lone surrogate."),
        e;
    }
    return this.parseIdent(!0);
  },
  Na.adaptDirectivePrologue = function (e) {
    for (var t = 0; t < e.length && this.isDirectiveCandidate(e[t]); ++t) {
      e[t].directive = e[t].expression.raw.slice(1, -1);
    }
  },
  Na.isDirectiveCandidate = function (e) {
...
var Oa = Pa.prototype;
Oa.toAssignable = function (e, t, s) {
  ...
  Oa.toAssignableList = function (e, t) {
    ...
    if (s) {
      var r = e[s - 1];
      6 === this.options.ecmaVersion && t && r && "RestElement" === r.type &&
        "Identifier" !== r.argument.type && this.unexpected(r.argument.start);
    }
    return e;
  },
  Oa.parseSpread = function (e) {
    var t = this.startNode();
    return this.next(),
  ...
  Oa.parseRestBinding = function () {
    ...
    return this.next(),
      6 === this.options.ecmaVersion && this.type !== ia.name &&
      this.unexpected(),
      e.argument = this.parseBindingAtom(),
      this.finishNode(e, "RestElement");
  },
  Oa.parseBindingAtom = function () {
    if (this.options.ecmaVersion >= 6) {
      switch (this.type) {
        case ia.bracketL:
          var e = this.startNode();
          return this.next(),
            e.elements = this.parseBindingList(ia.bracketR, !0, !0),
  ...
  Oa.parseBindingList = function (e, t, s) {
    for (var i = [], n = !0; !this.eat(e);) {
      if (n ? n = !1 : this.expect(ia.comma), t && this.type === ia.comma) {
        i.push(null);
      } else {
        if (s && this.afterTrailingComma(e)) break;
        if (this.type === ia.ellipsis) {
  ...
  Oa.parseBindingListItem = function (e) {
    return e;
  },
  Oa.parseMaybeDefault = function (e, t, s) {
    if (
      s = s || this.parseBindingAtom(),
        this.options.ecmaVersion < 6 || !this.eat(ia.eq)
    ) {
      return s;
    }
  ...
  Oa.checkLValSimple = function (e, t, s) {
    void 0 === t && (t = 0);
    var i = 0 !== t;
    switch (e.type) {
      case "Identifier":
  ...
  Oa.checkLValPattern = function (e, t, s) {
  ...
  Oa.checkLValInnerPattern = function (e, t, s) {
    switch (void 0 === t && (t = 0), e.type) {
      case "Property":
...
var Va = function (e, t, s, i, n) {
  ...
  Ba = {
    ...
    p_stat: new Va("(", !1),
    p_expr: new Va("(", !0),
    q_tmpl: new Va("`", !0, !0, function (e) {
      return e.tryReadTemplateToken();
    }),
    f_stat: new Va("function", !1),
    f_expr: new Va("function", !0),
    f_expr_gen: new Va("function", !0, !1, null, !0),
    f_gen: new Va("function", !1, !1, null, !0),
  },
  Fa = Pa.prototype;
Fa.initialContext = function () {
  return [Ba.b_stat];
},
  Fa.curContext = function () {
    return this.context[this.context.length - 1];
  },
  Fa.braceIsBlock = function (e) {
    var t = this.curContext();
    return t === Ba.f_expr || t === Ba.f_stat ||
      (e !== ia.colon || t !== Ba.b_stat && t !== Ba.b_expr
        ? e === ia._return || e === ia.name && this.exprAllowed
          ? na.test(this.input.slice(this.lastTokEnd, this.start))
          : e === ia._else || e === ia.semi || e === ia.eof ||
            e === ia.parenR || e === ia.arrow || (e === ia.braceL
              ? t === Ba.b_stat
              : e !== ia._var && e !== ia._const && e !== ia.name &&
                !this.exprAllowed)
        : !t.isExpr);
  },
  Fa.inGeneratorContext = function () {
  ...
  Fa.updateContext = function (e) {
    var t, s = this.type;
    s.keyword && e === ia.dot ? this.exprAllowed = !1
    : (t = s.updateContext) ? t.call(this, e) : this.exprAllowed = s.beforeExpr;
  },
  Fa.overrideContext = function (e) {
    this.curContext() !== e && (this.context[this.context.length - 1] = e);
  },
  ia.parenR.updateContext = ia.braceR.updateContext = function () {
    if (1 !== this.context.length) {
      var e = this.context.pop();
      e === Ba.b_stat && "function" === this.curContext().token &&
      (e = this.context.pop()), this.exprAllowed = !e.isExpr;
    } else this.exprAllowed = !0;
  },
  ia.braceL.updateContext = function (e) {
    this.context.push(this.braceIsBlock(e) ? Ba.b_stat : Ba.b_expr),
      this.exprAllowed = !0;
  },
  ia.dollarBraceL.updateContext = function () {
    this.context.push(Ba.b_tmpl), this.exprAllowed = !0;
  },
  ia.parenL.updateContext = function (e) {
    var t = e === ia._if || e === ia._for || e === ia._with || e === ia._while;
    this.context.push(t ? Ba.p_stat : Ba.p_expr), this.exprAllowed = !0;
  },
  ia.incDec.updateContext = function () {},
  ia._function.updateContext = ia._class.updateContext = function (e) {
    !e.beforeExpr || e === ia._else ||
      e === ia.semi && this.curContext() !== Ba.p_stat ||
      e === ia._return &&
        na.test(this.input.slice(this.lastTokEnd, this.start)) ||
      (e === ia.colon || e === ia.braceL) && this.curContext() === Ba.b_stat
      ? this.context.push(Ba.f_stat)
      : this.context.push(Ba.f_expr),
      this.exprAllowed = !1;
  },
  ia.backQuote.updateContext = function () {
    this.curContext() === Ba.q_tmpl
      ? this.context.pop()
      : this.context.push(Ba.q_tmpl), this.exprAllowed = !1;
  },
  ia.star.updateContext = function (e) {
    if (e === ia._function) {
      var t = this.context.length - 1;
      this.context[t] === Ba.f_expr
        ? this.context[t] = Ba.f_expr_gen
        : this.context[t] = Ba.f_gen;
    }
    this.exprAllowed = !0;
  },
  ia.name.updateContext = function (e) {
    var t = !1;
    this.options.ecmaVersion >= 6 && e !== ia.dot &&
...
za.checkPropClash = function (e, t, s) {
  if (
  ...
  za.parseExpression = function (e, t) {
    var s = this.start, i = this.startLoc, n = this.parseMaybeAssign(e, t);
    if (this.type === ia.comma) {
      var r = this.startNodeAt(s, i);
      for (r.expressions = [n]; this.eat(ia.comma);) {r.expressions.push(
  ...
  za.parseMaybeAssign = function (e, t, s) {
    ...
    this.type !== ia.parenL && this.type !== ia.name ||
    ...
    if (s && (l = s.call(this, l, o, h)), this.type.isAssign) {
      ...
      return c.operator = this.value,
        this.type === ia.eq && (l = this.toAssignable(l, !1, t)),
  ...
  za.parseExprOps = function (e, t) {
    var s = this.start,
      i = this.startLoc,
      n = this.parseMaybeUnary(t, !1, !1, e);
    return this.checkExpressionErrors(t) ||
        n.start === s && "ArrowFunctionExpression" === n.type ? n
    : this.parseExprOp(n, s, i, -1, e);
  },
  za.parseExprOp = function (e, t, s, i, n) {
    var r = this.type.binop;
    if (null != r && (!n || this.type !== ia._in) && r > i) {
      var a = this.type === ia.logicalOR || this.type === ia.logicalAND,
        o = this.type === ia.coalesce;
      o && (r = ia.logicalAND.binop);
      var h = this.value;
      this.next();
      var l = this.start,
        c = this.startLoc,
        u = this.parseExprOp(this.parseMaybeUnary(null, !1, !1, n), l, c, r, n),
        d = this.buildBinary(t, s, e, u, h, a || o);
      return (a && this.type === ia.coalesce ||
        o && (this.type === ia.logicalOR || this.type === ia.logicalAND)) &&
        this.raiseRecoverable(
          this.start,
  ...
  za.buildBinary = function (e, t, s, i, n, r) {
  ...
  za.parseMaybeUnary = function (e, t, s, i) {
    var n, r = this.start, a = this.startLoc;
    if (this.isContextual("await") && this.canAwait) {
      n = this.parseAwait(i), t = !0;
    } else if (this.type.prefix) {
      var o = this.startNode(), h = this.type === ia.incDec;
      o.operator = this.value,
        o.prefix = !0,
        this.next(),
        o.argument = this.parseMaybeUnary(null, !0, h, i),
        this.checkExpressionErrors(e, !0),
        h ? this.checkLValSimple(o.argument)
        : this.strict && "delete" === o.operator &&
    ...
    } else if (t || this.type !== ia.privateId) {
      ...
      (i || 0 === this.privateNameStack.length) && this.unexpected(),
        ...
        this.type !== ia._in && this.unexpected();
    }
    return s || !this.eat(ia.starstar) ? n
  ...
  za.parseExprSubscripts = function (e, t) {
  ...
  za.parseSubscripts = function (e, t, s, i, n) {
    for (
      var r = this.options.ecmaVersion >= 8 && "Identifier" === e.type &&
      ...
      if (
        o.optional && (a = !0), o === e || "ArrowFunctionExpression" === o.type
      ) {
        if (a) {
  ...
  za.parseSubscript = function (e, t, s, i, n, r, a) {
    var o = this.options.ecmaVersion >= 11, h = o && this.eat(ia.questionDot);
    i && h &&
      this.raise(
        this.lastTokStart,
        "Optional chaining cannot appear in the callee of new expressions",
      );
    var l = this.eat(ia.bracketL);
    if (
      l || h && this.type !== ia.parenL && this.type !== ia.backQuote ||
      this.eat(ia.dot)
    ) {
      var c = this.startNodeAt(t, s);
      c.object = e,
        l
          ? (c.property = this.parseExpression(), this.expect(ia.bracketR))
          : this.type === ia.privateId && "Super" !== e.type
      ...
      if (n && !h && !this.canInsertSemicolon() && this.eat(ia.arrow)) {
        return this.checkPatternErrors(u, !1),
          ...
          this.parseArrowExpression(this.startNodeAt(t, s), m, !0, a);
      }
    ...
    } else if (this.type === ia.backQuote) {
      (h || r) &&
        this.raise(
          this.start,
  ...
  za.parseExprAtom = function (e, t) {
    this.type === ia.slash && this.readRegexp();
    ...
    switch (this.type) {
      case ia._super:
        return this.allowSuper ||
          ...
          s = this.startNode(),
          this.next(),
          this.type !== ia.parenL || this.allowDirectSuper ||
          this.raise(s.start, "super() call outside constructor of a subclass"),
          this.type !== ia.dot && this.type !== ia.bracketL &&
          this.type !== ia.parenL && this.unexpected(),
      ...
      case ia.name:
        var n = this.start,
          ...
          o = this.parseIdent(!1);
        if (
          this.options.ecmaVersion >= 8 && !a && "async" === o.name &&
          !this.canInsertSemicolon() && this.eat(ia._function)
        ) {
          return this.overrideContext(Ba.f_expr),
            this.parseFunction(this.startNodeAt(n, r), 0, !1, !0, t);
        }
        if (i && !this.canInsertSemicolon()) {
          if (this.eat(ia.arrow)) {
          ...
          if (
            this.options.ecmaVersion >= 8 && "async" === o.name &&
            this.type === ia.name && !a &&
            (!this.potentialArrowInForAwait || "of" !== this.value ||
              this.containsEsc)
          ) {
            return o = this.parseIdent(!1),
              !this.canInsertSemicolon() && this.eat(ia.arrow) ||
              this.unexpected(),
      ...
      case ia._true:
      case ia._false:
        return (s = this.startNode()).value = this.type === ia._null
          ? null
          : this.type === ia._true,
      ...
      case ia.parenL:
        ...
        return e &&
          (e.parenthesizedAssign < 0 && !this.isSimpleAssignTarget(c) &&
      ...
      case ia.bracketL:
        return s = this.startNode(),
          this.next(),
          s.elements = this.parseExprList(ia.bracketR, !0, !0, e),
          this.finishNode(s, "ArrayExpression");
      case ia.braceL:
        return this.overrideContext(Ba.b_expr), this.parseObj(!1, e);
      case ia._function:
  ...
  za.parseDynamicImport = function (e) {
    if (this.next(), e.source = this.parseMaybeAssign(), !this.eat(ia.parenR)) {
      var t = this.start;
      this.eat(ia.comma) && this.eat(ia.parenR)
        ? this.raiseRecoverable(t, "Trailing comma is not allowed in import()")
        : this.unexpected(t);
    }
    return this.finishNode(e, "ImportExpression");
  },
  za.parseImportMeta = function (e) {
    this.next();
  ...
  za.parseParenExpression = function () {
    this.expect(ia.parenL);
    var e = this.parseExpression();
    return this.expect(ia.parenR), e;
  },
  za.parseParenAndDistinguishExpression = function (e, t) {
    ...
    if (this.options.ecmaVersion >= 6) {
      ...
      var a,
        ...
        p = this.yieldPos,
        f = this.awaitPos;
      for (this.yieldPos = 0, this.awaitPos = 0; this.type !== ia.parenR;) {
        if (
          c ? c = !1 : this.expect(ia.comma),
            r && this.afterTrailingComma(ia.parenR, !0)
        ) {
          u = !0;
          break;
        }
      ...
      if (
        this.expect(ia.parenR),
          e && !this.canInsertSemicolon() && this.eat(ia.arrow)
      ) {
        return this.checkPatternErrors(d, !1),
          this.checkYieldAwaitInDefaultParams(),
          this.yieldPos = p,
          this.awaitPos = f,
          this.parseParenArrowList(i, n, l, t);
      }
      l.length && !u || this.unexpected(this.lastTokStart),
        ...
        l.length > 1
          ? ((s = this.startNodeAt(o, h)).expressions = l,
            this.finishNodeAt(s, "SequenceExpression", m, g)) : s = l[0];
  ...
  za.parseParenItem = function (e) {
    return e;
  },
  za.parseParenArrowList = function (e, t, s, i) {
    return this.parseArrowExpression(this.startNodeAt(e, t), s, !1, i);
  };
var Ua = [];
za.parseNew = function () {
  this.containsEsc &&
    this.raiseRecoverable(this.start, "Escape sequence in keyword new");
  var e = this.startNode(), t = this.parseIdent(!0);
  if (this.options.ecmaVersion >= 6 && this.eat(ia.dot)) {
    e.meta = t;
  ...
  var i = this.start, n = this.startLoc, r = this.type === ia._import;
  return e.callee = this.parseSubscripts(this.parseExprAtom(), i, n, !0, !1),
    r && "ImportExpression" === e.callee.type &&
  ...
  za.parseTemplateElement = function (e) {
    var t = e.isTagged, s = this.startNode();
    return this.type === ia.invalidTemplate
      ? (t ||
        this.raiseRecoverable(
          this.start,
      ...
      this.next(),
      s.tail = this.type === ia.backQuote,
      this.finishNode(s, "TemplateElement");
  },
  za.parseTemplate = function (e) {
    void 0 === e && (e = {});
    var t = e.isTagged;
    void 0 === t && (t = !1);
    var s = this.startNode();
    ...
    for (s.quasis = [i]; !i.tail;) {
      ...
      this.raise(this.pos, "Unterminated template literal"),
        this.expect(ia.dollarBraceL),
        s.expressions.push(this.parseExpression()),
        this.expect(ia.braceR),
        s.quasis.push(i = this.parseTemplateElement({ isTagged: t }));
    }
    return this.next(), this.finishNode(s, "TemplateLiteral");
  },
  za.isAsyncProp = function (e) {
    return !e.computed && "Identifier" === e.key.type &&
      "async" === e.key.name &&
      (this.type === ia.name || this.type === ia.num ||
        this.type === ia.string || this.type === ia.bracketL ||
        this.type.keyword ||
        this.options.ecmaVersion >= 9 && this.type === ia.star) &&
      !na.test(this.input.slice(this.lastTokEnd, this.start));
  },
  za.parseObj = function (e, t) {
    var s = this.startNode(), i = !0, n = {};
    for (s.properties = [], this.next(); !this.eat(ia.braceR);) {
      if (i) i = !1;
      else if (
        this.expect(ia.comma),
          this.options.ecmaVersion >= 5 && this.afterTrailingComma(ia.braceR)
      ) {
        break;
      }
  ...
  za.parseProperty = function (e, t) {
    var s, i, n, r, a = this.startNode();
    if (this.options.ecmaVersion >= 9 && this.eat(ia.ellipsis)) {
      return e
        ...
        : (this.type === ia.parenL && t &&
          ...
          this.type === ia.comma && t && t.trailingComma < 0 &&
    ...
    this.options.ecmaVersion >= 6 &&
      (a.method = !1,
        ...
        e || (s = this.eat(ia.star)));
    var o = this.containsEsc;
    return this.parsePropertyName(a),
      !e && !o && this.options.ecmaVersion >= 8 && !s && this.isAsyncProp(a)
        ? (i = !0,
          s = this.options.ecmaVersion >= 9 && this.eat(ia.star),
          this.parsePropertyName(a, t))
        : i = !1,
      this.parsePropertyValue(a, e, s, i, n, r, t, o),
      this.finishNode(a, "Property");
  },
  za.parsePropertyValue = function (e, t, s, i, n, r, a, o) {
    if (
      (s || i) && this.type === ia.colon && this.unexpected(),
        this.eat(ia.colon)
    ) {
      e.value = t
        ? this.parseMaybeDefault(this.start, this.startLoc)
        : this.parseMaybeAssign(!1, a), e.kind = "init";
    } else if (this.options.ecmaVersion >= 6 && this.type === ia.parenL) {
      t && this.unexpected(),
        e.kind = "init",
        e.method = !0,
        e.value = this.parseMethod(s, i);
    } else if (
      t || o || !(this.options.ecmaVersion >= 5) || e.computed ||
      "Identifier" !== e.key.type ||
      "get" !== e.key.name && "set" !== e.key.name || this.type === ia.comma ||
      this.type === ia.braceR || this.type === ia.eq
    ) {
      this.options.ecmaVersion >= 6 && !e.computed &&
        ...
        ? ((s || i) && this.unexpected(),
          ...
          e.kind = "init",
          t ? e.value = this.parseMaybeDefault(n, r, this.copyNode(e.key))
          : this.type === ia.eq && a
  ...
  za.parsePropertyName = function (e) {
    if (this.options.ecmaVersion >= 6) {
      if (this.eat(ia.bracketL)) {
        return e.computed = !0,
          e.key = this.parseMaybeAssign(),
          this.expect(ia.bracketR),
          e.key;
      }
      e.computed = !1;
    }
    return e.key = this.type === ia.num || this.type === ia.string
      ? this.parseExprAtom()
      : this.parseIdent("never" !== this.options.allowReserved);
  },
  za.initFunction = function (e) {
    e.id = null,
      this.options.ecmaVersion >= 6 && (e.generator = e.expression = !1),
      this.options.ecmaVersion >= 8 && (e.async = !1);
  },
  za.parseMethod = function (e, t, s) {
    var i = this.startNode(),
      n = this.yieldPos,
      r = this.awaitPos,
    ...
    return this.initFunction(i),
      ...
      this.awaitPos = 0,
      this.awaitIdentPos = 0,
      this.enterScope(64 | Aa(t, i.generator) | (s ? 128 : 0)),
      this.expect(ia.parenL),
  ...
  za.parseArrowExpression = function (e, t, s, i) {
    var n = this.yieldPos, r = this.awaitPos, a = this.awaitIdentPos;
    return this.enterScope(16 | Aa(s, !1)),
      this.initFunction(e),
  ...
  za.parseFunctionBody = function (e, t, s, i) {
    var n = t && this.type !== ia.braceL, r = this.strict, a = !1;
    if (n) {
      e.body = this.parseMaybeAssign(i),
        e.expression = !0,
        this.checkParams(e, !1);
    } else {
      var o = this.options.ecmaVersion >= 7 &&
        !this.isSimpleParamList(e.params);
      r && !o ||
        (a = this.strictDirective(this.end)) && o &&
          this.raiseRecoverable(
            e.start,
      ...
      this.labels = [],
        ...
        this.checkParams(
          e,
          !r && !a && !t && !s && this.isSimpleParamList(e.params),
        ),
  ...
  za.isSimpleParamList = function (e) {
    for (var t = 0, s = e; t < s.length; t += 1) {
      if ("Identifier" !== s[t].type) return !1;
    }
    return !0;
  },
  za.checkParams = function (e, t) {
    for (
      var s = Object.create(null), i = 0, n = e.params; i < n.length; i += 1
    ) {
      var r = n[i];
      this.checkLValInnerPattern(r, 1, t ? null : s);
    }
  },
  za.parseExprList = function (e, t, s, i) {
    for (var n = [], r = !0; !this.eat(e);) {
      if (r) r = !1;
      else if (this.expect(ia.comma), t && this.afterTrailingComma(e)) break;
      var a = void 0;
      s && this.type === ia.comma
        ? a = null
        : this.type === ia.ellipsis
        ? (a = this.parseSpread(i),
          i && this.type === ia.comma && i.trailingComma < 0 &&
  ...
  za.parseIdent = function (e, t) {
    var s = this.startNode();
    return this.type === ia.name
      ? s.name = this.value
      : this.type.keyword
      ...
      (this.checkUnreserved(s),
        "await" !== s.name || this.awaitIdentPos ||
        (this.awaitIdentPos = s.start)),
      s;
  },
  za.parsePrivateIdent = function () {
    var e = this.startNode();
    return this.type === ia.privateId ? e.name = this.value : this.unexpected(),
      this.next(),
  ...
  za.parseYield = function (e) {
    this.yieldPos || (this.yieldPos = this.start);
    var t = this.startNode();
    return this.next(),
      this.type === ia.semi || this.canInsertSemicolon() ||
        this.type !== ia.star && !this.type.startsExpr
        ? (t.delegate = !1, t.argument = null)
        : (t.delegate = this.eat(ia.star),
          t.argument = this.parseMaybeAssign(e)),
      this.finishNode(t, "YieldExpression");
  },
  za.parseAwait = function (e) {
...
var ja = Pa.prototype;
ja.raise = function (e, t) {
  var s = xa(this.input, e);
  t += " (" + s.line + ":" + s.column + ")";
  var i = new SyntaxError(t);
  throw i.pos = e, i.loc = s, i.raisedAt = this.pos, i;
},
  ja.raiseRecoverable = ja.raise,
  ja.curPosition = function () {
    if (this.options.locations) {
      return new ya(this.curLine, this.pos - this.lineStart);
    }
  };
var Ga = Pa.prototype,
  Ha = function (e) {
...
Ga.enterScope = function (e) {
  this.scopeStack.push(new Ha(e));
},
  Ga.exitScope = function () {
    this.scopeStack.pop();
  },
  Ga.treatFunctionsAsVarInScope = function (e) {
    return 2 & e.flags || !this.inModule && 1 & e.flags;
  },
  Ga.declareName = function (e, t, s) {
    var i = !1;
    if (2 === t) {
...
Ka.startNode = function () {
  return new qa(this, this.start, this.startLoc);
},
  Ka.startNodeAt = function (e, t) {
    return new qa(this, e, t);
  },
  Ka.finishNode = function (e, t) {
    return Xa.call(this, e, t, this.lastTokEnd, this.lastTokEndLoc);
  },
  Ka.finishNodeAt = function (e, t, s, i) {
    return Xa.call(this, e, t, s, i);
  },
  Ka.copyNode = function (e) {
...
var Ya =
  ...
  Qa = Ya + " Extended_Pictographic",
  Za = Qa + " EBase EComp EMod EPres ExtPict",
  Ja = {
    9: Ya,
    10: Qa,
    11: Qa,
...
function oo(e) {
  var t = ao[e] = {
    binary: ma(Ja[e] + " " + eo),
    nonBinary: { General_Category: ma(eo), Script: ma(ro[e]) },
  };
...
for (var ho = 0, lo = [9, 10, 11, 12, 13]; ho < lo.length; ho += 1) oo(lo[ho]);
var co = Pa.prototype,
  uo = function (e) {
    this.parser = e,
      this.validFlags = "gim" + (e.options.ecmaVersion >= 6 ? "uy" : "") +
        (e.options.ecmaVersion >= 9 ? "s" : "") + (e.options.ecmaVersion >= 13
          ? "d"
          : ""),
      this.unicodeProperties = ao[
        e.options.ecmaVersion >= 13
          ? 13
...
uo.prototype.reset = function (e, t, s) {
  var i = -1 !== s.indexOf("u");
  this.start = 0 | e,
    this.source = t + "",
    this.flags = s,
  ...
  uo.prototype.raise = function (e) {
    this.parser.raiseRecoverable(
      this.start,
      "Invalid regular expression: /" + this.source + "/: " + e,
    );
  },
  uo.prototype.at = function (e, t) {
    void 0 === t && (t = !1);
  ...
  uo.prototype.nextIndex = function (e, t) {
    void 0 === t && (t = !1);
    var s = this.source, i = s.length;
    if (e >= i) return i;
    var n, r = s.charCodeAt(e);
    return !t && !this.switchU || r <= 55295 || r >= 57344 || e + 1 >= i ||
        (n = s.charCodeAt(e + 1)) < 56320 || n > 57343 ? e + 1 : e + 2;
  },
  uo.prototype.current = function (e) {
  ...
  uo.prototype.advance = function (e) {
    void 0 === e && (e = !1), this.pos = this.nextIndex(this.pos, e);
  },
  uo.prototype.eat = function (e, t) {
    return void 0 === t && (t = !1),
      this.current(t) === e && (this.advance(t), !0);
  },
  co.validateRegExpFlags = function (e) {
  ...
  co.validateRegExpPattern = function (e) {
    this.regexp_pattern(e),
      !e.switchN && this.options.ecmaVersion >= 9 && e.groupNames.length > 0 &&
      (e.switchN = !0, this.regexp_pattern(e));
  },
  co.regexp_pattern = function (e) {
    e.pos = 0,
      e.lastIntValue = 0,
      e.lastStringValue = "",
  ...
  co.regexp_disjunction = function (e) {
  ...
  co.regexp_alternative = function (e) {
    for (; e.pos < e.source.length && this.regexp_eatTerm(e););
  },
  co.regexp_eatTerm = function (e) {
    return this.regexp_eatAssertion(e)
      ...
      : !!(e.switchU
        ...
        : this.regexp_eatExtendedAtom(e)) && (this.regexp_eatQuantifier(e), !0);
  },
  co.regexp_eatAssertion = function (e) {
    var t = e.pos;
    ...
    if (e.eat(40) && e.eat(63)) {
      var s = !1;
      if (
        this.options.ecmaVersion >= 9 && (s = e.eat(60)), e.eat(61) || e.eat(33)
      ) {
  ...
  co.regexp_eatQuantifier = function (e, t) {
    return void 0 === t && (t = !1),
      !!this.regexp_eatQuantifierPrefix(e, t) && (e.eat(63), !0);
  },
  co.regexp_eatQuantifierPrefix = function (e, t) {
    return e.eat(42) || e.eat(43) || e.eat(63) ||
      this.regexp_eatBracedQuantifier(e, t);
  },
  co.regexp_eatBracedQuantifier = function (e, t) {
    var s = e.pos;
    if (e.eat(123)) {
      var i = 0, n = -1;
      if (
  ...
  co.regexp_eatAtom = function (e) {
    return this.regexp_eatPatternCharacters(e) || e.eat(46) ||
      this.regexp_eatReverseSolidusAtomEscape(e) ||
      this.regexp_eatCharacterClass(e) || this.regexp_eatUncapturingGroup(e) ||
      this.regexp_eatCapturingGroup(e);
  },
  co.regexp_eatReverseSolidusAtomEscape = function (e) {
    var t = e.pos;
    if (e.eat(92)) {
  ...
  co.regexp_eatUncapturingGroup = function (e) {
    var t = e.pos;
    if (e.eat(40)) {
  ...
  co.regexp_eatCapturingGroup = function (e) {
    if (e.eat(40)) {
      if (
        this.options.ecmaVersion >= 9
  ...
  co.regexp_eatExtendedAtom = function (e) {
  ...
  co.regexp_eatInvalidBracedQuantifier = function (e) {
    return this.regexp_eatBracedQuantifier(e, !0) &&
      e.raise("Nothing to repeat"),
      !1;
  },
  co.regexp_eatSyntaxCharacter = function (e) {
    var t = e.current();
    return !!fo(t) && (e.lastIntValue = t, e.advance(), !0);
  },
  co.regexp_eatPatternCharacters = function (e) {
    for (var t = e.pos, s = 0; -1 !== (s = e.current()) && !fo(s);) e.advance();
    return e.pos !== t;
  },
  co.regexp_eatExtendedPatternCharacter = function (e) {
    var t = e.current();
    return !(-1 === t || 36 === t || t >= 40 && t <= 43 || 46 === t ||
      63 === t || 91 === t || 94 === t || 124 === t) && (e.advance(), !0);
  },
  co.regexp_groupSpecifier = function (e) {
    if (e.eat(63)) {
  ...
  co.regexp_eatGroupName = function (e) {
  ...
  co.regexp_eatRegExpIdentifierName = function (e) {
    if (e.lastStringValue = "", this.regexp_eatRegExpIdentifierStart(e)) {
      for (
        e.lastStringValue += po(e.lastIntValue);
  ...
  co.regexp_eatRegExpIdentifierStart = function (e) {
    var t = e.pos, s = this.options.ecmaVersion >= 11, i = e.current(s);
    return e.advance(s),
      92 === i && this.regexp_eatRegExpUnicodeEscapeSequence(e, s) &&
      (i = e.lastIntValue),
      (function (e) {
          return Xr(e, !0) || 36 === e || 95 === e;
        })(i)
        ? (e.lastIntValue = i, !0)
        : (e.pos = t, !1);
  },
  co.regexp_eatRegExpIdentifierPart = function (e) {
    var t = e.pos, s = this.options.ecmaVersion >= 11, i = e.current(s);
    return e.advance(s),
      92 === i && this.regexp_eatRegExpUnicodeEscapeSequence(e, s) &&
      (i = e.lastIntValue),
      (function (e) {
          return Yr(e, !0) || 36 === e || 95 === e || 8204 === e || 8205 === e;
        })(i)
        ? (e.lastIntValue = i, !0)
        : (e.pos = t, !1);
  },
  co.regexp_eatAtomEscape = function (e) {
  ...
  co.regexp_eatBackReference = function (e) {
    var t = e.pos;
  ...
  co.regexp_eatKGroupName = function (e) {
    if (e.eat(107)) {
      if (this.regexp_eatGroupName(e)) {
  ...
  co.regexp_eatCharacterEscape = function (e) {
  ...
  co.regexp_eatCControlLetter = function (e) {
    var t = e.pos;
    if (e.eat(99)) {
  ...
  co.regexp_eatZero = function (e) {
    return 48 === e.current() && !Eo(e.lookahead()) &&
      (e.lastIntValue = 0, e.advance(), !0);
  },
  co.regexp_eatControlEscape = function (e) {
    var t = e.current();
  ...
  co.regexp_eatControlLetter = function (e) {
    var t = e.current();
    return !!mo(t) && (e.lastIntValue = t % 32, e.advance(), !0);
  },
  co.regexp_eatRegExpUnicodeEscapeSequence = function (e, t) {
    void 0 === t && (t = !1);
    ...
    if (e.eat(117)) {
      if (this.regexp_eatFixedHexDigits(e, 4)) {
        ...
        if (n && r >= 55296 && r <= 56319) {
          ...
          if (e.eat(92) && e.eat(117) && this.regexp_eatFixedHexDigits(e, 4)) {
            ...
            if (o >= 56320 && o <= 57343) {
              return e.lastIntValue = 1024 * (r - 55296) + (o - 56320) + 65536,
                !0;
            }
          }
      ...
      if (
        n && e.eat(123) && this.regexp_eatHexDigits(e) && e.eat(125) &&
        ((s = e.lastIntValue) >= 0 && s <= 1114111)
      ) {
        return !0;
      }
  ...
  co.regexp_eatIdentityEscape = function (e) {
    if (e.switchU) {
  ...
  co.regexp_eatDecimalEscape = function (e) {
    e.lastIntValue = 0;
    var t = e.current();
    if (t >= 49 && t <= 57) {
      do {
  ...
  co.regexp_eatCharacterClassEscape = function (e) {
    var t = e.current();
    if (
      function (e) {
  ...
  co.regexp_eatUnicodePropertyValueExpression = function (e) {
    var t = e.pos;
  ...
  co.regexp_validateUnicodePropertyNameAndValue = function (e, t, s) {
    pa(e.unicodeProperties.nonBinary, t) || e.raise("Invalid property name"),
      e.unicodeProperties.nonBinary[t].test(s) ||
      e.raise("Invalid property value");
  },
  co.regexp_validateUnicodePropertyNameOrValue = function (e, t) {
    e.unicodeProperties.binary.test(t) || e.raise("Invalid property name");
  },
  co.regexp_eatUnicodePropertyName = function (e) {
    var t = 0;
    for (e.lastStringValue = ""; go(t = e.current());) {
      e.lastStringValue += po(t), e.advance();
    }
    return "" !== e.lastStringValue;
  },
  co.regexp_eatUnicodePropertyValue = function (e) {
    var t = 0;
  ...
  co.regexp_eatLoneUnicodePropertyNameOrValue = function (e) {
    return this.regexp_eatUnicodePropertyValue(e);
  },
  co.regexp_eatCharacterClass = function (e) {
    if (e.eat(91)) {
  ...
  co.regexp_classRanges = function (e) {
  ...
  co.regexp_eatClassAtom = function (e) {
    var t = e.pos;
    if (e.eat(92)) {
      if (this.regexp_eatClassEscape(e)) return !0;
      if (e.switchU) {
        var s = e.current();
        (99 === s || bo(s)) && e.raise("Invalid class escape"),
          e.raise("Invalid escape");
      }
      e.pos = t;
    }
  ...
  co.regexp_eatClassEscape = function (e) {
    var t = e.pos;
  ...
  co.regexp_eatClassControlLetter = function (e) {
    var t = e.current();
    return !(!Eo(t) && 95 !== t) && (e.lastIntValue = t % 32, e.advance(), !0);
  },
  co.regexp_eatHexEscapeSequence = function (e) {
    var t = e.pos;
    if (e.eat(120)) {
  ...
  co.regexp_eatDecimalDigits = function (e) {
    var t = e.pos, s = 0;
    for (e.lastIntValue = 0; Eo(s = e.current());) {
      e.lastIntValue = 10 * e.lastIntValue + (s - 48), e.advance();
    }
    return e.pos !== t;
  },
  co.regexp_eatHexDigits = function (e) {
    var t = e.pos, s = 0;
    for (e.lastIntValue = 0; xo(s = e.current());) {
      e.lastIntValue = 16 * e.lastIntValue + vo(s), e.advance();
    }
    return e.pos !== t;
  },
  co.regexp_eatLegacyOctalEscapeSequence = function (e) {
  ...
  co.regexp_eatOctalDigit = function (e) {
    var t = e.current();
    return bo(t) ? (e.lastIntValue = t - 48, e.advance(), !0)
    : (e.lastIntValue = 0, !1);
  },
  co.regexp_eatFixedHexDigits = function (e, t) {
    var s = e.pos;
    e.lastIntValue = 0;
    for (var i = 0; i < t; ++i) {
      var n = e.current();
      if (!xo(n)) return e.pos = s, !1;
      e.lastIntValue = 16 * e.lastIntValue + vo(n), e.advance();
    }
    return !0;
  };
var So = function (e) {
    this.type = e.type,
      ...
      this.start = e.start,
      this.end = e.end,
      e.options.locations && (this.loc = new Ea(e, e.startLoc, e.endLoc)),
...
Ao.next = function (e) {
  ...
  this.raiseRecoverable(
    ...
    this.options.onToken && this.options.onToken(new So(this)),
  ...
  "undefined" != typeof Symbol && (Ao[Symbol.iterator] = function () {
    var e = this;
    return {
      next: function () {
        var t = e.getToken();
        return { done: t.type === ia.eof, value: t };
      },
    };
  }),
  Ao.nextToken = function () {
    ...
    return e && e.preserveSpace || this.skipSpace(),
      ...
      this.pos >= this.input.length ? this.finishToken(ia.eof) : e.override
        ? e.override(this)
        : void this.readToken(this.fullCharCodeAtPos());
  },
  Ao.readToken = function (e) {
    return Xr(e, this.options.ecmaVersion >= 6) || 92 === e ? this.readWord()
  ...
  Ao.skipBlockComment = function () {
    ...
    if (
      ...
      for (var i = void 0, n = t; (i = oa(this.input, n, this.pos)) > -1;) {
  ...
  Ao.skipLineComment = function (e) {
    for (
      ...
      this.pos < this.input.length && !aa(i);
    ) {
  ...
  Ao.skipSpace = function () {
    ...
    for (; this.pos < this.input.length;) {
      ...
      switch (e) {
        ...
        default:
          if (
            !(e > 8 && e < 14 || e >= 5760 && ha.test(String.fromCharCode(e)))
          ) {
            break e;
          }
          ++this.pos;
  ...
  Ao.readToken_dot = function () {
    ...
    return this.options.ecmaVersion >= 6 && 46 === e && 46 === t
      ? (this.pos += 3, this.finishToken(ia.ellipsis))
      : (++this.pos, this.finishToken(ia.dot));
  },
  Ao.readToken_slash = function () {
    var e = this.input.charCodeAt(this.pos + 1);
    return this.exprAllowed ? (++this.pos, this.readRegexp())
    : 61 === e ? this.finishOp(ia.assign, 2) : this.finishOp(ia.slash, 1);
  },
  Ao.readToken_mult_modulo_exp = function (e) {
    var t = this.input.charCodeAt(this.pos + 1),
      s = 1,
      i = 42 === e ? ia.star : ia.modulo;
    return this.options.ecmaVersion >= 7 && 42 === e && 42 === t &&
      (++s, i = ia.starstar, t = this.input.charCodeAt(this.pos + 2)),
      61 === t ? this.finishOp(ia.assign, s + 1) : this.finishOp(i, s);
  },
    ...
    if (t === e) {
      if (this.options.ecmaVersion >= 12) {
        if (61 === this.input.charCodeAt(this.pos + 2)) {
          return this.finishOp(ia.assign, 3);
        }
      }
      return this.finishOp(124 === e ? ia.logicalOR : ia.logicalAND, 2);
    }
    return 61 === t ? this.finishOp(ia.assign, 2)
    : this.finishOp(124 === e ? ia.bitwiseOR : ia.bitwiseAND, 1);
  },
  Ao.readToken_caret = function () {
    return 61 === this.input.charCodeAt(this.pos + 1)
      ? this.finishOp(ia.assign, 2) : this.finishOp(ia.bitwiseXOR, 1);
  },
  Ao.readToken_plus_min = function (e) {
    ...
    return t === e
      ? 45 !== t || this.inModule ||
          ...
          0 !== this.lastTokEnd &&
            !na.test(this.input.slice(this.lastTokEnd, this.pos))
        ? this.finishOp(ia.incDec, 2)
        : (this.skipLineComment(3), this.skipSpace(), this.nextToken())
      : 61 === t ? this.finishOp(ia.assign, 2) : this.finishOp(ia.plusMin, 1);
  },
  ...
  Ao.readToken_eq_excl = function (e) {
    ...
    return 61 === t
      ...
      ? (this.pos += 2, this.finishToken(ia.arrow))
      : this.finishOp(61 === e ? ia.eq : ia.prefix, 1);
  },
  Ao.readToken_question = function () {
    ...
    if (e >= 11) {
      ...
      if (46 === t) {
        ...
        if (s < 48 || s > 57) return this.finishOp(ia.questionDot, 2);
      }
      if (63 === t) {
        if (e >= 12) {
          if (61 === this.input.charCodeAt(this.pos + 2)) {
        ...
        return this.finishOp(ia.coalesce, 2);
      }
    }
    return this.finishOp(ia.question, 1);
  },
  Ao.readToken_numberSign = function () {
    var e = 35;
    if (
      this.options.ecmaVersion >= 13 &&
      (++this.pos, Xr(e = this.fullCharCodeAtPos(), !0) || 92 === e)
    ) {
      return this.finishToken(ia.privateId, this.readWord1());
    }
    this.raise(this.pos, "Unexpected character '" + ko(e) + "'");
  },
  Ao.getTokenFromCode = function (e) {
    switch (e) {
      ...
      case 40:
        return ++this.pos, this.finishToken(ia.parenL);
      case 41:
        return ++this.pos, this.finishToken(ia.parenR);
      case 59:
        return ++this.pos, this.finishToken(ia.semi);
      case 44:
        return ++this.pos, this.finishToken(ia.comma);
      case 91:
        return ++this.pos, this.finishToken(ia.bracketL);
      case 93:
        return ++this.pos, this.finishToken(ia.bracketR);
      case 123:
        return ++this.pos, this.finishToken(ia.braceL);
      case 125:
        return ++this.pos, this.finishToken(ia.braceR);
      case 58:
        return ++this.pos, this.finishToken(ia.colon);
      case 96:
        if (this.options.ecmaVersion < 6) break;
        return ++this.pos, this.finishToken(ia.backQuote);
      case 48:
        var t = this.input.charCodeAt(this.pos + 1);
      ...
      case 126:
        return this.finishOp(ia.prefix, 1);
      case 35:
  ...
  Ao.readRegexp = function () {
    for (var e, t, s = this.pos;;) {
      ...
      if (na.test(i) && this.raise(s, "Unterminated regular expression"), e) {
        e = !1;
      } else {
        if ("[" === i) t = !0;
        else if ("]" === i && t) t = !1;
    ...
    var o = this.regexpState || (this.regexpState = new uo(this));
    o.reset(s, n, a),
    ...
    return this.finishToken(ia.regexp, { pattern: n, flags: a, value: h });
  },
  Ao.readInt = function (e, t, s) {
    for (
  ...
  Ao.readRadixNumber = function (e) {
    ...
    return null == s &&
      ...
      this.options.ecmaVersion >= 11 && 110 === this.input.charCodeAt(this.pos)
        ? (s = Po(this.input.slice(t, this.pos)), ++this.pos)
        : Xr(this.fullCharCodeAtPos()) &&
          this.raise(this.pos, "Identifier directly after number"),
      this.finishToken(ia.num, s);
  },
  Ao.readNumber = function (e) {
    ...
    if (!s && !e && this.options.ecmaVersion >= 11 && 110 === i) {
      var n = Po(this.input.slice(t, this.pos));
      return ++this.pos,
        Xr(this.fullCharCodeAtPos()) &&
        this.raise(this.pos, "Identifier directly after number"),
        this.finishToken(ia.num, n);
    }
    s && /[89]/.test(this.input.slice(t, this.pos)) && (s = !1),
      ...
      this.raise(this.pos, "Identifier directly after number");
    var r,
      a = (r = this.input.slice(t, this.pos),
        s
          ? parseInt(r, 8)
          : parseFloat(r.replace(/_/g, "")));
    return this.finishToken(ia.num, a);
  },
  ...
  Ao.readString = function (e) {
    for (var t = "", s = ++this.pos;;) {
      ...
      92 === i
        ...
        : (aa(i) && this.raise(this.start, "Unterminated string constant"),
          ++this.pos);
    }
    return t += this.input.slice(s, this.pos++), this.finishToken(ia.string, t);
  };
var wo = {};
Ao.tryReadTemplateToken = function () {
    ...
    for (var e = "", t = this.pos;;) {
      ...
      if (96 === s || 36 === s && 123 === this.input.charCodeAt(this.pos + 1)) {
        return this.pos !== this.start ||
            this.type !== ia.template && this.type !== ia.invalidTemplate
          ? (e += this.input.slice(t, this.pos),
            this.finishToken(ia.template, e))
          : 36 === s
          ? (this.pos += 2, this.finishToken(ia.dollarBraceL))
          : (++this.pos, this.finishToken(ia.backQuote));
      }
      if (92 === s) {e += this.input.slice(t, this.pos),
          e += this.readEscapedChar(!0),
          t = this.pos;} else if (aa(s)) {
  ...
  Ao.readEscapedChar = function (e) {
    ...
    switch (++this.pos, t) {
      ...
      default:
        ...
        return aa(t) ? "" : String.fromCharCode(t);
    }
  },
  ...
  Ao.readWord1 = function () {
    ...
    for (
      ...
      if (Yr(n, i)) this.pos += n <= 65535 ? 1 : 2;
      else {
        if (92 !== n) break;
  ...
  Ao.readWord = function () {
    var e = this.readWord1(), t = ia.name;
    return this.keywords.test(e) && (t = ta[e]), this.finishToken(t, e);
  };
Pa.acorn = {
  Parser: Pa,
  version: "8.7.0",
  ...
  tokContexts: Ba,
  isIdentifierChar: Yr,
  isIdentifierStart: Xr,
  Token: So,
  isNewLine: aa,
  lineBreak: na,
  lineBreakG: ra,
  nonASCIIwhitespace: ha,
};
class Co {
  constructor(e) {
...
const Io = (e) =>
    () => {
      se({
        ...
        message:
          `Cannot access the file system (via "${e}") when using the browser build of Rollup. Make sure you supply a plugin with custom resolveId and load hooks to Rollup.`,
...
async function _o(e, t, s, i, n, r, a, o) {
  const h = await function (e, t, s, i, n, r, a) {
    let o = null, h = null;
    if (n) {
      o = new Set();
      for (const s of n) e === s.source && t === s.importer && o.add(s.plugin);
      h = (e, t) => ({
        ...e,
        resolve: (e, s, { custom: r, isEntry: a, skipSelf: o } = q) =>
          i(e, s, r, a, o ? [...n, { importer: s, plugin: t, source: e }] : n),
      });
    }
    return s.hookFirst("resolveId", [e, t, { custom: r, isEntry: a }], h, o);
  }(e, t, i, n, r, a, o);
  return h;
}
function $o(e, t, { hook: s, id: i } = {}) {
  return "string" == typeof e && (e = { message: e }),
    e.code && e.code !== ne.PLUGIN_ERROR && (e.pluginCode = e.code),
    e.code = ne.PLUGIN_ERROR,
    e.plugin = t,
    s && (e.hook = s),
    i && (e.id = i),
    se(e);
...
const Ro = { delete: () => !1, get() {}, has: () => !1, set() {} };
function Mo(e) {
  return e.startsWith("at position ") || e.startsWith("at output position ")
    ...
    : se({
      ...
      message:
        `The plugin name ${e} is being used twice in the same build. Plugin names must be distinct or provide a cacheKey (please post an issue to the plugin if you are a plugin user).`,
    });
}
async function Do(e, t, s, i) {
  const n = t.id, r = [];
  let a = null === e.map ? null : dr(e.map);
  const o = e.code;
  let h = e.ast;
  const c = [], u = [];
  let d = !1;
  ...
  let g;
  try {
    g = await s.hookReduceArg0("transform", [m, n], function (e, s, n) {
      let a, o;
      if ("string" == typeof s) a = s;
      else {
        if (!s || "object" != typeof s) return e;
        if (t.updateOptions(s), null == s.code) {
          return (s.map || s.ast) && i(function (e) {
            return {
              code: ne.NO_TRANSFORM_MAP_OR_AST_WITHOUT_CODE,
              message:
                `The plugin "${e}" returned a "map" or "ast" without returning a "code". This will be ignored.`,
            };
          }(n.name)),
            e;
        }
      ...
      return null !== o &&
        r.push(
          dr("string" == typeof o ? JSON.parse(o) : o) ||
            { missing: !0, plugin: n.name },
        ),
        a;
    }, (e, t) => {
      return f = t.name, {
        ...
        emitAsset: (
          t,
          s,
        ) => (u.push({ name: t, source: s, type: "asset" }), e.emitAsset(t, s)),
        emitChunk: (
          t,
          s,
        ) => (u.push({ id: t, name: s && s.name, type: "chunk" }),
          e.emitChunk(t, s)),
        ...
        getCombinedSourcemap() {
          const e = function (e, t, s, i, n) {
            return i.length
              ? { version: 3, ...gn(e, t, s, i, mn(n)).traceMappings() }
              : s;
          }(n, o, a, r, i);
          if (!e) {
    ...
    $o(e, f, { hook: "transform", id: n });
  }
  return d || u.length && (t.transformFiles = u),
    {
      ast: h,
      code: g,
...
class Lo {
  constructor(e, t, s, i) {
    this.graph = e,
      ...
      this.resolveId = async (e, t, s, i, n = null) =>
          ...
          this.getNormalizedResolvedIdWithoutDefaults(
            !this.options.external(e, t, !1) &&
              await _o(
                ...
                n,
                s,
                "boolean" == typeof i ? i : !t,
              ),
            t,
            e,
          ),
        ),
      this.hasModuleSideEffects = s.treeshake
        ? s.treeshake.moduleSideEffects
        : () => !0,
      this.readQueue = new Co(s.maxParallelFileReads);
  }
  ...
  async addEntryModules(e, t) {
    ...
    const n = await this.extendLoadModulesPromise(
      Promise.all(e.map(({ id: e, importer: t }) =>
        this.loadEntryModule(e, !0, t, null))).then((n) => {
          for (let r = 0; r < n.length; r++) {
            const a = n[r];
            a.isUserDefinedEntryPoint = a.isUserDefinedEntryPoint || t,
              Vo(a, e[r], t, i + r);
            const o = this.indexedEntryModules.find((e) =>
              e.module === a);
            o
              ? o.index = Math.min(o.index, s + r)
              : this.indexedEntryModules.push({ index: s + r, module: a });
          }
          return this.indexedEntryModules.sort(({ index: e }, { index: t }) =>
            e > t ? 1 : -1),
            n;
        }),
    );
  ...
  addEntryWithImplicitDependants(e, t) {
    ...
    return this.extendLoadModulesPromise(
      this.loadEntryModule(e.id, !1, e.importer, null).then(async (i) => {
        if (Vo(i, e, !1, s), !i.info.isEntry) {
          this.implicitEntryModules.add(i);
          const s = await Promise.all(t.map((t) =>
            this.loadEntryModule(t, !1, e.importer, i.id)));
          for (const e of s) {
  ...
  async addModuleSource(e, t, s) {
    ...
    try {
      i = await this.readQueue.run(async () => {
        var t;
        return null !== (t = await this.pluginDriver.hookFirst("load", [e])) &&
            void 0 !== t
          ? t
          : await No.readFile(e, "utf8");
      });
    } catch (s) {
      Li("load modules", 3);
      let i = `Could not load ${e}`;
      throw t && (i += ` (imported by ${ee(t)})`),
        i += `: ${s.message}`,
        s.message = i,
        s;
    }
    ...
    if (
      !r || r.customTransformCache || r.originalCode !== n.code ||
      ...
      s.updateOptions(n),
        s.setSource(await Do(n, s, this.pluginDriver, this.options.onwarn));
    } else {
      if (r.transformFiles) {
  ...
  async fetchModule(
    { id: e, meta: t, moduleSideEffects: s, syntheticNamedExports: i },
    n,
    r,
    a,
  ) {
    const o = this.modulesById.get(e);
    if (o instanceof Wi) return await this.handleExistingModule(o, r, a), o;
    const h = new Wi(this.graph, e, this.options, r, s, i, t);
  ...
  fetchResolvedDependency(e, t, s) {
    if (s.external) {
      const { external: i, id: n, moduleSideEffects: r, meta: a } = s;
      this.modulesById.has(n) ||
        this.modulesById.set(
          n,
          new ve(this.options, n, r, a, "absolute" !== i && P(n)),
        );
      const o = this.modulesById.get(n);
      return o instanceof ve ? Promise.resolve(o) : se(function (e, t) {
        return {
          code: ne.INVALID_EXTERNAL_ID,
          message: `'${e}' is imported as an external by ${
            ee(t)
  ...
  async fetchStaticDependencies(e, t) {
    for (
      const s of await Promise.all(t.map((t) =>
        t.then(([t, s]) => this.fetchResolvedDependency(t, e.id, s))))
    ) {
      e.dependencies.add(s), s.importers.push(e.id);
    }
    if (
      !this.options.treeshake || "no-treeshake" === e.info.moduleSideEffects
    ) {
      for (const t of e.dependencies) {
        t instanceof Wi && (t.importedFromNotTreeshaken = !0);
      }
    }
  }
    ...
    if (e) {
      if ("object" == typeof e) {
        ...
        return {
          ...e,
          external: n &&
            ("relative" === n || !P(e.id) || !0 === n && Bo(e.id, s, i) ||
              "absolute"),
        };
      }
      const n = this.options.external(e, t, !0);
      return {
        external: n && (Bo(e, s, i) || "absolute"),
        id: n && i ? Oo(e, t) : e,
      };
    }
    const n = i ? Oo(s, t) : s;
    return !1 === e || this.options.external(n, t, !0)
      ? { external: Bo(n, s, i) || "absolute", id: n }
      : null;
  }
  ...
  getResolveStaticDependencyPromises(e) {
    return Array.from(
      ...
      async (t) => [
        t,
        e.resolvedIds[t] = e.resolvedIds[t] ||
          this.handleResolveId(await this.resolveId(t, e.id, K, !1), t, e.id),
      ],
    );
  }
  getResolvedIdWithDefaults(e) {
    ...
    return {
      ...
      id: e.id,
      meta: e.meta || {},
      moduleSideEffects: null !== (t = e.moduleSideEffects) && void 0 !== t
        ? t
        : this.hasModuleSideEffects(e.id, !!i),
      syntheticNamedExports: null !== (s = e.syntheticNamedExports) &&
        void 0 !== s && s,
    };
  }
  async handleExistingModule(e, t, s) {
    const i = this.moduleLoadPromises.get(e);
    if (s) return "resolveDependencies" === s ? Fo(i) : i;
    if (t) {
  ...
  handleResolveId(e, t, s) {
    return null === e
      ? k(t)
        ? se(function (e, t) {
          return {
            code: ne.UNRESOLVED_IMPORT,
            message: `Could not resolve '${e}' from ${ee(t)}`,
          };
        }(t, s))
        : (this.options.onwarn(function (e, t) {
          return {
            code: ne.UNRESOLVED_IMPORT,
            importer: ee(t),
            message: `'${e}' is imported by ${
              ee(t)
      ...
      : (e.external && e.syntheticNamedExports &&
        this.options.onwarn(function (e, t) {
          return {
            code: ne.EXTERNAL_SYNTHETIC_EXPORTS,
            importer: ee(t),
            message:
              `External '${e}' can not have 'syntheticNamedExports' enabled.`,
            source: e,
          };
        }(t, s)),
        e);
    ...
    return null == n
      ? se(
        null === i
          ? function (e) {
            return {
              code: ne.UNRESOLVED_ENTRY,
              message: `Could not resolve entry module (${ee(e)}).`,
            };
          }(e)
          : function (e, t) {
            return {
      ...
      ? se(
        null === i
          ? function (e) {
            return {
              code: ne.UNRESOLVED_ENTRY,
              message: `Entry module cannot be external (${ee(e)}).`,
            };
          }(e)
          : function (e, t) {
            return {
      ...
      : this.fetchModule(
        this.getResolvedIdWithDefaults("object" == typeof n ? n : { id: n }),
        void 0,
        t,
        !1,
      );
  ...
  async resolveDynamicImport(e, t, s) {
    ...
    return "string" != typeof t
      ...
      : this.handleResolveId(
        this.getResolvedIdWithDefaults(
          this.getNormalizedResolvedIdWithoutDefaults(i, s, t),
        ),
        t,
        s,
      );
...
function Vo(e, { fileName: t, name: s }, i, n) {
  var r;
...
class zo extends wt {
  constructor() {
    super(), this.parent = null, this.variables.set("undefined", new mi());
  }
  findVariable(e) {
    let t = this.variables.get(e);
    return t || (t = new ts(e), this.variables.set(e, t)), t;
  }
}
function Wo(e, t, s, i, n, r) {
  let a = !1;
  return (
    ...o
  ) => (a ||
    (a = !0,
      fe(
        {
          message:
            `The "this.${t}" plugin context function used by plugin ${i} is deprecated. The "this.${s}" plugin context function should be used instead.`,
          plugin: i,
        },
        n,
        r,
...
function Uo(e, t, s, i, n, r) {
  let a, o = !0;
  if (
    "string" != typeof e.cacheKey &&
    (e.name.startsWith("at position ") ||
        e.name.startsWith("at output position ") || r.has(e.name)
      ? o = !1
      : r.add(e.name)), t
  ) {
    if (o) {
      const s = e.cacheKey || e.name;
      l = t[s] || (t[s] = Object.create(null)),
        a = {
          delete: (e) => delete l[e],
          get(e) {
            const t = l[e];
  ...
  const c = {
    ...
    load: (e) => s.moduleLoader.preloadModule(e),
    meta: { rollupVersion: "2.67.3", watchMode: s.watchMode },
    get moduleIds() {
      ...
      return function* () {
        fe(
          {
            message:
              `Accessing "this.moduleIds" on the plugin context by plugin ${e.name} is deprecated. The "this.getModuleIds" plugin context function should be used instead.`,
            plugin: e.name,
          },
          !1,
          i,
    ...
    resolve: (t, i, { custom: n, isEntry: r, skipSelf: a } = q) =>
      s.moduleLoader.resolveId(
        t,
        i,
        n,
        r,
        a ? [{ importer: i, plugin: e, source: t }] : null,
      ),
    resolveId: Wo(
      (e, t) =>
        s.moduleLoader.resolveId(e, t, q, void 0).then((e) => e && e.id),
      "resolveId",
      "resolve",
      e.name,
      !0,
...
function Go(e, t) {
  return se({
    ...
    message:
      `Error running plugin hook ${e} for ${t}, expected a function hook.`,
  });
}
class Ho {
  constructor(e, t, s, i, n) {
    this.graph = e,
      this.options = t,
      function (e, t) {
        for (const { active: s, deprecated: i, replacement: n } of To) {
          for (const r of e) {
            i in r &&
              fe(
                {
                  message:
                    `The "${i}" hook used by plugin ${r.name} is deprecated. The "${n}" hook should be used instead.`,
                  plugin: r.name,
                },
                s,
                t,
      ...
      this.pluginCache = i,
      this.fileEmitter = new kr(e, t, n && n.fileEmitter),
    ...
    if (
      this.pluginContexts = new Map(
        this.plugins.map((s) => [s, Uo(s, i, e, t, this.fileEmitter, r)]),
      ), n
    ) {
      for (const e of s) {
        for (const s of jo) {
          s in e &&
            t.onwarn(
              (a = e.name,
                o = s,
                {
                  code: ne.INPUT_HOOK_IN_OUTPUT_PLUGIN,
                  message:
                    `The "${o}" hook used by the output plugin ${a} is a build time hook and will not be run for that plugin. Either this plugin cannot be used as an output plugin, or it should have an option to configure it as an output plugin.`,
                }),
            );
        }
      }
  ...
  createOutputPluginDriver(e) {
    return new Ho(this.graph, this.options, e, this.pluginCache, this);
  }
  hookFirst(e, t, s, i) {
  ...
  hookReduceArg0(e, [t, ...s], i, n) {
    ...
    for (const t of this.plugins) {
      r = r.then((r) => {
        const a = [r, ...s], o = this.runHook(e, a, t, !1, n);
        return o
          ? o.then((e) => i.call(this.pluginContexts.get(t), r, e, t))
          : r;
      });
    }
    return r;
  ...
  hookReduceArg0Sync(e, [t, ...s], i, n) {
    for (const r of this.plugins) {
      const a = [t, ...s], o = this.runHookSync(e, a, r, n);
  ...
  hookReduceValue(e, t, s, i, n) {
    ...
    for (const t of this.plugins) {
      r = r.then((r) => {
        ...
        return a
          ? a.then((e) => i.call(this.pluginContexts.get(t), r, e, t))
          : r;
      });
    }
    return r;
  ...
  hookSeq(e, t, s) {
    ...
    for (const n of this.plugins) {
      i = i.then(() => this.runHook(e, t, n, !1, s));
    }
    return i;
  }
  hookSeqSync(e, t, s) {
  ...
  runHook(e, t, s, i, n) {
    ...
    return n && (a = n(a, s)),
      Promise.resolve().then(() => {
        if ("function" != typeof r) return i ? r : Go(e, s.name);
        const n = r.apply(a, t);
        if (!n || !n.then) return n;
        const o = Promise.resolve(n);
        return o.then(() => o);
      }).catch((t) => $o(t, s.name, { hook: e }));
  }
  runHookSync(e, t, s, i) {
    const n = s[e];
    if (!n) return;
    ...
    i && (r = i(r, s));
    try {
      return "function" != typeof n ? Go(e, s.name) : n.apply(r, t);
    } catch (t) {
      return $o(t, s.name, { hook: e });
    }
  }
}
class qo {
  constructor(e, t) {
    ...
    if (
      this.options = e,
        ...
        this.deoptimizationTracker = new B(),
        this.entryModules = [],
        this.modulesById = new Map(),
        this.needsTreeshakingPass = !1,
        this.phase = ki.LOAD_AND_PARSE,
        this.scope = new zo(),
      ...
      this.pluginCache = (null === (i = e.cache) || void 0 === i
        ? void 0
        : i.plugins) || Object.create(null);
    ...
    this.pluginDriver = new Ho(this, e, e.plugins, this.pluginCache),
      this.acornParser = Pa.extend(...e.acornInjectPlugins),
      this.moduleLoader = new Lo(
        this,
        this.modulesById,
        this.options,
        this.pluginDriver,
  ...
  async build() {
    Di("generate module graph", 2),
      await this.generateModuleGraph(),
      Li("generate module graph", 2),
      Di("sort modules", 2),
      this.phase = ki.ANALYSE,
      this.sortModules(),
      Li("sort modules", 2),
      Di("mark included statements", 2),
      this.includeStatements(),
      Li("mark included statements", 2),
      this.phase = ki.GENERATE;
  }
  contextParse(e, t = {}) {
    const s = t.onComment, i = [];
    t.onComment = s && "function" == typeof s
      ? (
        e,
        n,
        r,
        a,
        ...o
      ) => (i.push({ end: a, start: r, type: e ? "Block" : "Line", value: n }),
        s.call(t, e, n, r, a, ...o))
      : i;
    const n = this.acornParser.parse(e, { ...this.options.acorn, ...t });
    return "object" == typeof s && s.push(...i),
      t.onComment = s,
      function (e, t, s) {
        const i = [], n = [];
        for (const t of e) {Qe.test(t.value) ? i.push(t)
          : Ge.test(t.value) && n.push(t);}
        for (const e of n) Ze(t, e, !1);
        He(t, { annotationIndex: 0, annotations: i, code: s });
      }(i, n, e),
      n;
  }
  getCache() {
  ...
  includeStatements() {
    for (const e of [...this.entryModules, ...this.implicitEntryModules]) Bi(e);
    if (this.options.treeshake) {
      let e = 1;
      do {
        Di(`treeshaking pass ${e}`, 3), this.needsTreeshakingPass = !1;
        for (const e of this.modules) {
          e.isExecuted && ("no-treeshake" === e.info.moduleSideEffects
            ? e.includeAllInBundle()
            : e.include());
        }
        if (1 === e) {
          for (
            const e of [...this.entryModules, ...this.implicitEntryModules]
          ) {
            !1 !== e.preserveSignature &&
              (e.includeAllExports(!1), this.needsTreeshakingPass = !0);
          }
        }
        Li("treeshaking pass " + e++, 3);
    ...
    for (const e of this.implicitEntryModules) {
      for (const t of e.implicitlyLoadedAfter) {
        t.info.isEntry || t.isIncluded() || se(le(t));
      }
    }
  }
  sortModules() {
    const { orderedModules: e, cyclePaths: t } = function (e) {
      ...
      return { cyclePaths: s, orderedModules: a };
    }(this.entryModules);
    for (const e of t) {
      this.options.onwarn({
  ...
  warnForMissingExports() {
    for (const e of this.modules) {
      for (const t of e.importDescriptions.values()) {
        "*" === t.name || t.module.getVariableForExportName(t.name)[0] ||
          e.warn({
            code: "NON_EXISTENT_EXPORT",
            message: `Non-existent export '${t.name}' is imported from ${
              ee(t.module.id)
            }`,
            name: t.name,
            source: t.module.id,
...
const Xo = (e) => console.warn(e.message || e);
function Yo(e, t, s, i, n = /$./) {
  ...
  a.length > 0 &&
    i({
      code: "UNKNOWN_OPTION",
      message: `Unknown ${s}: ${a.join(", ")}. Allowed options: ${
        [...r].sort().join(", ")
      }`,
    });
}
const Qo = {
  ...
  Jo = (e, t, s, i) => {
    var n;
    const r = null === (n = e) || void 0 === n ? void 0 : n.preset;
    if (r) {
      const i = t[r];
      if (i) return { ...i, ...e };
      se(oe(`${s}.preset`, eh(s), `valid values are ${Z(Object.keys(t))}`, r));
    }
    return ((e, t, s) =>
      (i) => {
        if ("string" == typeof i) {
        ...
        return ((e) => e && "object" == typeof e ? e : {})(i);
      })(t, s, i)(e);
  },
  eh = (e) => e.split(".").join("").toLowerCase();
const th = (e) => {
    const { onwarn: t } = e;
    return t
      ? (e) => {
        e.toString = () => {
          ...
          return e.plugin && (t += `(${e.plugin} plugin) `),
            e.loc &&
            (t += `${ee(e.loc.file)} (${e.loc.line}:${e.loc.column}) `),
            t += e.message,
            t;
        }, t(e, Xo);
      }
  ...
  ih = (e) => Ko(e.acornInjectPlugins),
  nh = (e) => {
    var t;
    return (null === (t = e.cache) || void 0 === t ? void 0 : t.cache) ||
      e.cache;
  },
  rh = (e) => {
    if (!0 === e) return () => !0;
    ...
    if (e) {
      const t = new Set(), s = [];
      for (const i of Ko(e)) i instanceof RegExp ? s.push(i) : t.add(i);
  ...
  uh = (e, t) => {
    ...
    return null == s && t.add("preserveEntrySignatures"),
      null != s ? s : "strict";
  },
  dh = (e, t, s) => {
  ...
  ph = (e, t, s) => {
    const i = e.treeshake;
    if (!1 === i) return !1;
    const n = Jo(e.treeshake, Qo, "treeshake", "false, true, ");
    return void 0 !== n.pureExternalModules &&
      me(
      ...
      ),
      {
        ...
        moduleSideEffects: "object" == typeof i && i.pureExternalModules
          ...
          : fh(n.moduleSideEffects, void 0),
        propertyReadSideEffects: "always" === n.propertyReadSideEffects
          ? "always"
...
const Eh = (e, t, s) => {
  ...
  vh = (e, t) => {
    var s;
    const i = (null !== (s = e.inlineDynamicImports) && void 0 !== s
        ? s
  ...
  bh = (e, t, s) => {
    var i;
    const n =
      (null !== (i = e.preserveModules) && void 0 !== i
        ? i
        : s.preserveModules) || !1;
    if (n) {
      if (t) {
  ...
  Ph = (e) => {
    const t = { autoId: !1, basePath: "", define: "define", ...e.amd };
    ...
    let s;
    return s = t.autoId
      ? { autoId: !0, basePath: t.basePath, define: t.define }
      : { autoId: !1, define: t.define, id: t.id },
      s;
  },
  kh = (e, t) => {
    const s = e[t];
...
function Nh(e, t) {
  ...
  if (null == s) t.add("exports");
    ...
    return se(
      (i = s,
        {
          code: ne.INVALID_EXPORT_OPTION,
          message:
            `"output.exports" must be "default", "named", "none", "auto", or left unspecified (defaults to "auto"), received "${i}"`,
          url: "https://rollupjs.org/guide/en/#outputexports",
        }),
    );
  }
...
const _h = (e, t) => {
  ...
  Rh = (e, t) => {
        ...
        if (!i.has(e)) {
          if (i.add(e), !Th.has(e)) {
            return se(
              oe(
                ...
                "outputinterop",
                `use one of ${
                  Array.from(Th.values(), (e) => JSON.stringify(e)).join(", ")
                }`,
                e,
              ),
            );
          ...
          "boolean" == typeof e &&
            fe(
              {
                message:
                  `The boolean value "${e}" for the "output.interop" option is deprecated. Use ${
                    e
                      ? '"auto"'
                      : '"esModule", "default" or "defaultOnly"'
                  } instead.`,
                url: "https://rollupjs.org/guide/en/#outputinterop",
              },
              !1,
    ...
    if ("function" == typeof s) {
      ...
      let t = null;
      return (i) =>
        null === i ? t || n(t = s(i)) : i in e ? e[i] : n(e[i] = s(i));
    }
  ...
  Dh = (e, t, s) => {
    var i;
    return null !== (i = e.minifyInternalExports) && void 0 !== i ? i
    : s || "es" === t || "system" === t;
  };
function Lh(e) {
  return async function (e, t) {
      ...
      const s = Ko(e.plugins),
        { options: i, unsetOptions: n } = function (e) {
          ...
          const n = new Set(),
            ...
            h = {
              acorn: sh(e),
              acornInjectPlugins: ih(e),
              cache: nh(e),
              context: r,
              experimentalCacheExpiry:
                null !== (s = e.experimentalCacheExpiry) && void 0 !== s ? s
                : 10,
              external: rh(e.external),
              inlineDynamicImports: ah(e, a, o),
              input: oh(e),
              makeAbsoluteExternalsRelative:
                null === (i = e.makeAbsoluteExternalsRelative) ||
                void 0 === i || i,
              manualChunks: hh(e, a, o),
              maxParallelFileReads: lh(e),
              moduleContext: ch(e, r),
              onwarn: a,
              perf: e.perf || !1,
              plugins: Ko(e.plugins),
              preserveEntrySignatures: uh(e, n),
              preserveModules: dh(e, a, o),
          ...
          return Yo(
            ...
            { options: h, unsetOptions: n };
        }(
          await s.reduce(
            function (e) {
              return async (t, s) =>
                s.options &&
                  await s.options.call({
                    meta: { rollupVersion: "2.67.3", watchMode: e },
                  }, await t) || t;
            }(t),
            Promise.resolve(e),
          ),
        );
      return Oh(i.plugins, "at position "), { options: i, unsetOptions: n };
    }(e, null !== t);
    !function (e) {
      e.perf
        ? (_i = new Map(), Di = Ti, Li = Ri, e.plugins = e.plugins.map(Vi))
        : (Di = Ni, Li = Ni);
    }(s);
    const n = new qo(s, t), r = !1 !== e.cache;
    delete s.cache, delete e.cache, Di("BUILD", 1);
    try {
    ...
    await n.pluginDriver.hookParallel("buildEnd", []), Li("BUILD", 1);
    const a = {
      cache: r ? n.getCache() : void 0,
      async close() {
        a.closed ||
          (a.closed = !0, await n.pluginDriver.hookParallel("closeBundle", []));
      },
      closed: !1,
      generate: async (e) => a.closed ? se(pe()) : Vh(!1, s, i, e, n),
      watchFiles: Object.keys(n.watchFiles),
      write: async (e) => a.closed ? se(pe()) : Vh(!0, s, i, e, n),
    };
    s.perf && (a.getTimings = Mi);
    return a;
  }(e, null);
}
function Oh(e, t) {
...
async function Vh(e, t, s, i, n) {
  const { options: r, outputPluginDriver: a, unsetOptions: o } = function (
      e,
      t,
      s,
      i,
      ...
      const n = Ko(e.plugins);
      Oh(n, "at output position ");
      const r = t.createOutputPluginDriver(n);
      return { ...Bh(s, i, e, r), outputPluginDriver: r };
    ...
    await Promise.all(
      Object.values(l).map((e) =>
        async function (e, t) {
          ...
          let i, n;
          if (await No.mkdir(I(s), { recursive: !0 }), "asset" === e.type) {
            n = e.source;
            ...
            "inline" === t.sourcemap
              ? r = e.map.toUrl()
              : (r = `${C(e.fileName)}.map`,
                i = No.writeFile(`${s}.map`, e.map.toString())),
              "hidden" !== t.sourcemap && (n += `//# sourceMappingURL=${r}\n`);
          }
          return Promise.all([No.writeFile(s, n), i]);
        }(e, r)),
    ), await a.hookParallel("writeBundle", [r, l]);
  }
  return c = l,
    {
      output: Object.values(c).filter((e) => Object.keys(e).length > 0).sort(
        (e, t) => {
          const s = zh(e), i = zh(t);
...
function Bh(e, t, s, i) {
  return function (e, t, s) {
    ...
    const c = new Set(s),
      ...
      y = {
        amd: Ph(e),
        assetFileNames: null !== (i = e.assetFileNames) && void 0 !== i
          ? i
          : "assets/[name]-[hash][extname]",
        banner: kh(e, "banner"),
        chunkFileNames: null !== (n = e.chunkFileNames) && void 0 !== n ? n
        : "[name]-[hash].js",
        compact: u,
        dir: wh(e, m),
        dynamicImportFunction: Ch(e, t),
        entryFileNames: Ih(e, c),
        esModule: null === (r = e.esModule) || void 0 === r || r,
        exports: Nh(e, c),
        extend: e.extend || !1,
        externalLiveBindings: null === (a = e.externalLiveBindings) ||
          void 0 === a || a,
        file: m,
        footer: kh(e, "footer"),
        format: d,
        freeze: null === (o = e.freeze) || void 0 === o || o,
        generatedCode: _h(e, g),
        globals: e.globals || {},
        hoistTransitiveImports: null === (h = e.hoistTransitiveImports) ||
          void 0 === h || h,
        indent: $h(e, u),
        inlineDynamicImports: p,
        interop: Rh(e, t),
        intro: kh(e, "intro"),
        manualChunks: Mh(e, p, f, t),
        minifyInternalExports: Dh(e, d, u),
        name: e.name,
        ...
        preferConst: g,
        preserveModules: f,
        preserveModulesRoot: Ah(e),
        sanitizeFileName: "function" == typeof e.sanitizeFileName
          ? e.sanitizeFileName : !1 === e.sanitizeFileName ? (e) => e : yh,
    ...
    return Yo(e, Object.keys(y), "output options", t.onwarn),
      { options: y, unsetOptions: c };
  }(
    i.hookReduceArg0Sync("outputOptions", [s.output || s], (e, t) =>
      t || e, (e) => {
      const t = () =>
        e.error({
          code: ne.CANNOT_EMIT_FROM_OPTIONS_HOOK,
          message:
...
export { e as VERSION, Lh as rollup, Wh as defineConfig };
