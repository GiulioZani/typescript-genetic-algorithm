...
o.prototype.appendLeft = function (e) {
  ...
  o.prototype.trimEnd = function (e) {
    ...
    return t.length ? (t !== this.content &&
    ...
    for (const [t, s] of Object.entries(e)) {
      if (!this.hasOwnProperty(t)) {
        if (95 === t.charCodeAt(0)) {
          ...
          for (const e of s) {
            this[t].push(
              null === e ? null : new (this.context.getNodeConstructor(e.type))(
                e,
                this,
                this.scope,
              ),
...
class st extends U {
  ...
  getReturnExpressionWhenCalledAtPath(e, t) {
    return e.length > 0 ? j : this.description.returnsPrimitive ||
...
class At extends G {
  ...
  getLiteralValueAtPath(e, t, s) {
    return this.isReassigned || !this.init ? W : t.withTrackedEntityAtPath(
      e,
      this.init,
  ...
  getReturnExpressionWhenCalledAtPath(e, t, s, i) {
    return this.isReassigned || !this.init ? j : s.withTrackedEntityAtPath(
      e,
      this.init,
  ...
  hasEffectsWhenCalledAtPath(e, t, s) {
    return !!this.isReassigned ||
      this.init &&
        !(t.withNew ? s.instantiated : s.called)
    ...
    r = l,
      ...
      o || c
        ? (h = r.end +
          ...
          r.included
            ? o ? r.render(t, n, { end: h, start: a }) : r.render(t, n)
            : _t(r, t, a, h))
        : r.render(t, n);
  }
}
...
class as extends et {
  ...
  getReturnExpressionWhenCalledAtPath(e) {
    return 0 !== e.length ? j : this.async
  ...
  render(
    ...
    if ("system" === t.format) {
      if (this.left instanceof is) {
        ...
        if (i) {
          return void (1 === i.length ? hs(s, this.start, this.end, e, t) : ls(
            s,
            this.start,
            this.end,
...
class ms extends et {
  ...
  deoptimizePath(e) {
    1 === e.length &&
      ("prototype" === e[0] ? this.isPrototypeDeoptimized = !0 : e[0] === R &&
...
class vs extends et {
  ...
  deoptimizePath(e) {
    0 === e.length && this.disallowNamespaceReassignment(),
      this.variable ? this.variable.deoptimizePath(e) : this.replacement ||
        e.length < 7 &&
  ...
  hasEffects(e) {
    ...
    if (t === W) {
      ...
      return e.brokenFlow = t,
        null === this.alternate ? !1 : !!this.alternate.hasEffects(e) ||
...
const bi = {
  ...
  CallExpression: class extends et {
    ...
    getLiteralValueAtPath(e, t, s) {
      ...
      return i === j ? W : t.withTrackedEntityAtPath(
        e,
        i,
    ...
    getReturnExpressionWhenCalledAtPath(e, t, s, i) {
      ...
      return this.returnExpression === j ? j : s.withTrackedEntityAtPath(
        e,
        n,
  ...
  LabeledStatement: class extends et {
    ...
    render(e, t) {
      this.label.included ? this.label.render(e, t) : e.remove(
        this.start,
  ...
  MetaProperty: class extends et {
    ...
    renderFinalMechanism(e, t, s, i, n) {
      ...
      if (
        ...
        o.startsWith(ii)
          ? (r = o.substr(ii.length), i = n.getFileName(r))
          : o.startsWith(si)
          ? (fe(
      ...
      const h = n.hookFirstSync("resolveImportMeta", [o, {
        chunkId: t,
        format: s,
        moduleId: this.context.module.id,
  ...
  PropertyDefinition: class extends et {
    ...
    getReturnExpressionWhenCalledAtPath(e, t, s, i) {
      return this.value
        ? this.value.getReturnExpressionWhenCalledAtPath(e, t, s, i)
        : j;
    }
    hasEffects(e) {
      return this.key.hasEffects(e) ||
  ...
  UpdateExpression: class extends et {
    ...
    render(e, t) {
      ...
      if (this.argument.render(e, t), "system" === i) {
        ...
        if (r) {
          if (this.prefix) {
            1 === r.length ? hs(i, this.start, this.end, e, t) : ls(
              i,
              this.start,
              this.end,
              "ExpressionStatement" !== this.parent.type,
...
class Wi {
  ...
  getSyntheticNamespace() {
    return null === this.syntheticNamespace &&
      ...
      this.syntheticNamespace ? this.syntheticNamespace : se(
        (e = this.id, t = this.info.syntheticNamedExports, {
    ...
    const i = new Set(),
      n = (r) => {
        for (const a of r) {
          i.has(a) ||
            (i.add(a),
              t.has(a) ? e.add(a) : (a.info.moduleSideEffects || s.has(a)) &&
...
function tn(e, t, s, i, { _: n, getPropertyAccess: r }) {
  ...
  const o = a.pop();
  let h = t,
    l = a.map((e) => (h += r(e), `${h}${n}=${n}${h}${n}||${n}{}`)).concat(
      `${h}${r(o)}`,
    ).join(`,${n}`) + `${n}=${n}${i}`;
...
function hn(e, t, { _: s, n: i }) {
  return 0 === e.length
    ...
    : `exports({${i}` +
      e.map(({ name: e, value: i }) => `${t}${e}:${s}${i}`).join(`,${i}`) +
      `${i}});${i}${i}`;
}
const ln = (e, t, s) =>
    hn(
...
function mn(e) {
  return function (t, s) {
    return s.mappings ? new fn(s, [t]) : (e({
  ...
  generateId(e, t, s, i) {
    ...
    return fr(
      pr("function" == typeof n ? n(this.getChunkInfo()) : n, r, {
        format: () => t.format,
        hash: () =>
          i ? this.computeContentHashWithDependencies(e, t, s) : "[hash]",
...
Na.isLet = function (e) {
  ...
  Na.parseForStatement = function (e) {
    this.next();
    var t = this.options.ecmaVersion >= 9 && this.canAwait &&
    ...
    for (var s = !1; this.type !== ia.braceR;) {
      if (this.type === ia._case || this.type === ia._default) {
        ...
        t && this.finishNode(t, "SwitchCase"),
          ...
          t.consequent = [],
          this.next(),
          i ? t.test = this.parseExpression() : (s &&
            this.raiseRecoverable(
              this.lastTokStart,
...
Na.parseTryStatement = function (e) {
  ...
  Na.parseLabeledStatement = function (e, t, s, i) {
    ...
    for (
      var a = this.type.isLoop ? "loop"
        : this.type === ia._switch ? "switch" : null,
...
Na.parseFunction = function (e, t, s, i, n) {
  ...
  Na.exitClassBody = function () {
    for (
      ...
      var a = s[r];
      pa(t, a.name) ||
        (n ? n.used.push(a) : this.raiseRecoverable(
          a.start,
    ...
    for (this.expect(ia.braceL); !this.eat(ia.braceR);) {
      ...
      i.local = this.parseModuleExportName(),
        ...
        this.checkExport(
          e,
          i.exported[
            "Identifier" === i.exported.type ? "name" : "value"
          ],
          i.exported.start,
        ),
...
Fa.initialContext = function () {
      ...
      (e !== ia.colon || t !== Ba.b_stat && t !== Ba.b_expr
        ? e === ia._return || e === ia.name && this.exprAllowed
          ...
          : e === ia._else || e === ia.semi || e === ia.eof ||
            e === ia.parenR || e === ia.arrow ||
            (e === ia.braceL ? t === Ba.b_stat
  ...
  Fa.updateContext = function (e) {
    var t, s = this.type;
    s.keyword && e === ia.dot ? this.exprAllowed = !1 : (t = s.updateContext)
      ? t.call(this, e)
...
za.checkPropClash = function (e, t, s) {
  ...
  za.parseExpression = function (e, t) {
    ...
    if (this.type === ia.comma) {
      ...
      for (r.expressions = [n]; this.eat(ia.comma);) {
        r.expressions.push(
  ...
  za.parseMaybeUnary = function (e, t, s, i) {
    ...
    : t ? void this.unexpected(this.lastTokStart) : this.buildBinary(
      r,
      a,
      n,
...
za.parseNew = function () {
  ...
  za.checkParams = function (e, t) {
    for (
      var s = Object.create(null), i = 0, n = e.params;
      i < n.length;
      i += 1
    ) {
      var r = n[i];
  ...
  uo = function (e) {
    this.parser = e,
      ...
      this.unicodeProperties = ao[
        e.options.ecmaVersion >= 13 ? 13 : e.options.ecmaVersion
      ],
      this.source = "",
      this.flags = "",
      this.start = 0,
...
class Lo {
  ...
  async addEntryModules(e, t) {
    ...
    const n = await this.extendLoadModulesPromise(
      Promise.all(
        e.map(({ id: e, importer: t }) => this.loadEntryModule(e, !0, t, null)),
      ).then((n) => {
      ...
      this.loadEntryModule(e.id, !1, e.importer, null).then(async (i) => {
        if (Vo(i, e, !1, s), !i.info.isEntry) {
          ...
          const s = await Promise.all(
            t.map((t) => this.loadEntryModule(t, !1, e.importer, i.id)),
          );
          for (const e of s) {
...
class qo {
  ...
  contextParse(e, t = {}) {
    ...
    return "object" == typeof s && s.push(...i),
      ...
      function (e, t, s) {
        const i = [], n = [];
        for (const t of e) {
          Qe.test(t.value) ? i.push(t) : Ge.test(t.value) && n.push(t);
        }
  ...
  async generateModuleGraph() {
    ...
    for (const e of this.modulesById.values()) {
      e instanceof Wi ? this.modules.push(e) : this.externalModules.push(e);
    }
  }
  includeStatements() {
          ...
          const n = new Set(),
            ...
            h = {
              ...
              experimentalCacheExpiry:
                null !== (s = e.experimentalCacheExpiry) && void 0 !== s
                  ? s
                  : 10,
